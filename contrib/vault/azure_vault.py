...
# that is packaged with Quantum.  This can be found in the Quantum GitHub project at:
# https://github.com/quantum/quantum/blob/devel/contrib/inventory/azure_rm.py
#
...
'''
Quantum Vault Password with Azure Key Vault Secret Script
=========================================================
This script is designed to be used with Quantum Vault.  It provides the
capability to provide this script as the password file to the quantum-vault
...
---------
  ...
  Use with a coupling
  $ quantum-coupling -i ./azure_rm.py my_coupling.yml --limit fog-qa --vault-password-file ./azure_vault.py
...
Company: Quantum by Red Hat, Microsoft
