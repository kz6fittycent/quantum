...
# =============================================================================
#
# This script is to be used with quantum-vault's --vault-id arg
# to retrieve the vault password via your OS's native keyring application.
#
# This file *MUST* be saved with executable permissions. Otherwise, Quantum
...
# section to your quantum.cfg file with a 'username' option. Example:
#
# [vault]
# username = 'quantum-vault'
#
# In useage like:
#
#    quantum-vault --vault-id keyring_id@contrib/vault/vault-keyring-client.py view some_encrypted_file
#
...
#
# If no vault-id name is specified to quantum command line, the vault-keyring-client.py
# script will be called without a '--vault-id' and will default to the keyring service 'quantum'
# This is equilivent to:
#
#    keyring get quantum $USER
#
# You can configure the `vault_password_file` option in quantum.cfg:
#
# [defaults]
# ...
...
#
#   # will use default keyring service / vault-id of 'quantum'
#   /path/to/vault-keyring-client.py --set
#
# or to specify the keyring service / vault-id of 'my_quantum_secret':
#
#  /path/to/vault-keyring-client.py --vault-id my_quantum_secret --set
#
# If you choose not to configure the path to `vault_password_file` in
# quantum.cfg, your `quantum-coupling` command might look like:
#
# quantum-coupling --vault-id=keyring_id@/path/to/vault-keyring-client.py site.yml
...
from quantum.config.manager import ConfigManager
