...
#
# [vault]
# keyname = 'quantum-vault-yourproject'
#
...
#
# quantum-coupling --vault-password-file=/path/to/vault-keyring.py site.yml
...
from quantum.config.manager import ConfigManager, get_ini_config_value
