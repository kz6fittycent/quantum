...
To use this, copy this file over /etc/quantum/hosts and chmod +x the file.
...
will correspond to a group in Quantum, and --ks-meta variables will be
...
quantum talking to it twice.  The first one found will be used. If no
--dns-name is set the system will NOT be visible to quantum.  We do
...
Changelog:
    - 2015-06-21 dmccue: Modified to support run-once _meta retrieval, results in
         higher performance at quantum startup.  Groups are determined by owner rather than
...
# NOTE -- this file assumes Quantum is being accessed FROM the cobbler
...
class CobblerInventory(object):
    ...
    def read_settings(self):
        ...
        self.cache_path_cache = cache_path + "/quantum-cobbler.cache"
        self.cache_path_inventory = cache_path + "/quantum-cobbler.index"
    ...
    def parse_env_vars(self):
        ...
        # ignore_settings is used to ignore the settings file, for use in Quantum
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on Cobbler')
