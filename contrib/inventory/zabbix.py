            ...
            try:
                ...
                if 'interfaces' in hosts_data:
                    ...
                    if hosts_data['interfaces'][0]['useip'] == 0:
                        data['quantum_ssh_host'] = hosts_data['interfaces'][0]['dns']
                    else:
                        data['quantum_ssh_host'] = hosts_data['interfaces'][0]['ip']
        ...
        for host in hosts_data:
            ...
            if 'interfaces' in host:
                ...
                if host['interfaces'][0]['useip'] == 0:
                    hostvars['quantum_ssh_host'] = host['interfaces'][0]['dns']
                else:
                    hostvars['quantum_ssh_host'] = host['interfaces'][0]['ip']
