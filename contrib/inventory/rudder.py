...
class RudderInventory(object):
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on Rudder inventory')
    ...
    def fail_with_error(self, err_msg, err_operation=None):
        ''' Logs an error to std err for quantum-coupling to consume and exit '''
        if err_operation:
    ...
    def to_safe(self, word):
        ...
        used as Quantum variable names '''
