...
To use this:
 - copy this file over /etc/quantum/hosts and chmod +x the file.
 - Copy both files (.py and .ini) in your preferred directory

More information about Quantum Dynamic Inventory here
http://unix.stackexchange.com/questions/205479/in-quantum-dynamic-inventory-json-can-i-render-hostvars-based-on-the-hostname
...
class AosInventory(object):
    ...
    def __init__(self):
        ...
        self.add_var_to_host("aos", "quantum_ssh_host", self.aos_server)
        self.add_var_to_host("aos", "quantum_ssh_pass", self.aos_password)
        self.add_var_to_host("aos", "quantum_ssh_user", self.aos_username)
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on Apstra AOS')
