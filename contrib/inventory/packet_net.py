...
class PacketInventory(object):
    ...
    def read_settings(self):
        ...
        self.cache_path_cache = cache_dir + "/quantum-packet.cache"
        self.cache_path_index = cache_dir + "/quantum-packet.index"
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on Packet')
