...
class LibcloudInventory(object):
    ...
    def read_settings(self):
        ...
        self.cache_path_cache = cache_path + "/quantum-libcloud.cache"
        self.cache_path_index = cache_path + "/quantum-libcloud.index"
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on libcloud supported providers')
