...
NOTE: This script assumes Quantum is being executed where the environment
...
the AWS_PROFILE variable:
    ...
    AWS_PROFILE=prod quantum-coupling -i ec2.py mycoupling.yml
...
'webserver-quantum-blue-172.31.0.1'
'''
...
from quantum.module_utils import ec2 as ec2_utils
...
class Ec2Inventory(object):
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on EC2')
    ...
    def connect_to_aws(self, module, region):
        ...
        if self.iam_role:
            ...
            role = sts_conn.assume_role(self.iam_role, 'quantum_dynamic_inventory')
    ...
    def fail_with_error(self, err_msg, err_operation=None):
        '''log an error to std err for quantum-coupling to consume and exit'''
        if err_operation:
    ...
    def add_instance(self, instance, region):
        ...
        self.inventory["_meta"]["hostvars"][hostname]['quantum_host'] = dest
