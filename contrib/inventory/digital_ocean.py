...
Generates Quantum inventory of DigitalOcean Droplets.

In addition to the --list and --host options used by Quantum, there are options
...
location is /tmp/quantum-digital_ocean.cache).
...
Produce an Quantum Inventory file based on DigitalOcean credentials

optional arguments:
  -h, --help            show this help message and exit
  --list                List all active Droplets as Quantum inventory
                        (default: True)
  --host HOST           Get all Quantum inventory variables about a specific
                        Droplet
...
# https://github.com/quantum/quantum/blob/devel/contrib/inventory/ec2.py
#
...
class DigitalOceanInventory(object):
    ...
    def __init__(self):
        ...
        self.inventory = {}  # Quantum Inventory
        ...
        # Manage cache
        self.cache_filename = self.cache_path + "/quantum-digital_ocean.cache"
    ...
    def read_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on DigitalOcean credentials')

        parser.add_argument('--list', action='store_true', help='List all active Droplets as Quantum inventory (default: True)')
        parser.add_argument('--host', action='store', help='Get all Quantum inventory variables about a specific Droplet')
    ...
    def build_inventory(self):
        """ Build Quantum inventory of droplets """
        self.inventory = {
            'all': {
                'hosts': [],
