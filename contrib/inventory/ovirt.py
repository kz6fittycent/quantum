...
Generates inventory that Quantum can understand by making API requests to
...
Examples:
  ...
  $ quantum -i ovirt.py us-central1-a -m shell -a "/bin/uname -a"
...
USER_AGENT_PRODUCT = "Quantum-ovirt_inventory_plugin"
...
class OVirtInventory(object):
    ...
    def parse_cli_args():
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on ovirt')
    ...
    def node_to_dict(self, inst):
        ...
        return {
            ...
            'quantum_ssh_host': ips[0] if len(ips) > 0 else None
        }
