...
Generates inventory that Quantum can understand by making API requests
Google Compute Engine via the libcloud library.  Full install/configuration
instructions for the gce* modules can be found in the comments of
quantum/test/gce_tests.py.
...
Examples:
  ...
  $ quantum -i gce.py us-central1-a -m shell -a "/bin/uname -a"
...
USER_AGENT_PRODUCT = "Quantum-gce_inventory_plugin"
...
class CloudInventoryCache(object):
    def __init__(self, cache_name='quantum-cloud-cache', cache_path='/tmp',
                 cache_max_age=300):
...
class GceInventory(object):
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(
            description='Produce an Quantum Inventory file based on GCE')
