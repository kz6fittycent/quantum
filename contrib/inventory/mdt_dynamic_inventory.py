...
class MDTInventory(object):
    ...
    def get_hosts(self, hostname=False):
        ...
        # Configure to group name configured in Quantum Tower for this inventory
    ...
    def parse_cli_args(self):
        ...
        '''
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on MDT')
