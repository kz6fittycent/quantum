...
#
# This file is based on https://github.com/quantum/quantum/blob/devel/plugins/inventory/libvirt_lxc.py which is part of Quantum,
# and https://github.com/hnakamur/lxc-quantum-couplings/blob/master/provisioning/inventory-lxc.py
#
...
if distutils.spawn.find_executable('lxc'):
    ...
    result[group]['vars'] = {}
    result[group]['vars']['quantum_connection'] = connection
...
if len(sys.argv) == 2 and sys.argv[1] == '--list':
    ...
    if sys.argv[2] == 'localhost':
        print(json.dumps({'quantum_connection': 'local'}))
    else:
        if connection == 'lxd':
            print(json.dumps({'quantum_connection': connection}))
        else:
            print(json.dumps({'quantum_connection': connection, 'quantum_host': hosts[sys.argv[2]]}))
else:
