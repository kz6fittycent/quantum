...
from quantum.module_utils.six import integer_types, PY3
...
class VMWareInventory(object):
    ...
    def parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on PyVmomi')
    ...
    def instances_to_inventory(self, instances):
        ...
        for idx, instance in enumerate(instances):
            ...
            inventory['_meta']['hostvars'][thisid]['quantum_uuid'] = thisid
        ...
        for k, v in name_mapping.items():
            ...
            # set quantum_host (2.x)
            try:
                inventory['_meta']['hostvars'][k]['quantum_host'] = host_mapping[k]
                # 1.9.x backwards compliance
                inventory['_meta']['hostvars'][k]['quantum_ssh_host'] = host_mapping[k]
            except Exception:
                continue
