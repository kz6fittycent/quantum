...
NOTE: This script assumes Quantum is being executed where Chube is already
...
class LinodeInventory(object):
    ...
    def read_settings(self):
        ...
        self.cache_path_cache = cache_path + "/quantum-linode.cache"
        self.cache_path_index = cache_path + "/quantum-linode.index"
        self.cache_max_age = config.getint('linode', 'cache_max_age')
        self.use_public_ip = config.getboolean('linode', 'use_public_ip')

    def parse_cli_args(self):
        """Command line argument processing"""
        parser = argparse.ArgumentParser(description='Produce an Quantum Inventory file based on Linode')
    ...
    def _get_host_info(self, node):
        ...
        node_vars['quantum_ssh_host'] = node_vars["public_ip"]
        node_vars['quantum_host'] = node_vars["public_ip"]
    ...
    def to_safe(self, word):
        """Escapes any characters that would be invalid in an quantum group name."""
