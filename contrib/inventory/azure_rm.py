#!/usr/bin/env python
#
# Copyright (c) 2016 Matt Davis, <mdavis@quantum.com>
...
There's new Azure external inventory script at https://github.com/quantum/quantum/blob/devel/lib/quantum/plugins/inventory/azure_rm.py,
...
Examples:
---------
  Execute /bin/uname on all instances in the fog-qa resource group
  $ quantum -i azure_rm.py fog-qa -m shell -a "/bin/uname -a"

  Use the inventory script to print instance specific information
  $ contrib/inventory/azure_rm.py --host my_instance_host_name --pretty

  Use with a coupling
  $ quantum-coupling -i contrib/inventory/azure_rm.py my_coupling.yml --limit fog-qa
...
from quantum.module_utils.six.moves import configparser as cp
import quantum.module_utils.six.moves.urllib.parse as urlparse
...
ANSIBLE_USER_AGENT = 'Quantum/{0}'.format(quantum_version)
...
class AzureInventory(object):
    ...
    def _parse_cli_args(self):
        ...
        parser = argparse.ArgumentParser(
            description='Produce an Quantum Inventory file for an Azure subscription')
    ...
    def _load_machines(self, machines):
        for machine in machines:
            ...
            if machine.os_profile is not None and machine.os_profile.windows_configuration is not None:
                host_vars['quantum_connection'] = 'winrm'
                ...
                if network_interface.primary:
                    ...
                    for ip_config in network_interface.ip_configurations:
                        ...
                        if self.use_private_ip:
                            host_vars['quantum_host'] = ip_config.private_ip_address
                        if ip_config.public_ip_address:
                            ...
                            if not self.use_private_ip:
                                host_vars['quantum_host'] = public_ip_address.ip_address
    ...
    def _to_safe(self, word):
        ''' Converts 'bad' characters in a string to underscores so they can be used as Quantum groups '''
        regex = r"[^A-Za-z0-9\_"
