...
from quantum.module_utils.six import integer_types, text_type, string_types
...
class VMwareInventory(object):
    ...
    def _get_host_info(self, host, prefix='vmware'):
        ...
        if ('%s_ipAddress' % prefix) in host_info:
            host_info['quantum_ssh_host'] = host_info['%s_ipAddress' % prefix]
        return host_info
    ...
    def _get_vm_info(self, vm, prefix='vmware'):
        ...
        if ('%s_ipAddress' % prefix) in vm_info:
            vm_info['quantum_ssh_host'] = vm_info['%s_ipAddress' % prefix]
        return vm_info
