...
#
# some Quantum modules that may use Powershell 3 features, so systems may need
# to be upgraded.  This may be used by a sample coupling.  Refer to the windows
# documentation on docs.quantum.com for details.
#
# - hosts: windows
#   tasks:
