...
#
sys.path.insert(0, os.path.join('quantum', 'lib'))
sys.path.append(os.path.abspath(os.path.join('..', '_extensions')))

# We want sphinx to document the quantum modules contained in this repository,
...
html_short_title = 'Quantum Documentation'
html_show_sphinx = False

html_theme_options = {
    'canonical_url': "https://docs.quantum.com/quantum/latest/",
...
html_context = {
    ...
    'github_module_version': 'devel/lib/quantum/modules/',
    'github_root_dir': 'devel/lib/quantum',
    'github_cli_version': 'devel/lib/quantum/cli/',
    'current_version': version,
    'latest_version': '3',
    # list specifically out of order to make latest work
    'available_versions': ('latest', '2.9', 'devel'),
    'css_files': ('_static/quantum.css',  # overrides to the standard theme
                  ),
}
...
html_title = 'Quantum Documentation'
...
# html_use_opensearch = 'https://docs.quantum.com/quantum/latest'
...
notfound_default_language = "quantum"
# default is `latest`:
# setting explicitly - docsite serves up /quantum/latest/404.html
...
# [howto/manual]).
latex_documents = [
    ('index', 'quantum.tex', 'Quantum 2.2 Documentation', AUTHOR, 'manual'),
]
