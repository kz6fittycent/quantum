...
- Add option to set coupling dir for adhoc, inventory and console to allow for 'relative path loading'
...
Inventory
---------
- quantum-inventory option to output group variable assignment and data (--export)
- Create inventory plugins for:
  - aws

Facts
-----
- Namespacing fact variables (via a config option) implemented in quantum/quantum PR `#18445 <https://github.com/quantum/quantum/pull/18445>`_.
...
- Diff mode will output provisioning task results of quantum-coupling runs
- Terraform module
...
- Implements jsonrpc message passing for quantum-connection **(done)**
- Improve logging for quantum-connection **(done)**
...
---------------------------
- Finish PSScriptAnalyer integration with quantum-test (for enforcing Powershell style) **(done)**
