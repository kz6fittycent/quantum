...
* New connection plugin: eAPI `proposal#102 <https://github.com/quantum/proposals/issues/102>`_
...
* New ``netconf_get`` - Netconf module to fetch configuration and state data `proposal#104 <https://github.com/quantum/proposals/issues/104>`_
