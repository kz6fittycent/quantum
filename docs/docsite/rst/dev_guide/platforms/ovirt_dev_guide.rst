...
.. code:: python
    ...
    # Create the Quantum module, please always implement the
...
-  Integration testing is currently done in oVirt's CI system
   `on Jenkins <https://jenkins.ovirt.org/view/All/job/ovirt-system-tests_quantum-suite-master/>`__
   and
   `on GitHub <https://github.com/oVirt/ovirt-system-tests/tree/master/quantum-suite-master/>`__.
