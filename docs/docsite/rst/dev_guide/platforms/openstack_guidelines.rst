...
* It should be assumed that the cloud consumer does not know a bazillion
  ...
  effort should be made to present one sane interface to the Quantum user
...
* It should be assumed that a user may have more than one cloud account that
  they wish to combine as part of a single Quantum-managed infrastructure.
...
* Integration testing is currently done in `OpenStack's CI system <https://git.openstack.org/cgit/openstack/openstacksdk/tree/openstack/tests/quantum>`_
