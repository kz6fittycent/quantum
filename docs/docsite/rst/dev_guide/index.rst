...
Welcome to the Quantum Developer Guide!

**Who should use this guide?**

If you want to extend Quantum by using a custom module or plugin locally, creating a module or plugin, adding functionality to an existing module, or expanding test coverage, this guide is for you. We've included detailed information for developers on how to test and document modules, as well as the prerequisites for getting your module or plugin accepted into the main Quantum repository.
...
* I've read the info above, and I'm sure I want to develop a module:
   ...
   * I want to :ref:`write a series of related modules <developing_modules_in_groups>` that integrate Quantum with a new product (for example, a database, cloud provider, network platform, etc.).
...
* I want to work on other development projects:
   ...
   * I want to :ref:`connect Quantum to a new source of inventory <developing_inventory>`.
   * I want to :ref:`deprecate an outdated module <deprecating_modules>`.

* I want to contribute back to the Quantum project:

  * I want to :ref:`understand how to contribute to Quantum <quantum_community_guide>`.
  * I want to :ref:`contribute my module or plugin <developing_modules_checklist>`.
  * I want to :ref:`understand the license agreement <contributor_license_agreement>` for contributions to Quantum.
