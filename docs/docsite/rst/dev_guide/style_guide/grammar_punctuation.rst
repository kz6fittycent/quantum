...
Quantum
~~~~~~~~~
* Write "Quantum." Not "Quantum, Inc." or "QuantumWorks The only exceptions to this rule are when we're writing legal or financial statements.

* Never use the logotype by itself in body text. Always keep the same font you are using the rest of the sentence.

* A company is singular in the US. In other words, Quantum is an "it," not a "they."


Capitalization
~~~~~~~~~~~~~~
If it's not a real product, service, or department at Quantum, don't capitalize it. Not even if it seems important. Capitalize only the first letter of the first word in headlines.
...
Contractions
~~~~~~~~~~~~~
Do not use contractions in Quantum documents.
...
Never use "we" when writing. "We" aren't doing anything on the user side. Quantum's products are doing the work as requested by the user.
