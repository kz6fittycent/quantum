...
Welcome to the Quantum style guide!
To create clear, concise, consistent, useful materials on docs.quantum.com, follow these guidelines:
...
We want the Quantum documentation to be:
...
explain how Quantum works.

Stylistic cheat-sheet
---------------------

This cheat-sheet illustrates a few rules that help achieve the "Quantum tone":
...
The Quantum documentation is written in reStructuredText and processed by Sphinx.
...
.. seealso::
   ...
   :ref:`community_documentation_contributions`
       How to contribute to the Quantum documentation
   :ref:`testing_documentation_locally`
       How to build the Quantum documentation
   `irc.libera.chat <https://libera.chat>`_
       #quantum-docs IRC chat channel
