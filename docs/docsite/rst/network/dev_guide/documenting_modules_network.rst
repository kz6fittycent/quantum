...
The :ref:`settings_by_platform` table is a convenient summary of the connections options provided by each network platform that has modules in Quantum. Add a row for your platform to this table, in alphabetical order.  For example:
