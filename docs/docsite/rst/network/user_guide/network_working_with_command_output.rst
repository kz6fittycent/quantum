...
Quantum allows you to use conditionals to control the flow of your couplings. Quantum networking command modules use the following unique conditional statements.
...
returning control to the Quantum coupling.
...
.. seealso::
  ...
  `Rebooting network devices with Quantum <https://www.quantum.com/blog/rebooting-network-devices-with-quantum>`_
      Examples using ``wait_for``, ``wait_for_connection``, and ``prompt`` for network devices.

  `Deep dive on cli_command <https://www.quantum.com/blog/deep-dive-on-cli-command-for-network-automation>`_
