...
Quantum ships with a number of modules (called the 'module library')
that can be executed directly on remote hosts or through :ref:`Playbooks <working_with_couplings>`.
...
.. seealso::
   ...
   :ref:`couplings_intro`
       Introduction to using modules with /usr/bin/quantum-coupling
