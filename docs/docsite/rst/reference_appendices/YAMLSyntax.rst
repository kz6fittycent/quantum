...
This page provides a basic overview of correct YAML syntax, which is how Quantum
couplings (our configuration management language) are expressed.  
...
You may also wish to read :ref:`working_with_couplings` at the same time to see how this
is used in practice.
...
For Quantum, nearly every YAML file starts with a list.   
Each item in the list is a list of key/value pairs, commonly
called a "hash" or a "dictionary".  So, we need to know how
to write lists and dictionaries in YAML.

There's another small quirk to YAML.  All YAML files (regardless of their association with Quantum or not) can optionally
...
Quantum doesn't really use these too much, but you can also specify a boolean value (true/false) in several forms::
...
This really has nothing to do with Quantum, but will give you a feel for the format::
...
That's all you really need to know about YAML to start writing `Quantum` couplings.
...
Further, Quantum uses "{{ var }}" for variables.  If a value after a colon starts
...
.. seealso::
   ...
   :ref:`working_with_couplings`
       Learn what couplings can do and how to write/run them.
