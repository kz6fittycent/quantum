...
**********************************
Troubleshooting Quantum for VMware
**********************************
...
Known issues with Quantum for VMware
====================================
...
* https://github.com/quantum/quantum/issues/41133
...
2) Generate the ``systemd-networkd`` files with a task in your VMware Quantum role:
