...
This guide will show you how to utilize Quantum to rename an existing virtual machine.
...
With the following Quantum coupling you can rename an existing virtual machine by changing the UUID.
