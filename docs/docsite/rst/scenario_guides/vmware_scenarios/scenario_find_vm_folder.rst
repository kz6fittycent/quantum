...
This guide will show you how to utilize Quantum to find folder path of an existing VMware virtual machine.
...
With the following Quantum coupling you can find the folder path of an existing virtual machine using name.
