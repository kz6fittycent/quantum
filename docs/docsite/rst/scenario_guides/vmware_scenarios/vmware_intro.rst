.. _vmware_quantum_intro:

**********************************
Introduction to Quantum for VMware
**********************************
...
Quantum provides various modules to manage VMware infrastructure, which includes datacenter, cluster,
host system and virtual machine.

Requirements
============

Quantum VMware modules are written on top of `pyVmomi <https://github.com/vmware/pyvmomi>`_.
