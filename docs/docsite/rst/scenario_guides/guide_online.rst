...
Quantum has a dynamic inventory plugin that can list your resources.
...
.. code-block:: bash
    ...
    $ quantum-inventory -v -i online_inventory.yml --list


4. Now you can run your coupling or any other module with this inventory:

.. code-block:: console

    $ quantum all -i online_inventory.yml -m ping
    sd-96735 | SUCCESS => {
        "changed": false,
        "ping": "pong"
    }
