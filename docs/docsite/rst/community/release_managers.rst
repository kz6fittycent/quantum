...
* Developers with commit privileges on the `Quantum GitHub repository <https://github.com/quantum/quantum/>`_
* Contributors without commit privileges
* The community
* Quantum documentation team
...
more likely to be considered blockers because they will break present users' usage of Quantum.
...
.. note:: We want to specifically emphasize that code (in :file:`bin/`, :file:`lib/quantum/`, and
