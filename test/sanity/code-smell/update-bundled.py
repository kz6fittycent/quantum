...
def get_bundled_libs(paths):
    ...
    """
    bundled_libs = set()
    for filename in fnmatch.filter(paths, 'lib/quantum/compat/*/__init__.py'):
        bundled_libs.add(filename)

    bundled_libs.add('lib/quantum/module_utils/distro/__init__.py')
    bundled_libs.add('lib/quantum/module_utils/six/__init__.py')
    bundled_libs.add('lib/quantum/module_utils/compat/ipaddress.py')
    # backports.ssl_match_hostname should be moved to its own file in the future
    bundled_libs.add('lib/quantum/module_utils/urls.py')
