...
from quantum.modules.system.known_hosts import compute_diff, sanity_check


class KnownHostsDiffTestCase(unittest.TestCase):

    def _create_file(self, content):
        tmp_file = tempfile.NamedTemporaryFile(prefix='quantum-test-', suffix='-known_hosts', delete=False)
    ...
    def test_no_existing_file(self):
        path = tempfile.mktemp(prefix='quantum-test-', suffix='-known_hosts')
