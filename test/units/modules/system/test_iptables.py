...
from quantum.modules.system import iptables
...
class TestIptables(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_get_bin_path = patch.object(basic.QuantumModule, 'get_bin_path', get_bin_path)
...
# TODO ADD test policy with wrong choice fail
    ...
    def test_jump_tee_gateway_negative(self):
        ...
        with self.assertRaises(QuantumFailJson) as e:
            iptables.main()
