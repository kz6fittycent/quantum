...
from quantum.modules.system.java_keystore import create_jks, cert_changed, ArgumentSpec
...
class TestCreateJavaKeystore(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_create_file = patch('quantum.modules.system.java_keystore.create_file',
                                      side_effect=lambda path, content: path)
        self.mock_run_commands = patch('quantum.modules.system.java_keystore.run_commands')
        ...
        self.mock_selinux_context = patch('quantum.module_utils.basic.QuantumModule.selinux_context',
                                          side_effect=lambda path: ['unconfined_u', 'object_r', 'user_home_t', 's0'])
        self.mock_is_special_selinux_path = patch('quantum.module_utils.basic.QuantumModule.is_special_selinux_path',
