...
from quantum.modules.net_tools.nios import nios_network_view
...
class TestNiosNetworkViewModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_network_view.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}
        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_network_view.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_network_view.WapiModule.run')
    ...
    def test_nios_network_view_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'quantum',
    ...
    def test_nios_network_view_remove(self):
        self.module.params = {'provider': None, 'state': 'absent', 'name': 'quantum',
                              'comment': None, 'extattrs': None}

        ref = "networkview/ZG5zLm5ldHdvcmtfdmlldyQw:quantum/false"
