...
from quantum.modules.net_tools.nios import nios_nsgroup
...
class TestNiosNSGroupModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_nsgroup.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}

        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_nsgroup.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_nsgroup.WapiModule.run')
    ...
    def test_nios_nsgroup_remove(self):
        ...
        ref = "nsgroup/ZG5zLm5ldHdvcmtfdmlldyQw:quantum/false"
