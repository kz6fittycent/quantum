...
from quantum.modules.net_tools.nios import nios_naptr_record
...
class TestNiosNAPTRRecordModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_naptr_record.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}
        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_naptr_record.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_naptr_record.WapiModule.run')
    ...
    def test_nios_naptr_record_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': '*.subscriber-100.quantumzone.com',
                              'order': '1000', 'preference': '10', 'replacement': 'replacement1.network.quantumzone.com',
    ...
    def test_nios_naptr_record_remove(self):
        self.module.params = {'provider': None, 'state': 'absent', 'name': '*.subscriber-100.quantumzone.com',
                              'order': '1000', 'preference': '10', 'replacement': 'replacement1.network.quantumzone.com',
                              'comment': None, 'extattrs': None}
