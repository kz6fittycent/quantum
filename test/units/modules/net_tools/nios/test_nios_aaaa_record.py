...
from quantum.modules.net_tools.nios import nios_aaaa_record
...
class TestNiosAAAARecordModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_aaaa_record.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}
        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_aaaa_record.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_aaaa_record.WapiModule.run')
    ...
    def test_nios_aaaa_record_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'aaaa.quantum.com',
    ...
    def test_nios_aaaa_record_remove(self):
        self.module.params = {'provider': None, 'state': 'absent', 'name': 'aaaa.quantum.com',
                              'ipv6': '2001:0db8:85a3:0000:0000:8a2e:0370:7334', 'comment': None, 'extattrs': None}
    ...
    def test_nios_aaaa_record_update_record_name(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': {'new_name': 'aaaa_new.quantum.com', 'old_name': 'aaaa.quantum.com'},
        ...
        test_object = [
            {
                "comment": "test comment",
                "_ref": "aaaarecord/ZG5zLm5ldHdvcmtfdmlldyQw:default/true",
                "name": "aaaa_new.quantum.com",
                "old_name": "aaaa.quantum.com",
                "extattrs": {}
            }
        ]
