...
from quantum.modules.net_tools.nios import nios_host_record
...
class TestNiosHostRecordModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_host_record.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}

        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_host_record.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_host_record.WapiModule.run')
    ...
    def test_nios_host_record_remove(self):
        ...
        ref = "record:host/ZG5zLm5ldHdvcmtfdmlldyQw:quantum/false"
