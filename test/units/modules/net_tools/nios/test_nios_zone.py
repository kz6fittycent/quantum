...
from quantum.modules.net_tools.nios import nios_zone
...
class TestNiosZoneModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_zone.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}
        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_zone.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_zone.WapiModule.run')
    ...
    def test_nios_zone_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'fqdn': 'quantum.com',
        ...
        wapi.create_object.assert_called_once_with('testobject', {'fqdn': 'quantum.com'})

    def test_nios_zone_remove(self):
        self.module.params = {'provider': None, 'state': 'absent', 'fqdn': 'quantum.com',
                              'comment': None, 'extattrs': None}

        ref = "zone/ZG5zLm5ldHdvcmtfdmlldyQw:quantum/false"
