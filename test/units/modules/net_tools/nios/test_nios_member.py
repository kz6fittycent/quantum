...
from quantum.modules.net_tools.nios import nios_member
...
class TestNiosMemberModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_member.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}
        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_member.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_member.WapiModule.run')
    ...
    def test_nios_member_update(self):
        ...
        test_object = [
            {
                "comment": "Created with Quantum",
                "_ref": "member/b25lLnZpcnR1YWxfbm9kZSQ3:member01.quantum-dev.com",
                "config_addr_type": "IPV4",
                "host_name": "member01.quantum-dev.com",
                "platform": "VNIOS",
    ...
    def test_nios_member_remove(self):
        ...
        ref = "member/b25lLnZpcnR1YWxfbm9kZSQ3:member01.quantum-dev.com"
