...
from quantum.modules.net_tools.nios import nios_ptr_record
from quantum.module_utils.net_tools.nios import api
...
class TestNiosPTRRecordModule(TestNiosModule):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='quantum.modules.net_tools.nios.nios_ptr_record.WapiModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}

        self.mock_wapi = patch('quantum.modules.net_tools.nios.nios_ptr_record.WapiModule')
        self.exec_command = self.mock_wapi.start()
        self.mock_wapi_run = patch('quantum.modules.net_tools.nios.nios_ptr_record.WapiModule.run')
    ...
    def test_nios_ptr_record_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'ptrdname': 'quantum.test.com',
        ...
        wapi.create_object.assert_called_once_with('testobject', {'ipv4addr': '10.36.241.14', 'ptrdname': 'quantum.test.com', 'view': 'default'})

    def test_nios_ptr_record_remove(self):
        self.module.params = {'provider': None, 'state': 'absent', 'ptrdname': 'quantum.test.com',
                              'ipv4addr': '10.36.241.14', 'comment': None, 'extattrs': None, 'view': 'default'}
    ...
    def test_nios_ptr_record_update_record_ptrdname(self):
        self.module.params = {'provider': None, 'state': 'present', 'ptrdname': 'quantum.test.org',
    ...
    def test_nios_ptr6_record_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'ptrdname': 'quantum6.test.com',
        ...
        wapi.create_object.assert_called_once_with('testobject', {'ipv6addr': '2002:8ac3:802d:1242:20d:60ff:fe38:6d16',
                                                                  'ptrdname': 'quantum6.test.com', 'view': 'default'})
