...
from quantum.modules.net_tools import nmcli
...
def mocker_set(mocker, connection_exists=False):
    ...
    """
    mocker.patch('quantum.modules.net_tools.nmcli.HAVE_DBUS', True)
    mocker.patch('quantum.modules.net_tools.nmcli.HAVE_NM_CLIENT', True)
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_BOND, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_GENERIC, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_GENERIC_DNS4_SEARCH, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_CONNECTION, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_BRIDGE, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_BRIDGE_SLAVE, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_VLAN, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_VXLAN, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_IPIP, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_SIT, indirect=['patch_quantum_module'])
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_ETHERNET_DHCP, indirect=['patch_quantum_module'])
