...
from quantum.modules.network.cli import cli_config
...
class TestCliConfigModule(TestCliModule):
    ...
    def setUp(self):
        ...
        self.mock_connection = patch('quantum.modules.network.cli.cli_config.Connection')
    ...
    @patch('quantum.modules.network.cli.cli_config.run')
