...
from quantum.modules.network.check_point import cp_mgmt_threat_exception
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_threat_exception.api_call'
