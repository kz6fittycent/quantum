...
from quantum.modules.network.check_point import cp_mgmt_vpn_community_meshed
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_vpn_community_meshed.api_call'
