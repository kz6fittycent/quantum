...
from quantum.modules.network.check_point import cp_mgmt_threat_profile
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_threat_profile.api_call'
