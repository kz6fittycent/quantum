...
from quantum.modules.network.check_point import cp_mgmt_application_site
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_application_site.api_call'
