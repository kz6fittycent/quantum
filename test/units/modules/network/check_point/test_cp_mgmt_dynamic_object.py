...
from quantum.modules.network.check_point import cp_mgmt_dynamic_object
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_dynamic_object.api_call'
