...
from quantum.modules.network.check_point import cp_mgmt_exception_group
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_exception_group.api_call'
