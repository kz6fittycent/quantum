...
from quantum.modules.network.check_point import cp_mgmt_service_dce_rpc
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_service_dce_rpc.api_call'
