...
from quantum.modules.network.check_point import cp_mgmt_application_site_category
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_application_site_category.api_call'
