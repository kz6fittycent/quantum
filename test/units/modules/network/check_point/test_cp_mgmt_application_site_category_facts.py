...
from quantum.modules.network.check_point import cp_mgmt_application_site_category_facts
...
class TestCheckpointApplicationSiteCategoryFacts(object):
    ...
    def test_show_few_objects(self, mocker, connection_mock):
        ...
        assert OBJECT == result['quantum_facts'][api_call_object_plural_version]
