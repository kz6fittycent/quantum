...
from quantum.modules.network.check_point import cp_mgmt_vpn_community_star
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_vpn_community_star.api_call'
