...
from quantum.modules.network.check_point import checkpoint_session
...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('quantum.modules.network.check_point.checkpoint_session.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def get_session_200(self, mocker):
        mock_function = mocker.patch('quantum.modules.network.check_point.checkpoint_session.get_session')
