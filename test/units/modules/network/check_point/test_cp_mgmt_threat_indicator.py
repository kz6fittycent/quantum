...
from quantum.modules.network.check_point import cp_mgmt_threat_indicator
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_threat_indicator.api_call'
