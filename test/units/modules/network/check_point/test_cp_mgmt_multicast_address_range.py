...
from quantum.modules.network.check_point import cp_mgmt_multicast_address_range
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_multicast_address_range.api_call'
