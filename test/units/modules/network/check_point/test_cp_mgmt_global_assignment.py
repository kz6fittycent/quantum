...
from quantum.modules.network.check_point import cp_mgmt_global_assignment
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_global_assignment.api_call'
