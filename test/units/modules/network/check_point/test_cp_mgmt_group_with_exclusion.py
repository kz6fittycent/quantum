...
from quantum.modules.network.check_point import cp_mgmt_group_with_exclusion
...
function_path = 'quantum.modules.network.check_point.cp_mgmt_group_with_exclusion.api_call'
