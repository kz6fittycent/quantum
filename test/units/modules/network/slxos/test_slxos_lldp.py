...
from quantum.modules.network.slxos import slxos_lldp
...
class TestSlxosLldpModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.slxos.slxos_lldp.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.slxos.slxos_lldp.load_config'
        )
