...
from quantum.modules.network.slxos import slxos_interface
...
class TestSlxosInterfaceModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.slxos.slxos_interface.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.slxos.slxos_interface.load_config'
        )
        self._patch_exec_command = patch(
            'quantum.modules.network.slxos.slxos_interface.exec_command'
        )
