...
from quantum.modules.network.slxos import slxos_facts
...
class TestSlxosFactsModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.slxos.slxos_facts.run_commands')
    ...
    def test_slxos_facts(self):
        ...
        self.assertEqual(
            result['quantum_facts']['quantum_net_model'], 'BR-SLX9140'
        )
        self.assertEqual(
            result['quantum_facts']['quantum_net_serialnum'], 'EXH3349M005'
        )
