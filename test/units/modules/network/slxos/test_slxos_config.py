...
from quantum.modules.network.slxos import slxos_config
...
class TestSlxosConfigModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.slxos.slxos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.slxos.slxos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('quantum.modules.network.slxos.slxos_config.run_commands')
