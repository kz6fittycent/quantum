...
from quantum.modules.network.slxos import slxos_linkagg
...
class TestSlxosLinkaggModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.slxos.slxos_linkagg.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.slxos.slxos_linkagg.load_config'
        )
