...
from quantum.modules.network.slxos import slxos_vlan
...
class TestSlxosVlanModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_run_commands = patch(
            'quantum.modules.network.slxos.slxos_vlan.run_commands'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.slxos.slxos_vlan.load_config'
        )
