...
from quantum.modules.network.slxos import slxos_l2_interface
...
class TestSlxosL2InterfaceModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.slxos.slxos_l2_interface.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.slxos.slxos_l2_interface.load_config'
        )
        self._patch_run_commands = patch(
            'quantum.modules.network.slxos.slxos_l2_interface.run_commands'
        )
