...
from quantum.modules.network.dellos10 import dellos10_command
...
class TestDellos10CommandModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.dellos10.dellos10_command.run_commands')
