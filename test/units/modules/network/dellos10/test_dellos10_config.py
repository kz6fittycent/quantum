...
from quantum.modules.network.dellos10 import dellos10_config
...
class TestDellos10ConfigModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.dellos10.dellos10_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.dellos10.dellos10_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('quantum.modules.network.dellos10.dellos10_config.run_commands')
