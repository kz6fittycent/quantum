...
from quantum.modules.network.iosxr import iosxr_config
from quantum.plugins.cliconf.iosxr import Cliconf
...
class TestIosxrConfigModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.patcher_get_config = patch('quantum.modules.network.iosxr.iosxr_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()

        self.patcher_exec_command = patch('quantum.modules.network.iosxr.iosxr_config.load_config')
        self.mock_exec_command = self.patcher_exec_command.start()

        self.mock_get_connection = patch('quantum.modules.network.iosxr.iosxr_config.get_connection')
