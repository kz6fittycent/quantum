...
from quantum.modules.network.iosxr import iosxr_netconf
...
class TestIosxrNetconfModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.iosxr.iosxr_netconf.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.iosxr.iosxr_netconf.load_config')
