...
from quantum.modules.network.ingate import ig_unit_information
...
class TestUnitInformationModule(TestIngateModule):
    ...
    def setUp(self):
        ...
        self.mock_make_request = patch('quantum.modules.network.ingate.'
                                       'ig_unit_information.make_request')
        self.make_request = self.mock_make_request.start()

        self.mock_is_ingatesdk_installed = patch('quantum.modules.network.ingate.'
