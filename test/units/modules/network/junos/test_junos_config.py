...
from quantum.modules.network.junos import junos_config
...
class TestJunosConfigModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.junos.junos_config.get_configuration')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.junos.junos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_load_configuration = patch('quantum.modules.network.junos.junos_config.load_configuration')
        self.load_configuration = self.mock_load_configuration.start()

        self.mock_lock_configuration = patch('quantum.module_utils.network.junos.junos.lock_configuration')
        self.lock_configuration = self.mock_lock_configuration.start()

        self.mock_unlock_configuration = patch('quantum.module_utils.network.junos.junos.unlock_configuration')
        self.unlock_configuration = self.mock_unlock_configuration.start()

        self.mock_commit_configuration = patch('quantum.modules.network.junos.junos_config.commit_configuration')
        self.commit_configuration = self.mock_commit_configuration.start()

        self.mock_get_diff = patch('quantum.modules.network.junos.junos_config.get_diff')
        self.get_diff = self.mock_get_diff.start()

        self.mock_conn = patch('quantum.module_utils.connection.Connection')
        ...
        self.mock_exec_rpc = patch('quantum.modules.network.junos.junos_config.exec_rpc')
