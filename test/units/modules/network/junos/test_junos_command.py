...
from quantum.modules.network.junos import junos_command
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_conn = patch('quantum.module_utils.network.junos.junos.Connection')
        ...
        self.mock_exec_rpc = patch('quantum.modules.network.junos.junos_command.exec_rpc')
        ...
        self.mock_get_connection = patch('quantum.modules.network.junos.junos_command.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.mock_get_capabilities = patch('quantum.modules.network.junos.junos_command.get_capabilities')
