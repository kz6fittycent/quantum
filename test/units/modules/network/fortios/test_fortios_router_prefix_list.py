...
try:
    from quantum.modules.network.fortios import fortios_router_prefix_list
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_router_prefix_list.Connection')
