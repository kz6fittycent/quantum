...
try:
    from quantum.modules.network.fortios import fortios_firewall_service_group
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_firewall_service_group.Connection')
