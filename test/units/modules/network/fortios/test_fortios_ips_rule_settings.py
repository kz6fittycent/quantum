...
try:
    from quantum.modules.network.fortios import fortios_ips_rule_settings
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_ips_rule_settings.Connection')
