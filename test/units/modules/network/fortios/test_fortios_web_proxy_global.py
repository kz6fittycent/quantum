...
try:
    from quantum.modules.network.fortios import fortios_web_proxy_global
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_web_proxy_global.Connection')
