...
try:
    from quantum.modules.network.fortios import fortios_wanopt_remote_storage
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_wanopt_remote_storage.Connection')
