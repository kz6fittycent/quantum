...
try:
    from quantum.modules.network.fortios import fortios_switch_controller_security_policy_802_1X
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_switch_controller_security_policy_802_1X.Connection')
