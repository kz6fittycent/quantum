...
try:
    from quantum.modules.network.fortios import fortios_wireless_controller_hotspot20_anqp_3gpp_cellular
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_wireless_controller_hotspot20_anqp_3gpp_cellular.Connection')
