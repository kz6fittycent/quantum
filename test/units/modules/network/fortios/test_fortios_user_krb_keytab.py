...
try:
    from quantum.modules.network.fortios import fortios_user_krb_keytab
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_user_krb_keytab.Connection')
