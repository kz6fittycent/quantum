...
try:
    from quantum.modules.network.fortios import fortios_dlp_filepattern
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_dlp_filepattern.Connection')
