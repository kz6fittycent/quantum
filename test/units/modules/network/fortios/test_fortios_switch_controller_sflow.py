...
try:
    from quantum.modules.network.fortios import fortios_switch_controller_sflow
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_switch_controller_sflow.Connection')
