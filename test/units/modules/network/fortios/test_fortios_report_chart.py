...
try:
    from quantum.modules.network.fortios import fortios_report_chart
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_report_chart.Connection')
