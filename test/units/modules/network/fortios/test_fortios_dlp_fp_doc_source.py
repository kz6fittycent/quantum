...
try:
    from quantum.modules.network.fortios import fortios_dlp_fp_doc_source
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_dlp_fp_doc_source.Connection')
