...
try:
    from quantum.modules.network.fortios import fortios_webfilter_ips_urlfilter_setting6
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_webfilter_ips_urlfilter_setting6.Connection')
