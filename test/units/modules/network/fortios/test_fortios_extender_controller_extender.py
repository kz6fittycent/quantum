...
try:
    from quantum.modules.network.fortios import fortios_extender_controller_extender
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_extender_controller_extender.Connection')
