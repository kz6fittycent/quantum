...
try:
    from quantum.modules.network.fortios import fortios_web_proxy_forward_server
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_web_proxy_forward_server.Connection')
