...
try:
    from quantum.modules.network.fortios import fortios_vpn_ssl_web_host_check_software
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_vpn_ssl_web_host_check_software.Connection')
