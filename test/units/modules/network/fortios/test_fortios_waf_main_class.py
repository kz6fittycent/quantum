...
try:
    from quantum.modules.network.fortios import fortios_waf_main_class
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_waf_main_class.Connection')
