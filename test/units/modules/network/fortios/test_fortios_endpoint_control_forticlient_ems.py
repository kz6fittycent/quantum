...
try:
    from quantum.modules.network.fortios import fortios_endpoint_control_forticlient_ems
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_endpoint_control_forticlient_ems.Connection')
