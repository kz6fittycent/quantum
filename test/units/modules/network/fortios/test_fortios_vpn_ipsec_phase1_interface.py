...
try:
    from quantum.modules.network.fortios import fortios_vpn_ipsec_phase1_interface
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_vpn_ipsec_phase1_interface.Connection')
