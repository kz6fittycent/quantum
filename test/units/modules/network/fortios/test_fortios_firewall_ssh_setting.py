...
try:
    from quantum.modules.network.fortios import fortios_firewall_ssh_setting
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_firewall_ssh_setting.Connection')
