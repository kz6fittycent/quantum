...
try:
    from quantum.modules.network.fortios import fortios_system_fips_cc
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortios.fortios_system_fips_cc.Connection')
