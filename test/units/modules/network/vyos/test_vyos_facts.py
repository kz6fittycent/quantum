...
from quantum.modules.network.vyos import vyos_facts
...
class TestVyosFactsModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.module_utils.network.vyos.facts.legacy.base.run_commands')
        ...
        self.mock_get_capabilities = patch('quantum.module_utils.network.vyos.facts.legacy.base.get_capabilities')
    ...
    def test_vyos_facts_default(self):
        ...
        self.assertEqual(facts['quantum_net_hostname'].strip(), 'vyos01')
        self.assertEqual(facts['quantum_net_version'], 'VyOS 1.1.7')
