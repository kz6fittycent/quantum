...
from quantum.modules.network.vyos import vyos_banner
...
class TestVyosBannerModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.vyos.vyos_banner.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.vyos.vyos_banner.load_config')
