...
from quantum.modules.network.vyos import vyos_system
...
class TestVyosSystemModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.vyos.vyos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.vyos.vyos_system.load_config')
