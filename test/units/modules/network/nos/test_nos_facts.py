...
from quantum.modules.network.nos import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.nos.nos_facts.run_commands')
    ...
    def test_nos_facts(self):
        ...
        self.assertEqual(
            result['quantum_facts']['quantum_net_model'], 'BR-VDX6740'
        )
        self.assertEqual(
            result['quantum_facts']['quantum_net_serialnum'], 'CPL2541K01E'
        )
