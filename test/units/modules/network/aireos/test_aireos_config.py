...
from quantum.modules.network.aireos import aireos_config
...
class TestCiscoWlcConfigModule(TestCiscoWlcModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.aireos.aireos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.aireos.aireos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('quantum.modules.network.aireos.aireos_config.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_save_config = patch('quantum.modules.network.aireos.aireos_config.save_config')
