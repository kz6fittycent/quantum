...
from quantum.modules.network.opx import opx_cps
...
class TestOpxCpsModule(TestOpxModule):
    ...
    def setUp(self):
        ...
        self.mock_cps_get = patch('quantum.modules.network.opx.opx_cps.cps_get')
        self.cps_get = self.mock_cps_get.start()

        self.mock_cps_transaction = patch('quantum.modules.network.opx.opx_cps.cps_transaction')
        self.cps_transaction = self.mock_cps_transaction.start()

        self.mock_parse_cps_parameters = patch('quantum.modules.network.opx.opx_cps.parse_cps_parameters')
        self.parse_cps_parameters = self.mock_parse_cps_parameters.start()

        self.mock_get_config = patch('quantum.modules.network.opx.opx_cps.cps_get.parse_cps_parameters')
