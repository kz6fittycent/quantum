...
class TestCnosModule(unittest.TestCase):
    def setUp(self):
        ...
        self.test_log = tempfile.mkstemp(prefix='quantum-test-cnos-module-', suffix='.log')[1]
    ...
    def failed(self):
        ...
        with patch.object(basic.QuantumModule, 'fail_json', fail_json):
    ...
    def changed(self, changed=False):
        ...
        with patch.object(basic.QuantumModule, 'exit_json', exit_json):
