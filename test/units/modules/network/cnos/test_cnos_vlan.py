...
from quantum.modules.network.cnos import cnos_vlan
from quantum.modules.network.cnos.cnos_vlan import parse_vlan_brief
...
class TestCnosVlanModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.cnos.cnos_vlan.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.cnos.cnos_vlan.load_config')
