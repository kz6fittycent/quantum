...
from quantum.modules.network.cnos import cnos_interface
...
class TestCnosInterfaceModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.cnos.cnos_interface.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.cnos.cnos_interface.load_config'
        )
        self._patch_exec_command = patch(
            'quantum.modules.network.cnos.cnos_interface.exec_command'
        )
