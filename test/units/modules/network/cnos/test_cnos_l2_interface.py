...
from quantum.modules.network.cnos import cnos_l2_interface
...
class TestCnosL2InterfaceModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.cnos.cnos_l2_interface.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.cnos.cnos_l2_interface.load_config'
        )
        self._patch_run_commands = patch(
            'quantum.modules.network.cnos.cnos_l2_interface.run_commands'
        )
