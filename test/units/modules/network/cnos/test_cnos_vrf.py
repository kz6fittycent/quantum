...
from quantum.modules.network.cnos import cnos_vrf
...
class TestCnosVrfModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.cnos.cnos_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('quantum.modules.network.cnos.cnos_vrf.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self._patch_is_switchport = patch(
            'quantum.modules.network.cnos.cnos_vrf.is_switchport'
        )
