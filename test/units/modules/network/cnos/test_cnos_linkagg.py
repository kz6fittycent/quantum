...
from quantum.modules.network.cnos import cnos_linkagg
...
class TestCnosLinkaggModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.cnos.cnos_linkagg.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.cnos.cnos_linkagg.load_config'
        )
