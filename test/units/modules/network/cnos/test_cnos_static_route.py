...
from quantum.modules.network.cnos import cnos_static_route
...
class TestCnosStaticRouteModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('quantum.modules.network.cnos.cnos_banner.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('quantum.modules.network.cnos.cnos_static_route.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.cnos.cnos_static_route.get_config')
