...
from quantum.modules.network.cnos import cnos_lldp
...
class TestCnosLldpModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'quantum.modules.network.cnos.cnos_lldp.get_config'
        )
        self._patch_load_config = patch(
            'quantum.modules.network.cnos.cnos_lldp.load_config'
        )
        self._patch_get_ethernet_range = patch(
            'quantum.modules.network.cnos.cnos_lldp.get_ethernet_range'
        )
