...
from quantum.modules.network.cnos import cnos_logging
...
class TestCnosLoggingModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.cnos.cnos_logging.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.cnos.cnos_logging.load_config')
