...
from quantum.modules.network.cnos import cnos_system
...
class TestCnosSystemModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.cnos.cnos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.cnos.cnos_system.load_config')
