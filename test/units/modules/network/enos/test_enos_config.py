...
from quantum.modules.network.enos import enos_config
...
class TestEnosConfigModule(TestEnosModule):
    ...
    def setUp(self):
        self.patcher_get_config = patch('quantum.modules.network.enos.enos_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()
        self.patcher_exec_command = patch('quantum.modules.network.enos.enos_config.load_config')
