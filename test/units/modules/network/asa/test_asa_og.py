...
from quantum.modules.network.asa import asa_og
...
class TestAsaOgModule(TestAsaModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.asa.asa_og.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.asa.asa_og.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_connection = patch('quantum.module_utils.network.asa.asa.get_connection')
    ...
    def test_asa_og_idempotent(self):
        set_module_args(dict(
            ...
            description='quantum_test object-group description',
            state='present'
        ))
        commands = []
    ...
    def test_asa_og_replace(self):
        set_module_args(dict(
            ...
            description='quantum_test custom description',
            state='replace'
        ))
        commands = [
            'object-group network test_nets',
