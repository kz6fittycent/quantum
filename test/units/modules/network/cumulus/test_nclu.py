...
from quantum.modules.network.cumulus import nclu


class FakeModule(object):
    """Fake NCLU module to check the logic of the quantum module.
    ...
    Fake tests are used to test the logic of the quantum module proper - that
    ...
    To prepare a VX:
      ...
      sudo pip install quantum nose coverage
