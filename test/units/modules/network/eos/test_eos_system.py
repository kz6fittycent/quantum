...
from quantum.modules.network.eos import eos_system
...
class TestEosSystemModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.eos.eos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.eos.eos_system.load_config')
    ...
    def test_eos_system_domain_list(self):
        set_module_args(dict(domain_list=['quantum.com', 'redhat.com']))
        commands = ['no ip domain-list ops.quantum.com',
    ...
    def test_eos_system_no_change(self):
        set_module_args(dict(hostname='switch01', domain_name='eng.quantum.com'))
        commands = []
