...
from quantum.modules.network.eos import eos_banner
...
class TestEosBannerModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.eos.eos_banner.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.eos.eos_banner.load_config')
