...
from quantum.modules.network.eos import eos_eapi
...
class TestEosEapiModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.eos.eos_eapi.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.eos.eos_eapi.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_verify_state = patch('quantum.modules.network.eos.eos_eapi.verify_state')
