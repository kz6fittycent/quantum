...
from quantum.modules.network.eos import eos_vlans
...
class TestEosVlansModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.module_utils.network.common.network.Config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.module_utils.network.common.network.Config.load_config')
        ...
        self.mock_edit_config = patch('quantum.module_utils.network.eos.providers.providers.CliProvider.edit_config')
        self.edit_config = self.mock_edit_config.start()

        self.mock_execute_show_command = patch('quantum.module_utils.network.eos.config.vlans.vlans.Vlans.get_vlans_facts')
