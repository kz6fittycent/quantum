...
from quantum.modules.network.edgeswitch import edgeswitch_vlan
from quantum.modules.network.edgeswitch.edgeswitch_vlan import parse_vlan_brief, parse_interfaces_switchport
...
class TestEdgeswitchVlanModule(TestEdgeswitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.edgeswitch.edgeswitch_vlan.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.edgeswitch.edgeswitch_vlan.load_config')
