...
from quantum.modules.network.onyx import onyx_facts
...
class TestOnyxFacts(TestOnyxModule):
    ...
    def test_onyx_facts_version(self):
        ...
        version = facts['quantum_net_version']
    ...
    def test_onyx_facts_modules(self):
        ...
        facts = result.get('quantum_facts')
        self.assertEqual(len(facts), 2)
        modules = facts['quantum_net_modules']
    ...
    def test_onyx_facts_interfaces(self):
        ...
        facts = result.get('quantum_facts')
        self.assertEqual(len(facts), 2)
        interfaces = facts['quantum_net_interfaces']
