...
from quantum.modules.network.ios import _ios_vlan
from quantum.modules.network.ios._ios_vlan import parse_vlan_brief
...
class TestIosVlanModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.ios._ios_vlan.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.ios._ios_vlan.load_config')
