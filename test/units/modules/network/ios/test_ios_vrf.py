...
from quantum.modules.network.ios import ios_vrf
...
class TestIosVrfModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.ios.ios_vrf.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.ios.ios_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_exec_command = patch('quantum.modules.network.ios.ios_vrf.exec_command')
