...
from quantum.modules.network.ios import ios_banner
...
class TestIosBannerModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('quantum.modules.network.ios.ios_banner.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('quantum.modules.network.ios.ios_banner.load_config')
