...
from quantum.modules.network.ios import ios_config
from quantum.plugins.cliconf.ios import Cliconf
...
class TestIosConfigModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.ios.ios_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('quantum.modules.network.ios.ios_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('quantum.modules.network.ios.ios_config.run_commands')
