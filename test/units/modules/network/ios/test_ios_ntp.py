...
from quantum.modules.network.ios import ios_ntp
...
class TestIosNtpModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.ios.ios_ntp.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.ios.ios_ntp.load_config')
