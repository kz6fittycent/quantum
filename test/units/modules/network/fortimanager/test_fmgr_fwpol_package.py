...
try:
    from quantum.modules.network.fortimanager import fmgr_fwpol_package
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortimanager.fmgr_fwpol_package.Connection')
    return connection_class_mock
