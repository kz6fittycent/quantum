...
try:
    from quantum.modules.network.fortimanager import fmgr_device_provision_template
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortimanager.'
