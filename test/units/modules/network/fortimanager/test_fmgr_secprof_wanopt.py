...
try:
    from quantum.modules.network.fortimanager import fmgr_secprof_wanopt
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortimanager.fmgr_secprof_wanopt.Connection')
    return connection_class_mock
