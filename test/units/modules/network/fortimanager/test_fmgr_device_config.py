...
try:
    from quantum.modules.network.fortimanager import fmgr_device_config
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortimanager.fmgr_device_config.Connection')
    return connection_class_mock
