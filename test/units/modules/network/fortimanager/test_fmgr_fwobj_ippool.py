...
try:
    from quantum.modules.network.fortimanager import fmgr_fwobj_ippool
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('quantum.modules.network.fortimanager.fmgr_fwobj_ippool.Connection')
    return connection_class_mock
