...
from quantum.modules.network.cloudvision import cv_server_provision
...
class TestCvServerProvision(unittest.TestCase):
    @patch('quantum.modules.network.cloudvision.cv_server_provision.CvpApiError',
           new_callable=lambda: MockException)
    @patch('quantum.modules.network.cloudvision.cv_server_provision.server_configurable_configlet')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_in_compliance')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_info')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.connect')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.QuantumModule')
    ...
    def test_main_no_switch_configlet(self, mock_module, mock_connect,
                                      ...
                                      mock_exception):
        ''' Test main fails if switch has no configlet for Quantum to edit.
        '''
        mock_module_object = Mock()
    ...
    @patch('quantum.modules.network.cloudvision.cv_server_provision.CvpApiError',
           new_callable=lambda: MockException)
    @patch('quantum.modules.network.cloudvision.cv_server_provision.port_configurable')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.server_configurable_configlet')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_in_compliance')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_info')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.connect')
    ...
    @patch('quantum.modules.network.cloudvision.cv_server_provision.configlet_action')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.port_configurable')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.server_configurable_configlet')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_in_compliance')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_info')
    ...
    @patch('quantum.modules.network.cloudvision.cv_server_provision.wait_for_task_completion')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.configlet_update_task')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.configlet_action')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.port_configurable')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.server_configurable_configlet')
    @patch('quantum.modules.network.cloudvision.cv_server_provision.switch_in_compliance')
    ...
    @patch('quantum.modules.network.cloudvision.cv_server_provision.CvpClient')
    ...
    @patch('quantum.modules.network.cloudvision.cv_server_provision.CvpLoginError',
           new_callable=lambda: MockException)
    @patch('quantum.modules.network.cloudvision.cv_server_provision.CvpClient')
    ...
    @patch('quantum.modules.network.cloudvision.cv_server_provision.config_from_template')
    def test_configlet_action_add_with_task(self, mock_template):
        ...
        template_config = ('interface Ethernet3\n   description Host eos'
                           ' managed by Quantum and Jinja template\n'
                           '   load-interval 30\n'
                           '   switchport\n'
