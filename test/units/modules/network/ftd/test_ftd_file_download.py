...
from quantum.module_utils.network.ftd.common import HTTPMethod
from quantum.module_utils.network.ftd.fdm_swagger_client import FILE_MODEL_NAME, OperationField
from quantum.modules.network.ftd import ftd_file_download
...
class TestFtdFileDownload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('quantum.modules.network.ftd.ftd_file_download.Connection')
