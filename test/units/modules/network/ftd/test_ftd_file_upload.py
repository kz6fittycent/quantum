...
from quantum.modules.network.ftd import ftd_file_upload
from quantum.module_utils.network.ftd.fdm_swagger_client import OperationField
...
class TestFtdFileUpload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('quantum.modules.network.ftd.ftd_file_upload.Connection')
