...
from quantum.module_utils.network.ftd.common import FtdConfigurationError, FtdServerError, FtdUnexpectedResponse
from quantum.module_utils.network.ftd.configuration import FtdInvalidOperationNameError, CheckModeException
from quantum.module_utils.network.ftd.fdm_swagger_client import ValidationError
from quantum.modules.network.ftd import ftd_configuration
...
class TestFtdConfiguration(object):
    ...
    def resource_mock(self, mocker):
        resource_class_mock = mocker.patch('quantum.modules.network.ftd.ftd_configuration.BaseConfigurationResource')
