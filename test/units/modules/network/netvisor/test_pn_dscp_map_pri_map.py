...
from quantum.modules.network.netvisor import pn_dscp_map_pri_map
...
class TestCpuClassModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_dscp_map_pri_map.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('quantum.modules.network.netvisor.pn_dscp_map_pri_map.check_cli')
