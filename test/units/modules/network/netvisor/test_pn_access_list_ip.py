...
from quantum.modules.network.netvisor import pn_access_list_ip
...
class TestAccessListIpModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_access_list_ip.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('quantum.modules.network.netvisor.pn_access_list_ip.check_cli')
