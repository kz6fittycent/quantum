...
from quantum.modules.network.netvisor import pn_fabric_local
...
class TestFabricLocalModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_fabric_local.run_cli')
