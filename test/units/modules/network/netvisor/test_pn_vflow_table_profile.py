...
from quantum.modules.network.netvisor import pn_vflow_table_profile
...
class TestVflowTableProfileModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_vflow_table_profile.run_cli')
