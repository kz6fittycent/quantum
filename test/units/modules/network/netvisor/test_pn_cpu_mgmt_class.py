...
from quantum.modules.network.netvisor import pn_cpu_mgmt_class
...
class TestCpuMgmtClassModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_cpu_mgmt_class.run_cli')
