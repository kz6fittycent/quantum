...
from quantum.modules.network.netvisor import pn_prefix_list_network
...
class TestPrefixListNetworkModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_prefix_list_network.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('quantum.modules.network.netvisor.pn_prefix_list_network.check_cli')
