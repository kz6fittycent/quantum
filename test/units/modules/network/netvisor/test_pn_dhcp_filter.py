...
from quantum.modules.network.netvisor import pn_dhcp_filter
...
class TestDhcpFilterModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_dhcp_filter.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('quantum.modules.network.netvisor.pn_dhcp_filter.check_cli')
