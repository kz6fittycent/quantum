...
from quantum.modules.network.netvisor import pn_port_cos_rate_setting
...
class TestPortCosRateSettingModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_port_cos_rate_setting.run_cli')
