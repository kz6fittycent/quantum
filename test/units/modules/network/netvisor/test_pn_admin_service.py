...
from quantum.modules.network.netvisor import pn_admin_service
...
class TestAdminServiceModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_admin_service.run_cli')
