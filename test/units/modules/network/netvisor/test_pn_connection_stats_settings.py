...
from quantum.modules.network.netvisor import pn_connection_stats_settings
...
class TestAdminServiceModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_connection_stats_settings.run_cli')
