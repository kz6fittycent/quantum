...
from quantum.modules.network.netvisor import pn_snmp_trap_sink
...
class TestSnmpTrapSinkModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_snmp_trap_sink.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('quantum.modules.network.netvisor.pn_snmp_trap_sink.check_cli')
