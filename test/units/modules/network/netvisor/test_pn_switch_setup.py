...
from quantum.modules.network.netvisor import pn_switch_setup
...
class TestSwitchSetupModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('quantum.modules.network.netvisor.pn_switch_setup.run_cli')
