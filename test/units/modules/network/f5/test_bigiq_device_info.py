...
try:
    ...
    from quantum.modules.network.f5.bigiq_device_info import Parameters
    from quantum.modules.network.f5.bigiq_device_info import SystemInfoFactManager
    from quantum.modules.network.f5.bigiq_device_info import ModuleManager
    from quantum.modules.network.f5.bigiq_device_info import ArgumentSpec
