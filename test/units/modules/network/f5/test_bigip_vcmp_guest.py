...
try:
    ...
    from quantum.modules.network.f5.bigip_vcmp_guest import ModuleParameters
    from quantum.modules.network.f5.bigip_vcmp_guest import ApiParameters
    from quantum.modules.network.f5.bigip_vcmp_guest import ModuleManager
    from quantum.modules.network.f5.bigip_vcmp_guest import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_vcmp_guest.ModuleParameters.initial_image_exists')
            self.m1 = self.p1.start()
            self.m1.return_value = True
            self.p2 = patch('quantum.modules.network.f5.bigip_vcmp_guest.ModuleParameters.initial_hotfix_exists')
            self.m2 = self.p2.start()
            self.m2.return_value = True
