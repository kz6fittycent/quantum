...
try:
    ...
    from quantum.modules.network.f5.bigip_snmp import ApiParameters
    from quantum.modules.network.f5.bigip_snmp import ModuleParameters
    from quantum.modules.network.f5.bigip_snmp import ModuleManager
    from quantum.modules.network.f5.bigip_snmp import ArgumentSpec
