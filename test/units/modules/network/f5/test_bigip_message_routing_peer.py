...
try:
    ...
    from quantum.modules.network.f5.bigip_message_routing_peer import ApiParameters
    from quantum.modules.network.f5.bigip_message_routing_peer import ModuleParameters
    from quantum.modules.network.f5.bigip_message_routing_peer import ModuleManager
    from quantum.modules.network.f5.bigip_message_routing_peer import GenericModuleManager
    from quantum.modules.network.f5.bigip_message_routing_peer import ArgumentSpec
