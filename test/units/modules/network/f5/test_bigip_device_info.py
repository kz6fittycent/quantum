...
try:
    ...
    from quantum.modules.network.f5.bigip_device_info import Parameters
    from quantum.modules.network.f5.bigip_device_info import VirtualAddressesFactManager
    from quantum.modules.network.f5.bigip_device_info import ArgumentSpec
    from quantum.modules.network.f5.bigip_device_info import ModuleManager
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_device_info.modules_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = ['ltm', 'gtm', 'asm']
