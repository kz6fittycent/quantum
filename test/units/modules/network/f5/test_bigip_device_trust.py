...
try:
    ...
    from quantum.modules.network.f5.bigip_device_trust import Parameters
    from quantum.modules.network.f5.bigip_device_trust import ModuleManager
    from quantum.modules.network.f5.bigip_device_trust import ArgumentSpec
