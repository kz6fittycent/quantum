...
try:
    ...
    from quantum.modules.network.f5.bigip_ssl_ocsp import ApiParameters
    from quantum.modules.network.f5.bigip_ssl_ocsp import ModuleParameters
    from quantum.modules.network.f5.bigip_ssl_ocsp import ModuleManager
    from quantum.modules.network.f5.bigip_ssl_ocsp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_ssl_ocsp.tmos_version')
            self.m1 = self.p1.start()
            self.m1.return_value = '13.0.0'
