...
try:
    ...
    from quantum.modules.network.f5.bigip_sys_daemon_log_tmm import ApiParameters
    from quantum.modules.network.f5.bigip_sys_daemon_log_tmm import ModuleParameters
    from quantum.modules.network.f5.bigip_sys_daemon_log_tmm import ModuleManager
    from quantum.modules.network.f5.bigip_sys_daemon_log_tmm import ArgumentSpec
