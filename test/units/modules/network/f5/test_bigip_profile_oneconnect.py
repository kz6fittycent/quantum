...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_oneconnect import ApiParameters
    from quantum.modules.network.f5.bigip_profile_oneconnect import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_oneconnect import ModuleManager
    from quantum.modules.network.f5.bigip_profile_oneconnect import ArgumentSpec
