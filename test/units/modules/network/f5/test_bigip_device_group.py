...
try:
    ...
    from quantum.modules.network.f5.bigip_device_group import ApiParameters
    from quantum.modules.network.f5.bigip_device_group import ModuleParameters
    from quantum.modules.network.f5.bigip_device_group import ModuleManager
    from quantum.modules.network.f5.bigip_device_group import ArgumentSpec
