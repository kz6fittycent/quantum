...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_http import ApiParameters
    from quantum.modules.network.f5.bigip_profile_http import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_http import ModuleManager
    from quantum.modules.network.f5.bigip_profile_http import ArgumentSpec
