...
try:
    ...
    from quantum.modules.network.f5.bigip_dns_zone import ApiParameters
    from quantum.modules.network.f5.bigip_dns_zone import ModuleParameters
    from quantum.modules.network.f5.bigip_dns_zone import ModuleManager
    from quantum.modules.network.f5.bigip_dns_zone import ArgumentSpec
