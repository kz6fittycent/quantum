...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_snmp_dca import Parameters
    from quantum.modules.network.f5.bigip_monitor_snmp_dca import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_snmp_dca import ArgumentSpec
