...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_rule import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_rule import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_rule import ArgumentSpec
