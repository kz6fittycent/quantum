...
try:
    ...
    from quantum.modules.network.f5.bigip_ssl_key import ArgumentSpec
    from quantum.modules.network.f5.bigip_ssl_key import ModuleParameters
    from quantum.modules.network.f5.bigip_ssl_key import ModuleManager
