...
try:
    ...
    from quantum.modules.network.f5.bigip_snmp_trap import V2Parameters
    from quantum.modules.network.f5.bigip_snmp_trap import V1Parameters
    from quantum.modules.network.f5.bigip_snmp_trap import ModuleManager
    from quantum.modules.network.f5.bigip_snmp_trap import V2Manager
    from quantum.modules.network.f5.bigip_snmp_trap import V1Manager
    from quantum.modules.network.f5.bigip_snmp_trap import ArgumentSpec
