...
try:
    ...
    from quantum.modules.network.f5.bigip_appsvcs_extension import ModuleParameters
    from quantum.modules.network.f5.bigip_appsvcs_extension import ModuleManager
    from quantum.modules.network.f5.bigip_appsvcs_extension import ArgumentSpec
