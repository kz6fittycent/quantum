...
try:
    ...
    from quantum.modules.network.f5.bigip_apm_acl import ApiParameters
    from quantum.modules.network.f5.bigip_apm_acl import ModuleParameters
    from quantum.modules.network.f5.bigip_apm_acl import ModuleManager
    from quantum.modules.network.f5.bigip_apm_acl import ArgumentSpec
