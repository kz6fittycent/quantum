...
try:
    ...
    from quantum.modules.network.f5.bigiq_regkey_pool import ModuleParameters
    from quantum.modules.network.f5.bigiq_regkey_pool import ApiParameters
    from quantum.modules.network.f5.bigiq_regkey_pool import ModuleManager
    from quantum.modules.network.f5.bigiq_regkey_pool import ArgumentSpec
