...
try:
    ...
    from quantum.modules.network.f5.bigip_software_install import ApiParameters
    from quantum.modules.network.f5.bigip_software_install import ModuleParameters
    from quantum.modules.network.f5.bigip_software_install import ModuleManager
    from quantum.modules.network.f5.bigip_software_install import ArgumentSpec
