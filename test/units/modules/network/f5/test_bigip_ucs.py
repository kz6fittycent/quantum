...
try:
    ...
    from quantum.modules.network.f5.bigip_ucs import ModuleParameters
    from quantum.modules.network.f5.bigip_ucs import ModuleManager
    from quantum.modules.network.f5.bigip_ucs import ArgumentSpec
    from quantum.modules.network.f5.bigip_ucs import V1Manager
    from quantum.modules.network.f5.bigip_ucs import V2Manager
