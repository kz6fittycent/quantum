...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_tcp import ApiParameters
    from quantum.modules.network.f5.bigip_profile_tcp import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_tcp import ModuleManager
    from quantum.modules.network.f5.bigip_profile_tcp import ArgumentSpec
