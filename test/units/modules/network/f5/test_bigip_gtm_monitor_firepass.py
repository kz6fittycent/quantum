...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_monitor_firepass import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_monitor_firepass import ModuleParameters
    from quantum.modules.network.f5.bigip_gtm_monitor_firepass import ModuleManager
    from quantum.modules.network.f5.bigip_gtm_monitor_firepass import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_gtm_monitor_firepass.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
