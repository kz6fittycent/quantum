...
try:
    ...
    from quantum.modules.network.f5.bigip_partition import ApiParameters
    from quantum.modules.network.f5.bigip_partition import ModuleParameters
    from quantum.modules.network.f5.bigip_partition import ModuleManager
    from quantum.modules.network.f5.bigip_partition import ArgumentSpec
