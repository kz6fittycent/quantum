...
try:
    ...
    from quantum.modules.network.f5.bigip_asm_policy_manage import V1Parameters
    from quantum.modules.network.f5.bigip_asm_policy_manage import ModuleManager
    from quantum.modules.network.f5.bigip_asm_policy_manage import V1Manager
    from quantum.modules.network.f5.bigip_asm_policy_manage import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_asm_policy_manage.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
