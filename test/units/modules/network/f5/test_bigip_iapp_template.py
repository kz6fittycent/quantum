...
try:
    ...
    from quantum.modules.network.f5.bigip_iapp_template import Parameters
    from quantum.modules.network.f5.bigip_iapp_template import ArgumentSpec
    from quantum.modules.network.f5.bigip_iapp_template import ModuleManager
