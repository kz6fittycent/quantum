...
try:
    ...
    from quantum.modules.network.f5.bigip_traffic_selector import ApiParameters
    from quantum.modules.network.f5.bigip_traffic_selector import ModuleParameters
    from quantum.modules.network.f5.bigip_traffic_selector import ModuleManager
    from quantum.modules.network.f5.bigip_traffic_selector import ArgumentSpec
