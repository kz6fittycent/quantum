...
try:
    ...
    from quantum.modules.network.f5.bigip_remote_role import ApiParameters
    from quantum.modules.network.f5.bigip_remote_role import ModuleParameters
    from quantum.modules.network.f5.bigip_remote_role import ModuleManager
    from quantum.modules.network.f5.bigip_remote_role import ArgumentSpec
