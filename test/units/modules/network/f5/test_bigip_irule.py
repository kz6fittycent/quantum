...
try:
    ...
    from quantum.modules.network.f5.bigip_irule import Parameters
    from quantum.modules.network.f5.bigip_irule import ModuleManager
    from quantum.modules.network.f5.bigip_irule import ArgumentSpec
    from quantum.modules.network.f5.bigip_irule import GtmManager
    from quantum.modules.network.f5.bigip_irule import LtmManager
...
class TestManager(unittest.TestCase):
    ...
    def test_module_mutual_exclusion(self, *args):
        ...
        with patch('quantum.module_utils.basic.QuantumModule.fail_json', unsafe=True) as mo:
            QuantumModule(
                argument_spec=self.spec.argument_spec,
                supports_check_mode=self.spec.supports_check_mode,
                mutually_exclusive=self.spec.mutually_exclusive,
