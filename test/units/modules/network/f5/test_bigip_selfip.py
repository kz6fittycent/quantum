...
try:
    ...
    from quantum.modules.network.f5.bigip_selfip import ApiParameters
    from quantum.modules.network.f5.bigip_selfip import ModuleParameters
    from quantum.modules.network.f5.bigip_selfip import ModuleManager
    from quantum.modules.network.f5.bigip_selfip import ArgumentSpec
