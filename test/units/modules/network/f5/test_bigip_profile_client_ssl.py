...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_client_ssl import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_client_ssl import ApiParameters
    from quantum.modules.network.f5.bigip_profile_client_ssl import ModuleManager
    from quantum.modules.network.f5.bigip_profile_client_ssl import ArgumentSpec
