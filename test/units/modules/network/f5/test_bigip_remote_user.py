...
try:
    ...
    from quantum.modules.network.f5.bigip_remote_user import ApiParameters
    from quantum.modules.network.f5.bigip_remote_user import ModuleParameters
    from quantum.modules.network.f5.bigip_remote_user import ModuleManager
    from quantum.modules.network.f5.bigip_remote_user import ArgumentSpec
