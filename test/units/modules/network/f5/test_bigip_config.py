...
try:
    ...
    from quantum.modules.network.f5.bigip_config import Parameters
    from quantum.modules.network.f5.bigip_config import ModuleManager
    from quantum.modules.network.f5.bigip_config import ArgumentSpec
