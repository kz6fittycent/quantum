...
try:
    ...
    from quantum.modules.network.f5.bigip_pool import ApiParameters
    from quantum.modules.network.f5.bigip_pool import ModuleParameters
    from quantum.modules.network.f5.bigip_pool import ModuleManager
    from quantum.modules.network.f5.bigip_pool import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def test_create_pool_with_metadata(self, *args):
        ...
        assert 'quantum' in results['metadata']
        assert results['metadata']['quantum'] == '2.4'
