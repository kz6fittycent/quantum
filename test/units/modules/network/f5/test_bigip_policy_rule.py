...
try:
    ...
    from quantum.modules.network.f5.bigip_policy_rule import ModuleParameters
    from quantum.modules.network.f5.bigip_policy_rule import ApiParameters
    from quantum.modules.network.f5.bigip_policy_rule import ModuleManager
    from quantum.modules.network.f5.bigip_policy_rule import ArgumentSpec
