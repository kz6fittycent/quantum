...
try:
    ...
    from quantum.modules.network.f5.bigip_message_routing_protocol import ApiParameters
    from quantum.modules.network.f5.bigip_message_routing_protocol import ModuleParameters
    from quantum.modules.network.f5.bigip_message_routing_protocol import ModuleManager
    from quantum.modules.network.f5.bigip_message_routing_protocol import ArgumentSpec
