...
try:
    ...
    from quantum.modules.network.f5.bigip_command import Parameters
    from quantum.modules.network.f5.bigip_command import ModuleManager
    from quantum.modules.network.f5.bigip_command import V1Manager
    from quantum.modules.network.f5.bigip_command import V2Manager
    from quantum.modules.network.f5.bigip_command import ArgumentSpec
