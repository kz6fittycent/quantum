...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_external import ModuleParameters
    from quantum.modules.network.f5.bigip_monitor_external import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_external import ArgumentSpec
