...
try:
    ...
    from quantum.modules.network.f5.bigiq_regkey_license import ModuleParameters
    from quantum.modules.network.f5.bigiq_regkey_license import ApiParameters
    from quantum.modules.network.f5.bigiq_regkey_license import ModuleManager
    from quantum.modules.network.f5.bigiq_regkey_license import ArgumentSpec
