...
try:
    ...
    from quantum.modules.network.f5.bigiq_application_fastl4_udp import ModuleParameters
    from quantum.modules.network.f5.bigiq_application_fastl4_udp import ModuleManager
    from quantum.modules.network.f5.bigiq_application_fastl4_udp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigiq_application_fastl4_udp.bigiq_version')
            self.p2 = patch('quantum.modules.network.f5.bigiq_application_fastl4_udp.ModuleParameters.template_reference')
            self.p3 = patch('quantum.modules.network.f5.bigiq_application_fastl4_udp.ModuleParameters.default_device_reference')
