...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_dns import ApiParameters
    from quantum.modules.network.f5.bigip_profile_dns import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_dns import ModuleManager
    from quantum.modules.network.f5.bigip_profile_dns import ArgumentSpec
