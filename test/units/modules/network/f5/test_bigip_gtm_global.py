...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_global import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_global import ModuleParameters
    from quantum.modules.network.f5.bigip_gtm_global import ModuleManager
    from quantum.modules.network.f5.bigip_gtm_global import ArgumentSpec
