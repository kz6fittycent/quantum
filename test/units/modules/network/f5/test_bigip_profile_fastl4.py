...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_fastl4 import ApiParameters
    from quantum.modules.network.f5.bigip_profile_fastl4 import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_fastl4 import ModuleManager
    from quantum.modules.network.f5.bigip_profile_fastl4 import ArgumentSpec
