...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_http2 import ApiParameters
    from quantum.modules.network.f5.bigip_profile_http2 import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_http2 import ModuleManager
    from quantum.modules.network.f5.bigip_profile_http2 import ArgumentSpec
