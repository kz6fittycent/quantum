...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_tcp_half_open import Parameters
    from quantum.modules.network.f5.bigip_monitor_tcp_half_open import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_tcp_half_open import ArgumentSpec
