...
try:
    ...
    from quantum.modules.network.f5.bigip_ucs_fetch import Parameters
    from quantum.modules.network.f5.bigip_ucs_fetch import ModuleManager
    from quantum.modules.network.f5.bigip_ucs_fetch import V1Manager
    from quantum.modules.network.f5.bigip_ucs_fetch import ArgumentSpec
