...
try:
    ...
    from quantum.modules.network.f5.bigip_cli_script import ApiParameters
    from quantum.modules.network.f5.bigip_cli_script import ModuleParameters
    from quantum.modules.network.f5.bigip_cli_script import ModuleManager
    from quantum.modules.network.f5.bigip_cli_script import ArgumentSpec
