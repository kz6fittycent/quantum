...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_global_rules import ApiParameters
    from quantum.modules.network.f5.bigip_firewall_global_rules import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_global_rules import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_global_rules import ArgumentSpec
