...
try:
    ...
    from quantum.modules.network.f5.bigip_device_connectivity import ApiParameters
    from quantum.modules.network.f5.bigip_device_connectivity import ModuleParameters
    from quantum.modules.network.f5.bigip_device_connectivity import ModuleManager
    from quantum.modules.network.f5.bigip_device_connectivity import ArgumentSpec
