...
try:
    ...
    from quantum.modules.network.f5.bigip_ssl_certificate import ArgumentSpec
    from quantum.modules.network.f5.bigip_ssl_certificate import ApiParameters
    from quantum.modules.network.f5.bigip_ssl_certificate import ModuleParameters
    from quantum.modules.network.f5.bigip_ssl_certificate import ModuleManager
