...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_gateway_icmp import ApiParameters
    from quantum.modules.network.f5.bigip_monitor_gateway_icmp import ModuleParameters
    from quantum.modules.network.f5.bigip_monitor_gateway_icmp import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_gateway_icmp import ArgumentSpec
