...
try:
    ...
    from quantum.modules.network.f5.bigip_trunk import ApiParameters
    from quantum.modules.network.f5.bigip_trunk import ModuleParameters
    from quantum.modules.network.f5.bigip_trunk import ModuleManager
    from quantum.modules.network.f5.bigip_trunk import ArgumentSpec
