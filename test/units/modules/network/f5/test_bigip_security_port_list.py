...
try:
    ...
    try:
        from quantum.modules.network.f5.bigip_security_port_list import ApiParameters
        from quantum.modules.network.f5.bigip_security_port_list import ModuleParameters
        from quantum.modules.network.f5.bigip_security_port_list import ModuleManager
        from quantum.modules.network.f5.bigip_security_port_list import ArgumentSpec
