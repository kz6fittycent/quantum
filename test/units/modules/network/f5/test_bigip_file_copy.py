...
try:
    ...
    from quantum.modules.network.f5.bigip_file_copy import ApiParameters
    from quantum.modules.network.f5.bigip_file_copy import IFileManager
    from quantum.modules.network.f5.bigip_file_copy import ModuleParameters
    from quantum.modules.network.f5.bigip_file_copy import ModuleManager
    from quantum.modules.network.f5.bigip_file_copy import ArgumentSpec
