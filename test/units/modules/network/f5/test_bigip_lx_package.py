...
try:
    ...
    from quantum.modules.network.f5.bigip_lx_package import Parameters
    from quantum.modules.network.f5.bigip_lx_package import ArgumentSpec
    from quantum.modules.network.f5.bigip_lx_package import ModuleManager
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_lx_package.tmos_version')
            self.m1 = self.p1.start()
            self.m1.return_value = '12.1.3'
