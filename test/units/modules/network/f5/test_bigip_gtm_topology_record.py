...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_topology_record import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_topology_record import ModuleParameters
    from quantum.modules.network.f5.bigip_gtm_topology_record import ModuleManager
    from quantum.modules.network.f5.bigip_gtm_topology_record import ArgumentSpec
