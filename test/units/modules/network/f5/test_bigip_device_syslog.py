...
try:
    ...
    from quantum.modules.network.f5.bigip_device_syslog import ApiParameters
    from quantum.modules.network.f5.bigip_device_syslog import ModuleParameters
    from quantum.modules.network.f5.bigip_device_syslog import ModuleManager
    from quantum.modules.network.f5.bigip_device_syslog import ArgumentSpec
