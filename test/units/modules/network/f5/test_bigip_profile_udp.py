...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_udp import ApiParameters
    from quantum.modules.network.f5.bigip_profile_udp import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_udp import ModuleManager
    from quantum.modules.network.f5.bigip_profile_udp import ArgumentSpec
