...
try:
    ...
    from quantum.modules.network.f5.bigip_log_publisher import ApiParameters
    from quantum.modules.network.f5.bigip_log_publisher import ModuleParameters
    from quantum.modules.network.f5.bigip_log_publisher import ModuleManager
    from quantum.modules.network.f5.bigip_log_publisher import ArgumentSpec
