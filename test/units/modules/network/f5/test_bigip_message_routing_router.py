...
try:
    ...
    from quantum.modules.network.f5.bigip_message_routing_router import ApiParameters
    from quantum.modules.network.f5.bigip_message_routing_router import ModuleParameters
    from quantum.modules.network.f5.bigip_message_routing_router import ModuleManager
    from quantum.modules.network.f5.bigip_message_routing_router import GenericModuleManager
    from quantum.modules.network.f5.bigip_message_routing_router import ArgumentSpec
