...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_dos_profile import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_dos_profile import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_dos_profile import ArgumentSpec
