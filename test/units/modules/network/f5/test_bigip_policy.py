...
try:
    ...
    from quantum.modules.network.f5.bigip_policy import Parameters
    from quantum.modules.network.f5.bigip_policy import ModuleManager
    from quantum.modules.network.f5.bigip_policy import SimpleManager
    from quantum.modules.network.f5.bigip_policy import ArgumentSpec
