...
try:
    ...
    from quantum.modules.network.f5.bigip_device_traffic_group import ApiParameters
    from quantum.modules.network.f5.bigip_device_traffic_group import ModuleParameters
    from quantum.modules.network.f5.bigip_device_traffic_group import ModuleManager
    from quantum.modules.network.f5.bigip_device_traffic_group import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def test_modify_ha_order(self, *args):
        set_module_args(dict(
            ...
            ha_order=['v12-2.quantum.local', 'v12-1.quantum.local'],
            provider=dict(
                server='localhost',
                password='password',
                user='admin'
        ...
        assert results['changed'] is True
        assert results['ha_order'] == ['/Common/v12-2.quantum.local', '/Common/v12-1.quantum.local']
