...
try:
    ...
    from quantum.modules.network.f5.bigip_tunnel import ApiParameters
    from quantum.modules.network.f5.bigip_tunnel import ModuleParameters
    from quantum.modules.network.f5.bigip_tunnel import ModuleManager
    from quantum.modules.network.f5.bigip_tunnel import ArgumentSpec
