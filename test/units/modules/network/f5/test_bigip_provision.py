...
try:
    ...
    from quantum.modules.network.f5.bigip_provision import ModuleParameters
    from quantum.modules.network.f5.bigip_provision import ModuleManager
    from quantum.modules.network.f5.bigip_provision import ArgumentSpec
    from quantum.modules.network.f5.bigip_provision import ApiParameters
...
class TestManager(unittest.TestCase):
    ...
    def test_provision_all_modules(self, *args):
        ...
        for module in modules:
            ...
            with patch('quantum.module_utils.basic.QuantumModule.fail_json') as mo:
                QuantumModule(
                    argument_spec=self.spec.argument_spec,
                    supports_check_mode=self.spec.supports_check_mode,
                    mutually_exclusive=self.spec.mutually_exclusive
