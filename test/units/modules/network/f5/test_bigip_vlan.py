...
try:
    ...
    from quantum.modules.network.f5.bigip_vlan import ApiParameters
    from quantum.modules.network.f5.bigip_vlan import ModuleParameters
    from quantum.modules.network.f5.bigip_vlan import ModuleManager
    from quantum.modules.network.f5.bigip_vlan import ArgumentSpec
