...
try:
    ...
    from quantum.modules.network.f5.bigip_node import Parameters
    from quantum.modules.network.f5.bigip_node import ApiParameters
    from quantum.modules.network.f5.bigip_node import ModuleManager
    from quantum.modules.network.f5.bigip_node import ArgumentSpec
