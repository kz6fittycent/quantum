...
try:
    ...
    from quantum.modules.network.f5.bigiq_application_http import ModuleParameters
    from quantum.modules.network.f5.bigiq_application_http import ModuleManager
    from quantum.modules.network.f5.bigiq_application_http import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigiq_application_http.bigiq_version')
            self.p2 = patch('quantum.modules.network.f5.bigiq_application_http.ModuleParameters.template_reference')
            self.p3 = patch('quantum.modules.network.f5.bigiq_application_http.ModuleParameters.ssg_reference')
            self.p4 = patch('quantum.modules.network.f5.bigiq_application_http.ModuleParameters.default_device_reference')
