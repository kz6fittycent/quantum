...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_server import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_server import ModuleParameters
    from quantum.modules.network.f5.bigip_gtm_server import ModuleManager
    from quantum.modules.network.f5.bigip_gtm_server import V1Manager
    from quantum.modules.network.f5.bigip_gtm_server import V2Manager
    from quantum.modules.network.f5.bigip_gtm_server import ArgumentSpec
...
class TestV1Manager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_gtm_server.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
        ...
        try:
            ...
            self.p2 = patch('quantum.modules.network.f5.bigip_gtm_server.tmos_version')
            self.m2 = self.p2.start()
            self.m2.return_value = '13.0.0'
