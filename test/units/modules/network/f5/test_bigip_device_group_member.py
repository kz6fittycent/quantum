...
try:
    ...
    from quantum.modules.network.f5.bigip_device_group_member import Parameters
    from quantum.modules.network.f5.bigip_device_group_member import ModuleManager
    from quantum.modules.network.f5.bigip_device_group_member import ArgumentSpec
