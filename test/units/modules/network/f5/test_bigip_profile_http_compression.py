...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_http_compression import ApiParameters
    from quantum.modules.network.f5.bigip_profile_http_compression import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_http_compression import ModuleManager
    from quantum.modules.network.f5.bigip_profile_http_compression import ArgumentSpec
