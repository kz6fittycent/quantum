...
try:
    ...
    from quantum.modules.network.f5.bigip_sys_db import Parameters
    from quantum.modules.network.f5.bigip_sys_db import ModuleManager
    from quantum.modules.network.f5.bigip_sys_db import ArgumentSpec
