...
try:
    ...
    from quantum.modules.network.f5.bigip_configsync_action import Parameters
    from quantum.modules.network.f5.bigip_configsync_action import ModuleManager
    from quantum.modules.network.f5.bigip_configsync_action import ArgumentSpec
