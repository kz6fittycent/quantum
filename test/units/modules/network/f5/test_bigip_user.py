...
try:
    ...
    from quantum.modules.network.f5.bigip_user import Parameters
    from quantum.modules.network.f5.bigip_user import ModuleManager
    from quantum.modules.network.f5.bigip_user import ArgumentSpec
    from quantum.modules.network.f5.bigip_user import UnpartitionedManager
    from quantum.modules.network.f5.bigip_user import PartitionedManager
