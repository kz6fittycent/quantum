...
try:
    ...
    from quantum.modules.network.f5.bigip_profile_analytics import ApiParameters
    from quantum.modules.network.f5.bigip_profile_analytics import ModuleParameters
    from quantum.modules.network.f5.bigip_profile_analytics import ModuleManager
    from quantum.modules.network.f5.bigip_profile_analytics import ArgumentSpec
