...
try:
    ...
    from quantum.modules.network.f5.bigiq_utility_license_assignment import ModuleParameters
    from quantum.modules.network.f5.bigiq_utility_license_assignment import ModuleManager
    from quantum.modules.network.f5.bigiq_utility_license_assignment import ArgumentSpec
