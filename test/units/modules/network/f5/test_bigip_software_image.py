...
try:
    ...
    from quantum.modules.network.f5.bigip_software_image import ApiParameters
    from quantum.modules.network.f5.bigip_software_image import ModuleParameters
    from quantum.modules.network.f5.bigip_software_image import ModuleManager
    from quantum.modules.network.f5.bigip_software_image import ArgumentSpec
