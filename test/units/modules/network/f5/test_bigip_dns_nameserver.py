...
try:
    ...
    from quantum.modules.network.f5.bigip_dns_nameserver import ApiParameters
    from quantum.modules.network.f5.bigip_dns_nameserver import ModuleParameters
    from quantum.modules.network.f5.bigip_dns_nameserver import ModuleManager
    from quantum.modules.network.f5.bigip_dns_nameserver import ArgumentSpec
