...
try:
    ...
    from quantum.modules.network.f5.bigip_hostname import ApiParameters
    from quantum.modules.network.f5.bigip_hostname import ModuleParameters
    from quantum.modules.network.f5.bigip_hostname import ModuleManager
    from quantum.modules.network.f5.bigip_hostname import ArgumentSpec
