...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_wide_ip import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_wide_ip import ModuleParameters
    from quantum.modules.network.f5.bigip_gtm_wide_ip import ModuleManager
    from quantum.modules.network.f5.bigip_gtm_wide_ip import ArgumentSpec
    from quantum.modules.network.f5.bigip_gtm_wide_ip import UntypedManager
    from quantum.modules.network.f5.bigip_gtm_wide_ip import TypedManager
...
class TestUntypedManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_gtm_wide_ip.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
