...
try:
    ...
    from quantum.modules.network.f5.bigip_log_destination import V1ApiParameters
    from quantum.modules.network.f5.bigip_log_destination import V1ModuleParameters
    from quantum.modules.network.f5.bigip_log_destination import ModuleManager
    from quantum.modules.network.f5.bigip_log_destination import V1Manager
    from quantum.modules.network.f5.bigip_log_destination import ArgumentSpec
