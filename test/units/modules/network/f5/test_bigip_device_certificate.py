...
try:
    ...
    from quantum.modules.network.f5.bigip_device_certificate import ModuleParameters
    from quantum.modules.network.f5.bigip_device_certificate import ModuleManager
    from quantum.modules.network.f5.bigip_device_certificate import ArgumentSpec
