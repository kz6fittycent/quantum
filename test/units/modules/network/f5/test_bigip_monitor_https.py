...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_https import Parameters
    from quantum.modules.network.f5.bigip_monitor_https import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_https import ArgumentSpec
