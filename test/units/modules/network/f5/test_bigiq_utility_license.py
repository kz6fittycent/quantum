...
try:
    ...
    from quantum.modules.network.f5.bigiq_utility_license import ModuleParameters
    from quantum.modules.network.f5.bigiq_utility_license import ModuleManager
    from quantum.modules.network.f5.bigiq_utility_license import ArgumentSpec
