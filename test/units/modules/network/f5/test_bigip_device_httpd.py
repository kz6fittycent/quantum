...
try:
    ...
    from quantum.modules.network.f5.bigip_device_httpd import Parameters
    from quantum.modules.network.f5.bigip_device_httpd import ModuleManager
    from quantum.modules.network.f5.bigip_device_httpd import ArgumentSpec
