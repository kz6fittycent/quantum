...
try:
    ...
    from quantum.modules.network.f5.bigip_snat_pool import ModuleParameters
    from quantum.modules.network.f5.bigip_snat_pool import ApiParameters
    from quantum.modules.network.f5.bigip_snat_pool import ModuleManager
    from quantum.modules.network.f5.bigip_snat_pool import ArgumentSpec
