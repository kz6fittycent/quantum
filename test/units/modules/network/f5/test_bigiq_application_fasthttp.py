...
try:
    ...
    from quantum.modules.network.f5.bigiq_application_fasthttp import ModuleParameters
    from quantum.modules.network.f5.bigiq_application_fasthttp import ModuleManager
    from quantum.modules.network.f5.bigiq_application_fasthttp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigiq_application_fasthttp.bigiq_version')
            self.p2 = patch('quantum.modules.network.f5.bigiq_application_fasthttp.ModuleParameters.template_reference')
            self.p3 = patch('quantum.modules.network.f5.bigiq_application_fasthttp.ModuleParameters.ssg_reference')
            self.p4 = patch('quantum.modules.network.f5.bigiq_application_fasthttp.ModuleParameters.default_device_reference')
