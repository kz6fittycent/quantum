...
try:
    ...
    try:
        from quantum.modules.network.f5.bigip_security_address_list import ApiParameters
        from quantum.modules.network.f5.bigip_security_address_list import ModuleParameters
        from quantum.modules.network.f5.bigip_security_address_list import ModuleManager
        from quantum.modules.network.f5.bigip_security_address_list import ArgumentSpec
