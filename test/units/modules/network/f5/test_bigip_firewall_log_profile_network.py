...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_log_profile_network import ApiParameters
    from quantum.modules.network.f5.bigip_firewall_log_profile_network import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_log_profile_network import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_log_profile_network import ArgumentSpec
