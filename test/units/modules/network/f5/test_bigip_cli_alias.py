...
try:
    ...
    from quantum.modules.network.f5.bigip_cli_alias import ApiParameters
    from quantum.modules.network.f5.bigip_cli_alias import ModuleParameters
    from quantum.modules.network.f5.bigip_cli_alias import ModuleManager
    from quantum.modules.network.f5.bigip_cli_alias import ArgumentSpec
