...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_dns import ApiParameters
    from quantum.modules.network.f5.bigip_monitor_dns import ModuleParameters
    from quantum.modules.network.f5.bigip_monitor_dns import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_dns import ArgumentSpec
