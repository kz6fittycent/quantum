...
try:
    ...
    from quantum.modules.network.f5.bigip_static_route import ApiParameters
    from quantum.modules.network.f5.bigip_static_route import ModuleParameters
    from quantum.modules.network.f5.bigip_static_route import ModuleManager
    from quantum.modules.network.f5.bigip_static_route import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def test_invalid_unknown_params(self, *args):
        ...
        with patch('quantum.module_utils.f5_utils.QuantumModule.fail_json') as mo:
