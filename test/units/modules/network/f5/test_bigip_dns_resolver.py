...
try:
    ...
    from quantum.modules.network.f5.bigip_dns_resolver import ApiParameters
    from quantum.modules.network.f5.bigip_dns_resolver import ModuleParameters
    from quantum.modules.network.f5.bigip_dns_resolver import ModuleManager
    from quantum.modules.network.f5.bigip_dns_resolver import ArgumentSpec
