...
try:
    ...
    from quantum.modules.network.f5.bigip_device_auth_ldap import ApiParameters
    from quantum.modules.network.f5.bigip_device_auth_ldap import ModuleManager
    from quantum.modules.network.f5.bigip_device_auth_ldap import ArgumentSpec
