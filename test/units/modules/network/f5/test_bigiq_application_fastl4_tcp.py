...
try:
    ...
    from quantum.modules.network.f5.bigiq_application_fastl4_tcp import ModuleParameters
    from quantum.modules.network.f5.bigiq_application_fastl4_tcp import ModuleManager
    from quantum.modules.network.f5.bigiq_application_fastl4_tcp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigiq_application_fastl4_tcp.bigiq_version')
            self.p2 = patch('quantum.modules.network.f5.bigiq_application_fastl4_tcp.ModuleParameters.template_reference')
            self.p3 = patch('quantum.modules.network.f5.bigiq_application_fastl4_tcp.ModuleParameters.default_device_reference')
