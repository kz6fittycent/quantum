...
try:
    ...
    from quantum.modules.network.f5.bigip_qkview import Parameters
    from quantum.modules.network.f5.bigip_qkview import ModuleManager
    from quantum.modules.network.f5.bigip_qkview import MadmLocationManager
    from quantum.modules.network.f5.bigip_qkview import BulkLocationManager
    from quantum.modules.network.f5.bigip_qkview import ArgumentSpec
