...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_address_list import ApiParameters
    from quantum.modules.network.f5.bigip_firewall_address_list import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_address_list import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_address_list import ArgumentSpec
