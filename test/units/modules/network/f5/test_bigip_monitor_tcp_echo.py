...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_tcp_echo import Parameters
    from quantum.modules.network.f5.bigip_monitor_tcp_echo import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_tcp_echo import ArgumentSpec
