...
try:
    ...
    from quantum.modules.network.f5.bigip_pool_member import ModuleParameters
    from quantum.modules.network.f5.bigip_pool_member import ApiParameters
    from quantum.modules.network.f5.bigip_pool_member import NodeApiParameters
    from quantum.modules.network.f5.bigip_pool_member import ModuleManager
    from quantum.modules.network.f5.bigip_pool_member import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def test_create_reuse_node_with_name(self, *args):
        # Configure the arguments that would be sent to the Quantum module
