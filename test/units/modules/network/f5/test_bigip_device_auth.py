...
try:
    ...
    from quantum.modules.network.f5.bigip_device_auth import TacacsApiParameters
    from quantum.modules.network.f5.bigip_device_auth import TacacsModuleParameters
    from quantum.modules.network.f5.bigip_device_auth import TacacsManager
    from quantum.modules.network.f5.bigip_device_auth import ModuleManager
    from quantum.modules.network.f5.bigip_device_auth import ArgumentSpec
