...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_log_profile import ApiParameters
    from quantum.modules.network.f5.bigip_firewall_log_profile import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_log_profile import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_log_profile import ArgumentSpec
