...
try:
    ...
    from quantum.modules.network.f5.bigip_routedomain import ApiParameters
    from quantum.modules.network.f5.bigip_routedomain import ModuleParameters
    from quantum.modules.network.f5.bigip_routedomain import ModuleManager
    from quantum.modules.network.f5.bigip_routedomain import ArgumentSpec
