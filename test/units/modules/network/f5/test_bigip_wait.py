...
try:
    ...
    from quantum.modules.network.f5.bigip_wait import Parameters
    from quantum.modules.network.f5.bigip_wait import ModuleManager
    from quantum.modules.network.f5.bigip_wait import ArgumentSpec
