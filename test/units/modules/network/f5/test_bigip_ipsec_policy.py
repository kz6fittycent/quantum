...
try:
    ...
    from quantum.modules.network.f5.bigip_ipsec_policy import ApiParameters
    from quantum.modules.network.f5.bigip_ipsec_policy import ModuleParameters
    from quantum.modules.network.f5.bigip_ipsec_policy import ModuleManager
    from quantum.modules.network.f5.bigip_ipsec_policy import ArgumentSpec
