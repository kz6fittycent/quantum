...
try:
    ...
    from quantum.modules.network.f5.bigip_device_ntp import Parameters
    from quantum.modules.network.f5.bigip_device_ntp import ModuleManager
    from quantum.modules.network.f5.bigip_device_ntp import ArgumentSpec
