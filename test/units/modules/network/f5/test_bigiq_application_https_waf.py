...
try:
    ...
    from quantum.modules.network.f5.bigiq_application_https_waf import ModuleParameters
    from quantum.modules.network.f5.bigiq_application_https_waf import ModuleManager
    from quantum.modules.network.f5.bigiq_application_https_waf import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigiq_application_https_waf.bigiq_version')
            self.p2 = patch('quantum.modules.network.f5.bigiq_application_https_waf.ModuleParameters.template_reference')
            self.p3 = patch('quantum.modules.network.f5.bigiq_application_https_waf.ModuleParameters.ssg_reference')
            self.p4 = patch('quantum.modules.network.f5.bigiq_application_https_waf.ModuleParameters.default_device_reference')
