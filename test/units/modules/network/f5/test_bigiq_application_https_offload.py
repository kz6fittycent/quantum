...
try:
    ...
    from quantum.modules.network.f5.bigiq_application_https_offload import ModuleParameters
    from quantum.modules.network.f5.bigiq_application_https_offload import ModuleManager
    from quantum.modules.network.f5.bigiq_application_https_offload import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigiq_application_https_offload.bigiq_version')
            self.p2 = patch('quantum.modules.network.f5.bigiq_application_https_offload.ModuleParameters.template_reference')
            self.p3 = patch('quantum.modules.network.f5.bigiq_application_https_offload.ModuleParameters.ssg_reference')
            self.p4 = patch('quantum.modules.network.f5.bigiq_application_https_offload.ModuleParameters.default_device_reference')
