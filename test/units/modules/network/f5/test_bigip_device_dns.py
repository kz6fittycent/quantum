...
try:
    ...
    from quantum.modules.network.f5.bigip_device_dns import Parameters
    from quantum.modules.network.f5.bigip_device_dns import ModuleManager
    from quantum.modules.network.f5.bigip_device_dns import ArgumentSpec
