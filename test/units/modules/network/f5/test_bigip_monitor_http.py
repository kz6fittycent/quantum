...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_http import Parameters
    from quantum.modules.network.f5.bigip_monitor_http import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_http import ArgumentSpec
