...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_udp import Parameters
    from quantum.modules.network.f5.bigip_monitor_udp import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_udp import ArgumentSpec
