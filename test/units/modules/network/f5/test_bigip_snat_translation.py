...
try:
    ...
    from quantum.modules.network.f5.bigip_snat_translation import ApiParameters
    from quantum.modules.network.f5.bigip_snat_translation import ModuleParameters
    from quantum.modules.network.f5.bigip_snat_translation import ModuleManager
    from quantum.modules.network.f5.bigip_snat_translation import ArgumentSpec
