...
try:
    ...
    from quantum.modules.network.f5.bigip_management_route import ApiParameters
    from quantum.modules.network.f5.bigip_management_route import ModuleParameters
    from quantum.modules.network.f5.bigip_management_route import ModuleManager
    from quantum.modules.network.f5.bigip_management_route import ArgumentSpec
