...
try:
    ...
    from quantum.modules.network.f5.bigip_smtp import ApiParameters
    from quantum.modules.network.f5.bigip_smtp import ModuleParameters
    from quantum.modules.network.f5.bigip_smtp import ModuleManager
    from quantum.modules.network.f5.bigip_smtp import ArgumentSpec
