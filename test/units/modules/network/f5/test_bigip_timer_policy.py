...
try:
    ...
    from quantum.modules.network.f5.bigip_timer_policy import ApiParameters
    from quantum.modules.network.f5.bigip_timer_policy import ModuleParameters
    from quantum.modules.network.f5.bigip_timer_policy import ModuleManager
    from quantum.modules.network.f5.bigip_timer_policy import ArgumentSpec
