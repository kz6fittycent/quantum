...
try:
    ...
    from quantum.modules.network.f5.bigiq_device_discovery import ApiParameters
    from quantum.modules.network.f5.bigiq_device_discovery import ModuleParameters
    from quantum.modules.network.f5.bigiq_device_discovery import ModuleManager
    from quantum.modules.network.f5.bigiq_device_discovery import ArgumentSpec
