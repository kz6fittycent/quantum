...
try:
    ...
    from quantum.modules.network.f5.bigip_snmp_community import ApiParameters
    from quantum.modules.network.f5.bigip_snmp_community import ModuleParameters
    from quantum.modules.network.f5.bigip_snmp_community import ModuleManager
    from quantum.modules.network.f5.bigip_snmp_community import V1Manager
    from quantum.modules.network.f5.bigip_snmp_community import V2Manager
    from quantum.modules.network.f5.bigip_snmp_community import ArgumentSpec
