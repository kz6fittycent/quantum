...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_topology_region import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_topology_region import ModuleParameters
    from quantum.modules.network.f5.bigip_gtm_topology_region import ModuleManager
    from quantum.modules.network.f5.bigip_gtm_topology_region import ArgumentSpec
