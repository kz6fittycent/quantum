...
try:
    ...
    from quantum.modules.network.f5.bigip_gtm_pool import ApiParameters
    from quantum.modules.network.f5.bigip_gtm_pool import ModuleParameters
    ...
    from quantum.modules.network.f5.bigip_gtm_pool import UntypedManager
    from quantum.modules.network.f5.bigip_gtm_pool import TypedManager
...
class TestUntypedManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_gtm_pool.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
