...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_dos_vector import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_dos_vector import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_dos_vector import ArgumentSpec
    from quantum.modules.network.f5.bigip_firewall_dos_vector import ProtocolDnsManager
