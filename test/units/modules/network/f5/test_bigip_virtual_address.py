...
try:
    ...
    from quantum.modules.network.f5.bigip_virtual_address import ApiParameters
    from quantum.modules.network.f5.bigip_virtual_address import ModuleParameters
    from quantum.modules.network.f5.bigip_virtual_address import ModuleManager
    from quantum.modules.network.f5.bigip_virtual_address import ArgumentSpec
