...
if sys.version_info < (2, 7):
    pytestmark.append(pytest.mark.skip("F5 Quantum modules require Python >= 2.7"))
...
try:
    ...
    try:
        from quantum.modules.network.f5.bigip_gtm_pool import Parameters
        from quantum.modules.network.f5.bigip_gtm_pool import ModuleManager
        from quantum.modules.network.f5.bigip_gtm_pool import PoolFactManager
        from quantum.modules.network.f5.bigip_gtm_pool import TypedPoolFactManager
        from quantum.modules.network.f5.bigip_gtm_pool import ArgumentSpec
        from f5.bigip.tm.gtm.pool import A
        from f5.utils.responses.handlers import Stats
        from units.modules.utils import set_module_args
    except ImportError:
        pytestmark.append(pytest.mark.skip("F5 Quantum modules require the f5-sdk Python library"))
