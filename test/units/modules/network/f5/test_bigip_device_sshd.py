...
try:
    ...
    from quantum.modules.network.f5.bigip_device_sshd import ApiParameters
    from quantum.modules.network.f5.bigip_device_sshd import ModuleParameters
    from quantum.modules.network.f5.bigip_device_sshd import ModuleManager
    from quantum.modules.network.f5.bigip_device_sshd import ArgumentSpec
