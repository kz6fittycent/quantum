...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_rule_list import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_rule_list import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_rule_list import ArgumentSpec
