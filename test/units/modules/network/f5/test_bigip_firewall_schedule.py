...
try:
    ...
    from quantum.modules.network.f5.bigip_firewall_schedule import ApiParameters
    from quantum.modules.network.f5.bigip_firewall_schedule import ModuleParameters
    from quantum.modules.network.f5.bigip_firewall_schedule import ModuleManager
    from quantum.modules.network.f5.bigip_firewall_schedule import ArgumentSpec
