...
try:
    ...
    from quantum.modules.network.f5.bigip_data_group import ModuleParameters
    from quantum.modules.network.f5.bigip_data_group import ModuleManager
    from quantum.modules.network.f5.bigip_data_group import ExternalManager
    from quantum.modules.network.f5.bigip_data_group import InternalManager
    from quantum.modules.network.f5.bigip_data_group import ArgumentSpec
