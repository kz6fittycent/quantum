...
try:
    ...
    from quantum.modules.network.f5.bigip_monitor_tcp import Parameters
    from quantum.modules.network.f5.bigip_monitor_tcp import ModuleManager
    from quantum.modules.network.f5.bigip_monitor_tcp import ArgumentSpec
