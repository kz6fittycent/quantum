...
try:
    ...
    from quantum.modules.network.f5.bigip_asm_dos_application import ApiParameters
    from quantum.modules.network.f5.bigip_asm_dos_application import ModuleParameters
    from quantum.modules.network.f5.bigip_asm_dos_application import ModuleManager
    from quantum.modules.network.f5.bigip_asm_dos_application import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_asm_dos_application.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
