...
try:
    ...
    from quantum.modules.network.f5.bigip_apm_policy_fetch import ModuleParameters
    from quantum.modules.network.f5.bigip_apm_policy_fetch import ModuleManager
    from quantum.modules.network.f5.bigip_apm_policy_fetch import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('quantum.modules.network.f5.bigip_apm_policy_fetch.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
