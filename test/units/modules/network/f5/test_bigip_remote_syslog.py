...
try:
    ...
    from quantum.modules.network.f5.bigip_remote_syslog import ModuleParameters
    from quantum.modules.network.f5.bigip_remote_syslog import ModuleManager
    from quantum.modules.network.f5.bigip_remote_syslog import ArgumentSpec
