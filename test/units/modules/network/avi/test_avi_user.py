...
from quantum.modules.network.avi import avi_user
...
class TestAviUser(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        avi_user.avi_quantum_api = Mock(return_value=data['mock_create_res'])
    ...
    def test_put_on_user(self):
        ...
        avi_user.avi_quantum_api = Mock(return_value=data['mock_put_res'])
        response = avi_user.main()
        assert response['changed']
        assert response['obj']
    ...
    def test_delete_user(self):
        ...
        avi_user.avi_quantum_api = Mock(return_value=data['mock_del_res'])
        response = avi_user.main()
        assert response['changed']
