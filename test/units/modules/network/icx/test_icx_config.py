...
from quantum.modules.network.icx import icx_config
from quantum.plugins.cliconf.icx import Cliconf
...
class TestICXConfigModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.icx.icx_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('quantum.modules.network.icx.icx_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('quantum.modules.network.icx.icx_config.run_commands')
