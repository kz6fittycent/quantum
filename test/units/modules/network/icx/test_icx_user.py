...
from quantum.modules.network.icx import icx_user
...
class TestICXSCPModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.icx.icx_user.get_config')
        self.get_config = self.mock_get_config.start()
        self.mock_load_config = patch('quantum.modules.network.icx.icx_user.load_config')
        self.load_config = self.mock_load_config.start()
        self.mock_exec_command = patch('quantum.modules.network.icx.icx_user.exec_command')
