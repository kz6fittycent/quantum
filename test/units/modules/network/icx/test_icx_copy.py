...
from quantum.modules.network.icx import icx_copy
...
class TestICXSCPModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_scp = patch('quantum.modules.network.icx.icx_copy.exec_scp')
        self.mock_run_commands = patch('quantum.modules.network.icx.icx_copy.run_commands')
        self.exec_command = self.mock_exec_scp.start()
        self.run_commands = self.mock_run_commands.start()
        self.mock_exec_command = patch('quantum.modules.network.icx.icx_copy.exec_command')
