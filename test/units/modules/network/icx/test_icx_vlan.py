...
from quantum.modules.network.icx import icx_vlan
...
class TestICXVlanModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('quantum.modules.network.icx.icx_vlan.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('quantum.modules.network.icx.icx_vlan.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.icx.icx_vlan.get_config')
