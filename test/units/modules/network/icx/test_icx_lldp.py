...
from quantum.modules.network.icx import icx_lldp
...
class TestICXlldpModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.icx.icx_lldp.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('quantum.modules.network.icx.icx_lldp.run_commands')
