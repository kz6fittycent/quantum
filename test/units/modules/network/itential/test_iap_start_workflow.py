...
import mock
import unittest
from quantum.modules.network.itential import iap_start_workflow


class TestWorkflowModule(unittest.TestCase):

    @mock.patch('quantum.modules.network.itential.iap_start_workflow.start_workflow')
    def test_iap_workflow(self, iap_workflow):
        params = {"description": "NewTestQuantum",
                  "https": "false",
                  "iap_fqdn": "localhost",
                  "iap_port": "3000",
