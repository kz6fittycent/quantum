...
from quantum.modules.network.netscaler import netscaler_nitro_request
...
class TestNetscalerNitroRequestModule(TestModule):
    ...
    def test_fail_on_conflicting_authentication_methods(self):
        ...
        with patch('quantum.modules.network.netscaler.netscaler_nitro_request.QuantumModule', module_mock):
    ...
    def test_edit_response_data_no_body_success_status(self):
        with patch('quantum.modules.network.netscaler.netscaler_nitro_request.QuantumModule'):
            instance = netscaler_nitro_request.NitroAPICaller()
            r = None
            info = {
                'status': 200,
    ...
    def test_edit_response_data_actual_body_data(self):
        ...
        with patch('quantum.modules.network.netscaler.netscaler_nitro_request.QuantumModule', Mock(return_value=module_mock)):
