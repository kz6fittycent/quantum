...
class TestNetscalerLBVServerModule(TestModule):
    ...
    def test_graceful_nitro_api_import_error(self):
        ...
        self.nitro_base_patcher.stop()
        self.nitro_specific_patcher.stop()
        from quantum.modules.network.netscaler import netscaler_lb_vserver
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('quantum.modules.network.netscaler.netscaler_lb_vserver.get_nitro_client', m):
            with patch('quantum.modules.network.netscaler.netscaler_lb_vserver.nitro_exception', MockException):
                self.module = netscaler_lb_vserver
                result = self.failed()
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'quantum.modules.network.netscaler.netscaler_lb_vserver',
            get_nitro_client=m,
