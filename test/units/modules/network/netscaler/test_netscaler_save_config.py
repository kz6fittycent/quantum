...
class TestNetscalerSaveConfigModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        from quantum.modules.network.netscaler import netscaler_save_config
        ...
        with patch('quantum.modules.network.netscaler.netscaler_save_config.get_nitro_client', m):
            with patch('quantum.modules.network.netscaler.netscaler_save_config.nitro_exception', MockException):
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'quantum.modules.network.netscaler.netscaler_save_config',
            get_nitro_client=m,
