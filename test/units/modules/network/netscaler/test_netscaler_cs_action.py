...
class TestNetscalerCSActionModule(TestModule):
    ...
    def test_graceful_nitro_api_import_error(self):
        ...
        self.nitro_base_patcher.stop()
        self.nitro_specific_patcher.stop()
        from quantum.modules.network.netscaler import netscaler_cs_action
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('quantum.modules.network.netscaler.netscaler_cs_action.get_nitro_client', m):
            with patch('quantum.modules.network.netscaler.netscaler_cs_action.nitro_exception', MockException):
                self.module = netscaler_cs_action
                result = self.failed()
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'quantum.modules.network.netscaler.netscaler_cs_action',
            get_nitro_client=m,
