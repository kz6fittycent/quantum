...
from quantum.modules.network.routeros import routeros_command
...
class TestRouterosCommandModule(TestRouterosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.routeros.routeros_command.run_commands')
