...
from quantum.modules.network.nxos import nxos_acl
...
class TestNxosAclModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.nxos.nxos_acl.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_acl.load_config')
