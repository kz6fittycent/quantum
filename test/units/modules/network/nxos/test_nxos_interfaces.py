...
from quantum.modules.network.nxos import nxos_interfaces
from quantum.module_utils.network.nxos.config.interfaces.interfaces import Interfaces
...
class TestNxosInterfacesModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('quantum.module_utils.network.nxos.config.interfaces.interfaces.Interfaces.edit_config')
        self.edit_config = self.mock_edit_config.start()
        self.mock__device_info = patch('quantum.module_utils.network.nxos.facts.interfaces.interfaces.InterfacesFacts._device_info')
    ...
    def test_1(self):
        ...
        merged = [
            # Update existing device states with any differences in the coupling.
            'interface Ethernet1/1', 'description quantum',
            'interface Ethernet1/2', 'speed 10000', 'duplex auto', 'mtu 1500',
            'no ip forward', 'no fabric forwarding mode anycast-gateway',
            'interface Ethernet1/3', 'description quantum',
