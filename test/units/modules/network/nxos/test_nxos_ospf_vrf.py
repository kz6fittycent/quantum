...
from quantum.modules.network.nxos import nxos_ospf_vrf
...
class TestNxosOspfVrfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_ospf_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_ospf_vrf.get_config')
