...
from quantum.modules.network.nxos import nxos_feature
...
class TestNxosFeatureModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.nxos.nxos_feature.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_feature.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_capabilities = patch('quantum.modules.network.nxos.nxos_feature.get_capabilities')
