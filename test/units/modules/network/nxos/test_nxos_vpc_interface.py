...
from quantum.modules.network.nxos import nxos_vpc_interface
...
class TestNxosVpcModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_vpc_interface.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_vpc_interface.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_run_commands = patch('quantum.modules.network.nxos.nxos_vpc_interface.run_commands')
