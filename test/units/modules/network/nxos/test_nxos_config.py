...
from quantum.modules.network.nxos import nxos_config
from quantum.plugins.cliconf.nxos import Cliconf
...
class TestNxosConfigModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_save_config = patch('quantum.modules.network.nxos.nxos_config.save_config')
        self.save_config = self.mock_save_config.start()

        self.mock_get_connection = patch('quantum.modules.network.nxos.nxos_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('quantum.modules.network.nxos.nxos_config.run_commands')
