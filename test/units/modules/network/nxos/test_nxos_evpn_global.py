...
from quantum.modules.network.nxos import nxos_evpn_global
...
class TestNxosEvpnGlobalModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_evpn_global.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_evpn_global.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_capabilities = patch('quantum.modules.network.nxos.nxos_evpn_global.get_capabilities')
