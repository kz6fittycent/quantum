...
from quantum.modules.network.nxos import nxos_interface_ospf
...
class TestNxosInterfaceOspfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_interface_ospf.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_interface_ospf.load_config')
