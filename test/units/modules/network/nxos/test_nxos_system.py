...
from quantum.modules.network.nxos import nxos_system
...
class TestNxosSystemModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_system.load_config')
    ...
    def test_nxos_system_domain_name(self):
        ...
        commands = ['no ip domain-name quantum.com',
                    'vrf context management', 'no ip domain-name eng.quantum.com', 'exit',
    ...
    def test_nxos_system_domain_search(self):
        ...
        commands = ['vrf context management', 'no ip domain-list quantum.com', 'exit',
                    'vrf context management', 'no ip domain-list redhat.com', 'exit',
                    'no ip domain-list quantum.com', 'no ip domain-list redhat.com',
    ...
    def test_nxos_system_state_absent(self):
        ...
        commands = ['no hostname', 'no ip domain-name quantum.com',
                    'vrf context management', 'no ip domain-name eng.quantum.com', 'exit',
                    'no ip domain-list quantum.com', 'no ip domain-list redhat.com',
                    'vrf context management', 'no ip domain-list quantum.com', 'exit',
                    'vrf context management', 'no ip domain-list redhat.com', 'exit',
