...
from quantum.modules.network.nxos import nxos_pim_rp_address
...
class TestNxosPimRpAddressModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_pim_rp_address.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_pim_rp_address.get_config')
