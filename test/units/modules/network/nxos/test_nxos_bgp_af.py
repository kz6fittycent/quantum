...
from quantum.modules.network.nxos import nxos_bgp_af
...
class TestNxosBgpAfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_bgp_af.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_bgp_af.get_config')
