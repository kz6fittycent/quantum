...
from quantum.modules.network.nxos import nxos_vxlan_vtep_vni
...
class TestNxosVxlanVtepVniModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_vxlan_vtep_vni.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_vxlan_vtep_vni.get_config')
