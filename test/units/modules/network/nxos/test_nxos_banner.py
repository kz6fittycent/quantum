...
from quantum.modules.network.nxos import nxos_banner
...
class TestNxosBannerModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.nxos.nxos_banner.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_banner.load_config')
