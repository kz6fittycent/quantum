...
from quantum.modules.network.nxos import nxos_pim
...
class TestNxosPimModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.nxos.nxos_pim.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.nxos.nxos_pim.load_config')
