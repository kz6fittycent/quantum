...
from quantum.modules.network.edgeos import edgeos_facts
...
class TestEdgeosFactsModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.edgeos.edgeos_facts.run_commands')
    ...
    def test_edgeos_facts_default(self):
        ...
        self.assertEqual(facts['quantum_net_hostname'].strip(), 'er01')
        self.assertEqual(facts['quantum_net_version'], '1.9.7+hotfix.4')
