...
if not(sys.version_info[0] == 2 and sys.version_info[1] >= 7):
    pytestmark.append(pytest.mark.skip('Nuage Quantum modules requires Python 2.7'))

try:
    from vspk import v5_0 as vsdk
    from bambou.exceptions import BambouHTTPError
    from quantum.modules.network.nuage import nuage_vspk
except ImportError:
    pytestmark.append(pytest.mark.skip('Nuage Quantum modules requires the vspk and bambou python libraries'))
