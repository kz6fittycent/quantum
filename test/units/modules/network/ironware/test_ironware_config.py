...
from quantum.modules.network.ironware import ironware_config
...
class TestIronwareConfigModule(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('quantum.modules.network.ironware.ironware_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('quantum.modules.network.ironware.ironware_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('quantum.modules.network.ironware.ironware_config.run_commands')
