...
from quantum.modules.network.ironware import ironware_command
...
class TestIronwareCommandModule(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('quantum.modules.network.ironware.ironware_command.run_commands')
