...
if sys.version_info[:2] != (2, 6):
    from quantum.modules.cloud.cloudstack.cs_traffic_type import QuantumCloudStackTrafficType, setup_module_object
    from quantum.module_utils.cloudstack import HAS_LIB_CS
    if not HAS_LIB_CS:
...
class TestQuantumCloudstackTraffiType(TestCase):
    ...
    def test_update_called_when_traffic_type_exists(self):
        set_module_args(base_module_args)
        module = setup_module_object()
        actt = QuantumCloudStackTrafficType(module)
