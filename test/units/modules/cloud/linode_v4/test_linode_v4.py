...
from quantum.modules.cloud.linode import linode_v4
from quantum.module_utils.linode import get_user_agent
...
def test_user_agent_created_properly():
    try:
        from quantum.module_utils.quantum_release import (
            __version__ as quantum_version
        )
    except ImportError:
        quantum_version = 'unknown'

    expected_user_agent = 'Quantum-linode_v4_module/%s' % quantum_version
