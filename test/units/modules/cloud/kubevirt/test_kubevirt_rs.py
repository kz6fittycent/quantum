...
from units.utils.kubevirt_fixtures import base_fixture, RESOURCE_DEFAULT_ARGS, QuantumExitJson

from quantum.module_utils.k8s.raw import KubernetesRawModule
from quantum.modules.cloud.kubevirt import kubevirt_rs as mymodule
...
def test_scale_rs_nowait(_replicas, _changed):
    ...
    # Run code:
    with pytest.raises(QuantumExitJson) as result:
