...
from quantum.modules.cloud.openstack import os_server


class QuantumFail(Exception):
    pass


class QuantumExit(Exception):
    pass
...
class TestCreateServer(object):
    def setup_method(self, method):
        ...
        self.module = mock.MagicMock()
        self.module.params = params_from_doc(method)
        self.module.fail_json.side_effect = QuantumFail()
        self.module.exit_json.side_effect = QuantumExit()
    ...
    def test_create_server(self):
        ...
        - os_server:
            ...
            meta:
              - key: value
        '''
        with pytest.raises(QuantumExit):
    ...
    def test_create_server_bad_flavor(self):
        ...
        - os_server:
            ...
            nics:
              - net-name: network1
        '''
        with pytest.raises(QuantumFail):
            os_server._create_server(self.module, self.cloud)
