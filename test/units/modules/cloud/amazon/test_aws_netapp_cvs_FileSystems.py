...
''' unit tests ONTAP Quantum module: aws_netapp_cvs_FileSystems'''
...
from quantum.modules.cloud.amazon.aws_netapp_cvs_FileSystems \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('quantum.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('quantum.module_utils.netapp.AwsCvsRestAPI.post')
    ...
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystem')
    @patch('quantum.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('quantum.module_utils.netapp.AwsCvsRestAPI.delete')
