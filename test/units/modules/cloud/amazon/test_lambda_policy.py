...
from quantum.module_utils.aws.core import HAS_BOTO3
...
from quantum.modules.cloud.amazon import lambda_policy
from quantum.modules.cloud.amazon.lambda_policy import setup_module_object
try:
