...
''' unit tests ONTAP Quantum module: '''
...
from quantum.module_utils.netapp import AwsCvsRestAPI
from quantum.modules.cloud.amazon.aws_netapp_cvs_active_directory \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectoryId')
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectory')
