...
import quantum.modules.cloud.amazon.aws_api_gateway as agw
from quantum.module_utils.aws import core
...
def test_upload_api(monkeypatch):
    ...
    monkeypatch.setattr(core.QuantumAWSModule, "exit_json", fake_exit_json)
    ...
    set_module_args({
        ...
        "region": 'mars-north-1',
        "_quantum_tmpdir": "/tmp/ansibl-abcdef",
    })
