...
from quantum.modules.cloud.amazon.aws_netapp_cvs_pool \
...
class TestMyModule(unittest.TestCase):
    ...
    def set_default_args_fail_check(self):
        return dict({
            ...
            'vendorID': 'quantumPoolTestVendorA',
            'region': 'us-east-1',
    ...
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_pool.NetAppAWSCVS.get_aws_netapp_cvs_pool')
    @patch('quantum.module_utils.netapp.AwsCvsRestAPI.put')
