...
from quantum.modules.cloud.amazon import route53_zone
...
@patch('quantum.module_utils.aws.core.HAS_BOTO3', new=True)
@patch.object(route53_zone.QuantumAWSModule, 'client')
