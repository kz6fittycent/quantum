...
''' unit tests ONTAP Quantum module: aws_netapp_cvs_snapshots'''
...
from quantum.modules.cloud.amazon.aws_netapp_cvs_snapshots \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getSnapshotId')
    @patch('quantum.modules.cloud.amazon.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getfilesystemId')
