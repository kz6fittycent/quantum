...
@pytest.mark.parametrize('patch_quantum_module', testcase_module_params['params'], ids=testcase_module_params['ids'], indirect=True)
def test_xenserver_guest_info(mocker, capfd, XenAPI, xenserver_guest_info):
    ...
    mocker.patch('quantum.modules.cloud.xenserver.xenserver_guest_info.get_object_ref', return_value=None)
    mocker.patch('quantum.modules.cloud.xenserver.xenserver_guest_info.gather_vm_params', return_value=None)
    mocker.patch('quantum.modules.cloud.xenserver.xenserver_guest_info.gather_vm_facts', return_value=fake_vm_facts)
