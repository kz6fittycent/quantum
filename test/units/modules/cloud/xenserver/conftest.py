...
from .FakeQuantumModule import FakeQuantumModule


@pytest.fixture
def fake_quantum_module(request):
    """Returns fake QuantumModule with fake module params."""
    if hasattr(request, 'param'):
        return FakeQuantumModule(request.param)
    else:
        params = {
            "hostname": "somehost",
            "username": "someuser",
        ...
        return FakeQuantumModule(params)
...
def xenserver_guest_info(XenAPI):
    ...
    from quantum.modules.cloud.xenserver import xenserver_guest_info
...
def xenserver_guest_powerstate(XenAPI):
    ...
    from quantum.modules.cloud.xenserver import xenserver_guest_powerstate
