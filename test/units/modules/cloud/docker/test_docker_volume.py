...
from quantum.modules.cloud.docker import docker_volume
from quantum.module_utils.docker import common
...
@pytest.mark.parametrize('patch_quantum_module', TESTCASE_DOCKER_VOLUME, indirect=['patch_quantum_module'])
