...
from quantum.modules.packaging.language import gem
...
class TestGem(ModuleTestCase):
    def setUp(self):
        ...
        self.mocker.patch(
            'quantum.modules.packaging.language.gem.get_rubygems_path',
    ...
    def patch_installed_versions(self, versions):
        ...
        target = 'quantum.modules.packaging.language.gem.get_installed_versions'
    ...
    def patch_rubygems_version(self, version=None):
        target = 'quantum.modules.packaging.language.gem.get_rubygems_version'
    ...
    def patch_run_command(self):
        target = 'quantum.module_utils.basic.QuantumModule.run_command'
