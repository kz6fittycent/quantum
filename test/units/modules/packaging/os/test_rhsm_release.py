...
from quantum.modules.packaging.os import rhsm_release
from units.modules.utils import (
    QuantumExitJson, QuantumFailJson, ModuleTestCase, set_module_args)
...
class RhsmRepositoryReleaseModuleTestCase(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch('quantum.modules.packaging.os.rhsm_release.'
                                      'QuantumModule.run_command')
        self.module_main_command = self.mock_run_command.start()

        # Module does a get_bin_path check before every run_command call
        self.mock_get_bin_path = patch('quantum.modules.packaging.os.rhsm_release.'
                                       'QuantumModule.get_bin_path')
    ...
    def test_release_set(self):
        ...
        result = self.module_main(QuantumExitJson)
    ...
    def test_release_insane(self):
        ...
        result = self.module_main(QuantumFailJson)
