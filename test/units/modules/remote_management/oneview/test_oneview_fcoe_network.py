...
class FcoeNetworkSpec(unittest.TestCase,
    ...
    def test_should_create_new_fcoe_network(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(fcoe_network=DEFAULT_FCOE_NETWORK_TEMPLATE)
        )

    def test_should_not_update_when_data_is_equals(self):
        self.resource.get_by.return_value = [DEFAULT_FCOE_NETWORK_TEMPLATE]
        self.mock_quantum_module.params = PARAMS_FOR_PRESENT.copy()
    ...
    def test_update_when_data_has_modified_attributes(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(fcoe_network=data_merged)
        )
    ...
    def test_update_scopes_when_different(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            quantum_facts=dict(fcoe_network=patch_return),
            msg=FcoeNetworkModule.MSG_UPDATED
        )
    ...
    def test_should_do_nothing_when_scopes_are_the_same(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=False,
            quantum_facts=dict(fcoe_network=resource_data),
            msg=FcoeNetworkModule.MSG_ALREADY_PRESENT
        )
