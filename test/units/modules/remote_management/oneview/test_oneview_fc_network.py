...
class FcNetworkModuleSpec(unittest.TestCase,
    ...
    def test_should_create_new_fc_network(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(fc_network=DEFAULT_FC_NETWORK_TEMPLATE)
        )
    ...
    def test_update_when_data_has_modified_attributes(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(fc_network=data_merged)
        )
    ...
    def test_update_scopes_when_different(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            quantum_facts=dict(fc_network=patch_return),
            msg=FcNetworkModule.MSG_UPDATED
        )
    ...
    def test_should_do_nothing_when_scopes_are_the_same(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=False,
            quantum_facts=dict(fc_network=resource_data),
            msg=FcNetworkModule.MSG_ALREADY_PRESENT
        )
