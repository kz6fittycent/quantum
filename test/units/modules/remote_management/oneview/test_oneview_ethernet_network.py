...
class EthernetNetworkModuleSpec(unittest.TestCase,
    ...
    def test_should_create_new_ethernet_network(self):
        ...
        self.mock_quantum_module.params = PARAMS_FOR_PRESENT

        EthernetNetworkModule().run()

        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            msg=EthernetNetworkModule.MSG_CREATED,
            quantum_facts=dict(ethernet_network=DEFAULT_ENET_TEMPLATE)
        )
    ...
    def test_update_when_data_has_modified_attributes(self):
        ...
        self.mock_quantum_module.params = yaml.load(YAML_PARAMS_WITH_CHANGES)
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(ethernet_network=data_merged)
        )
    ...
    def test_update_when_only_bandwidth_has_modified_attributes(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            msg=EthernetNetworkModule.MSG_UPDATED,
            quantum_facts=dict(ethernet_network=DICT_PARAMS_WITH_CHANGES)
        )
    ...
    def test_rename_when_resource_exists(self):
        ...
        self.mock_quantum_module.params = params_to_rename
    ...
    def test_should_remove_ethernet_network(self):
        ...
        self.mock_quantum_module.params = PARAMS_FOR_ABSENT
    ...
    def test_should_create_all_ethernet_networks(self):
        ...
        self.mock_quantum_module.params = PARAMS_FOR_BULK_CREATED
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(ethernet_network_bulk=DEFAULT_BULK_ENET_TEMPLATE))
    ...
    def test_reset_successfully(self):
        ...
        self.mock_quantum_module.params = yaml.load(YAML_RESET_CONNECTION_TEMPLATE)

        EthernetNetworkModule().run()

        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True, msg=EthernetNetworkModule.MSG_CONNECTION_TEMPLATE_RESET,
            quantum_facts=dict(ethernet_network_connection_template={'result': 'success'}))
    ...
    def test_should_fail_when_reset_not_existing_ethernet_network(self):
        ...
        self.mock_quantum_module.fail_json.assert_called_once_with(
            exception=mock.ANY,
    ...
    def test_update_scopes_when_different(self):
        ...
        self.mock_quantum_module.params = params_to_scope
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            quantum_facts=dict(ethernet_network=patch_return),
            msg=EthernetNetworkModule.MSG_UPDATED
        )
    ...
    def test_should_do_nothing_when_scopes_are_the_same(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=False,
            quantum_facts=dict(ethernet_network=resource_data),
            msg=EthernetNetworkModule.MSG_ALREADY_PRESENT
        )
