...
class SanManagerModuleSpec(unittest.TestCase,
    ...
    def test_should_add_new_san_manager(self):
        ...
        self.mock_quantum_module.params = self.PARAMS_FOR_PRESENT
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(san_manager=DEFAULT_SAN_MANAGER_TEMPLATE)
        )
    ...
    def test_should_not_update_when_data_is_equals(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(san_manager=output_data)
        )
    ...
    def test_update_when_data_has_modified_attributes(self):
        ...
        self.mock_quantum_module.params = self.PARAMS_WITH_CHANGES
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(san_manager=data_merged)
        )
    ...
    def test_should_remove_san_manager(self):
        ...
        self.mock_quantum_module.params = self.PARAMS_FOR_ABSENT.copy()
    ...
    def test_should_fail_when_name_and_hosts_in_connectionInfo_missing(self):
        ...
        self.mock_quantum_module.params = bad_params
        ...
        self.mock_quantum_module.fail_json.assert_called_once_with(exception=mock.ANY, msg=msg)
    ...
    def test_connection_information_set_should_set_the_connection_information(self):
        ...
        self.resource.update.return_value = data_merged
        self.mock_quantum_module.params = self.PARAMS_FOR_CONNECTION_INFORMATION_SET
