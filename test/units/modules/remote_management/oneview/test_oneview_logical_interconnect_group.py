...
from quantum.modules.remote_management.oneview.oneview_logical_interconnect_group import LogicalInterconnectGroupModule
...
class LogicalInterconnectGroupGeneralSpec(unittest.TestCase,
    ...
    def test_should_create_new_lig(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(logical_interconnect_group=DEFAULT_LIG_TEMPLATE)
        )
    ...
    def test_should_create_new_with_named_permitted_interconnect_type(self):
        ...
        self.mock_quantum_module.params = deepcopy(PARAMS_LIG_TEMPLATE_WITH_MAP)
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            msg=LogicalInterconnectGroupModule.MSG_CREATED,
            quantum_facts=dict(logical_interconnect_group=PARAMS_FOR_PRESENT.copy())
        )
    ...
    def test_update_when_data_has_modified_attributes(self):
        ...
        self.mock_quantum_module.params = PARAMS_WITH_CHANGES
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(logical_interconnect_group=data_merged)
        )
    ...
    def test_update_scopes_when_different(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            quantum_facts=dict(logical_interconnect_group=patch_return),
            msg=LogicalInterconnectGroupModule.MSG_UPDATED
        )
    ...
    def test_should_do_nothing_when_scopes_are_the_same(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=False,
            quantum_facts=dict(logical_interconnect_group=resource_data),
            msg=LogicalInterconnectGroupModule.MSG_ALREADY_PRESENT
        )
