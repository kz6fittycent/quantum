...
class NetworkSetModuleSpec(unittest.TestCase,
    ...
    def test_should_create_new_network_set(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(network_set=NETWORK_SET)
        )
    ...
    def test_update_when_data_has_modified_attributes(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            ...
            quantum_facts=dict(network_set=data_merged)
        )
    ...
    def test_update_scopes_when_different(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=True,
            quantum_facts=dict(network_set=patch_return),
            msg=NetworkSetModule.MSG_UPDATED
        )
    ...
    def test_should_do_nothing_when_scopes_are_the_same(self):
        ...
        self.mock_quantum_module.exit_json.assert_called_once_with(
            changed=False,
            quantum_facts=dict(network_set=resource_data),
            msg=NetworkSetModule.MSG_ALREADY_PRESENT
        )
