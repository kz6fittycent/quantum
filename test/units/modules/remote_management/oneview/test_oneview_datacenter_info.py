...
from quantum.modules.remote_management.oneview.oneview_datacenter_info import DatacenterInfoModule
...
class TestDatacenterInfoModule(FactsParamsTest):
    ...
    def setUp(self, mock_quantum_module, mock_ov_client):
    ...
    def test_should_get_all_datacenters(self):
        ...
        self.mock_quantum_module.params = dict(config='config.json',)
    ...
    def test_should_get_datacenter_by_name(self):
        ...
        self.mock_quantum_module.params = dict(config='config.json', name="MyDatacenter")
    ...
    def test_should_get_datacenter_visual_content(self):
        ...
        self.mock_quantum_module.params = PARAMS_GET_CONNECTED
