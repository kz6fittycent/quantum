from quantum.module_utils.source_control.bitbucket import BitbucketHelper
from quantum.modules.source_control.bitbucket import bitbucket_pipeline_variable
from units.compat import unittest
from units.compat.mock import patch
from units.modules.utils import QuantumFailJson, QuantumExitJson, ModuleTestCase, set_module_args
...
class TestBucketPipelineVariableModule(ModuleTestCase):
    ...
    def test_without_required_parameters(self):
        with self.assertRaises(QuantumFailJson) as exec_info:
            set_module_args({
                'username': 'name',
                'repository': 'repo',
    ...
    def test_create_variable(self, *args):
        with patch.object(self.module, 'create_pipeline_variable') as create_pipeline_variable_mock:
            with self.assertRaises(QuantumExitJson) as exec_info:
                set_module_args({
                    'client_id': 'ABC',
                    'client_secret': 'XXX',
                    'username': 'name',
