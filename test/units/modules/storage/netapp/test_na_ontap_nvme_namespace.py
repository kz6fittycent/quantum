...
''' unit tests ONTAP Quantum module: na_ontap_nvme_namespace'''
...
from quantum.modules.storage.netapp.na_ontap_nvme_namespace \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nvme_namespace.NetAppONTAPNVMENamespace.create_namespace')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nvme_namespace.NetAppONTAPNVMENamespace.delete_namespace')
