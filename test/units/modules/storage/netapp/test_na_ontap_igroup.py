...
from quantum.modules.storage.netapp.na_ontap_igroup \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_igroup.NetAppOntapIgroup.add_initiators')
    @patch('quantum.modules.storage.netapp.na_ontap_igroup.NetAppOntapIgroup.remove_initiators')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_igroup.NetAppOntapIgroup.modify_initiator')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_igroup.NetAppOntapIgroup.get_igroup')
