''' unit tests ONTAP Quantum module: na_ontap_cluster_peer '''
...
from quantum.modules.storage.netapp.na_ontap_cluster_peer \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_cluster_peer.NetAppONTAPClusterPeer.cluster_peer_get')
