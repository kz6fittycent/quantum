...
''' unit tests ONTAP Quantum module: na_ontap_cifs '''
...
from quantum.modules.storage.netapp.na_ontap_cifs \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_cifs.NetAppONTAPCifsShare.create_cifs_share')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_cifs.NetAppONTAPCifsShare.delete_cifs_share')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_cifs.NetAppONTAPCifsShare.modify_cifs_share')
