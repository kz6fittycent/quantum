...
from quantum.modules.storage.netapp.netapp_e_hostgroup import NetAppESeriesHostGroup
...
class HostTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "rw",
                       ...
                       "ssid": "1"}
    REQ_FUNC = "quantum.modules.storage.netapp.netapp_e_hostgroup.NetAppESeriesHostGroup.request"
    HOSTS_GET_RESPONSE = [
    ...
    def test_hosts_fail(self):
        ...
        with mock.patch(self.REQ_FUNC, return_value=(200, [])):
            with self.assertRaisesRegexp(QuantumFailJson, "Expected host does not exist"):
                hosts = hostgroup_object.hosts
