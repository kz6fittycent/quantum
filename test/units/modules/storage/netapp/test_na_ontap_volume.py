...
from quantum.modules.storage.netapp.na_ontap_volume \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_volume.NetAppOntapVolume.get_volume')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_volume.NetAppOntapVolume.change_volume_state')
    @patch('quantum.modules.storage.netapp.na_ontap_volume.NetAppOntapVolume.volume_mount')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_volume.NetAppOntapVolume.check_job_status')
    @patch('quantum.modules.storage.netapp.na_ontap_volume.NetAppOntapVolume.get_volume')
