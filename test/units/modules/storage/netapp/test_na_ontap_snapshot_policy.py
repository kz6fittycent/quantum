...
''' unit tests ONTAP Quantum module: na_ontap_snapshot_policy'''
...
from quantum.modules.storage.netapp.na_ontap_snapshot_policy \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_snapshot_policy.NetAppOntapSnapshotPolicy.create_snapshot_policy')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_snapshot_policy.NetAppOntapSnapshotPolicy.modify_snapshot_policy')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_snapshot_policy.NetAppOntapSnapshotPolicy.delete_snapshot_policy')
    ...
    def test_if_all_methods_catch_exception(self):
        ...
        with pytest.raises(QuantumFailJson) as exc:
            my_obj.create_snapshot_policy()
        assert 'Error creating snapshot policy quantum:' in exc.value.args[0]['msg']
        with pytest.raises(QuantumFailJson) as exc:
            my_obj.delete_snapshot_policy()
        assert 'Error deleting snapshot policy quantum:' in exc.value.args[0]['msg']
