''' unit tests ONTAP Quantum module: na_ontap_quotas '''
...
from quantum.modules.storage.netapp.na_ontap_quotas \
...
class MockONTAPConnection(object):
    ...
    def build_quota_info():
        ...
        data = {'num-records': 1,
                'attributes-list': {'quota-entry': {'volume': 'quantum',
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_set')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_delete')
    ...
    def test_if_all_methods_catch_exception(self):
        ...
        assert 'Error setting quota-on for quantum' in exc.value.args[0]['msg']
