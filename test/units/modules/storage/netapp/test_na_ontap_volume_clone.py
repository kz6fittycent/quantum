...
''' unit tests ONTAP Quantum module: na_ontap_volume_clone'''
...
from quantum.modules.storage.netapp.na_ontap_volume_clone \
...
class MockONTAPConnection(object):
    ...
    def build_volume_clone_info():
        ...
        data = {'attributes': {'volume-clone-info': {'volume': 'quantum',
                                                     'parent-volume': 'quantum'}}}
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_volume_clone.NetAppONTAPVolumeClone.create_volume_clone')
