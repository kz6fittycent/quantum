...
from quantum.modules.storage.netapp.na_ontap_ndmp \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_ndmp.NetAppONTAPNdmp.ndmp_get_iter')
    ...
    def test_modify_error(self, ger_ndmp):
        ...
        assert exc.value.args[0]['msg'] == 'Error modifying ndmp on quantum: NetApp API failed. Reason - test:error'
