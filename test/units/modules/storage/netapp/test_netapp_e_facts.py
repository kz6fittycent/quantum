...
from quantum.modules.storage.netapp.netapp_e_facts import Facts
...
class FactsTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'quantum.modules.storage.netapp.netapp_e_facts.Facts.request'
    GET_CONTROLLERS_FUNC = 'quantum.modules.storage.netapp.netapp_e_facts.Facts.get_controllers'
    WORKLOAD_RESPONSE = [{"id": "4200000001000000000000000000000000000000", "name": "beegfs_metadata",
                          "workloadAttributes": [{"key": "profileId", "value": "quantum_workload_1"}]},
    ...
    EXPECTED_GET_ARRAY_FACTS = {'facts_from_proxy': False, 'netapp_controllers': [{'name': 'A', 'serial': '021619039162', 'status': 'optimal'}],
                                ...
                                'netapp_workload_tags': [
                                    {'attributes': [{'key': 'profileId', 'value': 'quantum_workload_1'}], 'id': '4200000001000000000000000000000000000000',
    ...
    def test_get_controllers_fail(self):
        ...
        self._set_args()
        facts = Facts()
        with self.assertRaisesRegexp(QuantumFailJson, "Failed to retrieve controller list!"):
