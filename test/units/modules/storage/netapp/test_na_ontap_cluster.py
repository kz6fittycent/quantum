...
''' unit tests ONTAP Quantum module: na_ontap_cluster '''
...
from quantum.modules.storage.netapp.na_ontap_cluster \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_cluster.NetAppONTAPCluster.create_cluster')
