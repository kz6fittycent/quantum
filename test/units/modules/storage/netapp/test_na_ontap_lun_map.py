''' unit tests ONTAP Quantum module: na_ontap_lun_map '''
...
from quantum.modules.storage.netapp.na_ontap_lun_map \
...
class MockONTAPConnection(object):
    ...
    def build_lun_info():
        ...
        data = {'initiator-groups': [{'initiator-group-info': {'initiator-group-name': 'quantum', 'lun-id': 2}}]}
...
class TestMyModule(unittest.TestCase):
    ...
    def set_default_args(self):
        if self.onbox:
            ...
            username = 'admin'
            password = 'password'
            initiator_group_name = 'quantum'
            vserver = 'quantum'
            path = '/vol/quantum/test'
            lun_id = 2
        else:
            hostname = 'hostname'
            username = 'username'
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_lun_map.NetAppOntapLUNMap.create_lun_map')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_lun_map.NetAppOntapLUNMap.delete_lun_map')
