...
from quantum.modules.storage.netapp.na_ontap_service_processor_network \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_service_processor_network.NetAppOntapServiceProcessorNetwork.'
