...
from quantum.modules.storage.netapp.na_ontap_unix_user \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_unix_user.NetAppOntapUnixUser.create_unix_user')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_unix_user.NetAppOntapUnixUser.modify_unix_user')
    @patch('quantum.modules.storage.netapp.na_ontap_unix_user.NetAppOntapUnixUser.delete_unix_user')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_unix_user.NetAppOntapUnixUser.get_unix_user')
    @patch('quantum.modules.storage.netapp.na_ontap_unix_user.NetAppOntapUnixUser.modify_unix_user')
