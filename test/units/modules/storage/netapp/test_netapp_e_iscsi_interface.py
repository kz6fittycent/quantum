...
from quantum.modules.storage.netapp.netapp_e_iscsi_interface import IscsiInterface
...
class IscsiInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'quantum.modules.storage.netapp.netapp_e_iscsi_interface.request'
    ...
    def test_fetch_target_interface_bad_channel(self):
        ...
        with self.assertRaisesRegexp(QuantumFailJson, r".*?channels include.*"):
    ...
    def test_update_fail_busy(self, get_controllers):
        ...
        inst = IscsiInterface()
        with self.assertRaisesRegexp(QuantumFailJson, r".*?busy.*") as result:
    ...
    def test_update_fail(self, get_controllers, make_body):
        ...
        with self.assertRaisesRegexp(QuantumFailJson, r".*?Failed to modify.*") as result:
        ...
        with self.assertRaisesRegexp(QuantumFailJson, r".*?Connection failure.*") as result:
