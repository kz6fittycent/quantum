...
from quantum.modules.storage.netapp.na_ontap_autosupport \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_autosupport.NetAppONTAPasup.get_autosupport_config')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_autosupport.NetAppONTAPasup.modify_autosupport_config')
