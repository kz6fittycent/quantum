...
from quantum.modules.storage.netapp.na_ontap_net_routes \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_net_routes.NetAppOntapNetRoutes.create_net_route')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_net_routes.NetAppOntapNetRoutes.get_net_route')
