...
from quantum.modules.storage.netapp.netapp_e_syslog import Syslog
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'quantum.modules.storage.netapp.netapp_e_syslog.request'
    ...
    def test_test_configuration_fail(self):
        ...
        with self.assertRaisesRegexp(QuantumFailJson, r"We failed to send test message!"):
