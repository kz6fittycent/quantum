...
from quantum.modules.storage.netapp.na_ontap_svm \
...
class TestMyModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_vserver = {
            'name': 'test_svm',
            'root_volume': 'quantum_vol',
            'root_volume_aggregate': 'quantum_aggr',
            'aggr_list': 'aggr_1,aggr_2',
            'ipspace': 'quantum_ipspace',
            'subtype': 'default',
            'language': 'c.utf_8',
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_svm.NetAppOntapSVM.create_vserver')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_svm.NetAppOntapSVM.delete_vserver')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_svm.NetAppOntapSVM.get_vserver')
