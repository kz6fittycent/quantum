...
''' unit tests for ONTAP Quantum module na_ontap_info '''
...
from quantum.modules.storage.netapp.na_ontap_info import main as info_main
from quantum.modules.storage.netapp.na_ontap_info import __finditem as info_finditem
from quantum.modules.storage.netapp.na_ontap_info \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.module_utils.netapp.ems_log_event')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_info.NetAppONTAPGatherInfo.get_all')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_info.NetAppONTAPGatherInfo.get_generic_get_iter')
