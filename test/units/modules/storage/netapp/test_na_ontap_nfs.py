...
from quantum.modules.storage.netapp.na_ontap_nfs \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nfs.NetAppONTAPNFS.delete_nfs')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nfs.NetAppONTAPNFS.get_nfs_service')
