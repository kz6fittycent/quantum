...
from quantum.modules.storage.netapp.na_ontap_vserver_cifs_security \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_vserver_cifs_security.NetAppONTAPCifsSecurity.cifs_security_get_iter')
    ...
    def test_modify_error(self, get_cifs_security):
        ...
        assert exc.value.args[0]['msg'] == 'Error modifying cifs security on quantum: NetApp API failed. Reason - test:error'
