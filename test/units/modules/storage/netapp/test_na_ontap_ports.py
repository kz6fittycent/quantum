...
''' unit tests for ONTAP Quantum module: na_ontap_port'''
...
from quantum.modules.storage.netapp.na_ontap_ports \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_ports.NetAppOntapPorts.add_broadcast_domain_ports')
    @patch('quantum.modules.storage.netapp.na_ontap_ports.NetAppOntapPorts.get_broadcast_domain_ports')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_ports.NetAppOntapPorts.add_portset_ports')
    @patch('quantum.modules.storage.netapp.na_ontap_ports.NetAppOntapPorts.portset_get')
