...
''' unit tests ONTAP Quantum module: na_ontap_nvme'''
...
from quantum.modules.storage.netapp.na_ontap_nvme \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nvme.NetAppONTAPNVMe.create_nvme')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nvme.NetAppONTAPNVMe.delete_nvme')
    ...
    @patch('quantum.modules.storage.netapp.na_ontap_nvme.NetAppONTAPNVMe.modify_nvme')
