...
from quantum.modules.storage.netapp.netapp_e_ldap import Ldap
from units.modules.utils import ModuleTestCase, set_module_args, QuantumFailJson, QuantumExitJson
...
class LdapTest(ModuleTestCase):
    ...
    REQ_FUNC = 'quantum.modules.storage.netapp.netapp_e_ldap.request'

    def setUp(self):
        super(LdapTest, self).setUp()

        self.temp_dir = tempfile.mkdtemp('quantum-test_netapp_e_ldap-')
    ...
    def test_make_configuration(self):
        """Validate the make_configuration method that translates Quantum params to the input body"""
    ...
    #     asup = Asup()
    #     # Expecting an update
    #     with self.assertRaisesRegexp(QuantumFailJson, r"not supported"):
    ...
    #     with self.assertRaisesRegexp(QuantumFailJson, r"start time is invalid"):
    #         Asup()
    #
    ...
    #     asup = Asup()
    #     with self.assertRaisesRegexp(QuantumExitJson, r"ASUP settings have been updated"):
