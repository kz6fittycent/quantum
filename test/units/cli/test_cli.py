...
class TestCliBuildVaultIds(unittest.TestCase):
    def setUp(self):
        self.tty_patcher = patch('quantum.cli.sys.stdin.isatty', return_value=True)
...
class TestCliSetupVaultSecrets(unittest.TestCase):
    def setUp(self):
        ...
        self.display_v_patcher = patch('quantum.cli.display.verbosity', return_value=6)
    ...
    @patch('quantum.cli.get_file_vault_secret')
    ...
    @patch('quantum.cli.PromptVaultSecret')
