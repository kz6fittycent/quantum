...
from quantum.template import QuantumUndefined, _escape_backslashes, _count_newlines_from_end
...
class TestQuantumUndefined(unittest.TestCase):
    def test_getattr(self):
        val = QuantumUndefined()
