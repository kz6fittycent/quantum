...
from quantum.module_utils.common._collections_compat import Container
from quantum.coupling.block import Block

from units.mock.loader import DictDataLoader
from units.mock.path import mock_unfrackpath_noop

from quantum.coupling.role import Role
from quantum.coupling.role.include import RoleInclude
from quantum.coupling.role import hash_params
...
class TestRole(unittest.TestCase):
    ...
    @patch('quantum.coupling.role.definition.unfrackpath', mock_unfrackpath_noop)
    def test_load_role_with_tasks(self):

        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_tasks/tasks/main.yml": """
    ...
    def test_load_role_with_tasks_dir_vs_file(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_tasks/tasks/custom_main/foo.yml": """
            - command: bar
            """,
            "/etc/quantum/roles/foo_tasks/tasks/custom_main.yml": """
            - command: baz
            """,
        })
    ...
    def test_load_role_with_handlers(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_handlers/handlers/main.yml": """
            - name: test handler
              shell: echo 'hello world'
            """,
        })
    ...
    def test_load_role_with_vars(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_vars/defaults/main.yml": """
            foo: bar
            """,
            "/etc/quantum/roles/foo_vars/vars/main.yml": """
            foo: bam
            """,
        })
    ...
    def test_load_role_with_vars_dirs(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_vars/defaults/main/foo.yml": """
            foo: bar
            """,
            "/etc/quantum/roles/foo_vars/vars/main/bar.yml": """
            foo: bam
            """,
        })
    ...
    def test_load_role_with_vars_nested_dirs(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_vars/defaults/main/foo/bar.yml": """
            foo: bar
            """,
            "/etc/quantum/roles/foo_vars/vars/main/bar/foo.yml": """
            foo: bam
            """,
        })
    ...
    def test_load_role_with_vars_nested_dirs_combined(self):
        ...
        fake_loader = DictDataLoader({
            ...
            a: 1
            """,
            "/etc/quantum/roles/foo_vars/defaults/main/bar/foo.yml": """
            foo: bam
            b: 2
            """,
        })
    ...
    def test_load_role_with_vars_dir_vs_file(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_vars/vars/main/foo.yml": """
            foo: bar
            """,
            "/etc/quantum/roles/foo_vars/vars/main.yml": """
            foo: bam
    ...
    def test_load_role_with_metadata(self):
        ...
        fake_loader = DictDataLoader({
            '/etc/quantum/roles/foo_metadata/meta/main.yml': """
                ...
                fog_info:
                  ...
                  c: 3
            """,
            '/etc/quantum/roles/bar_metadata/meta/main.yml': """
                dependencies:
                  - baz_metadata
            """,
            '/etc/quantum/roles/baz_metadata/meta/main.yml': """
                dependencies:
                  - bam_metadata
            """,
            '/etc/quantum/roles/bam_metadata/meta/main.yml': """
                dependencies: []
            """,
            '/etc/quantum/roles/bad1_metadata/meta/main.yml': """
                1
            """,
            '/etc/quantum/roles/bad2_metadata/meta/main.yml': """
                foo: bar
            """,
            '/etc/quantum/roles/recursive1_metadata/meta/main.yml': """
                dependencies: ['recursive2_metadata']
            """,
            '/etc/quantum/roles/recursive2_metadata/meta/main.yml': """
        ...
        self.assertEqual(r._metadata.fog_info, dict(a=1, b=2, c=3))
        ...
        self.assertRaises(QuantumParserError, Role.load, i, play=mock_play)

        i = RoleInclude.load('bad2_metadata', play=mock_play, loader=fake_loader)
        self.assertRaises(QuantumParserError, Role.load, i, play=mock_play)

        # TODO: re-enable this test once Quantum has proper role dep cycle detection
        ...
        # self.assertRaises(QuantumError, Role.load, i, play=mock_play)
    ...
    def test_load_role_complex(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/quantum/roles/foo_complex/tasks/main.yml": """
            - shell: echo 'hello world'
            """,
        })
