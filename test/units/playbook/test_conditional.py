...
from quantum.plugins.strategy import SharedPluginLoaderObj
from quantum.template import Templar
from quantum import errors

from quantum.coupling import conditional
...
class TestConditional(unittest.TestCase):
    ...
    def test_undefined(self):
        ...
        self.assertRaisesRegexp(errors.QuantumError, "The conditional check '{{ some_undefined_thing }}' failed",
                                self._eval_con, when, {})
