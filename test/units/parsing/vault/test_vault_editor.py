...
from quantum.parsing.vault import VaultLib, VaultEditor, match_encrypt_secret
...
class TestVaultEditor(unittest.TestCase):
    ...
    def _create_test_dir(self):
        suffix = '_quantum_unit_test_%s_' % (self.__class__.__name__)
    ...
    @patch('quantum.parsing.vault.subprocess.call')
    ...
    def test_edit_file_helper_call_exception(self, mock_sp_call):
        ...
        mock_sp_call.side_effect = errors.QuantumError(error_txt)
    ...
    def test_create_file(self, mock_editor_shell_command):
        ...
        _secrets = self._secrets('quantum')
    ...
    def test_decrypt_1_1(self):
        ...
        ve = self._vault_editor(self._secrets("quantum"))

        # make sure the password functions for the cipher
        error_hit = False
        try:
            ve.decrypt_file(v11_file.name)
        except errors.QuantumError:
            error_hit = True
