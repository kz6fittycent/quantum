...
from quantum.parsing.yaml import dumper, objects
...
class TestQuantumDumper(unittest.TestCase, YamlTestUtils):
    def setUp(self):
        ...
        self.dumper = dumper.QuantumDumper
    ...
    def test_quantum_vault_encrypted_unicode(self):
        plaintext = 'This is a string we are going to encrypt.'
        avu = objects.QuantumVaultEncryptedUnicode.from_plaintext(plaintext, vault=self.vault,
    ...
    def test_bytes(self):
        ...
        unsafe_object = QuantumUnsafeBytes(b_text)
        ...
        if PY2:
            ...
            # the Python3 behaviour) we need to change the methods in Quantum to:
    ...
    def test_unicode(self):
        u_text = u'nöel'
        unsafe_object = QuantumUnsafeText(u_text)
        yaml_out = self._dump_string(unsafe_object, dumper=self.dumper)
