...
from quantum.module_utils.six import text_type, binary_type
from quantum.module_utils.common._collections_compat import Sequence, Set, Mapping
...
class TestQuantumLoaderBasic(unittest.TestCase):
    ...
    def test_parse_number(self):
        stream = StringIO(u"""
                1
                """)
        loader = QuantumLoader(stream, 'myfile.yml')
    ...
    def test_parse_string(self):
        ...
        loader = QuantumLoader(stream, 'myfile.yml')
        data = loader.get_single_data()
        self.assertEqual(data, u'Quantum')
        self.assertIsInstance(data, text_type)

        self.assertEqual(data.quantum_pos, ('myfile.yml', 2, 17))
    ...
    def test_parse_dict(self):
        ...
        self.assertEqual(data[u'webster'].quantum_pos, ('myfile.yml', 2, 26))
        self.assertEqual(data[u'oed'].quantum_pos, ('myfile.yml', 3, 22))
    ...
    def test_parse_list(self):
        ...
        self.assertEqual(data[0].quantum_pos, ('myfile.yml', 2, 19))
        self.assertEqual(data[1].quantum_pos, ('myfile.yml', 3, 19))
    ...
    def test_parse_short_dict(self):
        ...
        self.assertEqual(data.quantum_pos, ('myfile.yml', 1, 1))
        self.assertEqual(data[u'foo'].quantum_pos, ('myfile.yml', 1, 9))
        ...
        self.assertEqual(data.quantum_pos, ('myfile.yml', 1, 1))
        self.assertEqual(data[u'foo'].quantum_pos, ('myfile.yml', 1, 6))
    ...
    def test_front_matter(self):
        ...
        self.assertEqual(data.quantum_pos, ('myfile.yml', 2, 1))
        self.assertEqual(data[u'foo'].quantum_pos, ('myfile.yml', 2, 6))
        ...
        self.assertEqual(data.quantum_pos, ('myfile.yml', 1, 2))
        self.assertEqual(data[0].quantum_pos, ('myfile.yml', 1, 4))
        self.assertEqual(data[0][u'foo'].quantum_pos, ('myfile.yml', 1, 9))
        self.assertEqual(data[0][u'baz'].quantum_pos, ('myfile.yml', 2, 9))


class TestQuantumLoaderVault(unittest.TestCase, YamlTestUtils):
    def setUp(self):
    ...
    def test_wrong_password(self):
        ...
        try:
            ...
            self.assertIsInstance(e, errors.QuantumError)
    ...
    def _loader(self, stream):
        return QuantumLoader(stream, vault_secrets=self.vault.secrets)
    ...
    def test_dump_load_cycle(self):
        avu = QuantumVaultEncryptedUnicode.from_plaintext('The plaintext for test_dump_load_cycle.', self.vault, self.vault_secret)
        self._dump_load_cycle(avu)

    def test_embedded_vault_from_dump(self):
        avu = QuantumVaultEncryptedUnicode.from_plaintext('setec astronomy', self.vault, self.vault_secret)
        ...
        self._dump_stream(blip, stream, dumper=QuantumDumper)
        ...
        self._dump_stream(data_from_yaml, stream2, dumper=QuantumDumper)
...
class TestQuantumLoaderPlay(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.loader = QuantumLoader(stream)
    ...
    def test_data_complete(self):
        ...
        self.assertEqual(self.data[0][u'vars'][u'string'], u'Quantum')
    ...
    def check_vars(self):
        ...
        # self.assertEqual(self.data[0][u'vars'][u'number'].quantum_pos, (self.play_filename, 4, 21))

        self.assertEqual(self.data[0][u'vars'][u'string'].quantum_pos, (self.play_filename, 5, 29))
        self.assertEqual(self.data[0][u'vars'][u'utf8_string'].quantum_pos, (self.play_filename, 6, 34))

        self.assertEqual(self.data[0][u'vars'][u'dictionary'].quantum_pos, (self.play_filename, 8, 23))
        self.assertEqual(self.data[0][u'vars'][u'dictionary'][u'webster'].quantum_pos, (self.play_filename, 8, 32))
        self.assertEqual(self.data[0][u'vars'][u'dictionary'][u'oed'].quantum_pos, (self.play_filename, 9, 28))

        self.assertEqual(self.data[0][u'vars'][u'list'].quantum_pos, (self.play_filename, 11, 23))
        self.assertEqual(self.data[0][u'vars'][u'list'][0].quantum_pos, (self.play_filename, 11, 25))
        self.assertEqual(self.data[0][u'vars'][u'list'][1].quantum_pos, (self.play_filename, 12, 25))
        # Numbers don't have line/col info yet
        # self.assertEqual(self.data[0][u'vars'][u'list'][2].quantum_pos, (self.play_filename, 13, 25))
        # self.assertEqual(self.data[0][u'vars'][u'list'][3].quantum_pos, (self.play_filename, 14, 25))

    def check_tasks(self):
        #
        # First Task
        #
        self.assertEqual(self.data[0][u'tasks'][0].quantum_pos, (self.play_filename, 16, 23))
        self.assertEqual(self.data[0][u'tasks'][0][u'name'].quantum_pos, (self.play_filename, 16, 29))
        self.assertEqual(self.data[0][u'tasks'][0][u'ping'].quantum_pos, (self.play_filename, 18, 25))
        self.assertEqual(self.data[0][u'tasks'][0][u'ping'][u'data'].quantum_pos, (self.play_filename, 18, 31))

        #
        # Second Task
        #
        self.assertEqual(self.data[0][u'tasks'][1].quantum_pos, (self.play_filename, 20, 23))
        self.assertEqual(self.data[0][u'tasks'][1][u'name'].quantum_pos, (self.play_filename, 20, 29))
        self.assertEqual(self.data[0][u'tasks'][1][u'ping'].quantum_pos, (self.play_filename, 22, 25))
        self.assertEqual(self.data[0][u'tasks'][1][u'ping'][u'data'].quantum_pos, (self.play_filename, 22, 31))

        #
        # Third Task
        #
        self.assertEqual(self.data[0][u'tasks'][2].quantum_pos, (self.play_filename, 24, 23))
        self.assertEqual(self.data[0][u'tasks'][2][u'name'].quantum_pos, (self.play_filename, 24, 29))
        self.assertEqual(self.data[0][u'tasks'][2][u'command'].quantum_pos, (self.play_filename, 25, 32))

    def test_line_numbers(self):
        # Check the line/column numbers are correct
        # Note: Remember, currently dicts begin at the start of their first entry
        self.assertEqual(self.data[0].quantum_pos, (self.play_filename, 2, 19))
        self.assertEqual(self.data[0][u'hosts'].quantum_pos, (self.play_filename, 2, 26))
        self.assertEqual(self.data[0][u'vars'].quantum_pos, (self.play_filename, 4, 21))

        self.check_vars()

        self.assertEqual(self.data[0][u'tasks'].quantum_pos, (self.play_filename, 16, 21))
