...
class TestVariableManager(unittest.TestCase):
    ...
    def test_basic_manager(self):
        ...
        # FIXME:  add the following ['quantum_version', 'quantum_coupling_python', 'groups']
        for varname, value in (('coupling_dir', os.path.abspath('.')), ):
    ...
    def test_variable_manager_precedence(self):
        ...
        fake_loader = DictDataLoader({
            # inventory1
            '/etc/quantum/inventory1': inventory1_filedata,
            # role defaults_only1
            '/etc/quantum/roles/defaults_only1/defaults/main.yml': """
            ...
            """,
            '/etc/quantum/roles/defaults_only1/tasks/main.yml': """
            - debug: msg="here i am"
            """,

            # role defaults_only2
            '/etc/quantum/roles/defaults_only2/defaults/main.yml': """
        ...
        inv1 = InventoryManager(loader=fake_loader, sources=['/etc/quantum/inventory1'])
        v = VariableManager(inventory=mock_inventory, loader=fake_loader)
        ...
        # self.assertEqual(res['coupling_group_var'], 'coupling_group_var')
        # self.assertEqual(res['host_var'], 'host_var_from_host_vars_host1')
        # self.assertEqual(res['coupling_host_var'], 'coupling_host_var')
    ...
    def test_variable_manager_role_vars_dependencies(self):
        ...
        fake_loader = DictDataLoader({
            # role common-role
            '/etc/quantum/roles/common-role/tasks/main.yml': """
            - debug: msg="{{role_var}}"
            """,
            ...
            # role role1
            '/etc/quantum/roles/role1/vars/main.yml': """
            role_var: "role_var_from_role1"
            """,
            '/etc/quantum/roles/role1/meta/main.yml': """
            dependencies:
              - { role: common-role }
            """,

            # role role2
            '/etc/quantum/roles/role2/vars/main.yml': """
            role_var: "role_var_from_role2"
            """,
            '/etc/quantum/roles/role2/meta/main.yml': """
            dependencies:
              - { role: common-role }
            """,
        })
