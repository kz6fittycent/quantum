...
from quantum.module_utils.six.moves.urllib.error import URLError, HTTPError
from quantum.module_utils.remote_management.dellemc.ome import RestOME
...
class TestRestOME(object):
    ...
    def test_invoke_request_with_session(self, mock_response, mocker):
        mocker.patch('quantum.module_utils.remote_management.dellemc.ome.open_url',
    ...
    def test_invoke_request_error_case_handling(self, exc, mock_response, mocker):
        open_url_mock = mocker.patch('quantum.module_utils.remote_management.dellemc.ome.open_url',
                                     return_value=mock_response)
