...
class TestSELinux(ModuleTestCase):
    def test_module_utils_basic_quantum_module_selinux_mls_enabled(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None

        am = basic.QuantumModule(
            argument_spec=dict(),
        )
    ...
    def test_module_utils_basic_quantum_module_selinux_initial_context(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
    ...
    def test_module_utils_basic_quantum_module_selinux_enabled(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
    ...
    def test_module_utils_basic_quantum_module_selinux_default_context(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
    ...
    def test_module_utils_basic_quantum_module_selinux_context(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
    ...
    def test_module_utils_basic_quantum_module_is_special_selinux_path(self):
        from quantum.module_utils import basic

        args = json.dumps(dict(ANSIBLE_MODULE_ARGS={'_quantum_selinux_special_fs': "nfs,nfsd,foos",
                                                    '_quantum_remote_tmp': "/tmp",
                                                    '_quantum_keep_remote_files': False}))
    ...
    def test_module_utils_basic_quantum_module_set_context_if_different(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
