...
class TestQuantumModuleTmpDir:

    DATA = (
        (
            {
                "_quantum_tmpdir": "/path/to/dir",
                "_quantum_remote_tmp": "/path/tmpdir",
        ...
        (
            {
                "_quantum_tmpdir": None,
                "_quantum_remote_tmp": "/path/tmpdir",
                "_quantum_keep_remote_files": False
            },
            False,
            "/path/tmpdir/quantum-moduletmp-42-"
        ),
        (
            {
                "_quantum_tmpdir": None,
        ...
        (
            {
                "_quantum_tmpdir": None,
                "_quantum_remote_tmp": "$HOME/.test",
                "_quantum_keep_remote_files": False
            },
            False,
            os.path.join(os.environ['HOME'], ".test/quantum-moduletmp-42-")
        ),
    )
    ...
    def test_tmpdir_property(self, monkeypatch, args, expected, stat_exists):
        ...
        with patch('time.time', return_value=42):
            am = basic.QuantumModule(argument_spec={})
    ...
    @pytest.mark.parametrize('stdin', ({"_quantum_tmpdir": None,
                                        "_quantum_remote_tmp": "$HOME/.test",
    ...
    def test_tmpdir_makedirs_failure(self, am, monkeypatch):
        ...
        assert mock_mkdtemp.call_args[1]['prefix'].startswith("quantum-moduletmp-")
