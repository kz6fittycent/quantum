...
class TestOtherFilesystem(ModuleTestCase):
    def test_module_utils_basic_quantum_module_user_and_group(self):
    ...
    def test_module_utils_basic_quantum_module_find_mount_point(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
    ...
    def test_module_utils_basic_quantum_module_set_owner_if_different(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
    ...
    def test_module_utils_basic_quantum_module_set_group_if_different(self):
        from quantum.module_utils import basic
        basic._ANSIBLE_ARGS = None
