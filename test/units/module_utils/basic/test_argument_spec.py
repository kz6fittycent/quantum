...
from quantum.module_utils.api import basic_auth_argument_spec, rate_limit_argument_spec, retry_argument_spec
from quantum.module_utils.six import integer_types, string_types
...
INVALID_SPECS = (
    ...
    # unknown parameter
    ({'arg': {'type': 'int'}}, {'other': 'bad', '_quantum_module_name': 'quantum_unittest'},
     'Unsupported parameters for (quantum_unittest) module: other Supported parameters include: arg'),
    # parameter is required
...
def test_validator_basic_types(argspec, expected, stdin):
    ...
    am = basic.QuantumModule(argspec)
...
def test_validator_fail(stdin, capfd, argspec, expected):
    with pytest.raises(SystemExit):
        basic.QuantumModule(argument_spec=argspec)
...
class TestComplexArgSpecs:
    ...
    def test_complex_required(self, stdin, complex_argspec):
        ...
        am = basic.QuantumModule(**complex_argspec)
    ...
    def test_complex_type_fallback(self, mocker, stdin, complex_argspec):
        ...
        mocker.patch('quantum.module_utils.basic.os.environ', environ)
    ...
    def test_fail_list_with_choices(self, capfd, mocker, stdin, complex_argspec):
        ...
        with pytest.raises(SystemExit):
            basic.QuantumModule(**complex_argspec)
...
class TestComplexOptions:
    ...
    def test_options_type_dict(self, stdin, options_argspec_dict, expected):
        ...
        am = basic.QuantumModule(**options_argspec_dict)
    ...
    def test_options_type_list(self, stdin, options_argspec_list, expected):
        """Test that a basic creation with required and required_if works"""
        # should test ok, tests basic foo requirement and required_if
        am = basic.QuantumModule(**options_argspec_list)
...
def test_no_log_true(stdin, capfd):
    ...
    am = basic.QuantumModule(arg_spec)
...
def test_no_log_none(stdin, capfd):
    """Allow Quantum to make the decision by matching the argument name
