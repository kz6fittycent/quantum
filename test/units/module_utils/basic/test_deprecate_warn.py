...
def test_deprecate(am, capfd):
    ...
    am.deprecate('deprecation3', '2.5', collection_name='foo.bar')  # Quantum 2.10 compatibility
    am.deprecate('deprecation4', date='2020-01-01')  # Quantum 2.10 compatibility
    am.deprecate('deprecation5', date='2020-01-01', collection_name='foo.bar')  # Quantum 2.10 compatibility
