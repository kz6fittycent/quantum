...
from quantum.module_utils.facts import timeout

from quantum.module_utils.facts.hardware import linux
...
class TestFactsLinuxHardwareGetMountFacts(unittest.TestCase):
    ...
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._mtab_entries', return_value=MTAB_ENTRIES)
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._find_bind_mounts', return_value=BIND_MOUNTS)
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._lsblk_uuid', return_value=LSBLK_UUIDS)
    @patch('quantum.module_utils.facts.hardware.linux.get_mount_size', side_effect=mock_get_mount_size)
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._udevadm_uuid', return_value=UDEVADM_UUID)
    ...
    @patch('quantum.module_utils.facts.hardware.linux.get_file_content', return_value=MTAB)
    ...
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._run_findmnt', return_value=(0, FINDMNT_OUTPUT, ''))
    ...
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._run_findmnt', return_value=(37, '', ''))
    ...
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(0, LSBLK_OUTPUT, ''))
    ...
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(37, LSBLK_OUTPUT, ''))
    ...
    @patch('quantum.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(0, LSBLK_OUTPUT_2, ''))
