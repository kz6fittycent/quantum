# unit tests for quantum ohai fact collector
# -*- coding: utf-8 -*-
#
    ...
    "storage": {
      ...
      "default": {
        ...
        "volumes": {
          ...
          "centos5-quantum_default.img": {
            "key": "/var/lib/libvirt/images/centos5-quantum_default.img",
            "name": "centos5-quantum_default.img",
            "path": "/var/lib/libvirt/images/centos5-quantum_default.img",
            "allocation": 8986624,
            "capacity": 42949672960,
            "type": 0
          },
...
class TestOhaiCollector(BaseFactsTest):
    ...
    @patch('quantum.module_utils.facts.other.ohai.OhaiFactCollector.get_ohai_output')
    ...
    @patch('quantum.module_utils.facts.other.ohai.OhaiFactCollector.run_ohai')
