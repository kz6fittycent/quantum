...
from quantum.module_utils.gcp import (_get_gcp_quantum_credentials, _get_gcp_credentials, _get_gcp_environ_var,
...
# Fake QuantumModule for use in tests
...
class GCPAuthTestCase(unittest.TestCase):
    ...
    def test_get_gcp_quantum_credentials(self):
        input_data = {'service_account_email': 'mysa',
                      'credentials_file': 'path-to-file.json',
                      'project_id': 'my-cool-project'}

        module = FakeModule(input_data)
        actual = _get_gcp_quantum_credentials(module)
    ...
    def test_get_gcp_environ_var(self):
        ...
        # works as expected.
        existing_var_name = 'gcp_quantum_auth_test_54321'
        non_existing_var_name = 'doesnt_exist_gcp_quantum_auth_test_12345'
    ...
    def test_validate_credentials_file(self):
        ...
        # of this function
        module = FakeModule()
        with mock.patch("quantum.module_utils.gcp.open",
    ...
    @mock.patch('quantum.module_utils.gcp._get_gcp_environ_var',
    ...
    def test_get_gcp_credentials(self, mockobj):
        ...
        # project_id (only) is set from Quantum params.
