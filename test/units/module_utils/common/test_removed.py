...
from quantum.module_utils.common.removed import removed_module
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            'The module documentation for Quantum-2.7 may contain hints for porting',
            u'',
        ),
        (
            2.8,
        ...
        (
            2,
            u'This module has been removed. '
            'The module documentation for Quantum-1 may contain hints for porting',
            u'',
        ),
        (
            u'café',
        ...
        (
            0.1,
            u'This module has been removed. '
            'The module documentation for Quantum-0.0 may contain hints for porting',
            u'',
        ),
    ]
)
