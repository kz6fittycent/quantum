...
TESTSETS = [
    ...
    {  # see https://github.com/quantum/quantum/issues/14837
        "name": "SLES 11.3",
        "input": {
    ...
    # ClearLinux https://github.com/quantum/quantum/issues/31501#issuecomment-340861535
    {
        "platform.dist": [
            "Clear Linux OS",
            "26580",
...
def test_distribution_version(am, mocker, testcase):
    ...
    * the output of quantum.module_utils.distro.linux_distribution() [called platform.dist() for historical reasons]
    * results for the quantum variables distribution* and os_family
    ...
    mocker.patch('quantum.module_utils.facts.system.distribution.get_file_content', mock_get_file_content)
    mocker.patch('quantum.module_utils.facts.system.distribution.get_uname', mock_get_uname)
    mocker.patch('quantum.module_utils.facts.system.distribution._file_exists', mock_file_exists)
    mocker.patch('quantum.module_utils.distro.name', mock_distro_name)
    mocker.patch('quantum.module_utils.distro.id', mock_distro_id)
    mocker.patch('quantum.module_utils.distro.version', mock_distro_version)
    mocker.patch('quantum.module_utils.distro.codename', mock_distro_codename)
