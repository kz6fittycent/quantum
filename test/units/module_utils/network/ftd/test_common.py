...
from quantum.module_utils.network.ftd.common import equal_objects, delete_ref_duplicates, construct_quantum_facts
...
def test_construct_quantum_facts_should_make_default_fact_with_name_and_type():
    response = {
        'id': '123',
        'name': 'foo',
        'type': 'bar'
    ...
    assert {'bar_foo': response} == construct_quantum_facts(response, {})


def test_construct_quantum_facts_should_not_make_default_fact_with_no_name():
    response = {
        'id': '123',
        'name': 'foo'
    }

    assert {} == construct_quantum_facts(response, {})


def test_construct_quantum_facts_should_not_make_default_fact_with_no_type():
    response = {
        'id': '123',
        'type': 'bar'
    }
...
def test_construct_quantum_facts_should_use_register_as_when_given():
    response = {
        'id': '123',
        'name': 'foo',
        'type': 'bar'
    ...
    assert {'fact_name': response} == construct_quantum_facts(response, params)


def test_construct_quantum_facts_should_extract_items():
    response = {'items': [
        {
            'id': '123',
            'name': 'foo',
    ...
    assert {'fact_name': response['items']} == construct_quantum_facts(response, params)


def test_construct_quantum_facts_should_ignore_items_with_no_register_as():
    response = {'items': [
        {
            'id': '123',
            'name': 'foo',
