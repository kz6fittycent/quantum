...
from quantum.module_utils.network.ftd.device import FtdPlatformFactory, FtdModel, FtdAsa5500xPlatform, \
...
class TestFtdPlatformFactory(object):
    ...
    def mock_devices(self, mocker):
        mocker.patch('quantum.module_utils.network.ftd.device.Kp')
        mocker.patch('quantum.module_utils.network.ftd.device.Ftd5500x')
...
class TestFtd2100Platform(object):
    ...
    def kp_mock(self, mocker):
        return mocker.patch('quantum.module_utils.network.ftd.device.Kp')
...
class TestFtdAsa5500xPlatform(object):
    ...
    def asa5500x_mock(self, mocker):
        return mocker.patch('quantum.module_utils.network.ftd.device.Ftd5500x')
