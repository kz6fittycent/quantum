...
# This file is part of Quantum by Red Hat
#
...
from quantum.module_utils.network.meraki.meraki import MerakiModule, meraki_argument_spec, HTTPError, RateLimitException
from quantum.module_utils.six import PY2, PY3
...
def test_fetch_url_404(module, mocker):
    url = '404'
    mocker.patch('quantum.module_utils.network.meraki.meraki.fetch_url', side_effect=mocked_fetch_url)
    mocker.patch('quantum.module_utils.network.meraki.meraki.MerakiModule.fail_json', side_effect=mocked_fail_json)
...
def test_fetch_url_429_success(module, mocker):
    url = '429'
    mocker.patch('quantum.module_utils.network.meraki.meraki.fetch_url', side_effect=mocked_fetch_url_rate_success)
    mocker.patch('quantum.module_utils.network.meraki.meraki.MerakiModule.fail_json', side_effect=mocked_fail_json)
    mocker.patch('time.sleep', return_value=None)
