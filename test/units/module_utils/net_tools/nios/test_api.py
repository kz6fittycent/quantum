...
class TestNiosApi(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.module = MagicMock(name='QuantumModule')
        self.module.check_mode = False
        self.module.params = {'provider': None}

        self.mock_connector = patch('quantum.module_utils.net_tools.nios.api.get_connector')
    ...
    def test_wapi_strip_network_view(self):
        ...
        test_object = [{
            "comment": "test comment",
            "_ref": "view/ZG5zLm5ldHdvcmtfdmlldyQw:quantum/true",
            "name": "quantum",
            "extattrs": {},
            "network_view": "default"
        }]
