...
from quantum.plugins.inventory.aws_ec2 import InventoryModule, instance_data_filter_to_boto_attr
...
instances = {
    u'Instances': [
        {u'Monitoring': {u'State': 'disabled'},
         ...
         u'Tags': [{u'Value': 'test', u'Key': 'quantum'}, {u'Value': 'aws_ec2', u'Key': 'name'}],
         u'AmiLaunchIndex': 0}],
...
def test_boto3_conn(inventory):
    ...
    with pytest.raises(QuantumError) as error_message:
