...
# Copyright 2017 Chris Meyers <cmeyers@quantum.com>
#
...
class TestInventoryModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        inv_loader = PluginLoader('InventoryModule', 'quantum.plugins.inventory', C.DEFAULT_INVENTORY_PLUGIN_PATH, 'inventory_plugins')
        ...
        self.BaseInventoryPlugin = register_patch('quantum.plugins.inventory.BaseInventoryPlugin')
    ...
    def test_parse_subprocess_path_not_found_fail(self):
        ...
        with pytest.raises(QuantumError) as e:
