...
{ 'dic_item_added': set([u"root['quantum_python_interpreter']"]),
...
from quantum.plugins.action.synchronize import ActionModule
...
class TestSynchronizeAction(unittest.TestCase):
    ...
    @patch('quantum.plugins.action.synchronize.connection_loader', FakePluginLoader)
    def test_basic(self):
        x = SynchronizeTester()
