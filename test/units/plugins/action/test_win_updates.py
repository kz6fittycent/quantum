...
from quantum.plugins.action.win_updates import ActionModule
from quantum.plugins.become.runas import BecomeModule
...
class TestWinUpdatesActionPlugin(object):
    ...
    def test_exec_with_become(self, test_win_updates):
        ...
        with patch('quantum.plugins.action.ActionBase._execute_module', new=MagicMock()):
    ...
    def test_module_exec_async_result(self, monkeypatch):
        return_val = {
            "quantum_async_watchdog_pid": 7584,
            "quantum_job_id": "545519115287.9620",
            "changed": True,
            "finished": 0,
            "results_file": r"C:\.quantum_async\545519115287.9620",
            "started": 1
        }
        ...
        assert actual['quantum_async_watchdog_pid'] == 7584
        assert actual['quantum_job_id'] == "545519115287.9620"
        assert actual['changed'] is True
        assert actual['finished'] == 0
        assert actual['results_file'] == r"C:\.quantum_async\545519115287.9620"
