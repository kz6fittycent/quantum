...
from quantum.module_utils.network.ftd.common import HTTPMethod, ResponseParams
from quantum.module_utils.network.ftd.fdm_swagger_client import SpecProp, FdmSwaggerParser
from quantum.module_utils.six import BytesIO, PY3, StringIO
from quantum.plugins.httpapi.ftd import HttpApi, BASE_HEADERS, TOKEN_PATH_TEMPLATE, DEFAULT_API_VERSIONS
...
class TestFtdHttpApi(unittest.TestCase):
    ...
    def test_login_raises_exception_when_no_refresh_token_and_no_credentials(self):
        with self.assertRaises(QuantumConnectionFailure) as res:
    ...
    @patch('quantum.plugins.httpapi.ftd.encode_multipart_formdata',
    ...
    @patch('quantum.plugins.httpapi.ftd.HttpApi._get_api_token_path', mock.MagicMock(return_value=None))
    @patch('quantum.plugins.httpapi.ftd.HttpApi._get_known_token_paths')
    ...
    @patch('quantum.plugins.httpapi.ftd.HttpApi._get_known_token_paths')
    @patch('quantum.plugins.httpapi.ftd.HttpApi._send_login_request')
    ...
    @patch('quantum.plugins.httpapi.ftd.HttpApi._get_known_token_paths')
    @patch('quantum.plugins.httpapi.ftd.HttpApi._send_login_request')
    @patch('quantum.plugins.httpapi.ftd.HttpApi._set_api_token_path')
    ...
    @patch('quantum.plugins.httpapi.ftd.HttpApi._get_supported_api_versions')
