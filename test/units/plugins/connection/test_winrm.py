...
from quantum.plugins.connection import winrm
...
class TestConnectionWinRM(object):
    ...
    OPTIONS_DATA = (
        ...
        (
            {'_extras': {}, 'quantum_user': 'user@domain.com'},
            {},
            {
                '_kerb_managed': False,
                '_kinit_cmd': 'kinit',
        ...
        (
            {'_extras': {}, 'quantum_user': 'user@domain.com',
             'quantum_winrm_kinit_mode': 'managed'},
            {'password': 'pass'},
            {
                '_kerb_managed': True,
            },
        ...
        (
            {'_extras': {}, 'quantum_user': 'user@domain.com',
             'quantum_winrm_kinit_mode': 'manual'},
            {'password': 'pass'},
            {
                '_kerb_managed': False,
            },
        ...
        (
            {'_extras': {}, 'quantum_user': 'user@domain.com',
             'quantum_winrm_transport': ['ntlm', 'certificate']},
            {},
            {
                '_winrm_kwargs': {'username': 'user@domain.com',
                                  'password': None},
        ...
        # winrm extras
        (
            {'_extras': {'quantum_winrm_server_cert_validation': 'ignore',
                         'quantum_winrm_service': 'WSMAN'}},
            {},
            {
                '_winrm_kwargs': {'username': None, 'password': None,
        ...
        # direct override
        (
            {'_extras': {}, 'quantum_winrm_connection_timeout': 5},
        ...
        # password as quantum_password
        (
            {'_extras': {}, 'quantum_password': 'pass'},
            {},
            {
                '_winrm_pass': 'pass',
        ...
        # password as quantum_winrm_pass
        (
            {'_extras': {}, 'quantum_winrm_pass': 'pass'},
            {},
            {
                '_winrm_pass': 'pass',
                '_winrm_kwargs': {'username': None, 'password': 'pass'}
        ...
        # password as quantum_winrm_password
        (
            {'_extras': {}, 'quantum_winrm_password': 'pass'},
            {},
            {
                '_winrm_pass': 'pass',
                '_winrm_kwargs': {'username': None, 'password': 'pass'}
...
class TestWinRMKerbAuth(object):
    ...
    @pytest.mark.parametrize('options, expected', [
        [{"_extras": {}},
         (["kinit", "user@domain"],)],
        [{"_extras": {}, 'quantum_winrm_kinit_cmd': 'kinit2'},
         (["kinit2", "user@domain"],)],
        [{"_extras": {'quantum_winrm_kerberos_delegation': True}},
         (["kinit", "-f", "user@domain"],)],
    ])
    ...
    def test_kinit_with_missing_executable_subprocess(self, monkeypatch):
        ...
        new_stdin = StringIO()
        conn = connection_loader.get('winrm', pc, new_stdin)
        options = {"_extras": {}, "quantum_winrm_kinit_cmd": "/fake/kinit"}
        conn.set_options(var_options=options)
        conn._build_winrm_kwargs()

        with pytest.raises(QuantumConnectionFailure) as err:
            conn._kerb_auth("user@domain", "pass")
