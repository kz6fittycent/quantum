...
class TestConnectionClass(unittest.TestCase):
    ...
    def test_network_cli__invalid_os(self):
        ...
        self.assertRaises(QuantumConnectionFailure, connection_loader.get, 'network_cli', pc, '/dev/null')
    ...
    @patch("quantum.plugins.connection.network_cli.terminal_loader")
    @patch("quantum.plugins.connection.paramiko_ssh.Connection._connect")
    ...
    @patch("quantum.plugins.connection.paramiko_ssh.Connection.close")
    ...
    @patch("quantum.plugins.connection.network_cli.Connection._get_terminal_std_re")
    @patch("quantum.plugins.connection.network_cli.Connection._connect")
    def test_network_cli_send(self, mocked_connect, mocked_terminal_re):
        ...
        mocked_terminal_re.side_effect = [[re.compile(b'^ERROR')], [re.compile(b'device#')]]
        with self.assertRaises(QuantumConnectionFailure) as exc:
            conn.send(b'command')
