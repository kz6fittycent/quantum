...
from quantum.module_utils.urls import ConnectionError, SSLValidationError
from quantum.module_utils.six.moves.urllib.error import HTTPError, URLError
from quantum.module_utils import six
from quantum.plugins.lookup.manifold import ManifoldApiClient, LookupModule, ApiError
import json
...
class TestManifoldApiClient(unittest.TestCase):
    @patch('quantum.plugins.lookup.manifold.open_url')
...
class TestLookupModule(unittest.TestCase):
    ...
    @patch('quantum.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('quantum.plugins.lookup.manifold.display')
    @patch('quantum.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('quantum.plugins.lookup.manifold.os.getenv')
    @patch('quantum.plugins.lookup.manifold.ManifoldApiClient')
