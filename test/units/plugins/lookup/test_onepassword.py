...
from quantum.plugins.lookup.onepassword import OnePass, LookupModule
from quantum.plugins.lookup.onepassword_raw import LookupModule as OnePasswordRawLookup
...
class MockOnePass(OnePass):
    ...
    def _run(self, args, expected_rc=0, command_input=None, ignore_errors=False):
        ...
        raise QuantumError('Unsupported command string passed to OnePass mock: {0}'.format(args))
...
@patch('quantum.plugins.lookup.onepassword.OnePass', MockOnePass)
...
@patch('quantum.plugins.lookup.onepassword_raw.OnePass', MockOnePass)
