...
from quantum.plugins.lookup.lastpass import LookupModule, LPass, LPassException
...
class TestLastpassPlugin(unittest.TestCase):
    ...
    @patch('quantum.plugins.lookup.lastpass.LPass', new=MockLPass)
    ...
    @patch('quantum.plugins.lookup.lastpass.LPass', LoggedOutMockLPass)
    ...
    @patch('quantum.plugins.lookup.lastpass.LPass', DisconnectedMockLPass)
