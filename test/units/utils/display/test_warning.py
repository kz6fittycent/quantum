...
def test_warning(capsys, mocker, warning_message):
    ...
    mocker.patch('quantum.utils.color.ANSIBLE_COLOR', True)
    mocker.patch('quantum.utils.color.parsecolor', return_value=u'1;35')  # value for 'bright purple'
...
def test_warning_no_color(capsys, mocker, warning_message):
    ...
    mocker.patch('quantum.utils.color.ANSIBLE_COLOR', False)
