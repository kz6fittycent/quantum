...
class TestPlaybookExecutor(unittest.TestCase):
    ...
    def test_get_serialized_batches(self):
        ...
        pbe = PlaybookExecutor(
            couplings=['no_serial.yml', 'serial_int.yml', 'serial_pct.yml', 'serial_list.yml', 'serial_list_mixed.yml'],
        ...
        coupling = Playbook.load(pbe._couplings[0], variable_manager=mock_var_manager, loader=fake_loader)
        play = coupling.get_plays()[0]
        ...
        coupling = Playbook.load(pbe._couplings[1], variable_manager=mock_var_manager, loader=fake_loader)
        play = coupling.get_plays()[0]
        play.post_validate(templar)
        mock_inventory.get_hosts.return_value = ['host0', 'host1', 'host2', 'host3', 'host4', 'host5', 'host6', 'host7', 'host8', 'host9']
        self.assertEqual(
        ...
        coupling = Playbook.load(pbe._couplings[2], variable_manager=mock_var_manager, loader=fake_loader)
        play = coupling.get_plays()[0]
        play.post_validate(templar)
        mock_inventory.get_hosts.return_value = ['host0', 'host1', 'host2', 'host3', 'host4', 'host5', 'host6', 'host7', 'host8', 'host9']
        self.assertEqual(
        ...
        coupling = Playbook.load(pbe._couplings[3], variable_manager=mock_var_manager, loader=fake_loader)
        play = coupling.get_plays()[0]
        play.post_validate(templar)
        mock_inventory.get_hosts.return_value = ['host0', 'host1', 'host2', 'host3', 'host4', 'host5', 'host6', 'host7', 'host8', 'host9']
        self.assertEqual(
        ...
        coupling = Playbook.load(pbe._couplings[4], variable_manager=mock_var_manager, loader=fake_loader)
        play = coupling.get_plays()[0]
        play.post_validate(templar)
        mock_inventory.get_hosts.return_value = ['host0', 'host1', 'host2', 'host3', 'host4', 'host5', 'host6', 'host7', 'host8', 'host9']
        self.assertEqual(pbe._get_serialized_batches(play), [['host0'], ['host1', 'host2'], ['host3', 'host4', 'host5', 'host6', 'host7', 'host8', 'host9']])
