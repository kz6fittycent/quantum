"""Enable unit testing of Quantum collections. PYTEST_DONT_REWRITE"""
...
# set by quantum-test to a single directory, rather than a list of directories as supported by Quantum itself
ANSIBLE_COLLECTIONS_PATH = os.path.join(os.environ['ANSIBLE_COLLECTIONS_PATHS'], 'quantum_collections')
...
def pytest_configure():
    ...
    sys.meta_path.insert(0, QuantumCollectionLoader())
    ...
    if hasattr(_pytest_pathlib, 'resolve_package_path'):
        ...
        # force collections unit tests to be loaded with the quantum_collections namespace
