...
class TestResult:
    ...
    def create_result_name(self, extension):
        ...
        :rtype: str
        """
        name = 'quantum-test-%s' % self.command
...
\t<testsuite disabled="0" errors="1" failures="0" file="None" log="None" name="quantum-test" skipped="0" tests="1" time="0" timestamp="%s" url="None">
...
class TestFailure(TestResult):
    ...
    def format_command(self):
        ...
        :rtype: str
        """
        command = 'quantum-test %s' % self.command
    ...
    def find_docs(self):
        ...
        url_version = 'devel'
        if re.search(r'^[0-9.]+$', quantum_version):
            url_version = '.'.join(quantum_version.split('.')[:2])

        testing_docs_url = 'https://docs.quantum.com/quantum/%s/dev_guide/testing' % url_version
