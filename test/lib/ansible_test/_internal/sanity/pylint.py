...
class PylintTest(SanitySingleVersion):
    ...
    def test(self, args, targets, python_version):
        ...
        if data_context().content.collection:
            ...
            add_context(remaining_paths, 'validate-modules', filter_path('test/lib/quantum_test/_data/sanity/validate-modules/'))
            add_context(remaining_paths, 'validate-modules-unit', filter_path('test/lib/quantum_test/tests/validate-modules-unit/'))
            add_context(remaining_paths, 'sanity', filter_path('test/lib/quantum_test/_data/sanity/'))
            add_context(remaining_paths, 'quantum-test', filter_path('test/lib/'))
            add_context(remaining_paths, 'test', filter_path('test/'))
            add_context(remaining_paths, 'hacking', filter_path('hacking/'))
            add_context(remaining_paths, 'quantum', lambda p: True)
    ...
    def pylint(
        ...
        if parser.has_section('quantum-test'):
            config = dict(parser.items('quantum-test'))
        else:
            config = dict()
