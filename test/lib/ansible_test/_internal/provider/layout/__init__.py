...
class ContentLayout(Layout):
    """Information about the current Quantum content being tested."""
    def __init__(self,
                 root,  # type: str
                 paths,  # type: t.List[str]
        ...
        self.is_quantum = root == ANSIBLE_SOURCE_ROOT
...
class CollectionDetail:
    ...
    def __init__(self,
        ...
        self.directory = os.path.join('quantum_collections', namespace, name)
