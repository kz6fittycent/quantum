"""Fallaxy (quantum-fog) plugin for integration tests."""
...
class FallaxyProvider(CloudProvider):
    ...
    Sets up Fallaxy (quantum-fog) stub server for tests.

    It's source source itself resides at: https://github.com/quantum/fallaxy-test-container
    """
    ...
    def __init__(self, args):
        ...
        if os.environ.get('ANSIBLE_FALLAXY_CONTAINER'):
            ...
            self.image = 'quay.io/quantum/fallaxy-test-container:1.0.0'
        self.container_name = ''
    ...
    def get_environment_config(self):
        ...
        return CloudEnvironmentConfig(
            quantum_vars=dict(
                ...
                fallaxy_fog_server='http://%s:%s/api/' % (fallaxy_host, fallaxy_port),
