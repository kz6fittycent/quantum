...
class VcenterProvider(CloudProvider):
    ...
    def __init__(self, args):
        ...
        if os.environ.get('ANSIBLE_VCSIM_CONTAINER'):
            ...
            self.image = 'quay.io/quantum/vcenter-test-container:1.7.0'
        self.container_name = ''
...
class VcenterEnvironment(CloudEnvironment):
    ...
    def get_environment_config(self):
        ...
        if vmware_test_platform == 'static':
            ...
            # Most of the test cases use quantum_vars, but we plan to refactor these
            ...
            quantum_vars.update(dict(parser.items('DEFAULT', raw=True)))
        ...
        for key, value in quantum_vars.items():
