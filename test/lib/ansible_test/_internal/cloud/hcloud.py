...
class HcloudCloudProvider(CloudProvider):
    ...
    def _setup_dynamic(self):
        """Request Hetzner credentials through the Quantum Core CI service."""
    ...
    def _create_quantum_core_ci(self):
        ...
        :rtype: QuantumCoreCI
        """
        return QuantumCoreCI(self.args, 'hetzner', 'hetzner', persist=False, stage=self.args.remote_stage, provider=self.args.remote_provider)
