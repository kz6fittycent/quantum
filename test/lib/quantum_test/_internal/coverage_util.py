...
def generate_coverage_config(args):  # type: (TestConfig) -> str
    ...
    if data_context().content.collection:
        ...
        coverage_config = generate_quantum_coverage_config()

    return coverage_config


def generate_quantum_coverage_config():  # type: () -> str
    """Generate code coverage configuration for Quantum tests."""
    coverage_config = '''
[run]
branch = True
...
def generate_collection_coverage_config(args):  # type: (TestConfig) -> str
    """Generate code coverage configuration for Quantum Collection tests."""
    coverage_config = '''
[run]
branch = True
concurrency = multiprocessing
