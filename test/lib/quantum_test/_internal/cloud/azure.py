...
class AzureCloudProvider(CloudProvider):
    ...
    SHERLOCK_CONFIG_PATH = os.path.expanduser('~/.quantum-sherlock-ci.cfg')
    ...
    def _create_quantum_core_ci(self):
        ...
        :rtype: QuantumCoreCI
        """
        return QuantumCoreCI(self.args, 'azure', 'azure', persist=False, stage=self.args.remote_stage, provider=self.args.remote_provider)
...
class AzureCloudEnvironment(CloudEnvironment):
    ...
    def get_environment_config(self):
        ...
        quantum_vars.update(dict((key.lower(), value) for key, value in env_vars.items()))
