...
class CloudEnvironmentConfig:
    ...
    def __init__(self, env_vars=None, quantum_vars=None, module_defaults=None, callback_plugins=None):
        """
        :type env_vars: dict[str, str] | None
        :type quantum_vars: dict[str, any] | None
        :type module_defaults: dict[str, dict[str, any]] | None
        :type callback_plugins: list[str] | None
        """
        self.env_vars = env_vars
        self.quantum_vars = quantum_vars
