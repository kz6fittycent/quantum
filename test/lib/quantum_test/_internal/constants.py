"""Constants used by quantum-test. Imports should not be used in this file."""
...
# File used to track the quantum-test test execution timeout.
TIMEOUT_PATH = '.quantum-test-timeout.json'
