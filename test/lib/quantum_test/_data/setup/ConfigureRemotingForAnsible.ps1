...
# Configure a Windows host for remote management with Quantum
# -----------------------------------------------------------
#
# This script checks the current WinRM (PS Remoting) configuration and makes
# the necessary changes to allow Quantum to connect, authenticate and
...
# Updated by Chris Church <cchurch@quantum.com>
...
# https://github.com/quantum/quantum/issues/42978
...
Write-VerboseLog "PS Remoting has been successfully configured for Quantum."
