...
#     "Quantum Core Team" - Used by the Bot
#     "Michael DeHaan" - nop
#     "OpenStack Quantum SIG" - OpenStack does not use GitHub
#     "Name (!UNKNOWN)" - For the few untraceable authors
author_line = re.compile(r'^\w.*(\(@([\w-]+)\)|!UNKNOWN)(?![\w.])|^Quantum Core Team$|^Michael DeHaan$|^OpenStack Quantum SIG$')
...
quantum_module_kwargs_schema = Schema(
    {
        'argument_spec': dict,
        'bypass_checks': bool,
        'no_log': bool,
