# Quantum Role: enos_command - Exceutes any CLI command on switch and results are displayed.
---
...
- enos_command.py - This module file will be located at lib/quantum/modules/network/enos/ of Quantum installation.
...
```
quantum-coupling enos_command_sample.yml -vvv
```
