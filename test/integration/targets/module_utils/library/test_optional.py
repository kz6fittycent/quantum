...
try:
    from quantum.module_utils.urls import fetch_url as yep1
except ImportError:
    yep1 = None

try:
    import quantum.module_utils.common.text.converters as yep2
except ImportError:
    yep2 = None

try:
    # optional import from a legit collection
    from quantum_collections.testns.testcoll.plugins.module_utils.legit import importme as yep3
except ImportError:
    yep3 = None

# and a bunch that should fail to be found, but not break the module_utils payload build in the process...
try:
    from quantum.module_utils.bogus import fromnope1
except ImportError:
    fromnope1 = None

if _private_false:
    from quantum.module_utils.alsobogus import fromnope2
else:
    fromnope2 = None

try:
    import quantum.module_utils.verybogus
    nope1 = quantum.module_utils.verybogus
except ImportError:
    nope1 = None
    ...
    if _private_true:
        if _private_true:
            if _private_true:
                if _private_true:
                    try:
                        import quantum.module_utils.stillbogus as nope2
                    except ImportError:
                        raise
except ImportError:
    nope2 = None
...
try:
    ...
    from quantum_collections.testns.testcoll.plugins.module_utils.bogus import collnope1
except ImportError:
    collnope1 = None

try:
    # optional import from a bogus collection
    from quantum_collections.bogusns.boguscoll.plugins.module_utils.bogus import collnope2
except ImportError:
    collnope2 = None
