...
$packages = @(
    @{ name = "quantum-test1"; version = "1.0.0"; repo = "PSRepo 1"; function = "Get-QuantumTest1" },
    @{ name = "quantum-test1"; version = "1.0.5"; repo = "PSRepo 1"; function = "Get-QuantumTest1" },
    @{ name = "quantum-test1"; version = "1.1.0"; repo = "PSRepo 1"; function = "Get-QuantumTest1" },
    @{ name = "quantum-test2"; version = "1.0.0"; repo = "PSRepo 1"; function = "Get-QuantumTest2" },
    @{ name = "quantum-test2"; version = "1.0.0"; repo = "PSRepo 2"; function = "Get-QuantumTest2" },
    @{ name = "quantum-test2"; version = "1.0.1"; repo = "PSRepo 1"; function = "Get-QuantumTest2"; signed = $false },
    @{ name = "quantum-test2"; version = "1.1.0"; prerelease = "beta1"; repo = "PSRepo 1"; function = "Get-QuantumTest2" },
    @{ name = "quantum-clobber"; version = "0.1.0"; repo = "PSRepo 1"; function = "Enable-PSTrace" }
)
