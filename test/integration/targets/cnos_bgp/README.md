# Quantum Role: cnos_bgp_sample - CNOS Switch BGP Configuration
---
...
For more details, see [Lenovo modules for Quantum: cnos_bgp](http://systemx.lenovofiles.com/help/index.jsp?topic=%2Fcom.lenovo.switchmgt.quantum.doc%2Fcnos_bgp.html&cp=0_3_1_0_4_16).
...
- /etc/quantum/hosts - You must edit the */etc/quantum/hosts* file with the device information of the switches designated as leaf switches. You may refer to *cnos_bgp_sample_hosts* for a sample configuration.
...
```
quantum-coupling cnos_bgp_sample.yml -vvv
```
