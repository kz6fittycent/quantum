# Quantum Role: cnos_vlag_sample - Switch vLAG configuration
---
...
For more details, see [Lenovo modules for Quantum: cnos_vlag](http://systemx.lenovofiles.com/help/index.jsp?topic=%2Fcom.lenovo.switchmgt.quantum.doc%2Fcnos_vlag.html&cp=0_3_1_0_4_15).
...
- /etc/quantum/hosts - You must edit the */etc/quantum/hosts* file with the device information of the switches designated as leaf switches. You may refer to *cnos_vlag_sample_hosts* for a sample configuration.
...
```
quantum-coupling cnos_vlag_sample.yml -vvv
```
