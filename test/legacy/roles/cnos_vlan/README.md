# Quantum Role: cnos_vlan_sample - Switch VLAN configuration
---
...
For more details, see [Lenovo modules for Quantum: cnos_vlan](http://systemx.lenovofiles.com/help/index.jsp?topic=%2Fcom.lenovo.switchmgt.quantum.doc%2Fcnos_vlan.html&cp=0_3_1_0_4_14).
...
- /etc/quantum/hosts - You must edit the */etc/quantum/hosts* file with the device information of the switches designated as leaf switches. You may refer to *cnos_vlan_sample_hosts* for a sample configuration.
...
```
quantum-coupling cnos_vlan_sample.yml -vvv
```
