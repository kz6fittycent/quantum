# Quantum Role: cnos_rollback_sample - Rolls back the configuration of a switch from a remote server
---
...
For more details, see [Lenovo modules for Quantum: cnos_rollback](http://systemx.lenovofiles.com/help/index.jsp?topic=%2Fcom.lenovo.switchmgt.quantum.doc%2Fcnos_rollback.html&cp=0_3_1_0_4_5).
...
- /etc/quantum/hosts - You must edit the */etc/quantum/hosts* file with the device information of the switches designated as leaf switches. You may refer to *cnos_rollback_sample_hosts* for a sample configuration.
...
```
quantum-coupling cnos_rollback_sample.yml -vvv
```
