# Quantum Role: cnos_save_sample - Saving the switch running configuration
---
...
For more details, see [Lenovo modules for Quantum: cnos_save](http://systemx.lenovofiles.com/help/index.jsp?topic=%2Fcom.lenovo.switchmgt.quantum.doc%2Fcnos_save.html&cp=0_3_1_0_4_3).
...
- /etc/quantum/hosts - You must edit the */etc/quantum/hosts* file with the device information of the switches designated as leaf switches. You may refer to *cnos_save_sample_hosts* for a sample configuration.
...
```
quantum-coupling cnos_save_sample.yml -vvv
```
