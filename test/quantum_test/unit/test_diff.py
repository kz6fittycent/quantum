...
from quantum_test._internal.util import (
    to_text,
    to_bytes,
)

from quantum_test._internal.diff import (
    parse_diff,
    FileDiff,
)
...
def test_parse_diff(base, head):
    """Integration test to verify parsing of quantum/quantum history."""
...
def test_parse_delete():
    ...
    assert deletes[0].old.path == 'lib/quantum/plugins/connection/nspawn.py'
    assert deletes[0].new.path == 'lib/quantum/plugins/connection/nspawn.py'
