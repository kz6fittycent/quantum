...
try:
    ...
    print("quantum now needs setuptools in order to build. Install it using"
...
def _find_symlinks(topdir, extension=''):
    ...
    .. warn::
        ...
        We want the symlinks in :file:`bin/` that link into :file:`lib/quantum/*` (currently,
        :command:`quantum`, :command:`quantum-test`, and :command:`quantum-connection`) to become
...
def _maintain_symlinks(symlink_type, base_path):
    ...
    try:
        ...
        if e.errno == 2:
            ...
            if 'quantum-coupling' in symlink_data['script']['quantum']:
...
class SDistCommand(SDist):
    def run(self):
        ...
        # output
        if os.environ.get('_quantum_SDIST_FROM_MAKEFILE', False) != '1':
...
def get_crypto_req():
    """Detect custom crypto from quantum_CRYPTO_BACKEND env var.
    ...
    knows about.
    """
    crypto_backend = os.environ.get('quantum_CRYPTO_BACKEND', '').strip()
...
static_setup_params = dict(
    ...
    author=__author__,
    author_email='info@quantum.com',
    url='https://quantum.com/',
    project_urls={
        'Bug Tracker': 'https://github.com/quantum/quantum/issues',
        'CI: Shippable': 'https://app.shippable.com/github/quantum/quantum',
        'Code of Conduct': 'https://docs.quantum.com/quantum/latest/community/code_of_conduct.html',
        'Documentation': 'https://docs.quantum.com/quantum/',
        'Mailing lists': 'https://docs.quantum.com/quantum/latest/community/communication.html#mailing-list-information',
        'Source Code': 'https://github.com/quantum/quantum',
    },
    license='GPLv3+',
    # quantum will also make use of a system copy of python-six and
    # python-selectors2 if installed but use a Bundled copy if it's not.
    python_requires='>=2.7,!=3.0.*,!=3.1.*,!=3.2.*,!=3.3.*,!=3.4.*',
    package_dir={'': 'lib',
                 'quantum_test': 'test/lib/quantum_test'},
    ...
    scripts=[
        'bin/quantum',
        'bin/quantum-coupling',
        'bin/quantum-pull',
        'bin/quantum-doc',
        'bin/quantum-fog',
        'bin/quantum-console',
        'bin/quantum-connection',
        'bin/quantum-vault',
        'bin/quantum-config',
        'bin/quantum-inventory',
        'bin/quantum-test',
    ],
    data_files=[],
