...
class LookupBase(QuantumPlugin):
    ...
    def run(self, terms, variables=None, **kwargs):
        """
        When the coupling specifies a lookup, this method is run.  The
        ...
        call.  It contains the variables available to quantum at the time the
        ...
        Lookup plugins can be used within couplings for looping.  When this
        happens, the first argument is a list containing the terms.  Lookup
        plugins can also be called from within couplings to return their
        ...
        QuantumError() with a message describing the error.
    ...
    def find_file_in_search_path(self, myvars, subdir, needle, ignore_missing=False):
        ...
        if 'quantum_search_path' in myvars:
            paths = myvars['quantum_search_path']
        else:
