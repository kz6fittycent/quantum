...
from quantum.module_utils.network.avi.avi_api import (ApiSession,
                                                      AviCredentials,
                                                      AviServerError,
                                                      ObjectNotFound,
                                                      APIError)
...
def _api(avi_session, path, **kwargs):
    ...
    try:
        ...
        raise QuantumError(to_native(e))
    except Exception as e:
        # Generic excption handling for connection failures
        raise QuantumError('Unable to communicate with controller'
...
class LookupModule(LookupBase):
    def run(self, terms, variables=None, avi_credentials=None, **kwargs):
        ...
        try:
            ...
            raise QuantumError("Please pass the obj_type for lookup")
