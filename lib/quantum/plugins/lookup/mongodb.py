...
from quantum.module_utils.six import string_types, integer_types
__metaclass__ = type
...
class LookupModule(LookupBase):
    ...
    def _fix_sort_parameter(self, sort_parameter):
        ...
        if not isinstance(sort_parameter, list):
            raise QuantumError(u"Error. Sort parameters must be a list, not [ {0} ]".format(sort_parameter))
    ...
    def run(self, terms, variables, **kwargs):
        ...
        for term in terms:
            ...
            Here is a sample coupling that uses it:
...
-------------------------------------------------------------------------------
            ...
            try:
                ...
                raise QuantumError(u'unable to connect to database: %s' % str(e))
