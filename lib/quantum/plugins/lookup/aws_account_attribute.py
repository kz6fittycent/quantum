...
try:
    ...
    raise QuantumError("The lookup aws_account_attribute requires boto3 and botocore.")

from quantum.plugins import QuantumPlugin
from quantum.plugins.lookup import LookupBase
from quantum.module_utils.ec2 import boto3_conn, get_aws_connection_info
...
class LookupModule(LookupBase):
    def run(self, terms, variables, **kwargs):
        ...
        try:
            ...
            raise QuantumError("Failed to describe account attributes: %s" % to_native(e))
