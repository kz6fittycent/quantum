...
# Copyright: (c) 2012-17, Quantum Project
    ...
    def run(self, terms, variables, **kwargs):
        ...
        for term in terms:
            ...
            if lookupfile:
                ...
                searchpath = variables.get('quantum_search_path', [])
                if searchpath:
                ...
                # plus some added by quantum (e.g., template_{path,mtime}),
                # plus anything passed to the lookup with the template_vars=
                # argument.
                vars = deepcopy(variables)
                vars.update(generate_quantum_template_vars(lookupfile))
                ...
                raise QuantumError("the template file %s could not be found for the lookup" % term)
