...
DOCUMENTATION = """
    ...
    notes:
      ...
      - Matching is against local system files on the Quantum controller.
    ...
    def run(self, terms, variables=None, **kwargs):
        ...
        for term in terms:
            ...
            if term_file != term:
                ...
                if 'quantum_search_path' in variables:
                    paths = variables['quantum_search_path']
                else:
