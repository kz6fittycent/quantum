...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
        ...
        if HAVE_DNS is False:
            raise QuantumError("The dig lookup requires the python 'dnspython' library and it is not installed")
                ...
                for ns in nsset:
                    ...
                    try:
                        ...
                        try:
                            ...
                            raise QuantumError("dns lookup NS: %s" % to_native(e))
            ...
            if '=' in t:
                ...
                if opt == 'qtype':
                    ...
                    try:
                        ...
                        raise QuantumError("dns lookup illegal CLASS: %s" % to_native(e))
        ...
        if qtype.upper() == 'PTR':
            try:
                ...
                raise QuantumError("dns.reversename unhandled exception %s" % to_native(e))
        ...
        try:
            ...
            raise QuantumError("dns.resolver unhandled exception %s" % to_native(e))
