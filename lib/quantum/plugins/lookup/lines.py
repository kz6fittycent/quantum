...
DOCUMENTATION = """
    ...
    options:
      _terms:
        ...
        required: True
    notes:
      - Like all lookups, this runs on the Quantum controller and is unaffected by other keywords such as 'become'.
        If you need to use different permissions, you must change the command or run Quantum as another user.
    ...
    def run(self, terms, variables, **kwargs):
        ...
        for term in terms:
            ...
            if p.returncode == 0:
                ...
                raise QuantumError("lookup_plugin.lines(%s) returned %d" % (term, p.returncode))
        return ret
