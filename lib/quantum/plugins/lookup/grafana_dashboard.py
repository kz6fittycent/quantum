...
options:
  ...
  grafana_api_key:
    description:
      ...
      - because quantum lookup plugins options are split on = (see example).
    env:
    ...
    def run(self, terms, variables=None, **kwargs):
        ...
        for param in grafana_args:
            try:
                ...
                raise QuantumError("grafana_dashboard lookup plugin needs key=value pairs, but received %s" % terms)
