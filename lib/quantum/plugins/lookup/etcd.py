...
EXAMPLES = '''
    ...
    - name: "since Quantum 2.5 you can set server options inline"
...
# this can be made configurable, not should not use quantum.cfg
#
# Made module configurable from couplings:
# If etcd  v2 running on host 192.168.1.21 on port 2379
# we can use the following in a coupling to retrieve /tfm/network/config key
#
