...
options:
  ...
  password:
    ...
    vars:
      ...
      - name: quantum_httpapi_pass
      - name: quantum_httpapi_password
  use_ssl:
    type: boolean
    description:
  ...
  validate_certs:
    ...
    default: True
    vars:
      - name: quantum_httpapi_validate_certs
  use_proxy:
    type: boolean
    version_added: "2.9"
    description:
    ...
    default: True
    vars:
      - name: quantum_httpapi_use_proxy
  timeout:
    type: int
    description:
...
from quantum.module_utils.six.moves.urllib.error import HTTPError, URLError
from quantum.module_utils.urls import open_url
from quantum.coupling.play_context import PlayContext
from quantum.plugins.loader import httpapi_loader
...
class Connection(NetworkConnectionBase):
    ...
    def __init__(self, play_context, new_stdin, *args, **kwargs):
        ...
        if self._network_os:
            ...
            if self.httpapi:
                ...
                raise QuantumConnectionFailure('unable to load API plugin for network_os %s' % self._network_os)
    ...
    def send(self, path, data, **kwargs):
        ...
        try:
            ...
            raise QuantumConnectionFailure('Could not connect to {0}: {1}'.format(self._url + path, exc.reason))
