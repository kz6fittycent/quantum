...
DOCUMENTATION = """
    ...
    description:
        - This transport permits you to use Quantum over Func.
        - For people who have already setup func and that wish to play with quantum,
          this permit to move gradually to quantum without having to redo completely the setup of the network.
    version_added: "1.1"
    options:
      remote_addr:
        description:
...
class Connection(object):
    ...
    def connect(self, port=None):
        if not HAVE_FUNC:
            raise QuantumError("func is not installed")
    ...
    def fetch_file(self, in_path, out_path):
        ...
        tmpdir = tempfile.mkdtemp(prefix="func_quantum")
