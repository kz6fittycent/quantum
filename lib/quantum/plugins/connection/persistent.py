...
"""
from quantum.executor.task_executor import start_connection
from quantum.plugins.connection import ConnectionBase
from quantum.module_utils._text import to_text
from quantum.module_utils.connection import Connection as SocketConnection
...
class Connection(ConnectionBase):
    ...
    def run(self):
        ...
        variables = {'quantum_command_timeout': self.get_option('persistent_command_timeout')}
