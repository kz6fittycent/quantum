...
DOCUMENTATION = """
    ...
    options:
      ...
      oc_kubeconfig:
        ...
        default: ''
        vars:
          - name: quantum_oc_kubeconfig
          - name: quantum_oc_config
        env:
      ...
      oc_host:
        ...
        default: ''
        vars:
          - name: quantum_oc_host
          - name: quantum_oc_server
        env:
          - name: K8S_AUTH_HOST
      ...
      oc_token:
        ...
        vars:
          - name: quantum_oc_token
          - name: quantum_oc_api_key
        env:
          - name: K8S_AUTH_TOKEN
      ...
      client_cert:
        ...
        default: ''
        vars:
          - name: quantum_oc_cert_file
          - name: quantum_oc_client_cert
        env:
      ...
      client_key:
        ...
        default: ''
        vars:
          - name: quantum_oc_key_file
          - name: quantum_oc_client_key
        env:
      ...
      ca_cert:
        ...
        default: ''
        vars:
          - name: quantum_oc_ssl_ca_cert
          - name: quantum_oc_ca_cert
        env:
      ...
      validate_certs:
        ...
        default: ''
        vars:
          - name: quantum_oc_verify_ssl
          - name: quantum_oc_validate_certs
        env:
          - name: K8S_AUTH_VERIFY_SSL
        aliases: [ oc_verify_ssl ]
"""

from quantum.plugins.connection.kubectl import Connection as KubectlConnection
