...
class Connection(ConnectionBase):
    ...
    def __init__(self, play_context, new_stdin, *args, **kwargs):
        ...
        if os.geteuid() != 0:
            raise QuantumError("zone connection requires running as root")
        ...
        if self.zone not in self.list_zones():
            raise QuantumError("incorrect zone name %s" % self.zone)
    ...
    def fetch_file(self, in_path, out_path):
        ...
        try:
            ...
            raise QuantumError("zone connection requires dd command in the zone")
