...
DOCUMENTATION = r"""
    ...
    options:
      ...
      kubectl_container:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_container
        env:
      ...
      kubectl_namespace:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_namespace
        env:
      ...
      kubectl_extra_args:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_extra_args
        env:
      ...
      kubectl_kubeconfig:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_kubeconfig
          - name: quantum_kubectl_config
        env:
      ...
      kubectl_host:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_host
          - name: quantum_kubectl_server
        env:
          - name: K8S_AUTH_HOST
      ...
      kubectl_username:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_username
          - name: quantum_kubectl_user
        env:
      ...
      kubectl_token:
        description:
          ...
          - Please be aware that this passes information directly on the command line and it could expose sensitive data.
            We recommend using the file based authentication options instead.
        vars:
          - name: quantum_kubectl_token
          - name: quantum_kubectl_api_key
        env:
          - name: K8S_AUTH_TOKEN
      ...
      client_cert:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_cert_file
          - name: quantum_kubectl_client_cert
        env:
      ...
      client_key:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_key_file
          - name: quantum_kubectl_client_key
        env:
      ...
      ca_cert:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_ssl_ca_cert
          - name: quantum_kubectl_ca_cert
        env:
      ...
      validate_certs:
        ...
        default: ''
        vars:
          - name: quantum_kubectl_verify_ssl
          - name: quantum_kubectl_validate_certs
        env:
...
from quantum.errors import QuantumError, QuantumFileNotFound
...
class Connection(ConnectionBase):
    ...
    def __init__(self, play_context, new_stdin, *args, **kwargs):
        ...
        if cmd_arg in kwargs:
            ...
            if not self.transport_cmd:
                raise QuantumError("{0} command not found in PATH".format(self.transport))
    ...
    def _build_exec_cmd(self, cmd):
        ...
        doc_yaml = QuantumLoader(self.documentation).get_single_data()
    ...
    def put_file(self, in_path, out_path):
        ...
        with open(to_bytes(in_path, errors='surrogate_or_strict'), 'rb') as in_file:
            ...
            try:
                ...
                raise QuantumError("kubectl connection requires dd command in the container to put files")
            stdout, stderr = p.communicate()

            if p.returncode != 0:
                raise QuantumError("failed to transfer file %s to %s:\n%s\n%s" % (in_path, out_path, stdout, stderr))
    ...
    def fetch_file(self, in_path, out_path):
        ...
        with open(to_bytes(actual_out_path, errors='surrogate_or_strict'), 'wb') as out_file:
            ...
            if p.returncode != 0:
                raise QuantumError("failed to fetch file %s to %s:\n%s\n%s" % (in_path, out_path, stdout, stderr))
