...
try:
    ...
    raise QuantumError("The 'pymongo' python module is required for the mongodb fact cache, 'pip install pymongo>=3.0'")
...
class CacheModule(BaseCacheModule):
    ...
    def _collection(self):
        ...
        try:
            ...
            # We'll fall back to using ``quantum`` as the database if one was not provided
