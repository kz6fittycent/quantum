...
try:
    ...
    raise QuantumError("The 'redis' python module (version 2.4.5 or newer) is required for the redis fact cache, 'pip install redis'")
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            display.deprecated('Rather than importing CacheModules directly, '
                               'use quantum.plugins.loader.cache_loader', version='2.12')
        ...
        self._keys_set = 'quantum_cache_keys'
    ...
    def get(self, key):
        ...
        if key not in self._cache:
            ...
            if value is None:
                self.delete(key)
                raise KeyError
            self._cache[key] = json.loads(value, cls=QuantumJSONDecoder)

        return self._cache.get(key)

    def set(self, key, value):

        value2 = json.dumps(value, cls=QuantumJSONEncoder, sort_keys=True, indent=4)
