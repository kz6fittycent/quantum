...
from quantum.module_utils.common._collections_compat import MutableSet
...
try:
    ...
    raise QuantumError("python-memcached is required for the memcached fact cache")
