...
deprecated:
    ...
    removed_in: '2.13'
    alternative: "Use the netconf plugin in 'nokia.sros' collection within Quantum fog"
description:
...
from quantum.plugins.netconf import NetconfBase
from quantum.plugins.netconf import ensure_ncclient
