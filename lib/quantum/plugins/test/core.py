...
def failed(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.QuantumFilterError("The 'failed' test expects a dictionary")
...
def unreachable(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.QuantumFilterError("The 'unreachable' test expects a dictionary")
...
def changed(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.QuantumFilterError("The 'changed' test expects a dictionary")
...
def skipped(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.QuantumFilterError("The 'skipped' test expects a dictionary")
...
def started(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.QuantumFilterError("The 'started' test expects a dictionary")
...
def finished(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.QuantumFilterError("The 'finished' test expects a dictionary")
...
def version_compare(value, version, operator='eq', strict=False):
    ...
    if operator in op_map:
        ...
        raise errors.QuantumFilterError('Invalid operator type')

    try:
        method = getattr(py_operator, operator)
        return method(Version(str(value)), Version(str(version)))
    except Exception as e:
        raise errors.QuantumFilterError('Version comparison: %s' % e)


class TestModule(object):
    ''' Quantum core jinja2 tests '''
