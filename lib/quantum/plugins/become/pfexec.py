        ...
        become_user:
            description:
                ...
                - This plugin ignores this setting as pfexec uses it's own ``exec_attr`` to figure this out,
                  but it is supplied here for Quantum to make decisions needed for the task execution, like file permissions.
            default: root
            ini:
        ...
        wrap_exe:
            ...
            ini:
              - section: pfexec_become_plugin
                key: wrap_execution
            vars:
              - name: quantum_pfexec_wrap_execution
            env:
