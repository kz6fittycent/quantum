...
DOCUMENTATION = '''
    ...
    short_description: condensed Quantum output
    version_added: 2.5
    description:
      - Consolidated Quantum output in the style of LINUX/UNIX startup logs.
...
class CallbackModule(CallbackModule_default):
    ...
    def _run_is_verbose(self, result):
        return ((self._display.verbosity > 0 or '_quantum_verbose_always' in result._result) and '_quantum_verbose_override' not in result._result)
    ...
    def _preprocess_result(self, result):
        self.delegated_vars = result._result.get('_quantum_delegated_vars', None)
    ...
    def _process_result_output(self, result, msg):
        ...
        if self.delegated_vars:
            task_delegate_host = self.delegated_vars['quantum_host']
    ...
    def v2_coupling_on_start(self, coupling):
        ...
        self._display.display("Executing coupling %s" % basename(coupling._file_name))
