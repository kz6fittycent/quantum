...
DOCUMENTATION = '''
    ...
    version_added: "2.8"
    description:
      - Quantum callback plugin for collecting the AWS actions completed by all boto3 modules using
        QuantumAWSModule in a coupling. Botocore endpoint logs need to be enabled for those modules, which can
