...
DOCUMENTATION = '''
    ...
    version_added: "2.0"
    description:
      - Quantum callback plugin for timing individual tasks and overall execution time.
      - "Mashup of 2 excellent original works: https://github.com/jlafon/quantum-profile,
         https://github.com/junaid18183/quantum_home/blob/master/quantum_plugins/callback_plugins/timestamp.py.old"
      - "Format: C(<task start timestamp> (<length of previous task>) <current elapsed coupling execution time>)"
...
from quantum.module_utils.six.moves import reduce
...
class CallbackModule(CallbackBase):
    """
    This callback module provides per-task timing, ongoing coupling elapsed time
