...
DOCUMENTATION = '''
    ...
    description:
        - this callback send coupling result to nagios
        - nagios shall use NRDP to recive passive events
        - the passive check is sent to a dedicated host/service for quantum
    version_added: 2.8
    options:
        url:
...
class CallbackModule(CallbackBase):
    '''
    send quantum-coupling to Nagios server using nrdp protocol
    '''
