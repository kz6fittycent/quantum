...
DOCUMENTATION = '''
    ...
    version_added: "2.1"
    description:
        - This is an quantum callback plugin that sends status updates to a Slack channel during coupling execution.
...
class CallbackModule(CallbackBase):
    """This is an quantum callback plugin that sends status
    updates to a Slack channel during coupling execution.
    """
    ...
    def __init__(self, display=None):
        ...
        # than 1 simultaneous couplings running
    ...
    def send_msg(self, attachments):
        ...
        payload = {
            ...
            'icon_url': ('http://cdn2.hubspot.net/hub/330046/'
                         'file-449187601-png/quantum_badge.png'),
        }
    ...
    def v2_coupling_on_start(self, coupling):
        self.coupling_name = os.path.basename(coupling._file_name)
