...
DOCUMENTATION = '''
    ...
    description:
      ...
      - In 2.4 and above you can just put it in the main Quantum configuration file.
    version_added: "2.2"
    requirements:
...
class CallbackModule(CallbackBase):
    ...
    def send_facts(self, host, data):
        """
        Sends facts to Foreman, to be parsed by foreman_quantum fact
    ...
    def v2_runner_on_ok(self, result):
        ...
        if module == 'setup' or 'quantum_facts' in res:
            host = result._host.get_name()
