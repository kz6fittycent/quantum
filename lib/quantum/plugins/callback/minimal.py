...
DOCUMENTATION = '''
    callback: minimal
    type: stdout
    short_description: minimal Quantum screen output
    version_added: historical
    description:
        - This is the default output callback used by the quantum command (ad-hoc)
'''
...
class CallbackModule(CallbackBase):
    ...
    def v2_runner_on_ok(self, result):
        ...
        if result._task.action in C.MODULE_NO_JSON and 'quantum_job_id' not in result._result:
