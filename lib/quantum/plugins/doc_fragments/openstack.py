...
options:
  ...
  wait:
    description:
      - Should quantum wait until the requested resource is complete.
    type: bool
    default: yes
  timeout:
    description:
      - How long should quantum wait for the requested resource.
    type: int
    default: 180
  api_timeout:
    description:
  ...
  validate_certs:
    description:
      ...
      - Before Quantum 2.3 this defaulted to C(yes).
    type: bool
    default: no
    aliases: [ verify ]
  ca_cert:
...
notes:
  ...
  - Auth information is driven by openstacksdk, which means that values
    can come from a yaml config file in /etc/quantum/openstack.yaml,
