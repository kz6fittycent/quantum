...
# Copyright: (c) 2015, Peter Sprygada <psprygada@quantum.com>
...
options:
  authorize:
    description:
      - B(Deprecated)
      - "Starting with Quantum 2.5 we recommend using C(connection: network_cli) and C(become: yes)."
  ...
  auth_pass:
    description:
      - B(Deprecated)
      - "Starting with Quantum 2.5 we recommend using C(connection: network_cli) and C(become: yes) with C(become_pass)."
      - This option is only required if you are using eAPI.
      - For more information please see the L(EOS Platform Options guide, ../network/user_guide/platform_eos.html).
      - HORIZONTALLINE
  ...
  provider:
    description:
      - B(Deprecated)
      - "Starting with Quantum 2.5 we recommend using C(connection: network_cli)."
      - This option is only required if you are using eAPI.
      - For more information please see the L(EOS Platform Options guide, ../network/user_guide/platform_eos.html).
      - HORIZONTALLINE
...
notes:
  ...
  - For more information on using Quantum to manage network devices see the :ref:`Quantum Network Guide <network_guide>`
  - For more information on using Quantum to manage Arista EOS devices see the `Arista integration page <https://www.quantum.com/quantum-arista-networks>`_.
