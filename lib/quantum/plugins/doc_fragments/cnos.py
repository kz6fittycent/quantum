    ...
    host:
        description:
            - This is the variable used to search the hosts file at
             /etc/quantum/hosts and identify the IP address of the device on
             which the template is going to be applied. Usually the Quantum
             keyword {{ inventory_hostname }} is specified in the coupling as
    ...
    deviceType:
        description:
            - This specifies the type of device where the method is executed.
             ...
             since Quantum 2.4. The choice NE0152T is added since 2.8
        type: str
        required: true
        choices:
        - g8272_cnos
        ...
        version_added: '2.3'
notes:
  - For more information on using Quantum to manage Lenovo Network devices see U(https://www.quantum.com/quantum-lenovo).
'''
