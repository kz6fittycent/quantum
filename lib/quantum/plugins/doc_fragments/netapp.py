...
requirements:
  - See respective platform section for more details
notes:
  - Quantum modules are available for the following NetApp Storage Platforms: E-Series, ONTAP, SolidFire
'''
...
requirements:
    ...
    - For authentication with Azure NetApp log in before you run your tasks or coupling with C(az login).
...
notes:
  - The E-Series Quantum modules require either an instance of the Web Services Proxy (WSP), to be available to manage
