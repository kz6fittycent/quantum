...
DOCUMENTATION = '''
    ...
    short_description: Quantum dynamic inventory plugin for GitLab runners.
    requirements:
        - python >= 2.7
        - python-gitlab > 1.8.0
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ''' Host inventory parser for quantum using GitLab API as source. '''
    ...
    def _populate(self):
        ...
        try:
            ...
            for runner in runners:
                ...
                self.inventory.set_variable(host, 'quantum_host', ip_address)
            ...
            raise QuantumParserError('Unable to fetch hosts from GitLab API, this was the original exception: %s' % to_native(e))
    ...
    def parse(self, inventory, loader, path, cache=True):
        if not HAS_GITLAB:
            raise QuantumError('The GitLab runners dynamic inventory plugin requires python-gitlab: https://python-gitlab.readthedocs.io/en/stable/')
