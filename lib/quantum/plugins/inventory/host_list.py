...
EXAMPLES = r'''
    ...
    # quantum -i '10.10.2.6, 10.10.2.4' -m ping all

    # DNS resolvable names
    # quantum -i 'host1.example.com, host2' -m user -a 'name=me state=absent' all

    # just use localhost
    # quantum-coupling -i 'localhost,' play.yml -c local
'''
