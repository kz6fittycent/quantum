    ...
    options:
        ...
        private:
            description: |
                ...
                running quantum inside a server in the cloud and would rather
        ...
        clouds_yaml_path:
            description: |
                ...
                quantum inventory adds /etc/quantum/openstack.yaml and
                /etc/quantum/openstack.yml to the regular locations documented
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ''' Host inventory provider for quantum using OpenStack clouds. '''
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        if not source_data:
            ...
            # particular quantum-inventory JSON output
            # TODO(mordred) Integrate openstack's logging with quantum's logging
