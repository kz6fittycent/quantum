      ...
      connections:
          ...
          suboptions:
            ...
            annotation_variable:
                ...
                - "Note, that the value in quantum annotations should be json."
                type: str
                default: 'quantum'
    requirements:
    - "openshift >= 0.6"
...
from quantum.plugins.inventory.k8s import K8sInventoryException, InventoryModule as K8sInventoryModule, format_dynamic_api_exc
...
class InventoryModule(K8sInventoryModule):
    ...
    def fetch_objects(self, connections):
        ...
        if connections:
            for connection in connections:
                ...
                annotation_variable = connection.get('annotation_variable', 'quantum')
    ...
    def get_vms_for_namespace(self, client, name, namespace, name_format, interface_name=None, api_version=None, annotation_variable=None):
        ...
        for vm in obj.items:
            ...
            # add hostvars
            self.inventory.set_variable(vm_name, 'quantum_host', vm_ip)
            ...
            # Add all variables which are listed in 'quantum' annotation:
