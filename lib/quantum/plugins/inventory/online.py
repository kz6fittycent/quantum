...
# Example command line: quantum-inventory --list -i online_inventory.yml
...
from quantum.module_utils.six.moves.urllib.parse import urljoin
...
class InventoryModule(BaseInventoryPlugin):
    ...
    def _fetch_information(self, url):
        ...
        try:
            ...
            raise QuantumError("Incorrect encoding of fetched payload from Online servers")
    ...
    def _fill_host_variables(self, hostname, host_infos):
        ...
        if self.extract_public_ipv4(host_infos=host_infos):
            ...
            self.inventory.set_variable(hostname, "quantum_host", self.extract_public_ipv4(host_infos=host_infos))
