...
DOCUMENTATION = r'''
    ...
    author:
      - Luke Murphy (@lwm)
    short_description: Quantum dynamic inventory plugin for Linode.
    version_added: "2.8"
    requirements:
        - python >= 2.7
        - linode_api4 >= 2.0.0
...
try:
    ...
    raise QuantumError('the Linode dynamic inventory plugin requires linode_api4.')
...
class InventoryModule(BaseInventoryPlugin):
    ...
    def _get_instances_inventory(self):
        ...
        try:
            ...
            raise QuantumError('Linode client raised: %s' % exception)
