...
DOCUMENTATION = '''
    ...
    version_added: "2.0"
    notes:
     - This was the default Quantum behaviour before 'strategy plugins' were introduced in 2.0.
...
class StrategyModule(StrategyBase):
    ...
    def _replace_with_noop(self, target):
        if self.noop_task is None:
            raise QuantumAssertionError('strategy.linear.StrategyModule.noop_task is None, need Task()')
