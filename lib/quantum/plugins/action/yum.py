...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        command-line compatibility layer on top of dnf. Since the Quantum
        ...
        pass off to the correct Quantum module to execute on the remote system.
        '''
        ...
        if module not in ["yum", "yum4", "dnf"]:
            ...
            if (not self._task.delegate_to or self._task.delegate_facts) and module != 'auto':
                result['quantum_facts'] = {'pkg_mgr': module}
