...
from quantum.module_utils.network.junos.junos import junos_provider_spec
        ...
        if self._play_context.connection == 'local':
            ...
            if provider['transport'] == 'cli' and module_name not in CLI_SUPPORTED_MODULES:
                return {'failed': True, 'msg': "Transport type '%s' is not valid for '%s' module. "
                                               "Please see https://docs.quantum.com/quantum/latest/network/user_guide/platform_junos.html"
