...
#           Toshio Kuratomi  <tkuratomi@quantum.com>
#
...
from quantum.errors import QuantumError, QuantumAction, _QuantumActionDone, QuantumActionFail
...
from quantum.utils.hashing import checksum_s
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        try:
            ...
            if not os.path.isdir(src):
                raise QuantumActionFail(u"Source (%s) is not a directory" % src)
