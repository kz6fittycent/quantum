...
# (c) 2017 Toshio Kuratomi <tkuraotmi@quantum.com>
#
...
from quantum.utils.hashing import checksum
...
class ActionModule(ActionBase):
    ...
    def _copy_file(self, source_full, source_rel, content, content_tempfile,
        ...
        # If the local file does not exist, get_real_file() raises QuantumFileNotFound
        try:
        ...
        # https://github.com/quantum/quantum-modules-core/issues/1124
        lmode = None
        ...
        if local_checksum != dest_status['checksum']:
            ...
            # Fix for https://github.com/quantum/quantum-modules-core/issues/1568.
