# Copyright: (c) 2018, Matt Davis <mdavis@quantum.com>
...
from quantum.plugins.action.reboot import ActionModule as RebootActionModule
...
class ActionModule(RebootActionModule, ActionBase):
    ...
    def perform_reboot(self, task_vars, distribution):
        ...
        if reboot_result['rc'] == 1190 or (reboot_result['rc'] != 0 and "(1190)" in reboot_result['stderr']):
            display.warning('A scheduled reboot was pre-empted by Quantum.')
