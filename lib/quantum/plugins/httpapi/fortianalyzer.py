...
from quantum.module_utils.network.fortianalyzer.common import BASE_HEADERS
...
class HttpApi(HttpApiBase):
    ...
    def send_request(self, method, params):
        ...
        try:
            # Sending URL and Data in Unicode, per Quantum Specifications for Connection Plugins
