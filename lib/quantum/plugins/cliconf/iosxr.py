...
from quantum.module_utils.network.iosxr.iosxr import sanitize_config, mask_config_blocks_from_diff
from quantum.plugins.cliconf import CliconfBase
...
class Cliconf(CliconfBase):
    ...
    def get_diff(self, candidate=None, running=None, diff_match='line', diff_ignore_lines=None, path=None, diff_replace='line'):
        ...
        if running and diff_match != 'none':
            ...
            running = mask_config_blocks_from_diff(running, candidate, "quantum")
