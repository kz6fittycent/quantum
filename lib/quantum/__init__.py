...
# Note: Do not add any code to this file.  The quantum module may be
# a namespace package when using Quantum-2.1+ Anything in this file may not be
...
# quantum.release instead of from here.
