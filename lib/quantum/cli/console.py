...
########################################################
# quantum-console is an interactive REPL shell for quantum
...
#  forks - change fork
#  become - become
#  ! - forces shell module instead of the quantum module (!yum update -y)
...
from quantum.plugins.loader import module_loader, fragment_loader
from quantum.utils import plugin_docs
...
class ConsoleCLI(CLI, cmd.Cmd):
    ''' a REPL that allows for running ad-hoc tasks against a chosen inventory (based on dominis' quantum-shell).'''
    ...
    def __init__(self, args):
        ...
        self.intro = 'Welcome to the quantum console.\nType help or ? to list commands.\n'
    ...
    def init_parser(self):
        super(ConsoleCLI, self).init_parser(
            desc="REPL console for executing Quantum tasks.",
    ...
    def run(self):
        ...
        histfile = os.path.join(os.path.expanduser("~"), ".quantum-console_history")
        try:
