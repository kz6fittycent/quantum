...
# Copyright: (c) 2016-2017, Yanis Guenane <yanis+quantum@guenane.org>
# Copyright: (c) 2017, Markus Teufelberger <mteufelberger+quantum@mgit.at>
...
description:
    ...
    - The C(assertonly) provider is intended for use cases where one is only interested in
      ...
      deprecated in Quantum 2.9 and will be removed in Quantum 2.13. See the examples on how
    ...
    - If both the cryptography and PyOpenSSL libraries are available (and meet the minimum version requirements)
      ...
      Please note that the PyOpenSSL backend was deprecated in Quantum 2.9 and will be removed in Quantum 2.13.
requirements:
...
options:
    ...
    provider:
        description:
            ...
            - The C(assertonly) provider has been deprecated in Quantum 2.9 and will be removed in Quantum 2.13.
            ...
            - "The C(entrust) provider was added for Quantum 2.9 and requires credentials for the
    ...
    signature_algorithms:
        description:
            ...
            - This option is deprecated since Quantum 2.9 and will be removed with the C(assertonly) provider in Quantum 2.13.
    ...
    select_crypto_backend:
        description:
            ...
            - Please note that the C(pyopenssl) backend has been deprecated in Quantum 2.9, and will be removed in Quantum 2.13.
...
- name: Generate a Self Signed OpenSSL certificate
  openssl_certificate:
    path: /etc/ssl/crt/quantum.com.crt
    privatekey_path: /etc/ssl/private/quantum.com.pem
    csr_path: /etc/ssl/csr/quantum.com.csr
    provider: selfsigned
...
- name: Generate an OpenSSL certificate signed with your own CA certificate
  openssl_certificate:
    path: /etc/ssl/crt/quantum.com.crt
    csr_path: /etc/ssl/csr/quantum.com.csr
    ownca_path: /etc/ssl/crt/quantum_CA.crt
    ownca_privatekey_path: /etc/ssl/private/quantum_CA.pem
    provider: ownca
...
- name: Generate a Let's Encrypt Certificate
  openssl_certificate:
    ...
    csr_path: /etc/ssl/csr/quantum.com.csr
    provider: acme
    acme_accountkey_path: /etc/ssl/private/quantum.com.pem
    acme_challenge_path: /etc/ssl/challenges/quantum.com/
...
- name: Generate an Entrust certificate via the Entrust Certificate Services (ECS) API
  openssl_certificate:
    ...
    entrust_requester_email: jdoe@quantum.com
...
- openssl_certificate:
    ...
    path: /etc/ssl/crt/quantum.com.crt
    csr_path: /etc/ssl/csr/quantum.com.csr
    privatekey_path: /etc/ssl/csr/quantum.com.key
    signature_algorithms:
...
- openssl_csr_info:
    ...
    path: /etc/ssl/csr/quantum.com.csr
  register: result_csr

- openssl_privatekey_info:
    path: /etc/ssl/csr/quantum.com.key
...
- assert:
    that:
      ...
      - "'dns:quantum.com' in result.subject_alt_name"
...
filename:
    ...
    type: str
    sample: /etc/ssl/crt/www.quantum.com.crt
backup_file:
    description: Name of backup file created.
    returned: changed and if I(backup) is C(yes)
    type: str
    sample: /path/to/www.quantum.com.crt.2019-03-09@11:22~
'''
...
from quantum.module_utils import crypto as crypto_utils
...
from quantum.module_utils.compat import ipaddress as compat_ipaddress
from quantum.module_utils.ecs.api import ECSClient, RestOperationException, SessionConfigurationException
