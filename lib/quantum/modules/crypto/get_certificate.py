...
description:
    ...
    - The module can use the cryptography Python library, or the pyOpenSSL Python
      ...
      backend was deprecated in Quantum 2.9 and will be removed in Quantum 2.13."
options:
    host:
      description:
...
- name: How many days until cert expires
  ...
  vars:
    expire_days: "{{ (( cert.not_after | to_datetime('%Y%m%d%H%M%SZ')) - (quantum_date_time.iso8601 | to_datetime('%Y-%m-%dT%H:%M:%SZ')) ).days }}"
'''
