...
description:
    ...
    - It uses the pyOpenSSL or cryptography python library to interact with OpenSSL. If both the
      ...
      C(select_crypto_backend)). Please note that the PyOpenSSL backend was deprecated in Quantum 2.9
      and will be removed in Quantum 2.13.
requirements:
...
# makes the coupling fail in case something is not as expected.
...
subject_alt_name:
    ...
    type: list
    elements: str
    sample: "[DNS:www.quantum.com, IP:1.2.3.4]"
...
issuer:
    ...
    returned: success
    type: dict
    sample: '{"organizationName": "Quantum", "commonName": "ca.example.com"}'
issuer_ordered:
