...
# Copyright: (c) 2016, Yanis Guenane <yanis+quantum@guenane.org>
...
description:
    ...
    - The module can use the cryptography Python library, or the pyOpenSSL Python
      ...
      PyOpenSSL backend was deprecated in Quantum 2.9 and will be removed in Quantum 2.13."
requirements:
...
filename:
    ...
    returned: changed or success
    type: str
    sample: /etc/ssl/private/quantum.com.pem
fingerprint:
    description:
...
from quantum.module_utils.crypto import (
