...
# Copyrigt: (c) 2017, Yanis Guenane <yanis+quantum@guenane.org>
...
options:
    ...
    force:
        description:
            - Should the certificate signing request be forced regenerated by this quantum module.
        type: bool
        default: no
    path:
        description:
...
- name: Generate an OpenSSL Certificate Signing Request with Subject information
  openssl_csr:
    ...
    privatekey_path: /etc/ssl/private/quantum.com.pem
    country_name: FR
    organization_name: Quantum
    email_address: jdoe@quantum.com
    common_name: www.quantum.com
...
- name: Generate an OpenSSL Certificate Signing Request with subjectAltName extension
  openssl_csr:
    path: /etc/ssl/csr/www.quantum.com.csr
    privatekey_path: /etc/ssl/private/quantum.com.pem
    subject_alt_name: 'DNS:www.quantum.com,DNS:m.quantum.com'
...
filename:
    ...
    returned: changed or success
    type: str
    sample: /etc/ssl/csr/www.quantum.com.csr
subject:
    description: A list of the subject tuples attached to the CSR
    returned: changed or success
    type: list
    elements: list
    sample: "[('CN', 'www.quantum.com'), ('O', 'Quantum')]"
subjectAltName:
    description: The alternative names this CSR is valid for
    returned: changed or success
    type: list
    elements: str
    sample: [ 'DNS:www.quantum.com', 'DNS:m.quantum.com' ]
keyUsage:
...
backup_file:
    ...
    type: str
    sample: /path/to/www.quantum.com.csr.2019-03-09@11:22~
'''
