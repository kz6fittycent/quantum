...
deprecated:
    removed_in: "2.12"
    why: "Replaced by re-designed individual modules living at https://github.com/theforeman/foreman-quantum-modules"
    alternative: https://github.com/theforeman/foreman-quantum-modules
description:
...
options:
    ...
    task_timeout:
        description:
            ...
            - If the timeout is reached and the Foreman action did not complete, the quantum task fails. However the foreman action does not get canceled.
        default: 1000
        version_added: "2.7"
        required: false
    verify_ssl:
