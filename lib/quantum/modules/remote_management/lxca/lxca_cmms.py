...
from quantum.module_utils.remote_management.lxca.common import LXCA_COMMON_ARGS, has_pylxca, connection_object
try:
...
def setup_module_object():
    """
    this function merge argument spec and create quantum module object
    :return:
    """
    args_spec = dict(LXCA_COMMON_ARGS)
    args_spec.update(INPUT_ARG_SPEC)
    module = QuantumModule(argument_spec=args_spec, supports_check_mode=False)
...
def execute_module(module):
    ...
    :param module: Quantum module object
    """
    try:
