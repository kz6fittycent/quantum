...
- This module was called C(intersight_facts) before Quantum 2.9. The usage did not change.
...
from quantum.module_utils.remote_management.intersight import IntersightModule, intersight_argument_spec
