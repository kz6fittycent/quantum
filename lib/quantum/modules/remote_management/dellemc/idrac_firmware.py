...
options:
    ...
    share_password:
        ...
        aliases: ['share_pwd']
    share_mnt:
        description: Local mount path of the network share with read-write permission for quantum user.
...
from quantum.module_utils.remote_management.dellemc.dellemc_idrac import iDRACConnection
