...
from quantum.module_utils.manageiq import ManageIQ, manageiq_argument_spec
...
class ManageIQTenant(object):
    ...
    def create_tenant_response(self, tenant, parent_tenant):
        """ Creates the quantum result object from a manageiq tenant entity
    ...
    def create_tenant_quotas_response(tenant_quotas):
        """ Creates the quantum result object from a manageiq tenant_quotas entity
