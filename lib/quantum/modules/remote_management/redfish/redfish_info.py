...
description:
  ...
  - This module was called C(redfish_facts) before Quantum 2.9, returning C(quantum_facts).
    Note that the M(redfish_info) module no longer returns C(quantum_facts)!
options:
  category:
    required: false
    description:
