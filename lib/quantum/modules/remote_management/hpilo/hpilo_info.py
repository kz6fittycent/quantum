...
- This module was called C(hpilo_facts) before Quantum 2.9, returning C(quantum_facts).
  Note that the M(hpilo_info) module no longer returns C(quantum_facts)!
options:
  host:
    description:
...
def main():
    ...
    if is_old_facts:
        module.exit_json(quantum_facts=info)
    else:
