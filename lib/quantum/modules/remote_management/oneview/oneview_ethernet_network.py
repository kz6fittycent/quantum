...
from quantum.module_utils.oneview import OneViewModuleBase, OneViewModuleResourceNotFound
...
class EthernetNetworkModule(OneViewModuleBase):
    ...
    def execute_module(self):
        ...
        changed, msg, quantum_facts, resource = False, '', {}, None
        ...
        if self.state == 'present':
            ...
            changed, msg, quantum_facts = self._default_bandwidth_reset(resource)
            return dict(changed=changed, msg=msg, quantum_facts=quantum_facts)
    ...
    def _present(self, resource):
        ...
        if bandwidth:
            if self._update_connection_template(result['quantum_facts']['ethernet_network'], bandwidth)[0]:
                result['changed'] = True
    ...
    def _bulk_present(self):
        ...
        result['quantum_facts']['ethernet_network_bulk'] = self.resource_client.get_range(self.data['namePrefix'], vlan_id_range)
