...
from quantum.module_utils.oneview import OneViewModuleBase, OneViewModuleValueError
...
class SanManagerModule(OneViewModuleBase):
    ...
    def execute_module(self):
        ...
        if self.state == 'present':
            ...
            return dict(changed=changed, msg=msg, quantum_facts=dict(san_manager=san_manager))
