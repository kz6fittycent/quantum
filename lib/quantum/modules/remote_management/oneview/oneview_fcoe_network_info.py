...
description:
    ...
    - This module was called C(oneview_fcoe_network_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(oneview_fcoe_network_info) module no longer returns C(quantum_facts)!
version_added: "2.4"
requirements:
    - hpOneView >= 2.0.1
author:
    ...
    def execute_module(self):
        ...
        if self.is_old_facts:
            return dict(changed=False,
                        quantum_facts=dict(fcoe_networks=fcoe_networks))
        else:
