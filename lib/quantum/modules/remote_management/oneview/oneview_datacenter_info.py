...
description:
    ...
    - This module was called C(oneview_datacenter_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(oneview_datacenter_info) module no longer returns C(quantum_facts)!
version_added: "2.5"
requirements:
    - "hpOneView >= 2.0.1"
author:
