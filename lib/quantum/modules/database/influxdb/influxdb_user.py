...
import quantum.module_utils.urls
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils._text import to_native
import quantum.module_utils.influxdb as influx
    ...
    try:
        ...
        for user in users:
            if user['user'] == user_name:
                user_result = user
                break
    except (quantum.module_utils.urls.ConnectionError, influx.exceptions.InfluxDBClientError) as e:
...
def check_user_password(module, client, user_name, user_password):
    try:
        ...
        if e.code == 401:
            return False
    except quantum.module_utils.urls.ConnectionError as e:
        module.fail_json(msg=to_native(e))
    finally:
