...
class PgDbConn(object):
    ...
    Arguments:
        module (QuantumModule): Object of QuantumModule class that
...
class PgClusterInfo(object):
    ...
    Arguments:
        module (QuantumModule): Object of QuantumModule class.
