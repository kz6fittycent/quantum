...
def lang_drop(cursor, lang, cascade):
    ...
    cursor.execute("SAVEPOINT quantum_pgsql_lang_drop")
    try:
        if cascade:
        ...
        cursor.execute("ROLLBACK TO SAVEPOINT quantum_pgsql_lang_drop")
        cursor.execute("RELEASE SAVEPOINT quantum_pgsql_lang_drop")
        return False
    cursor.execute("RELEASE SAVEPOINT quantum_pgsql_lang_drop")
    return True
