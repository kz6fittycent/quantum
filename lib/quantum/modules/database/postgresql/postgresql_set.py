...
description:
   ...
   - After change you can see in the quantum output the previous and
...
options:
  ...
  value:
    ...
    - To remove parameter string from postgresql.auto.conf and
      ...
      With I(value=default) the coupling always returns changed is true.
    type: str
    required: true
  reset:
    description:
...
value:
  description:
  - Dictionary that contains the current parameter value (at the time of coupling finish).
