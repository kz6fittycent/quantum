...
options:
  ...
  type:
    ...
    - The 'foreign_data_wrapper' and 'foreign_server' object types are available from Quantum version '2.8'.
    type: str
    default: table
...
from quantum.module_utils.postgres import postgres_common_argument_spec
