...
EXAMPLES = r'''
# Set owner as alice for function myfunc in database bar by quantum ad-hoc command:
# quantum -m postgresql_owner -a "db=bar new_owner=alice obj_name=myfunc obj_type=function"

- name: The same as above by coupling
  postgresql_owner:
    db: bar
    new_owner: alice
    obj_name: myfunc
...
try:
    ...
    # from quantum.module_utils.postgres
    pass

from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.database import pg_quote_identifier
from quantum.module_utils.postgres import (
    connect_to_db,
    exec_sql,
    get_conn_params,
...
class PgOwnership(object):
    ...
    Arguments:
        module (QuantumModule): Object of Quantum module class.
