...
def main():
    ...
    try:
        ...
        module.fail_json(msg=to_native(e), quantum_facts={'vertica_roles': role_facts})
    ...
    module.exit_json(changed=changed, role=role, quantum_facts={'vertica_roles': role_facts})
