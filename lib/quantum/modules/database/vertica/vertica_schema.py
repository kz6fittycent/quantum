...
def main():
    ...
    try:
        ...
        module.fail_json(msg=to_native(e), quantum_facts={'vertica_schemas': schema_facts})
    ...
    module.exit_json(changed=changed, schema=schema, quantum_facts={'vertica_schemas': schema_facts})
