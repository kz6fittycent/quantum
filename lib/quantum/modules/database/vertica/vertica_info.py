...
description:
  ...
  - This module was called C(vertica_facts) before Quantum 2.9, returning C(quantum_facts).
    Note that the M(vertica_info) module no longer returns C(quantum_facts)!
options:
  cluster:
    description:
    ...
    try:
        ...
        if is_old_facts:
            module.exit_json(changed=False,
                             quantum_facts={'vertica_schemas': schema_facts,
