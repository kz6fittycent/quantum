...
def main():
    ...
    try:
        ...
        module.fail_json(msg=to_native(e), quantum_facts={'vertica_users': user_facts})
    ...
    module.exit_json(changed=changed, user=user, quantum_facts={'vertica_users': user_facts})
