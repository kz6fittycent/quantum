...
def main():
    ...
    try:
        ...
        module.fail_json(msg=to_native(e), quantum_facts={'vertica_configuration': configuration_facts})
    ...
    module.exit_json(changed=changed, parameter=parameter_name, quantum_facts={'vertica_configuration': configuration_facts})
