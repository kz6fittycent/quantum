...
# quantum mysql-hosts -m mysql_info

# Display only databases and users info:
# quantum mysql-hosts -m mysql_info -a 'filter=databases,users'

# Display only slave status:
# quantum standby -m mysql_info -a 'filter=slave_status'

# Display all info from databases group except settings:
# quantum databases -m mysql_info -a 'filter=!settings'
...
from quantum.module_utils.mysql import (
    mysql_connect,
