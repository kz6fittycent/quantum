...
$tags = Get-QuantumParam -obj $params -name "tags" -type "list"
$test_parameters = Get-QuantumParam -obj $params -name "test_parameters" -type "dict"
$minimum_version = Get-QuantumParam -obj $params -name "minimum_version" -type "str" -failifempty $false
...
# Add actual pester's module version in the quantum's result variable
