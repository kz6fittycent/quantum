...
$dest = Get-QuantumParam -obj $params -name "destination" -type "str" -failifempty $true
$gateway = Get-QuantumParam -obj $params -name "gateway" -type "str"
$metric = Get-QuantumParam -obj $params -name "metric" -type "int" -default 1
