...
$computer_group_type = Get-QuantumParam -obj $params -name "computer_group_type" -type "str" -validateset $computer_group_types
$computer_group = Get-QuantumParam -obj $params -name "computer_group" -type "str" -failifempty ($computer_group_type -eq "ad_network_resource_group" -or $computer_group_type -eq "rdg_group")
$user_groups = Get-QuantumParam -obj $params -name "user_groups" -type "list"
$allowed_ports = Get-QuantumParam -obj $params -name "allowed_ports" -type "list"
