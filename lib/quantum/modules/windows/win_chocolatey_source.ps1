...
$diff = Get-QuantumParam -obj $params -name "_quantum_diff" -type "bool" -default $false

$name = Get-QuantumParam -obj $params -name "name" -type "str" -failifempty $true
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "absent", "disabled", "present"

$admin_only = Get-QuantumParam -obj $params -name "admin_only" -type "bool"
$allow_self_service = Get-QuantumParam -obj $params -name "allow_self_service" -type "bool"
$bypass_proxy = Get-QuantumParam -obj $params -name "bypass_proxy" -type "bool"
$certificate = Get-QuantumParam -obj $params -name "certificate" -type "str"
$certificate_password = Get-QuantumParam -obj $params -name "certificate_password" -type "str"
$priority = Get-QuantumParam -obj $params -name "priority" -type "int"
$source = Get-QuantumParam -obj $params -name "source" -type "str"
$source_username = Get-QuantumParam -obj $params -name "source_username" -type "str"
$source_password = Get-QuantumParam -obj $params -name "source_password" -type "str" -failifempty ($null -ne $source_username)
