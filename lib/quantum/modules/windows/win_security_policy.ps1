...
$section = Get-QuantumParam -obj $params -name "section" -type "str" -failifempty $true
$key = Get-QuantumParam -obj $params -name "key" -type "str" -failifempty $true
$value = Get-QuantumParam -obj $params -name "value" -failifempty $true
