...
$connect_timeout = Get-QuantumParam -obj $params -name "connect_timeout" -type "int" -default 5
$delay = Get-QuantumParam -obj $params -name "delay" -type "int"
$exclude_hosts = Get-QuantumParam -obj $params -name "exclude_hosts" -type "list"
$hostname = Get-QuantumParam -obj $params -name "host" -type "str" -default "127.0.0.1"
$path = Get-QuantumParam -obj $params -name "path" -type "path"
$port = Get-QuantumParam -obj $params -name "port" -type "int"
$regex = Get-QuantumParam -obj $params -name "regex" -type "str" -aliases "search_regex","regexp"
$sleep = Get-QuantumParam -obj $params -name "sleep" -type "int" -default 1
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "started" -validateset "present","started","stopped","absent","drained"
$timeout = Get-QuantumParam -obj $params -name "timeout" -type "int" -default 300
