...
$path = Get-QuantumParam -obj $params "path" -type "path" -failifempty $true
$state = Get-QuantumParam -obj $params "state" -type "str" -default "absent" -validateSet "present","absent" -resultobj $result
$reorganize = Get-QuantumParam -obj $params "reorganize" -type "bool" -default $false -resultobj $result
