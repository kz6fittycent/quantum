...
$diff_support = Get-QuantumParam -obj $params -name "_quantum_diff" -type "bool" -default $false

$name = Get-QuantumParam -obj $params -name "name" -failifempty $true
$description = Get-QuantumParam -obj $params -name "description" -type "str"
$direction = Get-QuantumParam -obj $params -name "direction" -type "str" -validateset "in","out"
$action = Get-QuantumParam -obj $params -name "action" -type "str" -validateset "allow","block"
$program = Get-QuantumParam -obj $params -name "program" -type "str"
$group = Get-QuantumParam -obj $params -name "group" -type "str"
$service = Get-QuantumParam -obj $params -name "service" -type "str"
$enabled = Get-QuantumParam -obj $params -name "enabled" -type "bool" -aliases "enable"
$profiles = Get-QuantumParam -obj $params -name "profiles" -type "list" -aliases "profile"
$localip = Get-QuantumParam -obj $params -name "localip" -type "str"
$remoteip = Get-QuantumParam -obj $params -name "remoteip" -type "str"
$localport = Get-QuantumParam -obj $params -name "localport" -type "str"
$remoteport = Get-QuantumParam -obj $params -name "remoteport" -type "str"
$protocol = Get-QuantumParam -obj $params -name "protocol" -type "str"
$interfacetypes = Get-QuantumParam -obj $params -name "interfacetypes" -type "list"
$edge = Get-QuantumParam -obj $params -name "edge" -type "str" -validateset "no","yes","deferapp","deferuser"
$security = Get-QuantumParam -obj $params -name "security" -type "str" -validateset "notrequired","authnoencap","authenticate","authdynenc","authenc"

$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present","absent"
