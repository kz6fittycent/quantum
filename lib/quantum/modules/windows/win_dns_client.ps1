...
$adapter_names = Get-QuantumParam $params "adapter_names" -Default "*"
$ipv4_addresses = Get-QuantumParam $params "ipv4_addresses" -FailIfEmpty $result
...
$check_mode = Get-QuantumParam $params "_quantum_check_mode" -Default $false
