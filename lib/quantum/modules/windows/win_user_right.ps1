...
$users = Get-QuantumParam -obj $params -name "users" -type "list" -failifempty $true
$action = Get-QuantumParam -obj $params -name "action" -type "str" -default "set" -validateset "add","remove","set"
...
$lsa_helper = New-Object -TypeName Quantum.LsaRightHelper
