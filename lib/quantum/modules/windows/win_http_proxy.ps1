...
namespace Quantum.WinHttpProxy
{
...
'@
Add-CSharpType -References $win_http_invoke -QuantumModule $module

$actual_proxy = New-Object -TypeName Quantum.WinHttpProxy.WinHttpProxy
...
if ($source -eq "ie") {
    ...
    $ie_proxy = [Quantum.WinHttpProxy.WinHttpProxy]::GetIEProxyConfig()
