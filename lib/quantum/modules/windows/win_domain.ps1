...
$dns_domain_name = Get-QuantumParam -obj $params -name "dns_domain_name" -failifempty $true
$domain_netbios_name = Get-QuantumParam -obj $params -name "domain_netbios_name"
$safe_mode_admin_password = Get-QuantumParam -obj $params -name "safe_mode_password" -failifempty $true
...
$create_dns_delegation = Get-QuantumParam -obj $params -name "create_dns_delegation" -type "bool"
$domain_mode = Get-QuantumParam -obj $params -name "domain_mode" -type "str"
$forest_mode = Get-QuantumParam -obj $params -name "forest_mode" -type "str"
