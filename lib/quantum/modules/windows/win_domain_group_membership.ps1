...
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present","absent","pure"
...
$members = Get-QuantumParam -obj $params -name "members" -type "list" -failifempty $true
