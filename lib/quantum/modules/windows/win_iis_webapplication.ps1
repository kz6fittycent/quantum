...
$site = Get-QuantumParam -obj $params -name "site" -type "str" -failifempty $true
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "absent","present"
$physical_path = Get-QuantumParam -obj $params -name "physical_path" -type "str" -aliases "path"
