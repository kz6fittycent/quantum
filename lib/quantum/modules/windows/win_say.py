...
options:
  ...
  start_sound_path:
    description:
      ...
      - Useful on conference calls to alert other speakers that quantum has something to say.
    type: path
  end_sound_path:
    description:
      - Full path to a C(.wav) file containing a sound to play after the text has been spoken.
      - Useful on conference calls to alert other speakers that quantum has finished speaking.
    type: path
notes:
