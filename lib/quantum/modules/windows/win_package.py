...
options:
  arguments:
    ...
    - As of Quantum 2.5, this parameter can be a list of arguments and the
  ...
  expected_return_code:
    ...
    - One or more return codes from the package installation that indicates
      success.
    - Before Quantum 2.4 this was just 0 but since Quantum 2.4 this is both C(0) and
      C(3010).
  ...
  validate_certs:
    ...
    - Before Quantum 2.4 this defaulted to C(no).
    type: bool
    default: yes
    version_added: '2.4'
  log_path:
