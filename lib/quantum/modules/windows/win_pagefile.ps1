...
$automatic = Get-QuantumParam -obj $params -name "automatic" -type "bool"
$drive = Get-QuantumParam -obj $params -name "drive" -type "str"
$fullPath = $drive + ":\pagefile.sys"
$initialSize = Get-QuantumParam -obj $params -name "initial_size" -type "int"
$maximumSize = Get-QuantumParam -obj $params -name "maximum_size" -type "int"
$override =  Get-QuantumParam -obj $params -name "override" -type "bool" -default $true
$removeAll = Get-QuantumParam -obj $params -name "remove_all" -type "bool" -default $false
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "query" -validateset "present","absent","query"
$systemManaged = Get-QuantumParam -obj $params -name "system_managed" -type "bool" -default $false
$testPath = Get-QuantumParam -obj $params -name "test_path" -type "bool" -default $true
