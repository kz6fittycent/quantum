...
$names = Get-QuantumParam -obj $params -name "names" -type "str" -failifempty $true -aliases "name"
$new_only = Get-QuantumParam -obj $params -name "new_only" -type "bool" -default $false
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "enabled" -validateset "enabled","disabled"
$prefix = Get-QuantumParam -obj $params -name "prefix" -type "str"
