...
# $ quantum -i vagrant-inventory -m win_iis_website -a "name='Default Web Site'" window
# host | success >> {
#     "changed": false,
#     "site": {
...
# $ quantum -i hosts -m win_iis_website -a "name='Default Web Site' state=stopped" host

# This creates a new site.
# $ quantum -i hosts -m win_iis_website -a "name=acme physical_path=C:\\sites\\acme" host
