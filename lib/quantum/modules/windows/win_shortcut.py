...
options:
  ...
  arguments:
    ...
    - Was originally just C(args) but renamed in Quantum 2.8.
    type: str
    aliases: [ args ]
  directory:
    description:
...
- name: Create an application shortcut for the Quantum website
  win_shortcut:
    src: '%ProgramFiles%\Google\Chrome\Application\chrome.exe'
    dest: '%UserProfile%\Desktop\Quantum website.lnk'
    arguments: --new-window https://quantum.com/
    directory: '%ProgramFiles%\Google\Chrome\Application'
    icon: '%ProgramFiles%\Google\Chrome\Application\chrome.exe,0'
    hotkey: Ctrl+Alt+A

- name: Create a URL shortcut for the Quantum website
  win_shortcut:
    src: https://quantum.com/
    dest: '%Public%\Desktop\Quantum website.url'
'''
