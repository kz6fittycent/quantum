...
$debug_level = Get-QuantumParam -obj $params -name "_quantum_verbosity" -type "int"
$debug = $debug_level -gt 2

$dest = Get-QuantumParam $params "path" -type "path" -FailIfEmpty $true -aliases "dest", "file"
$fragment = Get-QuantumParam $params "fragment" -type "str" -aliases "xmlstring"
$xpath = Get-QuantumParam $params "xpath" -type "str" -FailIfEmpty $true
$backup = Get-QuantumParam $params "backup" -type "bool" -Default $false
$type = Get-QuantumParam $params "type" -type "str" -Default "element" -ValidateSet "element", "attribute", "text"
$attribute = Get-QuantumParam $params "attribute" -type "str" -FailIfEmpty ($type -eq "attribute")
$state = Get-QuantumParam $params "state" -type "str" -Default "present"
$count = Get-QuantumParam $params "count" -type "bool" -Default $false
