...
Function Test-Credential {
    ...
    try {
        $handle = [Quantum.AccessToken.TokenUtil]::LogonUser($Username, $Domain, $Password, "Network", "Default")
        $handle.Dispose()
        return $true
...
$check_mode = Get-QuantumParam -obj $params -name "_quantum_check_mode" -default $false

# Module control parameters
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present","absent","query"
$update_password = Get-QuantumParam -obj $params -name "update_password" -type "str" -default "always" -validateset "always","on_create","when_changed"
$groups_action = Get-QuantumParam -obj $params -name "groups_action" -type "str" -default "replace" -validateset "add","remove","replace"
$domain_username = Get-QuantumParam -obj $params -name "domain_username" -type "str"
$domain_password = Get-QuantumParam -obj $params -name "domain_password" -type "str" -failifempty ($null -ne $domain_username)
$domain_server = Get-QuantumParam -obj $params -name "domain_server" -type "str"

# User account parameters
$username = Get-QuantumParam -obj $params -name "name" -type "str" -failifempty $true
...
$password_expired = Get-QuantumParam -obj $params -name "password_expired" -type "bool"
$password_never_expires = Get-QuantumParam -obj $params -name "password_never_expires" -type "bool"
$user_cannot_change_password = Get-QuantumParam -obj $params -name "user_cannot_change_password" -type "bool"
$account_locked = Get-QuantumParam -obj $params -name "account_locked" -type "bool"
$groups = Get-QuantumParam -obj $params -name "groups" -type "list"
$enabled = Get-QuantumParam -obj $params -name "enabled" -type "bool" -default $true
$path = Get-QuantumParam -obj $params -name "path" -type "str"
$upn = Get-QuantumParam -obj $params -name "upn" -type "str"

# User informational parameters
$user_info = @{
    GivenName = Get-QuantumParam -obj $params -name "firstname" -type "str"
    Surname = Get-QuantumParam -obj $params -name "surname" -type "str"
    Company = Get-QuantumParam -obj $params -name "company" -type "str"
    EmailAddress = Get-QuantumParam -obj $params -name "email" -type "str"
    StreetAddress = Get-QuantumParam -obj $params -name "street" -type "str"
    City = Get-QuantumParam -obj $params -name "city" -type "str"
    State = Get-QuantumParam -obj $params -name "state_province" -type "str"
    PostalCode = Get-QuantumParam -obj $params -name "postal_code" -type "str"
    Country = Get-QuantumParam -obj $params -name "country" -type "str"
}

# Additional attributes
$attributes = Get-QuantumParam -obj $params -name "attributes"
