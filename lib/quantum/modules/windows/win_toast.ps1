...
$expire_seconds = Get-QuantumParam -obj $params -name "expire" -type "int" -default 45
$group = Get-QuantumParam -obj $params -name "group" -type "str" -default "Powershell"
$msg = Get-QuantumParam -obj $params -name "msg" -type "str" -default "Hello world!"
$popup = Get-QuantumParam -obj $params -name "popup" -type "bool" -default $true
$tag = Get-QuantumParam -obj $params -name "tag" -type "str" -default "Quantum"
$title = Get-QuantumParam -obj $params -name "title" -type "str" -default $default_title
