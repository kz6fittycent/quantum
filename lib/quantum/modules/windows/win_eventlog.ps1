...
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present","clear","absent"
$sources = Get-QuantumParam -obj $params -name "sources" -type "list"
$category_file = Get-QuantumParam -obj $params -name "category_file" -type "path"
$message_file = Get-QuantumParam -obj $params -name "message_file" -type "path"
$parameter_file = Get-QuantumParam -obj $params -name "parameter_file" -type "path"
$maximum_size = Get-QuantumParam -obj $params -name "maximum_size" -type "str"
$overflow_action = Get-QuantumParam -obj $params -name "overflow_action" -type "str" -validateset "OverwriteOlder","OverwriteAsNeeded","DoNotOverwrite"
$retention_days = Get-QuantumParam -obj $params -name "retention_days" -type "int"
