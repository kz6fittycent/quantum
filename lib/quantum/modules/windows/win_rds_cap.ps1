...
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "absent","present","enabled","disabled"
$auth_method = Get-QuantumParam -obj $params -name "auth_method" -type "str" -validateset $auth_methods_set
$order = Get-QuantumParam -obj $params -name "order" -type "int"
$session_timeout = Get-QuantumParam -obj $params -name "session_timeout" -type "int"
$session_timeout_action = Get-QuantumParam -obj $params -name "session_timeout_action" -type "str" -default "disconnect" -validateset $session_timeout_actions_set
$idle_timeout = Get-QuantumParam -obj $params -name "idle_timeout" -type "int"
$allow_only_sdrts_servers = Get-QuantumParam -obj $params -name "allow_only_sdrts_servers" -type "bool"
$user_groups = Get-QuantumParam -obj $params -name "user_groups" -type "list"
$computer_groups = Get-QuantumParam -obj $params -name "computer_groups" -type "list"

# Device redirections
$redirect_clipboard = Get-QuantumParam -obj $params -name "redirect_clipboard" -type "bool"
$redirect_drives = Get-QuantumParam -obj $params -name "redirect_drives" -type "bool"
$redirect_printers = Get-QuantumParam -obj $params -name "redirect_printers" -type "bool"
$redirect_serial = Get-QuantumParam -obj $params -name "redirect_serial" -type "bool"
$redirect_pnp = Get-QuantumParam -obj $params -name "redirect_pnp" -type "bool"
