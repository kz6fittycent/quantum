...
$display_seconds = Get-QuantumParam -obj $params -name "display_seconds" -type "int" -default "10"
$msg = Get-QuantumParam -obj $params -name "msg" -type "str" -default "Hello world!"
$to = Get-QuantumParam -obj $params -name "to" -type "str" -default "*"
$wait = Get-QuantumParam -obj $params -name "wait" -type "bool" -default $false
