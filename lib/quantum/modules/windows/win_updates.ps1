...
$category_names = Get-QuantumParam -obj $params -name "category_names" -type "list" -default @("CriticalUpdates", "SecurityUpdates", "UpdateRollups")
$log_path = Get-QuantumParam -obj $params -name "log_path" -type "path"
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "installed" -validateset "installed", "searched", "downloaded"
$blacklist = Get-QuantumParam -obj $params -name "blacklist" -type "list"
$whitelist = Get-QuantumParam -obj $params -name "whitelist" -type "list"
$server_selection = Get-QuantumParam -obj $params -name "server_selection" -type "string" -default "default" -validateset "default", "managed_server", "windows_update"
