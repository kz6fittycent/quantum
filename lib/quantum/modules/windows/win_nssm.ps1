...
#Requires -Module Quantum.ModuleUtils.ArgvParser
...
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present","absent","started","stopped","restarted" -resultobj $result
...
$application = Get-QuantumParam -obj $params -name "application" -type "path"
$appDirectory  = Get-QuantumParam -obj $params -name "working_directory" -aliases "app_directory","chdir" -type "path"
$appParameters = Get-QuantumParam -obj $params -name "app_parameters"
$appArguments = Get-QuantumParam -obj $params -name "arguments" -aliases "app_parameters_free_form"

$stdoutFile = Get-QuantumParam -obj $params -name "stdout_file" -type "path"
$stderrFile = Get-QuantumParam -obj $params -name "stderr_file" -type "path"

$executable = Get-QuantumParam -obj $params -name "executable" -type "path" -default "nssm.exe"

# Deprecated options since 2.8. Remove in 2.12
$startMode = Get-QuantumParam -obj $params -name "start_mode" -type "str" -default "auto" -validateset $start_modes_map.Keys -resultobj $result
$dependencies = Get-QuantumParam -obj $params -name "dependencies" -type "list"
$user = Get-QuantumParam -obj $params -name "user" -type "str"
