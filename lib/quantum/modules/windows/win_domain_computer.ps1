...
$name = Get-QuantumParam -obj $params -name "name" -failifempty $true -resultobj $result
$sam_account_name = Get-QuantumParam -obj $params -name "sam_account_name" -default "$name$"
...
$description = Get-QuantumParam -obj $params -name "description" -default $null
...
$state = Get-QuantumParam -obj $params -name "state" -ValidateSet "present","absent" -default "present"
...
If ($state -eq "present") {
  $dns_hostname = Get-QuantumParam -obj $params -name "dns_hostname" -failifempty $true -resultobj $result
  $ou = Get-QuantumParam -obj $params -name "ou" -failifempty $true -resultobj $result
