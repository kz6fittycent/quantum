...
$category = Get-QuantumParam -obj $params -name "category" -type "str" -validateset "distribution","security"
$scope = Get-QuantumParam -obj $params -name "scope" -type "str" -validateset "domainlocal","global","universal"
$managed_by = Get-QuantumParam -obj $params -name "managed_by" -type "str"
$attributes = Get-QuantumParam -obj $params -name "attributes"
$organizational_unit = Get-QuantumParam -obj $params -name "organizational_unit" -type "str" -aliases "ou","path"
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present","absent"
$protect = Get-QuantumParam -obj $params -name "protect" -type "bool"
$ignore_protection = Get-QuantumParam -obj $params -name "ignore_protection" -type "bool" -default $false
