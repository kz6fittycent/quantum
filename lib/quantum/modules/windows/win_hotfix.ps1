...
$hotfix_kb = Get-QuantumParam -obj $params -name "hotfix_kb" -type "str"
$hotfix_identifier = Get-QuantumParam -obj $params -name "hotfix_identifier" -type "str"
$state = Get-QuantumParam -obj $params -name "state" -type "state" -default "present" -validateset "absent","present"
$source = Get-QuantumParam -obj $params -name "source" -type "path"
