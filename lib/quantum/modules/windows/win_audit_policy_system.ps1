...
Else
{
    ...
    the system and that the account quantum is running under is able to retrieve them. $($_.Exception.Message)"
}
...
### quantum params ###
######################
$category = Get-QuantumParam -obj $params -name "category" -type "str" -ValidateSet $categories
$subcategory = Get-QuantumParam -obj $params -name "subcategory" -type "str" -ValidateSet $subcategories
$audit_type = Get-QuantumParam -obj $params -name "audit_type" -type "list" -failifempty -
