...
Function Get-ChocolateyFeature {
    ...
    $result.quantum_facts.quantum_chocolatey.feature = $feature_info
}
...
Function Get-ChocolateyConfig {
    ...
    $result.quantum_facts.quantum_chocolatey.config = $config_info
}
...
Function Get-ChocolateyPackages {
    ...
    $result.quantum_facts.quantum_chocolatey.packages = $packages_info
}
...
Function Get-ChocolateySources {
    ...
    $result.quantum_facts.quantum_chocolatey.sources = $sources
}
