...
$required_version = Get-QuantumParam -obj $params -name "required_version" -type "str"
$minimum_version = Get-QuantumParam -obj $params -name "minimum_version" -type "str"
$maximum_version = Get-QuantumParam -obj $params -name "maximum_version" -type "str"
$repo = Get-QuantumParam -obj $params -name "repository" -type "str"
$url = Get-QuantumParam -obj $params -name "url" -type str
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateset "present", "absent", "latest"
$allow_clobber = Get-QuantumParam -obj $params -name "allow_clobber" -type "bool" -default $false
$skip_publisher_check = Get-QuantumParam -obj $params -name "skip_publisher_check" -type "bool" -default $false
$allow_prerelease = Get-QuantumParam -obj $params -name "allow_prerelease" -type "bool" -default $false
