...
$certificate = Get-QuantumParam $params -name "certificate_hash" -type "str"
$max_connections = Get-QuantumParam $params -name "max_connections" -type "int"
$ssl_bridging = Get-QuantumParam -obj $params -name "ssl_bridging" -type "str" -validateset $ssl_bridging_methods
$enable_only_messaging_capable_clients  = Get-QuantumParam $params -name "enable_only_messaging_capable_clients" -type "bool"
