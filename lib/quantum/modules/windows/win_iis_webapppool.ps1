...
$state = Get-QuantumParam -obj $params -name "state" -type "str" -default "present" -validateSet "started","restarted","stopped","absent","present"
$result = @{
    changed = $false
    attributes = @{}
    info = @{
...
$attributes = @{}
$input_attributes = Get-QuantumParam -obj $params -name "attributes"
if ($input_attributes) {
