...
# module parameters
$path = Get-QuantumParam -obj $params -name "path" -type "path" -failifempty $true -aliases "destination","dest"
$user = Get-QuantumParam -obj $params -name "user" -type "str" -failifempty $true
$rights = Get-QuantumParam -obj $params -name "rights" -type "list"
$inheritance_flags = Get-QuantumParam -obj $params -name "inheritance_flags" -type "list" -default 'ContainerInherit','ObjectInherit'
$propagation_flags = Get-QuantumParam -obj $params -name "propagation_flags" -type "str" -default "none" -ValidateSet 'InheritOnly','None','NoPropagateInherit'
$audit_flags = Get-QuantumParam -obj $params -name "audit_flags" -type "list" -default 'success'
