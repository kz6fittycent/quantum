...
$managers    = Get-QuantumParam -obj $params -name "permitted_managers"  -type "list" -default $null
$communities = Get-QuantumParam -obj $params -name "community_strings"   -type "list" -default $null
$action_in   = Get-QuantumParam -obj $params -name "action"              -type "str"  -default "set" -ValidateSet @("set", "add", "remove")
