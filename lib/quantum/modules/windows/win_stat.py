...
options:
    ...
    get_md5:
        description:
            - Whether to return the checksum sum of the file. Between Quantum 1.9
              and Quantum 2.2 this is no longer an MD5, but a SHA1 instead. As of Quantum
              2.3 this is back to an MD5. Will return None if host is unable to
              use specified algorithm.
            - The default of this option changed from C(yes) to C(no) in Quantum 2.5
              and will be removed altogether in Quantum 2.9.
...
stat:
    ...
    contains:
        ...
        lnk_target:
            ...
            sample: ..\link
        md5:
            description: The MD5 checksum of a file (Between Quantum 1.9 and Quantum 2.2 this was returned as a SHA1 hash), will be removed in Quantum 2.9.
