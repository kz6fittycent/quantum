...
Function Test-LocalCredential {
    ...
    try {
        $handle = [Quantum.AccessToken.TokenUtil]::LogonUser($Username, $null, $Password, "Network", "Default")
        $handle.Dispose()
...
$fullname = Get-QuantumParam -obj $params -name "fullname" -type "str"
...
$update_password = Get-QuantumParam -obj $params -name "update_password" -type "str" -default "always" -validateset "always","on_create"
...
$account_disabled = Get-QuantumParam -obj $params -name "account_disabled" -type "bool"
$account_locked = Get-QuantumParam -obj $params -name "account_locked" -type "bool"
$groups = Get-QuantumParam -obj $params -name "groups"
