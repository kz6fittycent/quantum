...
$module.Result.quantum_facts = @{
    quantum_os_product_id = (Get-CimInstance Win32_OperatingSystem).SerialNumber
    quantum_os_product_key = $product_key
    quantum_os_license_edition = $winlicense_edition
    quantum_os_license_channel = $winlicense_channel
    quantum_os_license_status = $winlicense_status
}
