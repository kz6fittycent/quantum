    ...
    if not module.check_mode:
        ...
        if mgr['version'] != module.params['version']:
            ...
            if module.params['auth_protocol'] and module.params['privacy_protocol']:
                ...
                module.fail_json(msg="Invalid parameters selected in update. Please raise issue in Quantum GitHub")
    ...
    if not module.check_mode:
        if module.params['version'] == "v2c":
            ...
            if module.params['auth_protocol'] and module.params['privacy_protocol']:
                ...
                module.fail_json(msg="Invalid parameters selected in create. Please raise issue in Quantum GitHub")
    module.exit_json(changed=changed)
