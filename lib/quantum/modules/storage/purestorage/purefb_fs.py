...
author: Pure Storage Quantum Team (@sdodsley) <pure-quantum-team@purestorage.com>
options:
  name:
    description:
      - Filesystem Name.
...
from quantum.module_utils.basic import QuantumModule, human_to_bytes
from quantum.module_utils.pure import get_blade, purefb_argument_spec
