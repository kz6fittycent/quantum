...
description:
  ...
  - This module was called C(gluster_heal_facts) before Quantum 2.9, returning C(quantum_facts).
    Note that the M(gluster_heal_info) module no longer returns C(quantum_facts)!
options:
  name:
    description:
      - The volume name.
...
def main():
    ...
    if is_old_facts:
        module.exit_json(quantum_facts=facts)
    else:
