...
from quantum.module_utils.netapp import NetAppESeriesModule, create_multipart_formdata, request
...
class NetAppESeriesFirmware(NetAppESeriesModule):
    ...
    def __init__(self):
        ...
        super(NetAppESeriesFirmware, self).__init__(quantum_options=quantum_options,
