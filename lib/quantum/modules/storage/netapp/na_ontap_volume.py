...
EXAMPLES = """
    ...
    - name: Create FlexVol
      na_ontap_volume:
        state: present
        name: quantumVolume12
        is_infinite: False
        aggregate_name: quantum_aggr
        size: 100
        size_unit: mb
        ...
        vserver: quantumVServer
        wait_for_completion: True
        space_slo: none
        nvfail_enabled: False
        comment: quantum created volume
...
def main():
    '''Apply volume operations from coupling'''
