...
DOCUMENTATION = '''
author: NetApp Quantum Team (@carchi8py) <ng-quantumteam@netapp.com>
description:
...
EXAMPLES = """
    ...
    - name: Create ONTAP/ONTAP SnapMirror
      na_ontap_snapmirror:
        ...
        source_vserver: quantum_src
        destination_vserver: quantum_dest
        schedule: hourly
    ...
    - name: Initialize ONTAP/ONTAP SnapMirror
      na_ontap_snapmirror:
        state: present
        source_path: 'quantum:test'
        destination_path: 'quantum:dest'
        hostname: "{{ destination_cluster_hostname }}"
        username: "{{ destination_cluster_username }}"
        password: "{{ destination_cluster_password }}"
    ...
    - name: Create SnapMirror from ElementSW to ONTAP
      na_ontap_snapmirror:
        ...
        destination_path: 'quantum_test:quantum_dest_vol'
        schedule: hourly
        policy: MirrorLatest
    ...
    - name: Create SnapMirror from ONTAP to ElementSW
      na_ontap_snapmirror:
        ...
        source_path: 'quantum_test:quantum_dest_vol'
        policy: MirrorLatest
...
from quantum.module_utils.netapp_elementsw_module import NaElementSWModule
from quantum.module_utils.netapp_module import NetAppModule
