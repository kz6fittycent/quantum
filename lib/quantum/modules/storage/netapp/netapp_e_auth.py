...
def set_password(module, ssid, api_url, user, pwd, current_password=None, new_password=None, set_admin=False):
    ...
    if rc == 422:
        ...
        try:
            ...
            module.fail_json(msg="Wrong or no admin password supplied. Please update your coupling and try again")
...
def main():
    ...
    module = QuantumModule(argument_spec=argument_spec, mutually_exclusive=[['name', 'ssid']],
