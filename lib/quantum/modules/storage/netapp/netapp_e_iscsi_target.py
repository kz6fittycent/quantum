...
options:
    ...
    log_path:
        description:
            - A local path (on the Quantum controller), to a file to be used for debug logging.
        required: no
notes:
...
class IscsiTarget(object):
    def __init__(self):
        ...
        self.module = QuantumModule(argument_spec=argument_spec, supports_check_mode=True, )
