...
class IscsiInterface(object):
    def __init__(self):
        ...
        self.module = QuantumModule(argument_spec=argument_spec, supports_check_mode=True, required_if=required_if, )
    ...
    def update(self):
        ...
        if update_required and not self.check_mode:
            try:
                ...
                # We could potentially retry this a few times, but it's probably a rare enough case (unless a coupling
