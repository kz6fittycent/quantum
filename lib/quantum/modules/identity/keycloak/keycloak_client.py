...
from quantum.module_utils.identity.keycloak.keycloak import KeycloakAPI, camel, \
        ...
        if isinstance(new_param_value, list):
            if client_param in ['attributes']:
                try:
                    ...
                    pass
        # Unfortunately, the quantum argument spec checker introduces variables with null values when
