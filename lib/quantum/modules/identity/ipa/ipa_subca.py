...
- ipa_subca:
    ...
    ipa_pass: Passw0rd!
    state: present
    subca_name: QuantumSubCA1
    subca_subject: 'CN=QuantumSubCA1,O=example.com'
    subca_desc: Quantum Sub CA
...
from quantum.module_utils.ipa import IPAClient, ipa_argument_spec
