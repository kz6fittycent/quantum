...
options:
  ...
  http_agent:
    description:
      - Set http user agent
    required: false
    default: "quantum-ipinfoio-module/0.0.1"
notes:
...
USER_AGENT = 'quantum-ipinfoio-module/0.0.1'
...
def main():
    ...
    ipinfoio_result = dict(
        changed=False, quantum_facts=ipinfoio.get_geo_data())
