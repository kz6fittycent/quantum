...
#
# This module was ported from https://github.com/mskarbek/quantum-nsupdate
#
...
options:
    ...
    zone:
        description:
            ...
            - Starting with Quantum 2.7 this parameter is optional.
    record:
        description:
...
EXAMPLES = '''
- name: Add or modify quantum.example.org A to 192.168.1.1"
  nsupdate:
    key_name: "nsupdate"
...
- name: Add or modify quantum.example.org A to 192.168.1.1, 192.168.1.2 and 192.168.1.3"
  nsupdate:
    key_name: "nsupdate"
    key_secret: "+bFQtBCta7j2vWkjPkAFtgA=="
    server: "10.1.1.1"
...
- name: Add 1.1.168.192.in-addr.arpa. PTR for quantum.example.org
  nsupdate:
    key_name: "nsupdate"
    key_secret: "+bFQtBCta7j2vWkjPkAFtgA=="
    server: "10.1.1.1"
