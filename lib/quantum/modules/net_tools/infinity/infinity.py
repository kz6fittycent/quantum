  ...
  tasks:
    - name: Reserve network into Infinity IPAM
      infinity:
        ...
        network_name: reserve_new_quantum_network
        network_family: 4
        network_type: lan
        network_id: 1201
        network_size: /28
...
network_info:
    ...
    "network_type": "lan","network_name": "'reserve_new_quantum_network'"}
'''


from quantum.module_utils.basic import QuantumModule, json
...
class Infinity(object):
    ...
    def _get_api_call_quantum_handler(
            self,
            method='get',
            resource_url='',
            stat_codes=None,
            ...
            payload_data=None):
        """
        Perform the HTTPS request by using quantum get/delete method
        """
    ...
    def get_network(self, network_id, network_name, limit=-1):
        ...
        if network_id:
            ...
            response = self._get_api_call_quantum_handler(method, resource_url)
        if network_id is None and network_name:
            method = "get"
            resource_url = "search"
            params = {"query": json.dumps(
                {"name": network_name, "type": "network"})}
            response = self._get_api_call_quantum_handler(
    ...
    def release_ip(self, network_id="", ip_address=""):
        ...
        for ip_id in ip_idlist:
            ...
            ip_response = self._get_api_call_quantum_handler(
                method,
                resource_url,
                stat_codes=[200])
    ...
    def reserve_network(self, network_id="",
        ...
        network_info = self._get_api_call_quantum_handler(
