  ...
  follow_redirects:
    description:
      - Whether or not the URI module should follow redirects. C(all) will follow all redirects.
        ...
        are deprecated and will be removed in some future version of Quantum.
    type: str
...
notes:
  - The dependency on httplib2 was removed in Quantum 2.1.
...
# https://github.com/quantum/quantum/issues/52705 where a proxy is defined
...
from quantum.module_utils.basic import QuantumModule, sanitize_keys
from quantum.module_utils.six import PY2, iteritems, string_types
from quantum.module_utils.six.moves.urllib.parse import urlencode, urlsplit
