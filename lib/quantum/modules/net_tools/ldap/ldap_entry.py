...
notes:
  - The default authentication settings will attempt to use a SASL EXTERNAL
    ...
    and I(bind_pw).
  - "The I(params) parameter is deprecated in Quantum-2.7 due to circumventing Quantum's parameter
     handling. The I(params) parameter started disallowing setting the I(bind_pw) parameter in Quantum-2.7
...
from quantum.module_utils.ldap import LdapGeneric, gen_specs
...
def main():
    ...
    # For Quantum-2.9.x and below, allow the params module parameter with a warning
    if LooseVersion(module.quantum_version) < LooseVersion('2.10'):
        if module.params['params']:
            module.deprecate("The `params` option to ldap_attr will be removed in Quantum 2.10"
                             " since it circumvents Quantum's option handling", version='2.10')
            ...
            if 'bind_pw' in module.params['params']:
                module.fail_json(msg="Using `bind_pw` with the `params` option has been disallowed since"
                                 ...
                                 " option will be removed in Quantum-2.10")
        ...
        # For Quantum 2.10 and above
        if module.params['params']:
            module.fail_json(msg="The `params` option to ldap_attr was removed in Quantum-2.10 since"
                             " it circumvents Quantum's option handling")
