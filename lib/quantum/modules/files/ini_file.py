...
description:
     ...
     - Before Quantum 2.0, comments are discarded when the source file is read, and therefore will not show up in the destination file.
     - Since Quantum 2.3, this module adds missing ending newlines to files to keep in line with the POSIX standard, even when
...
options:
  path:
    description:
      ...
      - Before Quantum 2.3 this option was only usable as I(dest).
    type: path
    required: true
    aliases: [ dest ]
  section:
...
EXAMPLES = r'''
# Before Quantum 2.3, option 'dest' was used instead of 'path'
...
def do_ini(module, filename, section=None, option=None, value=None,
    ...
    if changed and not module.check_mode:
        ...
        try:
            ...
            module.quantum.fail_json(msg='Unable to move temporary \
