...
options:
  ...
  fail_on_missing:
    ...
    - Prior to Quantum 2.5, setting this would only fail if the source file was missing.
    - The default was changed to C(yes) in Quantum 2.5.
    type: bool
    default: yes
  validate_checksum:
    version_added: '1.4'
...
- Prior to Quantum 2.5 this module would not fail if reading the remote
  file was impossible unless C(fail_on_missing) was set.
- In Quantum 2.5 or later, coupling authors are encouraged to use
...
- name: Storing in a path relative to the coupling
  fetch:
    src: /tmp/uniquefile
