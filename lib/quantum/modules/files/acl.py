...
- As of Quantum 2.0, this module only supports Linux distributions.
- As of Quantum 2.3, the I(name) option has been changed to I(path) as default, but I(name) still works as well.
'''
