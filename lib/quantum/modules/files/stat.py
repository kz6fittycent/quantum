...
options:
  ...
  get_mime:
    description:
      ...
      - In Quantum 2.3 this option changed from 'mime' to 'get_mime' and the default changed to 'Yes'.
    type: bool
    default: yes
...
stat:
    ...
    contains:
        ...
        lnk_target:
            ...
            version_added: 2.4
        md5:
            description: md5 hash of the path; this will be removed in Quantum 2.9 in
