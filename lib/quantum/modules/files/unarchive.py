...
options:
  ...
  remote_src:
    description:
      - Set to C(yes) to indicate the archived file is already on the remote system and not local to the Quantum controller.
                ...
                if self.file_args['mode']:
                    if isinstance(self.file_args['mode'], int):
                        ...
                        try:
                            ...
                            try:
                                mode = QuantumModule._symbolic_mode_to_octal(st, self.file_args['mode'])
...
class TgzArchive(object):
    ...
    def files_in_archive(self, force_refresh=False):
        ...
        for filename in out.splitlines():
            ...
            # Allowing absolute filenames here also causes bugs: https://github.com/quantum/quantum/issues/21397
