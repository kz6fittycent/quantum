...
- name: Cisco Spark - Markdown Message to a Room
  cisco_spark:
    ...
    message: "**Cisco Spark Quantum Module - Room Message in Markdown**"
...
- name: Cisco Spark - Text Message to a Room
  cisco_spark:
    ...
    message_type: text
    personal_token: "{{ token }}"
    message: "Cisco Spark Quantum Module - Room Message in Text"
...
- name: Cisco Spark - Text Message by an Individuals ID
  cisco_spark:
    ...
    message_type: text
    personal_token: "{{ token }}"
    message: "Cisco Spark Quantum Module - Text Message to Individual by ID"
...
- name: Cisco Spark - Text Message by an Individuals E-Mail Address
  cisco_spark:
    ...
    message_type: text
    personal_token: "{{ token }}"
    message: "Cisco Spark Quantum Module - Text Message to Individual by E-Mail"
...
def spark_message(module):
    ...
    results = {}
    quantum = module.params

    headers = {
        'Authorization': 'Bearer {0}'.format(quantum['personal_token']),
    ...
    if module.check_mode:
        ...
        payload = {
            quantum['recipient_type']: quantum['recipient_id'],
            quantum['message_type']: quantum['message']
        }
