...
from quantum.module_utils.basic import QuantumModule, _load_params
...
def get_existing_pipeline_variable(module, bitbucket):
    ...
    :param module: instance of the :class:`QuantumModule`
...
class BitBucketPipelineVariable(QuantumModule):
