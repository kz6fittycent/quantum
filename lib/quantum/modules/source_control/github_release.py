...
- name: Get latest release of test repo using username and password. Quantum 2.4.
  github_release:
    user: testuser
    password: secret123
    repo: testrepo
...
create_release:
    ...
    - "For Quantum version 2.5 and later, if specified release version already exists, then State is unchanged"
    - "For Quantum versions prior to 2.5, if specified release version already exists, then State is skipped"
    type: str
    returned: success
    sample: 1.1.0
