...
EXAMPLES = '''
# Example git checkout from Quantum Playbooks
- git:
...
- git:
    repo: https://github.com/quantum/quantum-examples.git
    dest: /src/quantum-examples
...
- git:
    repo: https://github.com/quantum/quantum-examples.git
    dest: /src/quantum-examples
    archive: /tmp/quantum-examples.zip

# Example clone a repo with separate git directory
- git:
    repo: https://github.com/quantum/quantum-examples.git
    dest: /src/quantum-examples
    separate_git_dir: /src/quantum-examples.git
'''
...
from quantum.module_utils.basic import QuantumModule, get_module_path
from quantum.module_utils.six import b, string_types
...
def head_splitter(headfile, remote, module=None, fail_on_error=False):
    ...
    # https://github.com/quantum/quantum-modules-core/pull/907
...
def unfrackgitpath(path):
    ...
    # copied from quantum.utils.path
...
def get_head_branch(git_path, module, dest, remote, bare=False):
    ...
    taken from lib/quantum/utils/__init__.py.  It finds the correct
