...
from quantum.module_utils.common.text.converters import container_to_bytes
    ...
    Args:
        ...
        params (list): Each element of this list
            ...
            ['argument_key', 'argument_value', ['required_arg_1',
                                                'required_arg_2']].
            Format is the same as `required_if` parameter of QuantumModule.
    """
    for param in params:
...
def diff(existing, new):
    """Constructs the diff for Quantum's --diff option.
