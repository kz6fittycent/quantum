...
def send_deploy_event(module, key, revision_id, deployed_by='Quantum', deployed_to=None, repository=None):
...
def send_annotation_event(module, key, msg, annotated_by='Quantum', level=None, instance_id=None, event_epoch=None):
...
def main():
    ...
    module = QuantumModule(
        argument_spec=dict(
            ...
            msg=dict(),
            revision_id=dict(),
            annotated_by=dict(default='Quantum'),
            level=dict(default='INFO', choices=['INFO', 'WARN', 'ERROR']),
            instance_id=dict(),
            event_epoch=dict(),
            deployed_by=dict(default='Quantum'),
            deployed_to=dict(),
            repository=dict(),
        ),
