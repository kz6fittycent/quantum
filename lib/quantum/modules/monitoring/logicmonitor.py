...
# LogicMonitor Quantum module for managing Collectors, Hosts and Hostgroups
...
---
module: logicmonitor
short_description: Manage your LogicMonitor account through Quantum Playbooks
description:
...
options:
  target:
    description:
      ...
      - NOTE You should use Quantum service modules such as M(service) or M(supervisorctl) for managing the Collector 'logicmonitor-agent' and
  ...
  fullpath:
    description:
      ...
      - Recommend running on a single Quantum host.
...
class LogicMonitor(object):
    ...
    def __init__(self, module, **params):
        ...
        self.__version__ = self.__version__ + "-quantum-module"
    ...
    def output_info(self, info):
        self.module.debug("Registering properties as Quantum facts")
        self.module.exit_json(changed=False, quantum_facts=info)
