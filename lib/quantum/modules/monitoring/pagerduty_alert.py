...
from quantum.module_utils.six.moves.urllib.parse import urlparse, urlencode, urlunparse
...
def main():
    module = QuantumModule(
        argument_spec=dict(
            ...
            desc=dict(required=False, default='Created via Quantum'),
