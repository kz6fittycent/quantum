...
def grafana_cli_bin(params):
    ...
    :param params: quantum module params. Used to fill grafana-cli global params.
    '''
    program = 'grafana-cli'
    grafana_cli = None
...
def get_grafana_plugin_version(module, params):
    ...
    :param module: quantum module object. used to run system commands.
    :param params: quantum module params.
    '''
