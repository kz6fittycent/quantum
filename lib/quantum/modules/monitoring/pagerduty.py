...
# Delete a maintenance window from a separate coupling than its creation, and if it is the only existing maintenance window.
- pagerduty:
...
def main():
    ...
    module = QuantumModule(
        argument_spec=dict(
            ...
            desc=dict(default='Created by Quantum', required=False),
