...
short_description: Wait for Quantum Tower job to finish.
description:
    - Wait for Quantum Tower job to finish and report success or failure. See
...
from quantum.module_utils.six.moves import cStringIO as StringIO
