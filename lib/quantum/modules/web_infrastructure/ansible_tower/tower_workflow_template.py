...
version_added: "2.7"
short_description: create, update, or destroy Quantum Tower workflow template.
description:
    - Create, update, or destroy Quantum Tower workflows. See
...
options:
    ...
    extra_vars:
      description:
        - Extra variables used by Quantum in YAML or key=value format.
    inventory:
      description:
