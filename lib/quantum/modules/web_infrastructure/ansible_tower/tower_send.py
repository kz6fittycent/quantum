...
version_added: "2.8"
short_description: Send assets to Quantum Tower.
description:
    - Send assets to Quantum Tower. See
...
from quantum.module_utils.quantum_tower import TowerModule, tower_auth_config, HAS_TOWER_CLI
...
def main():
    ...
    if not HAS_TOWER_CLI:
        module.fail_json(msg='quantum-tower-cli required for this module')

    if not TOWER_CLI_HAS_EXPORT:
        module.fail_json(msg='quantum-tower-cli version does not support export')
