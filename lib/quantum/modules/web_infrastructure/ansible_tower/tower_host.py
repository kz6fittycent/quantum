...
short_description: create, update, or destroy Quantum Tower host.
description:
    - Create, update, or destroy Quantum Tower hosts. See
...
from quantum.module_utils.quantum_tower import TowerModule, tower_auth_config, tower_check_mode, HAS_TOWER_CLI
