...
version_added: "2.7"
short_description: Create, update, or destroy custom Quantum Tower credential type.
description:
    - Create, update, or destroy Quantum Tower credential type. See
...
options:
    ...
    kind:
      description:
        - >-
          ...
          net can be used for creating credential types. Refer to the Quantum
    ...
    inputs:
      description:
        - >-
          Enter inputs using either JSON or YAML syntax. Refer to the Quantum
    ...
    injectors:
      description:
        - >-
          ...
          Quantum Tower documentation for example syntax.
      required: False
    state:
      description:
...
from quantum.module_utils.quantum_tower import (
    TowerModule,
    tower_auth_config,
    tower_check_mode
)
