...
version_added: "2.3"
short_description: create, update, or destroy Quantum Tower job template.
description:
    - Create, update, or destroy Quantum Tower job templates. See
      U(https://www.quantum.com/tower) for an overview.
options:
    name:
      description:
    ...
    coupling:
      description:
        - Path to the coupling to use for the job template within the project provided.
      required: True
    credential:
      description:
    ...
    forks:
      description:
        - The number of parallel or simultaneous processes to use while executing the coupling.
    limit:
      description:
        - A host pattern to further constrain the list of hosts managed or affected by the coupling
    verbosity:
      description:
        - Control the output level Quantum produces as the coupling runs. 0 - Normal, 1 - Verbose, 2 - More Verbose, 3 - Debug, 4 - Connection Debug.
      choices: [0, 1, 2, 3, 4]
      default: 0
    extra_vars_path:
      description:
    ...
    force_handlers_enabled:
      description:
        - Enable forcing coupling handlers to run even if a task fails.
      version_added: 2.7
      type: bool
      default: 'no'
    skip_tags:
    ...
    start_at_task:
      description:
        - Start the coupling at the task matching this name.
      version_added: 2.7
    diff_mode_enabled:
      description:
...
notes:
  - JSON for survey_spec can be found in Tower API Documentation. See
    U(https://docs.quantum.com/quantum-tower/latest/html/towerapi/api_ref.html#/Job_Templates/Job_Templates_job_templates_survey_spec_create)
...
from quantum.module_utils.quantum_tower import TowerModule, tower_auth_config, tower_check_mode
