...
version_added: "2.7"
short_description: create, update, or destroy Quantum Tower inventory source.
description:
    - Create, update, or destroy Quantum Tower inventories source. See
    ...
    source_regions:
      description:
        - >-
          ...
          updated. Refer to Quantum Tower documentation for more detail.
    instance_filters:
      description:
        - >-
          Provide a comma-separated list of filter expressions. Hosts are
          imported when all of the filters match. Refer to Quantum Tower
    ...
    group_by:
      description:
        - >-
          ...
          are created. Refer to Quantum Tower documentation for more detail.
    source_script:
      description:
        - >-
