...
version_added: "2.3"
short_description: create, update, or destroy Quantum Tower projects
description:
    - Create, update, or destroy Quantum Tower projects. See
...
options:
    ...
    local_path:
      description:
        - The server coupling directory for manual projects.
    scm_branch:
      description:
...
- name: Add Tower Project with cache timeout and custom virtualenv
  tower_project:
    ...
    custom_virtualenv: "/var/lib/awx/venv/quantum-2.2"
    state: present
    tower_config_file: "~/tower_cli.cfg"
'''
