...
version_added: "2.8"
short_description: Run a workflow in Quantum Tower
description:
    - Launch an Quantum Tower workflows. See
...
from quantum.module_utils.quantum_tower import TowerModule, tower_auth_config
