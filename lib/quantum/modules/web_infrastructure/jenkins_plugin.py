...
description:
  - Quantum module which helps to manage Jenkins plugins.
...
notes:
  ...
  - "The C(params) option was removed in Quantum 2.5 due to circumventing Quantum's
    option handling"
...
from quantum.module_utils.basic import QuantumModule, to_bytes
from quantum.module_utils.six.moves import http_cookiejar as cookiejar
from quantum.module_utils.six.moves.urllib.parse import urlencode
from quantum.module_utils.urls import fetch_url, url_argument_spec
from quantum.module_utils._text import to_native, text_type, binary_type
import base64
import hashlib
import json
import os
...
class JenkinsPlugin(object):
    ...
    def _download_updates(self):
        ...
        updates_dir = os.path.expanduser('~/.quantum/tmp')
...
def main():
    ...
    # Params was removed
    # https://meetbot.fedoraproject.org/quantum-meeting/2017-09-28/quantum_dev_meeting.2017-09-28-15.00.log.html
    if module.params['params']:
        module.fail_json(msg="The params option to jenkins_plugin was removed in Quantum 2.5 since it circumvents Quantum's option handling")
