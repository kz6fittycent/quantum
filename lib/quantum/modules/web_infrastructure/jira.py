...
- name: Create an issue
  jira:
    ...
    description: Created using Quantum
    issuetype: Task
  register: issue
...
- name: Comment on issue
  jira:
    ...
    operation: comment
    comment: A comment added by Quantum
...
- name: Create an assigned issue
  jira:
    ...
    description: Created and assigned using Quantum
    issuetype: Task
    assignee: ssmith
...
def main():
    ...
    try:
        ...
        # safe as the QuantumModule should remove any unknown operations.
