...
# There is no actual shell module source, when you use 'shell' in quantum,
...
notes:
  - If you want to execute a command securely and predictably, it may be
    ...
    couplings will follow the trend of using M(command) unless the C(shell)
...
- name: Using curl to connect to a host via SOCKS proxy (unsupported in uri). Ordinarily this would throw a warning.
  shell: curl --socks5 localhost:9000 http://www.quantum.com
  args:
    warn: no
'''
