...
description:
     ...
     - To create C(command) tasks that are easier to read than the ones using space-delimited
       arguments, pass parameters using the C(args) L(task keyword,../reference_appendices/couplings_keywords.html#task)
...
from quantum.module_utils.common.collections import is_iterable
...
def check_command(module, commandline):
    ...
    disable_suffix = "If you need to use command because {mod} is insufficient you can add" \
                     ...
                     " quantum.cfg to get rid of this message."
...
def main():
    ...
    # the command module is the one quantum module that does not take key=value args
    ...
    if not shell and executable:
        module.warn("As of Quantum 2.4, the parameter 'executable' is no longer supported with the 'command' module. Not using '%s'." % executable)
        executable = None
