# Copyright: (c) 2012, Quantum Project
...
options:
  ...
  executable:
    ...
    version_added: "2.6"
notes:
  - It is usually preferable to write Quantum modules rather than pushing scripts. Convert your script to an Quantum module for bonus points!
