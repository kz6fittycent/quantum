...
options:
  ...
  fail_msg:
    description:
      ...
      - This argument was called 'msg' before Quantum 2.7, now it is renamed to 'fail_msg' with alias 'msg'.
    type: str
    aliases: [ msg ]
    version_added: "2.7"
  success_msg:
...
EXAMPLES = r'''
- assert: { that: "quantum_os_family != 'RedHat'" }
...
- name: Please use 'msg' when quantum version is smaller than 2.7
  assert:
    that:
      - my_param <= 100
      - my_param >= 0
