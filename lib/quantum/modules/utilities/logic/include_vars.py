...
options:
  file:
    description:
      ...
      - If the path is relative, it will look for the file in vars/ subdirectory of a role or relative to coupling.
    type: path
    version_added: "2.2"
  dir:
    description:
      ...
      - If the path is relative and not inside a role, it will be parsed relative to the coupling.
    type: path
    version_added: "2.2"
  name:
    description:
...
- name: Load a variable file based on the OS type, or a default if not found. Using free-form to specify the file.
  ...
  vars:
    possible_files:
      - "{{ quantum_distribution }}.yaml"
      - "{{ quantum_os_family }}.yaml"
      - default.yaml
