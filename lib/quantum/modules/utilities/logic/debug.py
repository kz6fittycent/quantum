...
- debug:
    msg: System {{ inventory_hostname }} has uuid {{ quantum_product_uuid }}

- debug:
    msg: System {{ inventory_hostname }} has gateway {{ quantum_default_ipv4.gateway }}
  when: quantum_default_ipv4.gateway is defined
