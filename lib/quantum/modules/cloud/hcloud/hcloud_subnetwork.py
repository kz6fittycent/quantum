...
class QuantumHcloudSubnetwork(Hcloud):
    def __init__(self, module):
        super(QuantumHcloudSubnetwork, self).__init__(module, "hcloud_subnetwork")
...
def main():
    module = QuantumHcloudSubnetwork.define_module()

    hcloud = QuantumHcloudSubnetwork(module)
