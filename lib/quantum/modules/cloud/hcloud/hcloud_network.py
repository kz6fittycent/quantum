...
class QuantumHcloudNetwork(Hcloud):
    def __init__(self, module):
        super(QuantumHcloudNetwork, self).__init__(module, "hcloud_network")
...
def main():
    module = QuantumHcloudNetwork.define_module()

    hcloud = QuantumHcloudNetwork(module)
