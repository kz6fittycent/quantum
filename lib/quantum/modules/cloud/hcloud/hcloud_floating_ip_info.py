...
description:
    ...
    - This module was called C(hcloud_floating_ip_facts) before Quantum 2.9, returning C(quantum_facts) and C(hcloud_floating_ip_facts).
      Note that the M(hcloud_floating_ip_info) module no longer returns C(quantum_facts) and the value was renamed to C(hcloud_floating_ip_info)!
...
class QuantumHcloudFloatingIPInfo(Hcloud):
...
def main():
    module = QuantumHcloudFloatingIPInfo.define_module()
    ...
    hcloud = QuantumHcloudFloatingIPInfo(module)
