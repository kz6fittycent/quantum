...
description:
    ...
    - This module was called C(hcloud_datacenter_facts) before Quantum 2.9, returning C(quantum_facts) and C(hcloud_datacenter_facts).
      Note that the M(hcloud_datacenter_info) module no longer returns C(quantum_facts) and the value was renamed to C(hcloud_datacenter_info)!
...
class QuantumHcloudDatacenterInfo(Hcloud):
...
def main():
    module = QuantumHcloudDatacenterInfo.define_module()
    ...
    hcloud = QuantumHcloudDatacenterInfo(module)
