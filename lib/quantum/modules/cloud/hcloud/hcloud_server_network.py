...
class QuantumHcloudServerNetwork(Hcloud):
    def __init__(self, module):
        super(QuantumHcloudServerNetwork, self).__init__(module, "hcloud_server_network")
...
def main():
    module = QuantumHcloudServerNetwork.define_module()

    hcloud = QuantumHcloudServerNetwork(module)
