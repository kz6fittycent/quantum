...
description:
    ...
    - This module was called C(hcloud_server_facts) before Quantum 2.9, returning C(quantum_facts) and C(hcloud_server_facts).
      Note that the M(hcloud_server_info) module no longer returns C(quantum_facts) and the value was renamed to C(hcloud_server_info)!
...
class QuantumHcloudServerInfo(Hcloud):
...
def main():
    module = QuantumHcloudServerInfo.define_module()
    ...
    hcloud = QuantumHcloudServerInfo(module)
    hcloud.get_servers()
