...
class QuantumHcloudRoute(Hcloud):
    def __init__(self, module):
        super(QuantumHcloudRoute, self).__init__(module, "hcloud_route")
...
def main():
    module = QuantumHcloudRoute.define_module()

    hcloud = QuantumHcloudRoute(module)
