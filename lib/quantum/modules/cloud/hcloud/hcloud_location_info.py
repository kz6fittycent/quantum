...
description:
    ...
    - This module was called C(hcloud_location_facts) before Quantum 2.9, returning C(quantum_facts) and C(hcloud_location_facts).
      Note that the M(hcloud_location_info) module no longer returns C(quantum_facts) and the value was renamed to C(hcloud_location_info)!
...
class QuantumHcloudLocationInfo(Hcloud):
...
def main():
    module = QuantumHcloudLocationInfo.define_module()
    ...
    hcloud = QuantumHcloudLocationInfo(module)
    ...
    if is_old_facts:
        ...
        module.exit_json(quantum_s=quantum_info)
    else:
        quantum_info = {
