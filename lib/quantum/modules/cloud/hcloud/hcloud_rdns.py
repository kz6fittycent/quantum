...
class QuantumHcloudReverseDNS(Hcloud):
    def __init__(self, module):
        super(QuantumHcloudReverseDNS, self).__init__(module, "hcloud_rdns")
...
def main():
    module = QuantumHcloudReverseDNS.define_module()

    hcloud = QuantumHcloudReverseDNS(module)
