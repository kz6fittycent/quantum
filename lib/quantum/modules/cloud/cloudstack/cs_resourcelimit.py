...
class QuantumCloudStackResourceLimit(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackResourceLimit, self).__init__(module)
        self.returns = {
            'max': 'limit',
        }
    ...
    def get_result(self, resource_limit):
        self.result = super(QuantumCloudStackResourceLimit, self).get_result(resource_limit)
...
def main():
    ...
    acs_resource_limit = QuantumCloudStackResourceLimit(module)
