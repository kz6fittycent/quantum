...
class QuantumCloudStackIso(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackIso, self).__init__(module)
        self.returns = {
            'checksum': 'checksum',
            'status': 'status',
            'isready': 'is_ready',
    ...
    def get_result(self, iso):
        super(QuantumCloudStackIso, self).get_result(iso)
        # Workaround API does not return cross_zones=true
...
def main():
    ...
    acs_iso = QuantumCloudStackIso(module)
