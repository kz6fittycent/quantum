...
description:
  ...
  returned: success
  type: str
  sample: snapshot brought to you by Quantum
domain:
...
class QuantumCloudStackVmSnapshot(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackVmSnapshot, self).__init__(module)
        self.returns = {
            'type': 'type',
            'current': 'current',
        }
...
def main():
    ...
    acs_vmsnapshot = QuantumCloudStackVmSnapshot(module)
