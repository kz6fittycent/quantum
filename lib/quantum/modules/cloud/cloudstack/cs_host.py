...
class QuantumCloudStackHost(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackHost, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, host):
        super(QuantumCloudStackHost, self).get_result(host)
        if host:
...
def main():
    ...
    acs_host = QuantumCloudStackHost(module)
