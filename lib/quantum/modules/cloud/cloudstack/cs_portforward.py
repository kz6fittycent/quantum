...
from quantum.module_utils.cloudstack import QuantumCloudStack, cs_argument_spec, cs_required_together


class QuantumCloudStackPortforwarding(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackPortforwarding, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, portforwarding_rule):
        super(QuantumCloudStackPortforwarding, self).get_result(portforwarding_rule)
        if portforwarding_rule:
...
def main():
    ...
    acs_pf = QuantumCloudStackPortforwarding(module)
