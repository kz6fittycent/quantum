...
class QuantumCloudStackSnapshotPolicy(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackSnapshotPolicy, self).__init__(module)
        self.returns = {
            'schedule': 'schedule',
            'timezone': 'time_zone',
            'maxsnaps': 'max_snaps',
    ...
    def get_result(self, policy):
        super(QuantumCloudStackSnapshotPolicy, self).get_result(policy)
...
def main():
    ...
    acs_snapshot_policy = QuantumCloudStackSnapshotPolicy(module)
