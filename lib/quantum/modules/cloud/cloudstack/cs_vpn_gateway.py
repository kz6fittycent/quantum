...
class QuantumCloudStackVpnGateway(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackVpnGateway, self).__init__(module)
        self.returns = {
            'publicip': 'public_ip'
        }
    ...
    def get_result(self, vpn_gateway):
        super(QuantumCloudStackVpnGateway, self).get_result(vpn_gateway)
        if vpn_gateway:
...
def main():
    ...
    acs_vpn_gw = QuantumCloudStackVpnGateway(module)
