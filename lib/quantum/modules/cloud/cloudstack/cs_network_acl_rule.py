...
class QuantumCloudStackNetworkAclRule(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackNetworkAclRule, self).__init__(module)
        self.returns = {
            'cidrlist': 'cidr',
    ...
    def get_result(self, network_acl_rule):
        super(QuantumCloudStackNetworkAclRule, self).get_result(network_acl_rule)
        if network_acl_rule:
...
def main():
    ...
    acs_network_acl_rule = QuantumCloudStackNetworkAclRule(module)
