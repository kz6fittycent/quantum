...
class QuantumCloudStackServiceOffering(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackServiceOffering, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, service_offering):
        super(QuantumCloudStackServiceOffering, self).get_result(service_offering)
        if service_offering:
...
def main():
    ...
    acs_so = QuantumCloudStackServiceOffering(module)
