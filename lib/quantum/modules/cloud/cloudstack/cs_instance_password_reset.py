...
class QuantumCloudStackPasswordReset(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackPasswordReset, self).__init__(module)
        self.returns = {
            'password': 'password',
        }
        self.password = None
...
def main():
    ...
    acs_password = QuantumCloudStackPasswordReset(module)
