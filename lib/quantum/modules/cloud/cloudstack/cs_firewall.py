...
class QuantumCloudStackFirewall(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackFirewall, self).__init__(module)
        self.returns = {
            'cidrlist': 'cidr',
    ...
    def get_result(self, firewall_rule):
        super(QuantumCloudStackFirewall, self).get_result(firewall_rule)
        if firewall_rule:
...
def main():
    ...
    acs_fw = QuantumCloudStackFirewall(module)
