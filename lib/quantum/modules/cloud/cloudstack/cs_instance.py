...
class QuantumCloudStackInstance(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackInstance, self).__init__(module)
        self.returns = {
            'group': 'group',
    ...
    def get_result(self, instance):
        super(QuantumCloudStackInstance, self).get_result(instance)
        if instance:
...
def main():
    ...
    acs_instance = QuantumCloudStackInstance(module)
