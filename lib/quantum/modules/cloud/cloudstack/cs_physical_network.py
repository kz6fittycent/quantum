...
class QuantumCloudStackPhysicalNetwork(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackPhysicalNetwork, self).__init__(module)
        self.returns = {
...
def main():
    ...
    acs_network = QuantumCloudStackPhysicalNetwork(module)
