...
class QuantumCloudStackSecurityGroupRule(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackSecurityGroupRule, self).__init__(module)
        self.returns = {
            'icmptype': 'icmp_type',
            'icmpcode': 'icmp_code',
            'endport': 'end_port',
    ...
    def get_result(self, security_group_rule):
        super(QuantumCloudStackSecurityGroupRule, self).get_result(security_group_rule)
...
def main():
    ...
    acs_sg_rule = QuantumCloudStackSecurityGroupRule(module)
