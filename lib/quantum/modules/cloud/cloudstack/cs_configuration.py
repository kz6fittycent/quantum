...
class QuantumCloudStackConfiguration(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackConfiguration, self).__init__(module)
        self.returns = {
            'category': 'category',
            'scope': 'scope',
            'value': 'value',
    ...
    def get_zone(self, key=None):
        ...
        if zone:
            return super(QuantumCloudStackConfiguration, self).get_zone(key=key)
    ...
    def get_result(self, configuration):
        self.result = super(QuantumCloudStackConfiguration, self).get_result(configuration)
        if self.account:
...
def main():
    ...
    acs_configuration = QuantumCloudStackConfiguration(module)
