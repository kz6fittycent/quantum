...
class QuantumCloudStackNetwork(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackNetwork, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, network):
        super(QuantumCloudStackNetwork, self).get_result(network)
        if network:
...
def main():
    ...
    acs_network = QuantumCloudStackNetwork(module)
