...
class QuantumCloudStackSecurityGroup(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackSecurityGroup, self).__init__(module)
...
def main():
    ...
    acs_sg = QuantumCloudStackSecurityGroup(module)
