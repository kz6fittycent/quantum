...
from quantum.module_utils.cloudstack import QuantumCloudStack, cs_argument_spec


class QuantumCloudStackInstanceInfo(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackInstanceInfo, self).__init__(module)
        self.returns = {
            'group': 'group',
    ...
    def update_result(self, instance, result=None):
        result = super(QuantumCloudStackInstanceInfo, self).update_result(instance, result)
        if instance:
...
def main():
    ...
    acs_instance_info = QuantumCloudStackInstanceInfo(module=module)
