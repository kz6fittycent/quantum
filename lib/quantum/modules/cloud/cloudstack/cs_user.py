...
class QuantumCloudStackUser(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackUser, self).__init__(module)
        self.returns = {
            'username': 'username',
    ...
    def get_result(self, user):
        super(QuantumCloudStackUser, self).get_result(user)
        if user:
...
def main():
    ...
    acs_acc = QuantumCloudStackUser(module)
