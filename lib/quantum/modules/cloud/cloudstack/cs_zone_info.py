...
class QuantumCloudStackZoneInfo(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackZoneInfo, self).__init__(module)
        self.returns = {
            'dns1': 'dns1',
            'dns2': 'dns2',
    ...
    def get_zone(self):
        if self.module.params['zone']:
            zones = [super(QuantumCloudStackZoneInfo, self).get_zone()]
        else:
...
def main():
    ...
    acs_zone_info = QuantumCloudStackZoneInfo(module=module)
