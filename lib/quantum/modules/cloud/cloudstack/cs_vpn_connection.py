...
class QuantumCloudStackVpnConnection(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackVpnConnection, self).__init__(module)
        self.returns = {
            'dpd': 'dpd',
    ...
    def get_result(self, vpn_conn):
        super(QuantumCloudStackVpnConnection, self).get_result(vpn_conn)
        if vpn_conn:
...
def main():
    ...
    acs_vpn_conn = QuantumCloudStackVpnConnection(module)
