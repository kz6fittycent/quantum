...
from quantum.module_utils.facts import quantum_collector, default_collectors
...
class CloudStackFacts(object):
    ...
    def __init__(self):
        collector = quantum_collector.get_quantum_collector(all_collector_classes=default_collectors.collectors,
...
def main():
    ...
    cs_facts_result = dict(changed=False, quantum_facts=cs_facts)
