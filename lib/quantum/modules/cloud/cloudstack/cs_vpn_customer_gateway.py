...
class QuantumCloudStackVpnCustomerGateway(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackVpnCustomerGateway, self).__init__(module)
        self.returns = {
            'dpd': 'dpd',
    ...
    def get_result(self, vpn_customer_gateway):
        super(QuantumCloudStackVpnCustomerGateway, self).get_result(vpn_customer_gateway)
        if vpn_customer_gateway:
...
def main():
    ...
    acs_vpn_cgw = QuantumCloudStackVpnCustomerGateway(module)
