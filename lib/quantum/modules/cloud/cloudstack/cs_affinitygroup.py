...
class QuantumCloudStackAffinityGroup(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackAffinityGroup, self).__init__(module)
        self.returns = {
            'type': 'affinity_type',
        }
...
def main():
    ...
    acs_ag = QuantumCloudStackAffinityGroup(module)
