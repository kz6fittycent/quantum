...
class QuantumCloudStackNetworkOffering(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackNetworkOffering, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, network_offering):
        super(QuantumCloudStackNetworkOffering, self).get_result(network_offering)
        if network_offering:
...
def main():
    ...
    acs_network_offering = QuantumCloudStackNetworkOffering(module)
