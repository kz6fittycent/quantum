...
class QuantumCloudStackVPCOffering(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackVPCOffering, self).__init__(module)
        self.returns = {
...
def main():
    ...
    acs_vpc_offering = QuantumCloudStackVPCOffering(module)
