...
class QuantumCloudStackInstanceNicSecondaryIp(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackInstanceNicSecondaryIp, self).__init__(module)
    ...
    def get_result(self, nic):
        super(QuantumCloudStackInstanceNicSecondaryIp, self).get_result(nic)
...
def main():
    ...
    acs_instance_nic_secondaryip = QuantumCloudStackInstanceNicSecondaryIp(module)
