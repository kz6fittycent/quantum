...
class QuantumCloudStackDiskOffering(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackDiskOffering, self).__init__(module)
        self.returns = {
            'disksize': 'disk_size',
    ...
    def get_result(self, disk_offering):
        super(QuantumCloudStackDiskOffering, self).get_result(disk_offering)
        if disk_offering:
...
def main():
    ...
    acs_do = QuantumCloudStackDiskOffering(module)
