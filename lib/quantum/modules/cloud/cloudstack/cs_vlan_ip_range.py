...
class QuantumCloudStackVlanIpRange(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackVlanIpRange, self).__init__(module)
        self.returns = {
            'startip': 'start_ip',
            'endip': 'end_ip',
...
def main():
    ...
    acs_vlan_ip_range = QuantumCloudStackVlanIpRange(module)
