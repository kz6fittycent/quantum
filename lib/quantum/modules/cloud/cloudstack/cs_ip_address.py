...
class QuantumCloudStackIPAddress(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackIPAddress, self).__init__(module)
        self.returns = {
...
def main():
    ...
    acs_ip_address = QuantumCloudStackIPAddress(module)
