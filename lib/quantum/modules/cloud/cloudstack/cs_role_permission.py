...
class QuantumCloudStackRolePermission(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackRolePermission, self).__init__(module)
...
def main():
    ...
    acs_role_perm = QuantumCloudStackRolePermission(module)
