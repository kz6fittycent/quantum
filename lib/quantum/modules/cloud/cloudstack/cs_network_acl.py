...
class QuantumCloudStackNetworkAcl(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackNetworkAcl, self).__init__(module)
...
def main():
    ...
    acs_network_acl = QuantumCloudStackNetworkAcl(module)
