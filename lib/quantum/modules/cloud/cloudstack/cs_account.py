...
class QuantumCloudStackAccount(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackAccount, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, account):
        super(QuantumCloudStackAccount, self).get_result(account)
        if account:
...
def main():
    ...
    acs_acc = QuantumCloudStackAccount(module)
