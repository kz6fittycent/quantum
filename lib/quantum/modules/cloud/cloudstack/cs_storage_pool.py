...
class QuantumCloudStackStoragePool(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackStoragePool, self).__init__(module)
        self.returns = {
    ...
    def get_result(self, pool):
        super(QuantumCloudStackStoragePool, self).get_result(pool)
        if pool:
...
def main():
    ...
    acs_storage_pool = QuantumCloudStackStoragePool(module)
