...
class QuantumCloudStackPod(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackPod, self).__init__(module)
        self.returns = {
            'endip': 'end_ip',
            'startip': 'start_ip',
            'gateway': 'gateway',
    ...
    def get_result(self, pod):
        ...
        super(QuantumCloudStackPod, self).get_result(pod)
        return self.result
...
def main():
    ...
    acs_pod = QuantumCloudStackPod(module)
