...
class QuantumCloudStackInstanceGroup(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackInstanceGroup, self).__init__(module)
...
def main():
    ...
    acs_ig = QuantumCloudStackInstanceGroup(module)
