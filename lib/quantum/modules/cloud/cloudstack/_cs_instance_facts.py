...
class QuantumCloudStackInstanceFacts(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackInstanceFacts, self).__init__(module)
        self.instance = None
        self.returns = {
            'group': 'group',
    ...
    def get_result(self, instance):
        super(QuantumCloudStackInstanceFacts, self).get_result(instance)
        if instance:
...
def main():
    ...
    acs_instance_facts = QuantumCloudStackInstanceFacts(module=module)
