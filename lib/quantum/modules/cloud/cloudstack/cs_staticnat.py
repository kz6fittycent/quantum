...
class QuantumCloudStackStaticNat(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackStaticNat, self).__init__(module)
        self.returns = {
...
def main():
    ...
    acs_static_nat = QuantumCloudStackStaticNat(module)
