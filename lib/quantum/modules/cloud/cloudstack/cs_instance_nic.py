...
from quantum.module_utils.cloudstack import (QuantumCloudStack,
                                             cs_argument_spec,
                                             cs_required_together)


class QuantumCloudStackInstanceNic(QuantumCloudStack):

    def __init__(self, module):
        super(QuantumCloudStackInstanceNic, self).__init__(module)
        self.nic = None
        self.returns = {
    ...
    def get_result(self, nic):
        super(QuantumCloudStackInstanceNic, self).get_result(nic)
...
def main():
    ...
    acs_nic = QuantumCloudStackInstanceNic(module)
