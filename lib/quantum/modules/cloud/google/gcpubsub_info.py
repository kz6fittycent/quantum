...
description:
    ...
    - This module was called C(gcpubsub_facts) before Quantum 2.9. The usage did not change.
requirements:
  - "python >= 2.6"
  - "google-auth >= 0.5.0"
...
from quantum.module_utils.gcp import check_min_pkg_version, get_google_cloud_credentials
