...
from quantum.module_utils.gcp import check_params, get_google_api_client, GCPUtils
from quantum.module_utils.six import string_types


USER_AGENT_PRODUCT = 'quantum-url_map'
...
def _validate_params(params):
    ...
    :param params: Quantum dictionary containing configuration.
    :type  params: ``dict``
...
def _validate_path_matcher_params(path_matchers):
    ...
    :param path_matchers: Quantum dictionary containing path_matchers
                     configuration (only).
...
def _validate_host_rules_params(host_rules):
    ...
    :param host_rules: Quantum dictionary containing host_rules
                     configuration (only).
...
def _build_url_map_dict(params, project_id=None):
    """
    Reformat services in Quantum Params.

    :param params: Params from QuantumModule object
    :type params: ``dict``
...
def create_url_map(client, params, project_id):
    ...
    :param params: Dictionary of arguments from QuantumModule.
    :type params:  ``dict``
