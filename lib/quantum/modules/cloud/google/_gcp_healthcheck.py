...
from quantum.module_utils.gcp import get_google_api_client, GCPUtils


USER_AGENT_PRODUCT = 'quantum-healthcheck'
...
def _validate_healthcheck_params(params):
    ...
    Simple validation has already assumed by QuantumModule.
...
def _build_healthcheck_dict(params):
    """
    Reformat services in Quantum Params for GCP.
