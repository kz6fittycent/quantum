...
description:
    - This module can create and destroy Google Compute Engine C(loadbalancer)
      ...
      the quantum module simplifies the configuration by following the
      libcloud model.
...
from quantum.module_utils.gce import USER_AGENT_PRODUCT, USER_AGENT_VERSION, gce_connect, unexpected_error_msg
