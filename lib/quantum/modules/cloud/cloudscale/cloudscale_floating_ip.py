...
class QuantumCloudscaleFloatingIP(QuantumCloudscaleBase):

    def __init__(self, module):
        super(QuantumCloudscaleFloatingIP, self).__init__(module)
...
def main():
    ...
    floating_ip = QuantumCloudscaleFloatingIP(module)
