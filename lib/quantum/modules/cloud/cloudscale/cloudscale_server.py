...
- name: Start cloudscale.ch server
  cloudscale_server:
    ...
    image: debian-8
    flavor: flex-4
    ssh_keys: ssh-rsa XXXXXXXXXX...XXXX quantum@cloudscale
...
- name: Start second cloudscale.ch server
  cloudscale_server:
    ...
    image: ubuntu-16.04
    flavor: flex-8
    ssh_keys: ssh-rsa XXXXXXXXXXX quantum@cloudscale
    server_groups: shiny-group
    api_token: xxxxxx
...
from quantum.module_utils.cloudscale import QuantumCloudscaleBase, cloudscale_argument_spec
...
class QuantumCloudscaleServer(QuantumCloudscaleBase):

    def __init__(self, module):
        super(QuantumCloudscaleServer, self).__init__(module)
...
def main():
    ...
    cloudscale_server = QuantumCloudscaleServer(module)
