...
from quantum.module_utils.cloudscale import (QuantumCloudscaleBase,
                                             cloudscale_argument_spec,
                                             )


class QuantumCloudscaleVolume(QuantumCloudscaleBase):

    def __init__(self, module):
        super(QuantumCloudscaleVolume, self).__init__(module)
        self._info = {}
...
def main():
    ...
    cloudscale_volume = QuantumCloudscaleVolume(module)
