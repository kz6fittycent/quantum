...
class QuantumCloudscaleServerGroup(QuantumCloudscaleBase):

    def __init__(self, module, namespace):
        super(QuantumCloudscaleServerGroup, self).__init__(module)
        self._info = {}
...
def main():
    ...
    cloudscale_server_group = QuantumCloudscaleServerGroup(module, 'cloudscale_server_group')
