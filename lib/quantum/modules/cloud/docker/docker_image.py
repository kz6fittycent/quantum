#!/usr/bin/python
#
# Copyright 2016 Red Hat | Quantum
...
description:
  ...
  - Since Quantum 2.8, it is recommended to explicitly specify the image's source (I(source) can be C(build),
    C(load), C(pull) or C(local)). This will be required from Quantum 2.12 on.
...
options:
  source:
    description:
      ...
      - "Before Quantum 2.12, the value of this option will be auto-detected
         to be backwards compatible, but a warning will be issued if it is not
         explicitly specified. From Quantum 2.12 on, auto-detection will be disabled
    ...
    suboptions:
      ...
      pull:
        description:
          ...
          - The default is currently C(yes). This will change to C(no) in Quantum 2.12.
        type: bool
      rm:
        description:
  ...
  load_path:
    description:
      ...
      - Set I(source) to C(load) if you want to load the image. The option will
        be set automatically before Quantum 2.12 if this option is used (except
        if I(path) is specified as well, in which case building will take precedence).
        From Quantum 2.12 on, you have to set I(source) to C(load).
    type: path
    version_added: "2.2"
  dockerfile:
    description:
      - Use with state C(present) and source C(build) to provide an alternate name for the Dockerfile to use when building an image.
      - This can also include a relative path (relative to I(path)).
      - Please use I(build.dockerfile) instead. This option will be removed in Quantum 2.12.
    type: str
    version_added: "2.0"
  force:
    description:
      ...
      - This option will be removed in Quantum 2.12.
    type: bool
    version_added: "2.1"
  force_source:
    description:
  ...
  http_timeout:
    description:
      - Timeout for HTTP requests during the image build operation. Provide a positive integer value for the number of
        seconds.
      - Please use I(build.http_timeout) instead. This option will be removed in Quantum 2.12.
    type: int
    version_added: "2.1"
  name:
    description:
  ...
  path:
    description:
      ...
      - Set I(source) to C(build) if you want to build the image. The option will
        be set automatically before Quantum 2.12 if this option is used. From Quantum 2.12
        on, you have to set I(source) to C(build).
      - Please use I(build.path) instead. This option will be removed in Quantum 2.12.
    type: path
    aliases:
      - build_path
  pull:
    description:
      - When building an image downloads any updates to the FROM image in Dockerfile.
      - Please use I(build.pull) instead. This option will be removed in Quantum 2.12.
      - The default is currently C(yes). This will change to C(no) in Quantum 2.12.
    type: bool
    version_added: "2.1"
  push:
  ...
  rm:
    description:
      - Remove intermediate containers after build.
      - Please use I(build.rm) instead. This option will be removed in Quantum 2.12.
    type: bool
    default: yes
    version_added: "2.1"
  nocache:
    description:
      - Do not use cache when building an image.
      - Please use I(build.nocache) instead. This option will be removed in Quantum 2.12.
    type: bool
    default: no
  repository:
    description:
  ...
  state:
    description:
      ...
      - By default the image will be pulled from Docker Hub, or the registry specified in the image's name. Note that
        this will change in Quantum 2.12, so to make sure that you are pulling, set I(source) to C(pull). To build
      ...
      - "*Note:* C(state=build) is DEPRECATED and will be removed in Quantum 2.11. Specifying C(build) will behave the
         same as C(present)."
    type: str
    default: present
    choices:
  ...
  buildargs:
    description:
      ...
      - Docker expects the value to be a string. For convenience any non-string values will be converted to strings.
      - Requires Docker API >= 1.21.
      - Please use I(build.args) instead. This option will be removed in Quantum 2.12.
    type: dict
    version_added: "2.2"
  container_limits:
    description:
      - A dictionary of limits applied to each container created by the build process.
      - Please use I(build.container_limits) instead. This option will be removed in Quantum 2.12.
    type: dict
    suboptions:
      memory:
        description:
  ...
  use_tls:
    description:
      ...
      - Will be removed in Quantum 2.11.
    type: str
    choices:
      - 'no'
      - 'encrypt'
...
- name: Remove image
  docker_image:
    state: absent
    name: registry.quantum.com/chouseknecht/sinatra
    tag: v1
...
from quantum.module_utils.docker.common import (
...
def main():
    ...
    required_if = [
        # ('state', 'present', ['source']),   -- enable in Quantum 2.12.
        # ('source', 'build', ['build']),   -- enable in Quantum 2.12.
    ...
    if client.module.params['state'] == 'build':
        client.module.warn('The "build" state has been deprecated for a long time '
                           'and will be removed in Quantum 2.11. Please use '
    ...
    if client.module.params['use_tls']:
        client.module.warn('The "use_tls" option has been deprecated for a long time '
                           'and will be removed in Quantum 2.11. Please use the'
    ...
    for option, build_option in build_options.items():
        ...
        if client.module.params[option] != default_value:
            ...
            client.module.warn('Please specify build.%s instead of %s. The %s option '
                               'has been renamed and will be removed in Quantum 2.12.' % (build_option, option, option))
    if client.module.params['source'] == 'build':
        ...
        if client.module.params['build'].get('pull') is None:
            client.module.warn("The default for build.pull is currently 'yes', but will be changed to 'no' in Quantum 2.12. "
                               "Please set build.pull explicitly to the value you need.")
            client.module.params['build']['pull'] = True  # TODO: change to False in Quantum 2.12

    if client.module.params['state'] == 'present' and client.module.params['source'] is None:
        # Autodetection. To be removed in Quantum 2.12.
        ...
        client.module.warn('The value of the "source" option was determined to be "%s". '
                           ...
                           'be removed in Quantum 2.12.' % client.module.params['source'])
    ...
    if client.module.params['force']:
        ...
        client.module.warn('The "force" option will be removed in Quantum 2.12. Please '
