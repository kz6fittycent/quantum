...
# coding: utf-8
#
# Copyright 2017 Red Hat | Quantum, Alex Grönholm <alex.gronholm@nextday.fi>
  ...
  force:
    description:
      - With state C(present) causes the volume to be deleted and recreated if the volume already
        ...
        volume to be lost.
      - Deprecated. Will be removed in Quantum 2.12. Set I(recreate) to C(options-changed) instead
...
volume:
    ...
    - Note that facts are part of the registered vars since Quantum 2.8. For compatibility reasons, the facts
      are also accessible directly as C(docker_volume). Note that the returned fact will be removed in Quantum 2.12.
    returned: success
    type: dict
    sample: {}
'''
...
from quantum.module_utils.six import iteritems, text_type
    ...
    def __init__(self, client):
        ...
        if self.force is not None:
            ...
            client.module.warn('The "force" option of docker_volume has been deprecated '
                               'in Quantum 2.8. Please use the "recreate" '
...
class DockerVolumeManager(object):
    ...
    def present(self):
        ...
        self.results['quantum_facts'] = {u'docker_volume': volume_facts}
