...
options:
  ...
  join_token:
    description:
      ...
      - If this value is specified, the corresponding value in the return values will be censored by Quantum.
              ...
              Worker:
                  description:
                    ...
                    - "B(Note:) if this value has been specified as I(join_token), the value here will not
                       ...
                       make sure your coupling/role does not depend on this return value!"
                  returned: success
                  type: str
...
from quantum.module_utils.docker.swarm import QuantumDockerSwarmClient
...
class TaskParameters(DockerBaseClass):
    ...
    @staticmethod
    def from_quantum_params(client):
...
class SwarmManager(DockerBaseClass):
    ...
    def __init__(self, client, results):
        ...
        self.parameters = TaskParameters.from_quantum_params(client)
    ...
    def __update_swarm(self):
        try:
            ...
            if self.differences.empty:
                ...
                self.results['changed'] = False
                return
            update_parameters = TaskParameters.from_quantum_params(self.client)
...
def main():
    ...
    client = QuantumDockerSwarmClient(
