...
description:
     ...
     - Adds to the metadata of new configs 'quantum_key', an encrypted hash representation of the data, which is then used
       in future runs to test if a config has changed. If 'quantum_key' is not present, then a config will not be updated
