...
- 'To acquire XenAPI Python library, just run C(pip install XenAPI) on your Quantum Control Node. The library can also be found inside
   ...
   Quantum Control Node to use it. Latest version of the library can also be acquired from GitHub:
...
from quantum.module_utils.common.network import is_mac
from quantum.module_utils import six
from quantum.module_utils.xenserver import (xenserver_common_argument_spec, XAPI, XenServerObject, get_object_ref,
...
class XenServerVM(XenServerObject):
    ...
    def __init__(self, module):
        ...
        Args:
            module: Reference to Quantum module object.
        """
    ...
    def deploy(self):
        ...
        try:
            ...
            # Support for Quantum check mode.
                        ...
                        for network_change_list in change['networks_changed']:
                            if network_change_list:
                                ...
                                if self.vm_params['customization_agent'] == "native":
                                    ...
                                    # make those changes in coupling manually.
        ...
        try:
            ...
            if self.module.params['hardware']:
                ...
                if num_cpus is not None:
                    # Kept for compatibility with older Quantum versions that
