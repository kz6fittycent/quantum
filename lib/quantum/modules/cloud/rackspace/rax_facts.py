...
- name: Gather info about servers
  ...
  tasks:
    ...
    - name: Map some facts
      set_fact:
        quantum_ssh_host: "{{ rax_accessipv4 }}"
'''
...
from quantum.module_utils.rax import (rax_argument_spec,
...
def rax_facts(module, address, name, server_id):
    ...
    if len(servers) > 1:
        ...
        quantum_facts = rax_to_dict(servers[0], 'server')

    module.exit_json(changed=changed, quantum_facts=quantum_facts)
