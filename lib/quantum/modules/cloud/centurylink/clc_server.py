...
description:
  - An Quantum module to Create, Delete, Start and Stop servers in CenturyLink Cloud.
version_added: "2.0"
options:
  additional_disks:
    description:
...
class ClcServer:
    ...
    def _define_module_argument_spec():
        """
        Define the argument spec for the quantum module
    ...
    def _find_group(module, datacenter, lookup_group=None):
        ...
        :param module: the QuantumModule instance
    ...
    def _find_group_recursive(module, group_list, lookup_group):
        ...
        :param module: the QuantumModule instance to use
    ...
    def _set_user_agent(clc):
        if hasattr(clc, 'SetRequestsSession'):
            agent_string = "ClcQuantumModule/" + __version__
...
def main():
    ...
    module = QuantumModule(supports_check_mode=True, **argument_dict)
