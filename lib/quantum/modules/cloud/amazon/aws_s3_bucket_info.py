...
description:
    ...
    - This module was called C(aws_s3_bucket_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(aws_s3_bucket_info) module no longer returns C(quantum_facts)!
version_added: "2.4"
...
from quantum.module_utils.ec2 import (boto3_conn, ec2_argument_spec, HAS_BOTO3, camel_dict_to_snake_dict,
...
def main():
    ...
    module = QuantumModule(argument_spec=ec2_argument_spec(), supports_check_mode=True)
    ...
    # Send exit
    if is_old_facts:
        module.exit_json(msg="Retrieved s3 facts.", quantum_facts=result)
    else:
