...
options:
  ...
  managed_policy:
    description:
      - A list of managed policy ARNs or, since Quantum 2.4, a list of either managed policy ARNs or friendly names.
...
from quantum.module_utils.ec2 import camel_dict_to_snake_dict, ec2_argument_spec, get_aws_connection_info, boto3_conn, compare_policies
