...
from quantum.module_utils.ec2 import boto3_conn, ec2_argument_spec, get_aws_connection_info, HAS_BOTO3
...
def main():
    ...
    module = QuantumModule(argument_spec=argument_spec, required_if=required_if)
