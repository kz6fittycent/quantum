...
description:
  ...
  - This module was called C(elasticache_facts) before Quantum 2.9. The usage did not change.
version_added: "2.5"
options:
  name:
    description:
...
from quantum.module_utils.ec2 import camel_dict_to_snake_dict, AWSRetry
...
def get_elasticache_clusters(client, module, region):
    ...
    for cluster in clusters:
        ...
        cluster['tags'] = boto3_tag_list_to_quantum_dict(tags)
