...
description:
    ...
    - This module was called C(ec2_vpc_dhcp_option_facts) before Quantum 2.9. The usage did not change.
version_added: "2.2"
requirements: [ boto3 ]
...
from quantum.module_utils.ec2 import (ec2_argument_spec, boto3_conn, HAS_BOTO3,
                                      quantum_dict_to_boto3_filter_list, get_aws_connection_info,
...
def get_dhcp_options_info(dhcp_option):
    dhcp_option_info = {'DhcpOptionsId': dhcp_option['DhcpOptionsId'],
                        ...
                        'Tags': boto3_tag_list_to_quantum_dict(dhcp_option.get('Tags', [{'Value': '', 'Key': 'Name'}]))}
    return dhcp_option_info


def list_dhcp_options(client, module):
    params = dict(Filters=quantum_dict_to_boto3_filter_list(module.params.get('filters')))
