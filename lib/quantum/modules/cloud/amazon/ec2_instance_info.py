...
description:
    ...
    - This module was called C(ec2_instance_facts) before Quantum 2.9. The usage did not change.
version_added: "2.4"
author:
...
from quantum.module_utils.ec2 import (quantum_dict_to_boto3_filter_list,
                                      boto3_conn, boto3_tag_list_to_quantum_dict, camel_dict_to_snake_dict,
...
def list_ec2_instances(connection, module):
    ...
    for instance in snaked_instances:
        instance['tags'] = boto3_tag_list_to_quantum_dict(instance.get('tags', []), 'key', 'value')
