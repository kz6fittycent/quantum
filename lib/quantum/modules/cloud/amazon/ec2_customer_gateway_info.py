...
description:
    ...
    - This module was called C(ec2_customer_gateway_facts) before Quantum 2.9. The usage did not change.
version_added: "2.5"
requirements: [ boto3 ]
...
def list_customer_gateways(connection, module):
    ...
    if snaked_customer_gateways:
        for customer_gateway in snaked_customer_gateways:
            customer_gateway['tags'] = boto3_tag_list_to_quantum_dict(customer_gateway.get('tags', []))
