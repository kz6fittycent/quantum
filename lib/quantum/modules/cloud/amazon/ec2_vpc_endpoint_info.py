...
description:
  ...
  - This module was called C(ec2_vpc_endpoint_facts) before Quantum 2.9. The usage did not change.
version_added: "2.4"
requirements: [ boto3 ]
options:
  query:
...
from quantum.module_utils.ec2 import (ec2_argument_spec, boto3_conn, get_aws_connection_info,
                                      quantum_dict_to_boto3_filter_list, HAS_BOTO3, camel_dict_to_snake_dict, AWSRetry)
