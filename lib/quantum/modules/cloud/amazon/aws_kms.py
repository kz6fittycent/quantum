...
from quantum.module_utils.ec2 import ec2_argument_spec
from quantum.module_utils.ec2 import AWSRetry, camel_dict_to_snake_dict
from quantum.module_utils.ec2 import boto3_tag_list_to_quantum_dict, quantum_dict_to_boto3_tag_list
from quantum.module_utils.ec2 import compare_aws_tags, compare_policies
...
def get_key_details(connection, module, key_id):
    ...
    result['tags'] = boto3_tag_list_to_quantum_dict(tags, 'TagKey', 'TagValue')
...
def create_key(connection, module):
    params = dict(BypassPolicyLockoutSafetyCheck=False,
                  Tags=quantum_dict_to_boto3_tag_list(module.params['tags'], tag_name_key_name='TagKey', tag_value_key_name='TagValue'),
