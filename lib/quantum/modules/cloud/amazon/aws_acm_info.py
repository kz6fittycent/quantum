...
description:
  ...
  - This module was called C(aws_acm_facts) before Quantum 2.9. The usage did not change.
version_added: "2.5"
options:
  domain_name:
    description:
...
from quantum.module_utils.ec2 import camel_dict_to_snake_dict, AWSRetry, HAS_BOTO3, boto3_tag_list_to_quantum_dict
    ...
    for certificate in certificates:
        ...
        try:
            ...
            module.fail_json(msg="Couldn't obtain tags for domain %s" % certificate['DomainName'],
                             exception=traceback.format_exc(),
                             **camel_dict_to_snake_dict(e.response))
        cert_data['tags'] = boto3_tag_list_to_quantum_dict(tags)
