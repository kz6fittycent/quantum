...
- name: note that encrypted volumes are only supported in >= Quantum 2.4
  ec2_lc:
    name: special
    image_id: ami-XXX
    key_name: default
...
import traceback
from quantum.module_utils.ec2 import (get_aws_connection_info, ec2_argument_spec, ec2_connect, camel_dict_to_snake_dict, get_ec2_security_group_ids_from_names,
