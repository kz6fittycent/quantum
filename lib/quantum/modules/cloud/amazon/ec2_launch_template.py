...
from quantum.module_utils.common.dict_transformations import camel_dict_to_snake_dict, snake_dict_to_camel_dict
from quantum.module_utils.ec2 import quantum_dict_to_boto3_tag_list, AWSRetry, boto3_tag_list_to_quantum_dict, quantum_dict_to_boto3_tag_list
...
def format_module_output(module):
    ...
    for v in template_versions:
        for ts in (v['launch_template_data'].get('tag_specifications') or []):
            ts['tags'] = boto3_tag_list_to_quantum_dict(ts.pop('tags'))
