#!/usr/bin/python
# Copyright (c) 2014-2017 Quantum Project
...
description:
  ...
  - This module was called C(rds_snapshot_facts) before Quantum 2.9. The usage did not change.
options:
...
from quantum.module_utils.ec2 import AWSRetry, boto3_tag_list_to_quantum_dict, camel_dict_to_snake_dict
...
def common_snapshot_info(module, conn, method, prefix, params):
    ...
    for snapshot in results:
        try:
            snapshot['Tags'] = boto3_tag_list_to_quantum_dict(conn.list_tags_for_resource(ResourceName=snapshot['%sArn' % prefix],
