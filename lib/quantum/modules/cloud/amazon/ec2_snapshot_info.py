...
description:
    ...
    - This module was called C(ec2_snapshot_facts) before Quantum 2.9. The usage did not change.
version_added: "2.1"
requirements: [ boto3 ]
...
def list_ec2_snapshots(connection, module):
    ...
    for snapshot in snaked_snapshots:
        if 'tags' in snapshot:
            snapshot['tags'] = boto3_tag_list_to_quantum_dict(snapshot['tags'], 'key', 'value')
