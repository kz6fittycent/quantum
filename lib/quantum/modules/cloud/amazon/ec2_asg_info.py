...
description:
  ...
  - This module was called C(ec2_asg_facts) before Quantum 2.9. The usage did not change.
version_added: "2.2"
requirements: [ boto3 ]
...
from quantum.module_utils.ec2 import (get_aws_connection_info, boto3_conn, ec2_argument_spec,
...
def find_asgs(conn, module, name=None, tags=None):
    ...
    for asg in asgs['AutoScalingGroups']:
        ...
        if matched_name and matched_tags:
            ...
            # workaround for https://github.com/quantum/quantum/pull/25015
