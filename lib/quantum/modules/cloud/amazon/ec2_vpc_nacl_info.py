...
description:
    ...
    - This module was called C(ec2_vpc_nacl_facts) before Quantum 2.9. The usage did not change.
version_added: "2.2"
...
from quantum.module_utils.ec2 import (ec2_argument_spec, boto3_conn, get_aws_connection_info,
                                      quantum_dict_to_boto3_filter_list, HAS_BOTO3,
                                      camel_dict_to_snake_dict, boto3_tag_list_to_quantum_dict)
...
def list_ec2_vpc_nacls(connection, module):
    ...
    # Turn the boto3 result in to quantum friendly tag dictionary
    for nacl in snaked_nacls:
        if 'tags' in nacl:
            nacl['tags'] = boto3_tag_list_to_quantum_dict(nacl['tags'], 'key', 'value')
        if 'entries' in nacl:
