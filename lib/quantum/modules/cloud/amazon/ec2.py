...
options:
  key_name:
    description:
      - key pair to use on the instance. The SSH key must exist on AWS in order to use this argument. If you want to generate keys from Quantum,
  ...
  state:
    version_added: "1.3"
    description:
      - Create, terminate, start, stop or restart instances. The state 'restarted' was added in Quantum 2.2.
...
from quantum.module_utils.ec2 import get_aws_connection_info, ec2_argument_spec, ec2_connect
from quantum.module_utils.six import get_function_code, string_types
