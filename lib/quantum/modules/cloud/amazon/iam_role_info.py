...
description:
    ...
    - This module was called C(iam_role_facts) before Quantum 2.9. The usage did not change.
version_added: "2.5"
requirements: [ boto3 ]
author:
...
iam_roles:
  ...
  contains:
    arn:
      ...
      returned: always
      type: str
      sample: arn:aws:iam::123456789012:role/QuantumTestRole
    ...
    managed_policies:
      ...
      contains:
        policy_arn:
          ...
          returned: always
          type: str
          sample: arn:aws:iam::123456789012:policy/QuantumTestEC2Policy
        policy_name:
          description: Name of managed policy
          returned: always
          type: str
          sample: QuantumTestEC2Policy
    instance_profiles:
      ...
      contains:
        arn:
          ...
          returned: always
          type: str
          sample: arn:aws:iam::123456789012:instance-profile/QuantumTestEC2Policy
        create_date:
