...
description:
    ...
    - This module was called C(ec2_group_facts) before Quantum 2.9. The usage did not change.
version_added: "2.3"
requirements: [ boto3 ]
author:
...
from quantum.module_utils.ec2 import (ec2_argument_spec, boto3_conn, HAS_BOTO3, get_aws_connection_info,
                                      boto3_tag_list_to_quantum_dict, quantum_dict_to_boto3_filter_list,
...
def main():
    ...
    try:
        security_groups = connection.describe_security_groups(
            Filters=quantum_dict_to_boto3_filter_list(sanitized_filters)
        )
    ...
    for security_group in security_groups['SecurityGroups']:
        # Modify boto3 tags list to be quantum friendly dict
        # but don't camel case tags
        security_group = camel_dict_to_snake_dict(security_group)
        security_group['tags'] = boto3_tag_list_to_quantum_dict(security_group.get('tags', {}), tag_name_key_name='key', tag_value_key_name='value')
