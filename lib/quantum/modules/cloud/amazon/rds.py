...
instance:
    ...
    contains:
        ...
        endpoint:
            ...
            returned: when RDS instance exists
            type: str
            sample: "my-quantum-database.asdfaosdgih.us-east-1.rds.amazonaws.com"
        port:
...
from quantum.module_utils.ec2 import HAS_BOTO, connect_to_aws, ec2_argument_spec, get_aws_connection_info
