...
from quantum.module_utils.ec2 import (QuantumAWSError, HAS_BOTO, connect_to_aws, ec2_argument_spec,
...
def main():
    ...
    quantum_facts = {'ec2_elbs': [lb.name for lb in elb_man.lbs]}
    ec2_facts_result = dict(changed=elb_man.changed, quantum_facts=quantum_facts)
