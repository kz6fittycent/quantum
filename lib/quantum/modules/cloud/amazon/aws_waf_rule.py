...
rule:
  ...
  contains:
    metric_name:
      ...
      returned: always
      type: str
      sample: quantumtest1234rule
    name:
      description: Friendly name for the rule
      returned: always
      type: str
      sample: quantum-test-1234_rule
    predicates:
...
from quantum.module_utils.ec2 import boto3_conn, get_aws_connection_info, ec2_argument_spec
from quantum.module_utils.ec2 import camel_dict_to_snake_dict
from quantum.module_utils.aws.waf import run_func_with_change_token_backoff, list_rules_with_backoff, list_regional_rules_with_backoff, MATCH_LOOKUP
from quantum.module_utils.aws.waf import get_web_acl_with_backoff, list_web_acls_with_backoff, list_regional_web_acls_with_backoff
