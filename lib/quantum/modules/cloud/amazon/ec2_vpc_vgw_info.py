...
description:
    ...
    - This module was called C(ec2_vpc_vgw_facts) before Quantum 2.9. The usage did not change.
version_added: "2.3"
requirements: [ boto3 ]
options:
  filters:
...
from quantum.module_utils.ec2 import (ec2_argument_spec, get_aws_connection_info, boto3_conn,
                                      camel_dict_to_snake_dict, quantum_dict_to_boto3_filter_list, HAS_BOTO3)
