...
description:
  ...
  - This module was called C(ec2_vpc_peering_facts) before Quantum 2.9. The usage did not change.
version_added: "2.4"
requirements: [ boto3 ]
options:
  peer_connection_ids:
...
from quantum.module_utils.ec2 import (boto3_tag_list_to_quantum_dict,
                                      ec2_argument_spec, boto3_conn, get_aws_connection_info,
                                      quantum_dict_to_boto3_filter_list, HAS_BOTO3, camel_dict_to_snake_dict)
...
def main():
    ...
    # Turn the boto3 result in to quantum friendly_snaked_names
    ...
    for peer in results:
        peer['tags'] = boto3_tag_list_to_quantum_dict(peer.get('tags', []))
