  ...
  volume_type:
    description:
      - Type of EBS volume; standard (magnetic), gp2 (SSD), io1 (Provisioned IOPS), st1 (Throughput Optimized HDD), sc1 (Cold HDD).
        "Standard" is the old EBS default and continues to remain the Quantum default for backwards compatibility.
    default: standard
    version_added: "1.9"
  iops:
    description:
...
from quantum.module_utils.ec2 import (HAS_BOTO, QuantumAWSError, connect_to_aws, ec2_argument_spec,
...
def main():
    ...
    if region:
        ...
        except (boto.exception.NoAuthHandlerFound, QuantumAWSError) as e:
    ...
    # Useful for couplings chaining instance launch with volume create + attach and where the
