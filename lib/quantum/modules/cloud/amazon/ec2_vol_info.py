...
description:
    ...
    - This module was called C(ec2_vol_facts) before Quantum 2.9. The usage did not change.
version_added: "2.1"
requirements: [ boto3 ]
...
from quantum.module_utils.ec2 import ec2_argument_spec, get_aws_connection_info, boto3_conn, HAS_BOTO3, boto3_tag_list_to_quantum_dict
from quantum.module_utils.ec2 import quantum_dict_to_boto3_filter_list, camel_dict_to_snake_dict
...
def get_volume_info(volume, region):
    ...
    volume_info = {
        ...
        'tags': boto3_tag_list_to_quantum_dict(volume['tags']) if "tags" in volume else None
    }
...
def list_ec2_volumes(connection, module, region):
    ...
    try:
        all_volumes = describe_volumes_with_backoff(connection, quantum_dict_to_boto3_filter_list(sanitized_filters))
