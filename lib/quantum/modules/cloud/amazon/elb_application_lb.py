...
from quantum.module_utils.ec2 import boto3_conn, get_aws_connection_info, camel_dict_to_snake_dict, ec2_argument_spec, \
    boto3_tag_list_to_quantum_dict, compare_aws_tags, HAS_BOTO3

from quantum.module_utils.aws.elbv2 import ApplicationLoadBalancer, ELBListeners, ELBListener, ELBListenerRules, ELBListenerRule
from quantum.module_utils.aws.elb_utils import get_elb_listener_rules
...
def create_or_update_elb(elb_obj):
    ...
    if elb_obj.elb:
        ...
        if elb_obj.tags is not None:
            ...
            tags_need_modify, tags_to_delete = compare_aws_tags(boto3_tag_list_to_quantum_dict(elb_obj.elb['tags']),
                                                                boto3_tag_list_to_quantum_dict(elb_obj.tags), elb_obj.purge_tags)
            if tags_to_delete:
    ...
    # Change tags to quantum friendly dict
    snaked_elb['tags'] = boto3_tag_list_to_quantum_dict(snaked_elb['tags'])
