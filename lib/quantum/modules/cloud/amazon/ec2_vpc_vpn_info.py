...
description:
    ...
    - This module was called C(ec2_vpc_vpn_facts) before Quantum 2.9. The usage did not change.
version_added: "2.6"
requirements: [ boto3 ]
...
from quantum.module_utils.ec2 import (quantum_dict_to_boto3_filter_list, ec2_argument_spec,
...
def list_vpn_connections(connection, module):
    ...
    params['Filters'] = quantum_dict_to_boto3_filter_list(module.params.get('filters'))
    ...
    if snaked_vpn_connections:
        for vpn_connection in snaked_vpn_connections:
            vpn_connection['tags'] = boto3_tag_list_to_quantum_dict(vpn_connection.get('tags', []))
