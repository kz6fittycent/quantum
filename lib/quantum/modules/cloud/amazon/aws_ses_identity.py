...
from quantum.module_utils.ec2 import camel_dict_to_snake_dict, AWSRetry, get_aws_connection_info
...
def get_identity_notifications(connection, module, identity, retries=0, retryDelay=10):
    ...
    for attempt in range(0, retries + 1):
        ...
        # See: https://github.com/quantum/quantum/issues/36065
...
def main():
    ...
    # the quantum build runs multiple instances of the test in parallel that's caused throttling
