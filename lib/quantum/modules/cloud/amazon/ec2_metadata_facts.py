...
- debug:
  ...
  when: quantum_ec2_instance_type == "t1.micro"
'''
...
quantum_facts:
    ...
    contains:
        ...
        quantum_ec2_block_device_mapping_ebsN:
            ...
            type: str
            sample: "/dev/xvdb"
        quantum_ec2_block_device_mapping_ephemeralN:
            ...
            type: str
            sample: "/dev/xvdc"
        quantum_ec2_block_device_mapping_root:
            description:
        ...
        quantum_ec2_iam_security_credentials_<role name>:
            ...
            type: str
            sample: ""
        quantum_ec2_iam_security_credentials_<role name>_accesskeyid:
            description: IAM role access key ID.
            type: str
            sample: ""
        quantum_ec2_iam_security_credentials_<role name>_code:
            description: IAM code.
            type: str
            sample: "Success"
        quantum_ec2_iam_security_credentials_<role name>_expiration:
            description: IAM role credentials expiration time.
            type: str
            sample: "2017-05-12T09:11:41Z"
        quantum_ec2_iam_security_credentials_<role name>_lastupdated:
            description: IAM role last updated time.
            type: str
            sample: "2017-05-12T02:40:44Z"
        quantum_ec2_iam_security_credentials_<role name>_secretaccesskey:
            description: IAM role secret access key.
            type: str
            sample: ""
        quantum_ec2_iam_security_credentials_<role name>_token:
            description: IAM role token.
            type: str
            sample: ""
        quantum_ec2_iam_security_credentials_<role name>_type:
            description: IAM role type.
            type: str
            sample: "AWS-HMAC"
        quantum_ec2_instance_action:
            description: Notifies the instance that it should reboot in preparation for bundling.
            type: str
            sample: "none"
        quantum_ec2_instance_id:
            description: The ID of this instance.
            type: str
            sample: "i-XXXXXXXXXXXXXXXXX"
        quantum_ec2_instance_identity_document:
            description: JSON containing instance attributes, such as instance-id, private IP address, etc.
            type: str
            sample: ""
        quantum_ec2_instance_identity_document_accountid:
            description: ""
            type: str
            sample: "012345678901"
        quantum_ec2_instance_identity_document_architecture:
            description: Instance system architecture.
            type: str
            sample: "x86_64"
        quantum_ec2_instance_identity_document_availabilityzone:
            description: The Availability Zone in which the instance launched.
            type: str
            sample: "us-east-1a"
        quantum_ec2_instance_identity_document_billingproducts:
            description: Billing products for this instance.
            type: str
            sample: ""
        quantum_ec2_instance_identity_document_devpayproductcodes:
            description: Product codes for the launched AMI.
            type: str
            sample: ""
        quantum_ec2_instance_identity_document_imageid:
            description: The AMI ID used to launch the instance.
            type: str
            sample: "ami-01234567"
        quantum_ec2_instance_identity_document_instanceid:
            description: The ID of this instance.
            type: str
            sample: "i-0123456789abcdef0"
        quantum_ec2_instance_identity_document_instancetype:
            description: The type of instance.
            type: str
            sample: "m4.large"
        quantum_ec2_instance_identity_document_kernelid:
            description: The ID of the kernel launched with this instance, if applicable.
            type: str
            sample: ""
        quantum_ec2_instance_identity_document_pendingtime:
            description: The instance pending time.
            type: str
            sample: "2017-05-11T20:51:20Z"
        quantum_ec2_instance_identity_document_privateip:
            description:
                - The private IPv4 address of the instance.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
            sample: "10.0.0.1"
        quantum_ec2_instance_identity_document_ramdiskid:
            description: The ID of the RAM disk specified at launch time, if applicable.
            type: str
            sample: ""
        quantum_ec2_instance_identity_document_region:
            description: The Region in which the instance launched.
            type: str
            sample: "us-east-1"
        quantum_ec2_instance_identity_document_version:
            description: Identity document version.
            type: str
            sample: "2010-08-31"
        quantum_ec2_instance_identity_pkcs7:
            description: Used to verify the document's authenticity and content against the signature.
            type: str
            sample: ""
        quantum_ec2_instance_identity_rsa2048:
            description: Used to verify the document's authenticity and content against the signature.
            type: str
            sample: ""
        quantum_ec2_instance_identity_signature:
            description: Data that can be used by other parties to verify its origin and authenticity.
            type: str
            sample: ""
        quantum_ec2_instance_type:
            description: The type of instance.
            type: str
            sample: "m4.large"
        quantum_ec2_local_hostname:
            description:
                - The private IPv4 DNS hostname of the instance.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
            sample: "ip-10-0-0-1.ec2.internal"
        quantum_ec2_local_ipv4:
            description:
                - The private IPv4 address of the instance.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
        ...
        quantum_ec2_metrics_vhostmd:
            description: Metrics.
            type: str
            sample: ""
        quantum_ec2_network_interfaces_macs_<mac address>_device_number:
            description:
            ...
            type: str
            sample: "0"
        quantum_ec2_network_interfaces_macs_<mac address>_interface_id:
            description: The elastic network interface ID.
            type: str
            sample: "eni-12345678"
        quantum_ec2_network_interfaces_macs_<mac address>_ipv4_associations_<ip address>:
            description: The private IPv4 addresses that are associated with each public-ip address and assigned to that interface.
            type: str
            sample: ""
        quantum_ec2_network_interfaces_macs_<mac address>_ipv6s:
            description: The IPv6 addresses associated with the interface. Returned only for instances launched into a VPC.
            type: str
            sample: ""
        quantum_ec2_network_interfaces_macs_<mac address>_local_hostname:
            description: The interface's local hostname.
            type: str
            sample: ""
        quantum_ec2_network_interfaces_macs_<mac address>_local_ipv4s:
            description: The private IPv4 addresses associated with the interface.
            type: str
            sample: ""
        quantum_ec2_network_interfaces_macs_<mac address>_mac:
            description: The instance's MAC address.
            type: str
            sample: "00:11:22:33:44:55"
        quantum_ec2_network_interfaces_macs_<mac address>_owner_id:
            description:
            ...
            type: str
            sample: "01234567890"
        quantum_ec2_network_interfaces_macs_<mac address>_public_hostname:
            description:
        ...
        quantum_ec2_network_interfaces_macs_<mac address>_public_ipv4s:
            description: The Elastic IP addresses associated with the interface. There may be multiple IPv4 addresses on an instance.
            type: str
            sample: "1.2.3.4"
        quantum_ec2_network_interfaces_macs_<mac address>_security_group_ids:
        ...
        quantum_ec2_network_interfaces_macs_<mac address>_security_groups:
        ...
        quantum_ec2_network_interfaces_macs_<mac address>_subnet_id:
        ...
        quantum_ec2_network_interfaces_macs_<mac address>_subnet_ipv4_cidr_block:
            ...
            type: str
            sample: "10.0.1.0/24"
        quantum_ec2_network_interfaces_macs_<mac address>_subnet_ipv6_cidr_blocks:
            ...
            type: str
            sample: ""
        quantum_ec2_network_interfaces_macs_<mac address>_vpc_id:
            description: The ID of the VPC in which the interface resides. Returned only for instances launched into a VPC.
            type: str
            sample: "vpc-0123456"
        quantum_ec2_network_interfaces_macs_<mac address>_vpc_ipv4_cidr_block:
            ...
            type: str
            sample: "10.0.0.0/16"
        quantum_ec2_network_interfaces_macs_<mac address>_vpc_ipv4_cidr_blocks:
            description: The IPv4 CIDR block of the VPC in which the interface resides. Returned only for instances launched into a VPC.
            type: str
            sample: "10.0.0.0/16"
        quantum_ec2_network_interfaces_macs_<mac address>_vpc_ipv6_cidr_blocks:
            ...
            type: str
            sample: ""
        quantum_ec2_placement_availability_zone:
            description: The Availability Zone in which the instance launched.
            type: str
            sample: "us-east-1a"
        quantum_ec2_placement_region:
            description: The Region in which the instance launched.
            type: str
            sample: "us-east-1"
        quantum_ec2_product_codes:
        ...
        quantum_ec2_services_partition:
            ...
            type: str
            sample: "aws"
        quantum_ec2_spot_termination_time:
            description:
...
from quantum.module_utils.six.moves.urllib.parse import quote
...
class Ec2Metadata(object):
    ...
    def run(self):
        ...
        if 'quantum_ec2_instance_identity_document_region' in data:
            data['quantum_ec2_placement_region'] = data['quantum_ec2_instance_identity_document_region']
        return data
...
def main():
    ...
    ec2_metadata_facts_result = dict(changed=False, quantum_facts=ec2_metadata_facts)
