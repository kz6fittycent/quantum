...
try:
    import botocore
    from quantum.module_utils.ec2 import quantum_dict_to_boto3_tag_list, boto3_conn
    HAS_BOTO3 = True
except ImportError:
    HAS_BOTO3 = False

from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.ec2 import QuantumAWSError, connect_to_aws, ec2_argument_spec, get_aws_connection_info
    ...
    try:
        ...
        if tags:
            ...
            boto3_dynamodb.tag_resource(
                ...
                ':table/' +
                table_name,
                Tags=quantum_dict_to_boto3_tag_list(tags))
            result['tags'] = tags
...
def main():
    ...
    except (NoAuthHandlerFound, QuantumAWSError) as e:
