...
notes:
   - There may be a delay between the time the EIP is assigned and when
     ...
     pause to delay further coupling execution until the instance is reachable,
     if necessary.
...
from quantum.module_utils.ec2 import HAS_BOTO, ec2_argument_spec, ec2_connect
...
def generate_tag_dict(module, tag_name, tag_value):
    # type: (QuantumModule, str, str) -> Optional[Dict]
