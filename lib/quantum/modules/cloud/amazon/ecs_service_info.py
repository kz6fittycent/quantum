...
description:
    ...
    - This module was called C(ecs_service_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(ecs_service_info) module no longer returns C(quantum_facts)!
version_added: "2.1"
author:
...
from quantum.module_utils.ec2 import ec2_argument_spec, AWSRetry
...
def main():
    ...
    if is_old_facts:
        module.exit_json(changed=False, quantum_facts=ecs_info, **ecs_info)
    else:
