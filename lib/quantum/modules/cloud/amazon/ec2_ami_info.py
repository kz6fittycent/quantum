...
description:
  ...
  - This module was called C(ec2_ami_facts) before Quantum 2.9. The usage did not change.
author:
...
from quantum.module_utils.ec2 import (boto3_conn, ec2_argument_spec, get_aws_connection_info, quantum_dict_to_boto3_filter_list,
...
def list_ec2_images(ec2_client, module):
    ...
    filters = quantum_dict_to_boto3_filter_list(filters)
    ...
    for image in images:
        try:
            image['tags'] = boto3_tag_list_to_quantum_dict(image.get('tags', []))
