...
from quantum.module_utils.ec2 import ec2_argument_spec, boto3_conn
from quantum.module_utils.ec2 import snake_dict_to_camel_dict
...
def main():
    ...
    module = QuantumAWSModule(argument_spec=argument_spec, supports_check_mode=False, mutually_exclusive=[['distribution_id', 'alias']])
