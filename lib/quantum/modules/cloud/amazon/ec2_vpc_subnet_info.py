...
description:
    ...
    - This module was called C(ec2_vpc_subnet_facts) before Quantum 2.9. The usage did not change.
version_added: "2.1"
...
def describe_subnets(connection, module):
    ...
    for subnet in response['Subnets']:
        ...
        subnet_info[-1]['tags'] = boto3_tag_list_to_quantum_dict(subnet.get('Tags', []))
