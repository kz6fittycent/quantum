...
description:
    - This module allows the management of AWS Lambda functions aliases via the Quantum
...
from quantum.module_utils.ec2 import (HAS_BOTO3, boto3_conn, camel_dict_to_snake_dict, ec2_argument_spec,
...
class AWSConnection:
    ...
    def __init__(self, quantum_obj, resources, boto3_=True):

        try:
            self.region, self.endpoint, aws_connect_kwargs = get_aws_connection_info(quantum_obj, boto3=boto3_)
            ...
            for resource in resources:
                ...
                self.resource_client[resource] = boto3_conn(quantum_obj, **aws_connect_kwargs)
            ...
            quantum_obj.fail_json(msg="Unable to connect, authorize or access resource: {0}".format(e))
...
def validate_params(module, aws):
    ...
    :param module: Quantum module reference
