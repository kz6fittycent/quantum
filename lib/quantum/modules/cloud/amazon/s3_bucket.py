...
from quantum.module_utils.ec2 import compare_policies, ec2_argument_spec, boto3_tag_list_to_quantum_dict, quantum_dict_to_boto3_tag_list
from quantum.module_utils.ec2 import get_aws_connection_info, boto3_conn, AWSRetry
...
def put_bucket_tagging(s3_client, bucket_name, tags):
    s3_client.put_bucket_tagging(Bucket=bucket_name, Tagging={'TagSet': quantum_dict_to_boto3_tag_list(tags)})
...
def get_current_bucket_tags_dict(s3_client, bucket_name):
    ...
    return boto3_tag_list_to_quantum_dict(current_tags)
