...
options:
    ...
    network_mode:
        description:
            ...
            - C(awsvpc) mode was added in Quantum 2.5
        required: false
        default: bridge
...
from quantum.module_utils.ec2 import boto3_conn, camel_dict_to_snake_dict, ec2_argument_spec, get_aws_connection_info
