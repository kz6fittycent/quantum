...
description:
  ...
  - This module was called C(rds_instance_facts) before Quantum 2.9. The usage did not change.
options:
...
from quantum.module_utils.ec2 import quantum_dict_to_boto3_filter_list, boto3_tag_list_to_quantum_dict, AWSRetry, camel_dict_to_snake_dict
...
def instance_info(module, conn):
    ...
    if filters:
        params['Filters'] = quantum_dict_to_boto3_filter_list(filters)
    ...
    for instance in results:
        try:
            instance['Tags'] = boto3_tag_list_to_quantum_dict(conn.list_tags_for_resource(ResourceName=instance['DBInstanceArn'],
