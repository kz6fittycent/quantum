...
from quantum.module_utils.ec2 import (AWSRetry, camel_dict_to_snake_dict, compare_aws_tags,
                                      quantum_dict_to_boto3_tag_list, boto3_tag_list_to_quantum_dict)
from quantum.module_utils.six import string_types
from quantum.module_utils._text import to_native
from quantum.module_utils.network.common.utils import to_subnet
    ...
    try:
        ...
        if tags_to_update:
            if not module.check_mode:
                tags = quantum_dict_to_boto3_tag_list(tags_to_update)
                vpc_obj = AWSRetry.backoff(
                    delay=1, tries=5,
                    catch_extra_error_codes=['InvalidVpcID.NotFound'],
                ...
                expected_tags = boto3_tag_list_to_quantum_dict(tags)
...
def main():
    ...
    if state == 'present':
        ...
        final_state['tags'] = boto3_tag_list_to_quantum_dict(final_state.get('tags', []))
