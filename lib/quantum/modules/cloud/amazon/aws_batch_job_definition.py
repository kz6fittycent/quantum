...
from quantum.module_utils.aws.batch import AWSConnection, cc, set_api_params
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.ec2 import ec2_argument_spec, HAS_BOTO3
...
# logging.basicConfig(filename='quantum_debug.log')
