...
description:
    ...
    - This module was called C(aws_kms_facts) before Quantum 2.9. The usage did not change.
version_added: "2.5"
...
from quantum.module_utils.ec2 import AWSRetry, camel_dict_to_snake_dict, HAS_BOTO3
