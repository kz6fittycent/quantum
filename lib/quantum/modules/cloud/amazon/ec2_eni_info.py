...
description:
    ...
    - This module was called C(ec2_eni_facts) before Quantum 2.9. The usage did not change.
version_added: "2.0"
...
from quantum.module_utils.ec2 import quantum_dict_to_boto3_filter_list, boto3_conn
from quantum.module_utils.ec2 import boto3_tag_list_to_quantum_dict, camel_dict_to_snake_dict
from quantum.module_utils.ec2 import ec2_argument_spec, get_aws_connection_info
...
def list_eni(connection, module):
    ...
    if module.params.get("filters") is None:
        ...
        filters = quantum_dict_to_boto3_filter_list(module.params.get("filters"))
    ...
    # Modify boto3 tags list to be quantum friendly dict and then camel_case
    camel_network_interfaces = []
    for network_interface in network_interfaces_result:
        network_interface['TagSet'] = boto3_tag_list_to_quantum_dict(network_interface['TagSet'])
