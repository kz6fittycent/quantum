...
description:
    ...
    - This module was called C(cloudwatchlogs_log_group_facts) before Quantum 2.9. The usage did not change.
version_added: "2.5"
author:
...
from quantum.module_utils.ec2 import HAS_BOTO3, camel_dict_to_snake_dict, boto3_conn, ec2_argument_spec, get_aws_connection_info
