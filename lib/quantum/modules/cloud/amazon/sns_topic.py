...
sns_topic:
  ...
  contains:
    ...
    name:
      ...
      returned: always
      type: str
      sample: quantum-test-dummy-topic
    owner:
    ...
    policy:
      ...
      sample: >
        ...
        "Action":"sns:Subscribe","Resource":"arn:aws:sns:us-east-2:111111111111:quantum-test-dummy-topic","Condition":{"StringEquals":{"sns:Protocol":"email"}}}]}
    state:
    ...
    topic_arn:
      ...
      returned: when topic is owned by this AWS account
      type: str
      sample: arn:aws:sns:us-east-2:111111111111:quantum-test-dummy-topic
    topic_created:
...
from quantum.module_utils.ec2 import compare_policies, AWSRetry, camel_dict_to_snake_dict
