...
class QuantumEc2TgwInfo(object):
    ...
    def describe_transit_gateways(self):
        ...
        module  : QuantumAWSModule object
        connection  : boto3 client connection object
        """
        # collect parameters
        filters = quantum_dict_to_boto3_filter_list(self._module.params['filters'])
        ...
        for transit_gateway in response['TransitGateways']:
            ...
            # convert tag list to quantum dict
            transit_gateway_info[-1]['tags'] = boto3_tag_list_to_quantum_dict(transit_gateway.get('Tags', []))
...
def main():
    ...
    tgwf_manager = QuantumEc2TgwInfo(module=module, results=results)
