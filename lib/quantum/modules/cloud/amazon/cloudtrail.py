...
from quantum.module_utils.ec2 import (boto3_conn, ec2_argument_spec, get_aws_connection_info,
                                      HAS_BOTO3, quantum_dict_to_boto3_tag_list,
                                      boto3_tag_list_to_quantum_dict, camel_dict_to_snake_dict)
...
def tag_trail(module, client, tags, trail_arn, curr_tags=None, dry_run=False):
    ...
    module : QuantumModule object
    client : boto3 client connection object
    tags : Dict of tags converted from quantum_dict to boto3 list of dicts
    ...
    if curr_tags is None:
        ...
        adds = quantum_dict_to_boto3_tag_list(tags)
    else:
...
def get_trail_facts(module, client, name):
    ...
    if len(trail_resp['trailList']):
        ...
        trail['tags'] = boto3_tag_list_to_quantum_dict(tags_list['ResourceTagList'][0]['TagsList'])
...
def main():
    ...
    module = QuantumModule(argument_spec=argument_spec, supports_check_mode=True, required_together=required_together, required_if=required_if)
