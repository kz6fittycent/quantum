...
notes:
    ...
    - This module was called C(ecs_taskdefinition_facts) before Quantum 2.9. The usage did not change.
description:
...
from quantum.module_utils.ec2 import camel_dict_to_snake_dict, boto3_conn, ec2_argument_spec, get_aws_connection_info
