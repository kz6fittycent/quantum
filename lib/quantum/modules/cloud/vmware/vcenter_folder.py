...
from quantum.module_utils.vmware import vmware_argument_spec, PyVmomi, find_datacenter_by_name, wait_for_task, get_all_objs
    ...
    def ensure(self):
        ...
        if state == 'present':
            ...
            try:
                ...
                # and the coupling should simply carry on with other tasks.
                # User will have to take care of this exception
                # https://github.com/quantum/quantum/issues/35388#issuecomment-362283078
