...
from quantum.module_utils.vmware import vmware_argument_spec, PyVmomi, find_datastore_by_name, find_obj
...
class VMwareHostDatastore(PyVmomi):
    def __init__(self, module):
        ...
        # NOTE: The below parameter is deprecated starting from Quantum v2.11
