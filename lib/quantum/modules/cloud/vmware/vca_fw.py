...
from quantum.module_utils.vca import VcaError, vca_argument_spec, vca_login
...
def validate_fw_rules(fw_rules):
    for rule in fw_rules:
        ...
        rule['description'] = rule.get('description', 'rule added by Quantum')
