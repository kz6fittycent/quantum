...
from quantum.module_utils.six.moves.urllib.parse import urlencode, quote
from quantum.module_utils._text import to_native
from quantum.module_utils.urls import open_url
from quantum.module_utils.vmware import PyVmomi, vmware_argument_spec, wait_for_task, get_parent_datacenter
import os
