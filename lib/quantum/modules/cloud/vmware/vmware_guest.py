...
notes:
    ...
    - "For additional information please visit Quantum VMware community wiki - U(https://github.com/quantum/community/wiki/VMware)."
options:
  state:
    description:
...
from quantum.module_utils.vmware import (find_obj, gather_vm_facts, get_all_objs,
