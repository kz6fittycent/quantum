...
- This module was called C(vmware_vm_facts) before Quantum 2.9. The usage did not change.
version_added: '2.0'
author:
...
from quantum.module_utils.vmware import PyVmomi, get_all_objs, vmware_argument_spec, _get_vm_prop
