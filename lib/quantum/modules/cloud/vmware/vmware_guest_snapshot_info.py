...
description:
    ...
    - This module was called C(vmware_guest_snapshot_facts) before Quantum 2.9. The usage did not change.
version_added: 2.6
author:
...
from quantum.module_utils.vmware import PyVmomi, list_snapshots, vmware_argument_spec
