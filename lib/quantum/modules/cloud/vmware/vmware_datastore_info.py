...
description:
    ...
    - This module was called C(vmware_datastore_facts) before Quantum 2.9. The usage did not change.
version_added: 2.5
author:
...
from quantum.module_utils.vmware import (PyVmomi, vmware_argument_spec, get_all_objs,
