...
options:
    ...
    mtu:
        description:
            ...
            - Required parameter for C(state) both C(present) and C(absent), before Quantum 2.6 version.
            - Required only if C(state) is set to C(present), for Quantum 2.6 and onwards.
...
from quantum.module_utils.vmware import (
