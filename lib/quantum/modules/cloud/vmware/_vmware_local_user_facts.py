...
notes:
    - Tested on ESXi 6.5
    - The C(full_name), C(principal), and C(user_group) properties are deprecated starting from Quantum v2.12
requirements:
    - "python >= 2.6"
    - PyVmomi
    ...
    def gather_user_facts(self):
        ...
        if user_accounts:
            for user in user_accounts:
                temp_user = dict()
                # NOTE: the properties full_name, principal, and user_group are deprecated starting from Quantum v2.12
