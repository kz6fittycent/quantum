...
description:
    ...
    - This module was called C(vmware_cluster_facts) before Quantum 2.9. The usage did not change.
version_added: '2.6'
author:
...
from quantum.module_utils.vmware import PyVmomi, vmware_argument_spec, find_datacenter_by_name, find_cluster_by_name
