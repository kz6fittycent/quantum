...
from quantum.module_utils.vmware import (PyVmomi, vmware_argument_spec, wait_for_task, find_cluster_by_name,
...
class VmwareVmHostRuleDrs(PyVmomi):
    ...
    def get_msg(self):
        """
        Returns message for Quantum result
        Args: none
