...
EXAMPLES = '''
# a coupling task line:
- virt:
    name: alpha
    state: running

# /usr/bin/quantum invocations
# quantum host -m virt -a "name=alpha command=status"
# quantum host -m virt -a "name=alpha command=get_xml"
# quantum host -m virt -a "name=alpha command=create uri=lxc:///"
