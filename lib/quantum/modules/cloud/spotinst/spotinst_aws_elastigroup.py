...
description:
  - Can create, update, or delete Spotinst AWS Elastigroups
    ...
    token = <YOUR TOKEN>
    Full documentation available at https://help.spotinst.com/hc/en-us/articles/115003530285-Quantum-
requirements:
  - python >= 2.7
  - spotinst_sdk >= 1.0.38
options:
...
capacity_fields = (dict(quantum_field_name='min_size',
                        spotinst_field_name='minimum'),
                   dict(quantum_field_name='max_size',
...
iam_fields = (dict(quantum_field_name='iam_role_name',
                   spotinst_field_name='name'),
              dict(quantum_field_name='iam_role_arn',
...
action_fields = (dict(quantum_field_name='action_type',
    ...
    if item is not None:
        for field in fields:
            if isinstance(field, dict):
                quantum_field_name = field['quantum_field_name']
                spotinst_field_name = field['spotinst_field_name']
            else:
                quantum_field_name = field
                spotinst_field_name = field
            if item.get(quantum_field_name) is not None:
                setattr(new_obj, spotinst_field_name, item.get(quantum_field_name))
