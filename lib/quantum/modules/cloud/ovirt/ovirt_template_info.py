...
description:
    ...
    - This module was called C(ovirt_template_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(ovirt_template_info) module no longer returns C(quantum_facts)!
notes:
