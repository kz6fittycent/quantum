...
description:
    ...
    - This module was called C(ovirt_storage_domain_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(ovirt_storage_domain_info) module no longer returns C(quantum_facts)!
notes:
