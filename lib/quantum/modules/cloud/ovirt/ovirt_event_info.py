...
description:
    ...
    - This module was called C(ovirt_event_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(ovirt_event_info) module no longer returns C(quantum_facts)!
options:
    case_sensitive:
        description:
