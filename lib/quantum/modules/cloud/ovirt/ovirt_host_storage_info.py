...
description:
    ...
    - This module was called C(ovirt_host_storage_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(ovirt_host_storage_info) module no longer returns C(quantum_facts)!
options:
    host:
        description:
