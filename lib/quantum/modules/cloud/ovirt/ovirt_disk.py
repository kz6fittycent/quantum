...
options:
    ...
    content_type:
        description:
            ...
            - The Hosted Engine disk content types are available with Engine 4.3+ and Quantum 2.8
    ...
    storage_domains:
        description:
            ...
            - "There is no reliable way to achieve idempotency, so every time
               ...
               your coupling accordingly to not copy the disks all the time. This
    ...
    image_provider:
        description:
            ...
            - "There is no reliable way to achieve idempotency, so every time
               ...
               your coupling accordingly to not export the disk all the time.
...
from quantum.module_utils.six.moves.http_client import HTTPSConnection, IncompleteRead
