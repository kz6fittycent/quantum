...
description:
    ...
    - This module was called C(ovirt_disk_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(ovirt_disk_info) module no longer returns C(quantum_facts)!
notes:
