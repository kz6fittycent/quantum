...
description:
    - "This module authenticates to oVirt/RHV engine and creates SSO token, which should be later used in
       ...
       This module returns an Quantum fact called I(ovirt_auth). Every module can use this
...
# in yaml file.
# This is mainly useful when using Quantum Tower or AWX, as it will work
...
from quantum.module_utils.ovirt import check_sdk
