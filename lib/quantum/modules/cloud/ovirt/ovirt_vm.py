...
options:
    ...
    type:
        description:
            ...
            - Default value is set by oVirt/RHV engine.
            - I(high_performance) is supported since Quantum 2.5 and oVirt/RHV 4.2.
...
notes:
    ...
    - "If you update a VM parameter that requires a reboot, the oVirt engine always creates a new snapshot for the VM,
      and an Quantum coupling will report this as changed."
...
- name: Run VM with cloud init
  ovirt_vm:
    ...
    high_availability_priority: 50  # Available from Quantum 2.5
    cloud_init:
...
- name: Run VM with cloud init, with multiple network interfaces
  ovirt_vm:
    ...
    - nic_name: eth1
      ...
      nic_gateway: 10.34.63.254
      nic_on_boot: true
    # IP version 6 parameters are supported since quantum 2.9
    - nic_name: eth2
