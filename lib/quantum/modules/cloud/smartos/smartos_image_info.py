...
description:
    ...
    - This module was called C(smartos_image_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(smartos_image_info) module no longer returns C(quantum_facts)!
version_added: "2.2"
...
# in quantum_facts['smartos_images'] and can be used as follows.
...
def main():
    ...
    if is_old_facts:
        module.exit_json(quantum_facts=data)
    else:
