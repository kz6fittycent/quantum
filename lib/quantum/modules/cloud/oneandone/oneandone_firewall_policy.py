...
- oneandone_firewall_policy:
    ...
    name: quantum-firewall-policy
    description: Testing creation of firewall policies with quantum
    rules:
     -
       protocol: TCP
       port_from: 80
...
- oneandone_firewall_policy:
    auth_token: oneandone_private_api_key
    state: update
    firewall_policy: quantum-firewall-policy
    name: quantum-firewall-policy-updated
    description: Testing creation of firewall policies with quantum - updated

# Add server to a firewall policy.

- oneandone_firewall_policy:
    auth_token: oneandone_private_api_key
    firewall_policy: quantum-firewall-policy-updated
    add_server_ips:
