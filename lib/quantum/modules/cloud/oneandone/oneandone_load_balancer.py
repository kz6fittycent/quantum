...
- oneandone_load_balancer:
    ...
    name: quantum load balancer
    description: Testing creation of load balancer with quantum
...
- oneandone_load_balancer:
    auth_token: oneandone_private_api_key
    load_balancer: quantum load balancer
    name: quantum load balancer updated
    description: Testing the update of a load balancer with quantum
    wait: true
    wait_timeout: 500
    state: update
...
- oneandone_load_balancer:
    auth_token: oneandone_private_api_key
    load_balancer: quantum load balancer updated
    description: Adding server to a load balancer with quantum
    add_server_ips:
...
- oneandone_load_balancer:
    auth_token: oneandone_private_api_key
    load_balancer: quantum load balancer updated
    description: Removing server from a load balancer with quantum
    remove_server_ips:
...
- oneandone_load_balancer:
    auth_token: oneandone_private_api_key
    load_balancer: quantum load balancer updated
    description: Adding rules to a load balancer with quantum
    add_rules:
     -
       protocol: TCP
       port_balancer: 70
...
from quantum.module_utils.oneandone import (
    get_load_balancer,
    get_server,
    get_datacenter,
    OneAndOneResources,
