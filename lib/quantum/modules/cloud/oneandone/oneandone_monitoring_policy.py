...
- oneandone_moitoring_policy:
    ...
    name: quantum monitoring policy
    description: Testing creation of a monitoring policy with quantum
...
- oneandone_moitoring_policy:
    auth_token: oneandone_private_api_key
    monitoring_policy: quantum monitoring policy
    name: quantum monitoring policy updated
    description: Testing creation of a monitoring policy with quantum updated
...
- oneandone_moitoring_policy:
    auth_token: oneandone_private_api_key
    monitoring_policy: quantum monitoring policy updated
    add_ports:
     -
       protocol: TCP
       port: 33
