...
description:
    - This module allows the user to create, delete and update virtual cloud networks(VCNs) in OCI.
      The complete Oracle Cloud Infrastructure Quantum Modules can be downloaded from
      U(https://github.com/oracle/oci-quantum-modules/releases).
version_added: "2.8"
options:
    cidr_block:
...
vcn:
    ...
    sample: {
            ...
            "vcn_domain_name": "quantumvcn.oraclevcn.com"
        }
"""

from quantum.module_utils.basic import QuantumModule, missing_required_lib
from quantum.module_utils.oracle import oci_utils
