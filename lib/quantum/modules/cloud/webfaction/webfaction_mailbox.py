...
# Create webfaction mailbox using Quantum and the Webfaction API
...
description:
    - Add or remove mailboxes on a Webfaction account. Further documentation at https://github.com/quentinsf/quantum-webfaction.
