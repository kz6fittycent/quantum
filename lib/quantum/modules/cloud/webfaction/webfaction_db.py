...
# Create a webfaction database using Quantum and the Webfaction API
...
description:
    - Add or remove a database on a Webfaction host. Further documentation at https://github.com/quentinsf/quantum-webfaction.
