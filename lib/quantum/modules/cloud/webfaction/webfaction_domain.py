...
# Create Webfaction domains and subdomains using Quantum and the Webfaction API
...
description:
    - Add or remove domains or subdomains on a Webfaction host. Further documentation at https://github.com/quentinsf/quantum-webfaction.
...
notes:
    ...
    - >
      You can run couplings that use this on a local machine, or on a Webfaction host, or elsewhere, since the scripts use the remote webfaction API.
