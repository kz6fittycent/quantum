...
# Create Webfaction website using Quantum and the Webfaction API
...
description:
    - Add or remove a website on a Webfaction host.  Further documentation at https://github.com/quentinsf/quantum-webfaction.
