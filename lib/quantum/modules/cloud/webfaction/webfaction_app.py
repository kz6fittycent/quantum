...
# Create a Webfaction application using Quantum and the Webfaction API
#
...
description:
    - Add or remove applications on a Webfaction host. Further documentation at U(https://github.com/quentinsf/quantum-webfaction).
