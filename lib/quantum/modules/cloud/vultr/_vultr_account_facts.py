...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_account_facts
'''
...
class QuantumVultrAccountFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrAccountFacts, self).__init__(module, "vultr_account_facts")
...
def main():
    ...
    account_facts = QuantumVultrAccountFacts(module)
