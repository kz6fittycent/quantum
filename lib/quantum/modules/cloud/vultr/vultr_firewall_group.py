...
class QuantumVultrFirewallGroup(Vultr):

    def __init__(self, module):
        super(QuantumVultrFirewallGroup, self).__init__(module, "vultr_firewall_group")
...
def main():
    ...
    vultr_firewall_group = QuantumVultrFirewallGroup(module)
