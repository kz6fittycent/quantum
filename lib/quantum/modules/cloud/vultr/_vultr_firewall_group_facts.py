...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_firewall_group_facts
'''
...
class QuantumVultrFirewallGroupFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrFirewallGroupFacts, self).__init__(module, "vultr_firewall_group_facts")
...
def main():
    ...
    fw_group_facts = QuantumVultrFirewallGroupFacts(module)
