...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_dns_domain_facts
'''
...
class QuantumVultrDnsDomainFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrDnsDomainFacts, self).__init__(module, "vultr_dns_domain_facts")
...
def main():
    ...
    domain_facts = QuantumVultrDnsDomainFacts(module)
