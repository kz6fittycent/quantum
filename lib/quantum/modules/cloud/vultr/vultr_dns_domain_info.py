...
class QuantumVultrDnsDomainInfo(Vultr):

    def __init__(self, module):
        super(QuantumVultrDnsDomainInfo, self).__init__(module, "vultr_dns_domain_info")
...
def main():
    ...
    domain_info = QuantumVultrDnsDomainInfo(module)
