...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_network_facts
'''
...
class QuantumVultrNetworkFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrNetworkFacts, self).__init__(module, "vultr_network_facts")
...
def main():
    ...
    network_facts = QuantumVultrNetworkFacts(module)
