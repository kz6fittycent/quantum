...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_os_facts
'''
...
class QuantumVultrOSFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrOSFacts, self).__init__(module, "vultr_os_facts")
...
def main():
    ...
    os_facts = QuantumVultrOSFacts(module)
