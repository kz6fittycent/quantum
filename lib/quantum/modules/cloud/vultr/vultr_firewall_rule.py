...
class QuantumVultrFirewallRule(Vultr):

    def __init__(self, module):
        super(QuantumVultrFirewallRule, self).__init__(module, "vultr_firewall_rule")
    ...
    def get_result(self, resource):
        ...
        return super(QuantumVultrFirewallRule, self).get_result(resource)
...
def main():
    ...
    vultr_firewall_rule = QuantumVultrFirewallRule(module)
