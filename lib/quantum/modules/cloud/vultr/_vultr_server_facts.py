...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_server_facts
'''
...
class QuantumVultrServerFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrServerFacts, self).__init__(module, "vultr_server_facts")
...
def main():
    ...
    server_facts = QuantumVultrServerFacts(module)
