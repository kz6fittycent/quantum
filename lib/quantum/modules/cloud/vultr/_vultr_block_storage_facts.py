...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_block_storage_facts
'''
...
class QuantumVultrBlockStorageFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrBlockStorageFacts, self).__init__(module, "vultr_block_storage_facts")
...
def main():
    ...
    volume_facts = QuantumVultrBlockStorageFacts(module)
