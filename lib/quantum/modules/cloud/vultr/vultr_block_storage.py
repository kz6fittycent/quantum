...
class QuantumVultrBlockStorage(Vultr):

    def __init__(self, module):
        super(QuantumVultrBlockStorage, self).__init__(module, "vultr_block_storage")
...
def main():
    ...
    vultr_block_storage = QuantumVultrBlockStorage(module)
