...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_region_facts
'''
...
class QuantumVultrRegionFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrRegionFacts, self).__init__(module, "vultr_region_facts")
...
def main():
    ...
    region_facts = QuantumVultrRegionFacts(module)
