...
class QuantumVultrStartupScript(Vultr):

    def __init__(self, module):
        super(QuantumVultrStartupScript, self).__init__(module, "vultr_startup_script")
...
def main():
    ...
    vultr_script = QuantumVultrStartupScript(module)
