...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_startup_script_facts
'''
...
from quantum.module_utils.vultr import (
    Vultr,
    vultr_argument_spec,
)


class QuantumVultrStartupScriptFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrStartupScriptFacts, self).__init__(module, "vultr_startup_script_facts")
...
def main():
    ...
    startupscript_facts = QuantumVultrStartupScriptFacts(module)
    ...
    module.exit_json(quantum_facts=quantum_facts, **result)
