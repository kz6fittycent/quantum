...
class QuantumVultrStartupScriptInfo(Vultr):

    def __init__(self, module):
        super(QuantumVultrStartupScriptInfo, self).__init__(module, "vultr_startup_script_info")
...
def main():
    ...
    startupscript_info = QuantumVultrStartupScriptInfo(module)
