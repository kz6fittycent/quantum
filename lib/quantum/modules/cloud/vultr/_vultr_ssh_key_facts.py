...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_ssh_key_facts
'''
...
class QuantumVultrSSHKeyFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrSSHKeyFacts, self).__init__(module, "vultr_ssh_key_facts")
...
def main():
    ...
    sshkey_facts = QuantumVultrSSHKeyFacts(module)
