...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_user_facts
'''
...
class QuantumVultrUserFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrUserFacts, self).__init__(module, "vultr_user_facts")
...
def main():
    ...
    user_facts = QuantumVultrUserFacts(module)
