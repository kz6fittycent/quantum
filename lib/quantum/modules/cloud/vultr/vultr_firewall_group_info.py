...
class QuantumVultrFirewallGroupInfo(Vultr):

    def __init__(self, module):
        super(QuantumVultrFirewallGroupInfo, self).__init__(module, "vultr_firewall_group_info")
...
def main():
    ...
    fw_group_info = QuantumVultrFirewallGroupInfo(module)
