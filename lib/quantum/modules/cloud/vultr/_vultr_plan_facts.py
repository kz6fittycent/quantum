...
- name: Print the gathered facts
  debug:
    var: quantum_facts.vultr_plan_facts
'''
...
class QuantumVultrPlanFacts(Vultr):

    def __init__(self, module):
        super(QuantumVultrPlanFacts, self).__init__(module, "vultr_plan_facts")
...
def main():
    ...
    plan_facts = QuantumVultrPlanFacts(module)
