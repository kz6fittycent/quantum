...
def getOvhClient(quantumModule):
    endpoint = quantumModule.params.get('endpoint')
    application_key = quantumModule.params.get('application_key')
    application_secret = quantumModule.params.get('application_secret')
    consumer_key = quantumModule.params.get('consumer_key')
