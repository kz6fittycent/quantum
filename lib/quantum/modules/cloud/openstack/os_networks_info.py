...
description:
    ...
    - This module was called C(os_networks_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(os_networks_info) module no longer returns C(quantum_facts)!
requirements:
    - "python >= 2.7"
    - "sdk"
options:
...
from quantum.module_utils.openstack import openstack_full_argument_spec, openstack_cloud_from_module
...
def main():
    ...
    try:
        ...
        if is_old_facts:
            module.exit_json(changed=False, quantum_facts=dict(
