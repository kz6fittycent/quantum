...
description:
    ...
    - This module was called C(os_server_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(os_server_info) module no longer returns C(quantum_facts)!
notes:
