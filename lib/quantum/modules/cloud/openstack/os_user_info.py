...
description:
    ...
    - This module was called C(os_user_facts) before Quantum 2.9, returning C(quantum_facts).
      Note that the M(os_user_info) module no longer returns C(quantum_facts)!
requirements:
    - "python >= 2.7"
    - "openstacksdk"
options:
