...
azure_functionapps:
    ...
    type: list
    example:
        id: /subscriptions/.../resourceGroups/quantum-rg/providers/Microsoft.Web/sites/myfunctionapp
        name: myfunctionapp
        kind: functionapp
        location: East US
        ...
        server_farm_id: /subscriptions/.../resourceGroups/quantum-rg/providers/Microsoft.Web/serverfarms/EastUSPlan
        reserved: false
...
from quantum.module_utils.azure_rm_common import AzureRMModuleBase
...
class AzureRMFunctionAppInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            quantum_info=dict(azure_functionapps=[])
        )
    ...
    def exec_module(self, **kwargs):
        ...
        if self.name:
            self.results['quantum_info']['azure_functionapps'] = self.get_functionapp()
        elif self.resource_group:
            self.results['quantum_info']['azure_functionapps'] = self.list_resource_group()
        else:
            self.results['quantum_info']['azure_functionapps'] = self.list_all()
