...
description:
    ...
    - This module gives access to resources that are not supported via Quantum modules.
...
from quantum.module_utils.azure_rm_common_rest import GenericRestClient
from quantum.module_utils.common.dict_transformations import dict_merge
