...
class AzureRMDeploymentManager(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.module_arg_spec = dict(
            ...
            name=dict(type='str', default="quantum-arm", aliases=['deployment_name']),
    ...
    def deploy_template(self):
        ...
        :param module: Quantum module containing the validated configuration for the deployment template
