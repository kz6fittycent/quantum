...
description:
    ...
    - Supports custom images since Quantum 2.5.
...
options:
    ...
    public_ip_allocation_method:
        description:
            ...
            - The C(Disabled) choice was added in Quantum 2.6.
        choices:
            - Dynamic
            - Static
            - Disabled
...
from quantum.module_utils.basic import to_native, to_bytes
from quantum.module_utils.azure_rm_common import AzureRMModuleBase, azure_id_to_dict, normalize_location_name, format_resource_id
...
class AzureRMVirtualMachine(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            ...
            quantum_facts=dict(azure_vm=None)
        )
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['quantum_facts']['azure_vm'] = results
        ...
        if changed:
            if self.state == 'present':
                ...
                if (powerstate_change == 'poweron' and
                        self.results['quantum_facts']['azure_vm']['powerstate'] != 'running'):
                ...
                self.results['quantum_facts']['azure_vm'] = self.serialize_vm(self.get_vm())

            elif self.state == 'absent':
                # delete the VM
                self.log("Delete virtual machine {0}".format(self.name))
                self.results['quantum_facts']['azure_vm'] = None
                self.delete_vm(vm)
