...
from quantum.module_utils.alicloud_ecs import ecs_argument_spec, ecs_connect
...
def create_instance(module, ecs, exact_count):
    ...
    client_token = "Quantum-Alicloud-{0}-{1}".format(hash(str(module.params)), str(time.time()))
