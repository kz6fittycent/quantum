...
description:
     ...
     - This module was called C(ali_instance_facts) before Quantum 2.9. The usage did not change.
...
from quantum.module_utils.alicloud_ecs import get_acs_connection_info, ecs_argument_spec, ecs_connect
