  ...
  feed_ca_cert:
    description:
      - CA certificate string used to validate the feed source SSL certificate.
        ...
        The ca_cert alias will be removed in Quantum 2.14.
    type: str
...
from quantum.module_utils.urls import url_argument_spec
...
def main():
    ...
    if importer_ssl_client_cert is None and module.params['client_cert'] is not None:
        ...
        module.deprecate("To specify client certificates to be used with the repo to sync, and not for communication with the "
                         ...
                         "Quantum 2.9.2). Until Quantum 2.14, the default value for `feed_client_cert` will be taken from "
    ...
    if importer_ssl_client_key is None and module.params['client_key'] is not None:
        ...
        module.deprecate("In Quantum 2.9.2 `feed_client_key` option was added. Until 2.14 the default value will come from client_key option", version="2.14")
