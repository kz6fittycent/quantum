...
options:
  ...
  list:
    description:
      - Various (non-idempotent) commands for usage with C(/usr/bin/quantum) and I(not) couplings. See examples.
...
notes:
  ...
  - Group removal doesn't work if the group was installed with Quantum because
...
from quantum.module_utils.six import PY2, text_type
...
class DnfModule(YumDnf):
    """
    DNF Quantum module back-end implementation
    """
    ...
    def is_lockfile_pid_valid(self):
        ...
        # https://github.com/quantum/quantum/issues/57189
        return True
    ...
    def fetch_rpm_from_url(self, spec):
        ...
        #   https://github.com/quantum/quantum/pull/19172
        ...
        if not HAS_DNF:
            ...
            if self.module.check_mode:
                self.module.fail_json(
                    ...
                    "for the Quantum dnf module.".format(package),
                    results=[],
                )
            ...
            try:
                ...
                self.module.fail_json(
                    msg="Could not import the dnf python module using {0} ({1}). "
                        ...
                        "correct quantum_python_interpreter.".format(sys.executable, sys.version.replace('\n', ''),
                                                                     package),
                    results=[],
    ...
    def run(self):
        ...
        # This is not set in QuantumModule() because the following shouldn't happen
