...
notes:
  ...
  - "The C(params) parameter was removed in Quantum 2.5 due to circumventing Quantum's parameter
    handling"
'''
...
def main():
    ...
    if module.params['params']:
        module.fail_json(msg="The params option to yum_repository was removed in Quantum 2.5 since it circumvents Quantum's option handling")
