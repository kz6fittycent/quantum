...
# Discussion: https://github.com/quantum/quantum/pull/50807#discussion_r248827899
RETURN = '''
k8s_auth:
...
from quantum.module_utils.six.moves.urllib_parse import urlparse, parse_qs, urlencode
...
class KubernetesAuthModule(QuantumModule):
    def __init__(self):
        QuantumModule.__init__(
            self,
