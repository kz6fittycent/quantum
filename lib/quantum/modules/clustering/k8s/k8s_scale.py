...
- name: Scale deployment based on a file from the Quantum controller filesystem
  k8s_scale:
...
from quantum.module_utils.k8s.scale import KubernetesQuantumScaleModule


def main():
    KubernetesQuantumScaleModule().execute_module()
