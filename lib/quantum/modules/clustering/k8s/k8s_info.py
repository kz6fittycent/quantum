...
description:
  ...
  - Supports check mode.
  - This module was called C(k8s_facts) before Quantum 2.9. The usage did not change.
...
from quantum.module_utils.k8s.common import KubernetesQuantumModule, AUTH_ARG_SPEC
import copy


class KubernetesInfoModule(KubernetesQuantumModule):
