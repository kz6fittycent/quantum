  ...
  src:
    description:
      - The I(src) argument provides a path to the configuration file
        ...
        or relative to the root of the implemented role or coupling.
  ...
  save_when:
    description:
      - When changes are made to the device running-configuration, the
        ...
        I(changed) was added in Quantum 2.6.
    default: never
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/nxos_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /couplings/quantum/backup/nxos_config
date:
...
from quantum.module_utils.network.nxos.nxos import get_config, load_config, run_commands, get_connection
from quantum.module_utils.network.nxos.nxos import nxos_argument_spec
from quantum.module_utils.network.nxos.nxos import check_args as nxos_check_args
