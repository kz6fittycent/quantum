...
# Using merged
# This action will merge telemetry configuration defined in the coupling with
...
# telemetry configuration defined in the coupling.
...
def main():
    ...
    """
    module = QuantumModule(argument_spec=TelemetryArgs.argument_spec,
