...
from quantum.module_utils.network.nxos.nxos import run_commands, load_config
...
def main():
    ...
    warning_msg += " when params 'http, http_port, https, https_port' are not set in the coupling"
