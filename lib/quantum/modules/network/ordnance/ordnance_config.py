  ...
  backup:
    description:
      - This argument will cause the module to create a full backup of
        ...
        folder in the coupling root directory.  If the directory does not
        exist, it is created.
    type: bool
    default: 'no'
  config:
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/ordnance_config.2016-07-16@22:28:34
"""
import re
import time
import traceback

from quantum.module_utils.network.common.network import NetworkModule, NetworkError
from quantum.module_utils.network.common.config import NetworkConfig, dumps
from quantum.module_utils.network.common.parsing import Command
from quantum.module_utils.network.ordnance.ordnance import get_config
