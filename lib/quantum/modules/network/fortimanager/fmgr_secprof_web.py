...
version_added: "2.8"
notes:
    - Full Documentation at U(https://ftnt-quantum-docs.readthedocs.io/en/latest/).
author:
...
description:
  -  Manage web filter security profiles in FortiManager through couplings using the FMG API
...
options:
  ...
  ftgd_wf:
    description:
      ...
      - Dictionaries must use FortiManager API parameters, not the quantum ones listed below.
...
EXAMPLES = '''
  - name: DELETE Profile
    fmgr_secprof_web:
      name: "Quantum_Web_Filter_Profile"
      mode: "delete"

  - name: CREATE Profile
    fmgr_secprof_web:
      name: "Quantum_Web_Filter_Profile"
      comment: "Created by Quantum Module TEST"
      mode: "set"
      extended_log: "enable"
...
from quantum.module_utils.basic import QuantumModule, env_fallback
...
from quantum.module_utils.network.fortimanager.common import FMGRMethods
from quantum.module_utils.network.fortimanager.common import DEFAULT_RESULT_OBJ
from quantum.module_utils.network.fortimanager.common import FAIL_SOCKET_MSG
from quantum.module_utils.network.fortimanager.common import prepare_dict
...
def main():
    ...
    module = QuantumModule(argument_spec=argument_spec, supports_check_mode=False, )
    # MODULE PARAMGRAM
    paramgram = {
    ...
    try:
        ...
        fmgr.govern_response(module=module, results=results,
                             quantum_facts=fmgr.construct_quantum_facts(results, module.params, paramgram))
