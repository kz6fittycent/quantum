...
- name: SET SNMP SYSTEM INFO different template (SNMPv2)
  fmgr_device_provision_template:
    provisioning_template: "quantumTest"
    snmp_status: "enable"
    mode: "set"
    adom: "quantum"
...
- name: SET CUSTOM SMTP SERVER
  fmgr_device_provision_template:
    ...
    smtp_port: "25"
    smtp_replyto: "quantum@do-not-reply.com"
...
- name: DELETE ENTIRE PROVISIONING TEMPLATE
  fmgr_device_provision_template:
    delete_provisioning_template: "quantumTest"
    mode: "delete"
    adom: "quantum"
