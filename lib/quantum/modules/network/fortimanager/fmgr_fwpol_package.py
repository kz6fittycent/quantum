...
- name: ADD PACKAGE INTO PARENT FOLDER
  fmgr_fwpol_package:
    mode: "set"
    adom: "quantum"
    name: "quantumTestPackage2"
    object_type: "pkg"
    parent_folder: "quantumTestFolder1"

- name: ADD FOLDER INTO PARENT FOLDER
  fmgr_fwpol_package:
    mode: "set"
    adom: "quantum"
    name: "quantumTestFolder2"
    object_type: "folder"
    parent_folder: "quantumTestFolder1"
...
def fmgr_fwpol_package_install(fmgr, paramgram):
    """
    This method/function installs FMGR FW Policy Packages to the scope members defined in the coupling.
