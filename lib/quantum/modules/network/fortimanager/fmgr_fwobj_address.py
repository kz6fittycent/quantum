...
options:
  ...
  group_name:
    description:
      - Address group name. If this is defined in coupling task, all other options are ignored.
...
- name: ADD IPv6 ADDRESS RANGE
  fmgr_fwobj_address:
    ...
    name: "quantum_v6range"
    comment: "Created by Quantum"

- name: ADD IPv4 IP ADDRESS GROUP
  fmgr_fwobj_address:
    ipv4: "group"
    group_name: "quantumIPv4Group"
    group_members: "quantum_fqdn, quantum_wildcard, quantum_range"

- name: ADD IPv6 IP ADDRESS GROUP
  fmgr_fwobj_address:
    ipv6: "group"
    group_name: "quantumIPv6Group"
    group_members: "quantum_v6Obj, quantum_v6range"
