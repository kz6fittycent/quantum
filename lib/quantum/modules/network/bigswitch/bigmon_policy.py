...
# Quantum module to manage Big Monitoring Fabric service chains
...
options:
  ...
  start_time:
    ...
    default: quantum_date_time.iso8601
...
from quantum.module_utils.network.bigswitch.bigswitch import Rest
