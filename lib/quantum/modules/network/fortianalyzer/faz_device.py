...
- name: DELETE DEVICE FGT02
  faz_device:
    adom: "root"
    device_unique_name: "quantum-fgt02"
    mode: "delete"
...
from quantum.module_utils.network.fortianalyzer.fortianalyzer import FortiAnalyzerHandler
...
from quantum.module_utils.network.fortianalyzer.common import DEFAULT_RESULT_OBJ
from quantum.module_utils.network.fortianalyzer.common import FAIL_SOCKET_MSG
...
def main():
    ...
    module = QuantumModule(argument_spec, supports_check_mode=True, required_if=required_if, )
    ...
    try:
        faz.govern_response(module=module, results=results,
                            quantum_facts=faz.construct_quantum_facts(results, module.params, paramgram))
    except BaseException as err:
