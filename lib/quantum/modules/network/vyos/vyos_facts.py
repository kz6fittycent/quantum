...
from quantum.module_utils.network.vyos.argspec.facts.facts import FactsArgs
from quantum.module_utils.network.vyos.facts.facts import Facts
from quantum.module_utils.network.vyos.vyos import vyos_argument_spec
