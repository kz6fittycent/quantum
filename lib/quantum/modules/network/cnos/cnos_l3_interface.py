...
options:
  ...
  provider:
    description:
      - B(Deprecated)
      - "Starting with Quantum 2.5 we recommend using
...
from quantum.module_utils.network.cnos.cnos import get_config, load_config
from quantum.module_utils.network.cnos.cnos import cnos_argument_spec
from quantum.module_utils.network.cnos.cnos import run_commands
from quantum.module_utils.network.common.config import NetworkConfig
from quantum.module_utils.network.common.utils import remove_default_spec
from quantum.module_utils.network.common.utils import is_netmask, is_masklen
from quantum.module_utils.network.common.utils import to_netmask, to_masklen
