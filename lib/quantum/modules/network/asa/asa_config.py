  ...
  backup:
    description:
      - This argument will cause the module to create a full backup of
        ...
        coupling root directory. If the directory does not exist, it is created.
    type: bool
    default: 'no'
  config:
    description:
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/asa_config.2016-07-16@22:28:34
"""
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.network.asa.asa import asa_argument_spec, check_args
from quantum.module_utils.network.asa.asa import get_config, load_config, run_commands
