...
from quantum.module_utils.network.ironware.ironware import run_commands
...
def main():
    ...
    for key, value in iteritems(facts):
        key = 'quantum_net_%s' % key
        quantum_facts[key] = value

    check_args(module)

    module.exit_json(quantum_facts=quantum_facts)
