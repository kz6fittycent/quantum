  ...
  package:
    description:
      ...
      - When C(state) is C(absent), it is not necessary for the package to exist on the
        Quantum controller. If the full path to the package is provided, the filename will
...
requirements:
  ...
  - The 'rpm' tool installed on the Quantum controller
...
class Parameters(QuantumF5Parameters):
    ...
    def package_name(self):
        ...
        is only used though when the file actually exists on your Quantum
        controller.
