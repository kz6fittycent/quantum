...
description:
  ...
  - This module was called C(bigiq_device_facts) before Quantum 2.9. The usage did not change.
version_added: 2.8
options:
  gather_subset:
    description:
...
try:
    ...
    from quantum.module_utils.network.f5.bigiq import F5RestClient
    ...
    from quantum.module_utils.network.f5.icontrol import bigiq_version
