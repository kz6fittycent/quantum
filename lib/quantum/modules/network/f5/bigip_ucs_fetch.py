...
notes:
  ...
  - If you are using this module with either Quantum Tower or Quantum AWX, you
    should be aware of how these Quantum products execute jobs in restricted
    environments. More information can be found here
    https://clouddocs.f5.com/products/orchestration/quantum/devel/usage/module-usage-with-tower.html
...
dest:
  description: Location on the quantum host that the UCS was saved to
  returned: success
  type: str
...
try:
    ...
    from quantum.module_utils.network.f5.icontrol import download_file
