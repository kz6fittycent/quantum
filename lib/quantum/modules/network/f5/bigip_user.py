...
# you either,
#
#   * Put this in its own coupling that you run when you need to
...
try:
    ...
    #
    # These libraries *should* be available on most Quantum controllers
    # by default though as crypto is a dependency of Quantum.
    #
