...
options:
  ...
  inline:
    description:
      ...
      - The policy can be be retrieved in coupling C(result) dictionary under C(inline_policy) key.
    type: bool
  compact:
    description:
...
try:
    ...
    from quantum.module_utils.network.f5.icontrol import download_asm_file
