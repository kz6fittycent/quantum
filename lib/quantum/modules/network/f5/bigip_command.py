  ...
  warn:
    description:
      - Whether the module should raise warnings related to command idempotency
        or not.
      - Note that the F5 Quantum developers specifically leave this on to make you
        aware that your usage of this module may be better served by official F5
        Quantum modules. This module should always be used as a last resort.
    default: True
    type: bool
    version_added: 2.6
  chdir:
...
from quantum.module_utils.network.common.parsing import FailedConditionsError
from quantum.module_utils.network.common.parsing import Conditional
from quantum.module_utils.network.common.utils import ComplexList
...
try:
    ...
    from quantum.module_utils.network.f5.common import is_cli

try:
    from quantum.module_utils.network.f5.common import run_commands
...
class NoChangeReporter(object):
    ...
    def find_no_change(self, responses):
        ...
        This method borrows heavily from Quantum's ``_find_prompt`` method
        defined in the ``lib/quantum/plugins/connection/network_cli.py::Connection``
        class.
