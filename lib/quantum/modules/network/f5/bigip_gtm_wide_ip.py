...
options:
  ...
  name:
    description:
      - Wide IP name. This name must be formatted as a fully qualified
        ...
        is deprecated and will be removed in a future Quantum version.
    type: str
    required: True
    aliases:
      - wide_ip
  ...
  last_resort_pool:
    ...
    version_added: 2.8
notes:
  - Support for TMOS versions below v12.x has been deprecated for this module, and will be removed in Quantum 2.12.
...
try:
    ...
    from quantum.module_utils.network.f5.common import is_valid_fqdn
