...
class V1Parameters(QuantumF5Parameters):
...
# TODO(Remove in 2.12)
class V2Parameters(QuantumF5Parameters):
...
class V3Parameters(QuantumF5Parameters):
    api_map = {
...
class V4Manager(BaseManager):
    ...
    In Quantum 2.12, the Parameter classes will undergo a rename
