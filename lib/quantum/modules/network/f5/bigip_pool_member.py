...
- name: Add pool member
  bigip_pool_member:
    pool: my-pool
    partition: Common
    host: "{{ quantum_default_ipv4['address'] }}"
    port: 80
...
from quantum.module_utils.urls import urlparse
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.basic import env_fallback
from quantum.module_utils.six import iteritems
from quantum.module_utils.network.common.utils import remove_default_spec
...
try:
    ...
    from quantum.module_utils.network.f5.common import is_valid_hostname
    from quantum.module_utils.network.f5.common import flatten_boolean
    from quantum.module_utils.network.f5.compare import cmp_str_with_none
    ...
    from quantum.module_utils.network.f5.icontrol import TransactionContextManager
