...
from quantum.module_utils.network.ftd.common import construct_quantum_facts, FtdServerError, HTTPMethod
...
def main():
    ...
    try:
        ...
        module.exit_json(changed=True, response=resp, quantum_facts=construct_quantum_facts(resp, module.params))
