...
options:
    ...
    description:
        ...
        default: "Quantum-originated commit"
'''
...
- name: Add 48 interfaces and commit the change.
  nclu:
    template: |
        ...
        {% endfor %}
    commit: true
    description: "Quantum - add swps1-48"
...
def main(testing=False):
    module = QuantumModule(argument_spec=dict(
        ...
        description=dict(required=False, type='str', default="Quantum-originated commit"),
