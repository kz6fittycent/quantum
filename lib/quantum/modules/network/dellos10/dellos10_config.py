#!/usr/bin/python
#
# (c) 2015 Peter Sprygada, <psprygada@quantum.com>
  ...
  src:
    description:
      - Specifies the source path to the file that contains the configuration
        ...
        path from the coupling or role root directory. This argument is
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/dellos10_config.2016-07-16@22:28:34
"""
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.network.dellos10.dellos10 import get_config, get_sublevel_config
from quantum.module_utils.network.dellos10.dellos10 import dellos10_argument_spec, check_args
from quantum.module_utils.network.dellos10.dellos10 import load_config, run_commands
from quantum.module_utils.network.dellos10.dellos10 import WARNING_PROMPTS_RE
