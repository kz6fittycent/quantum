...
options:
    ...
    type:
        ...
        - As of Quantum 2.8, C(combined) type is no longer accepted.
        - As of Quantum 2.8, changes to this parameter are no longer idempotent.
    ...
    tags:
        ...
        - C(tags) name conflicts with the tags parameter in Quantum. Indentation problems may cause unexpected behaviors.
        - Quantum 2.8 converts this to a list from a comma separated list.
    timezone:
        description:
    ...
    disable_my_meraki:
        description: >
            ...
            - Will be deprecated in Quantum 2.13 in favor of C(enable_my_meraki).
        type: bool
        version_added: '2.7'
    enable_my_meraki:
        description: >
            ...
            U[wired.meraki.com](wired.meraki.com)).
            - Quantum 2.7 had this parameter as C(disable_my_meraki).
        type: bool
        version_added: '2.9'
