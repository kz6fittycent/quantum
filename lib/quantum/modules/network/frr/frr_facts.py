...
quantum_net_python_version:
  description: The Python version that the Quantum controller is using
  returned: always
  type: str

# hardware
quantum_net_mem_stats:
...
quantum_net_interfaces:
  ...
  returned: when interfaces is configured
  type: dict
quantum_net_mpls_ldp_neighbors:
...
from quantum.module_utils.network.frr.frr import run_commands, get_capabilities
