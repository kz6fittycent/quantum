...
from quantum.module_utils.network.cloudengine.ce import load_config
from quantum.module_utils.network.cloudengine.ce import get_connection, rm_config_prefix
from quantum.module_utils.network.cloudengine.ce import ce_argument_spec
...
class NetstreamTemplate(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.module = QuantumModule(argument_spec=self.spec, supports_check_mode=True)
