...
notes:
  ...
  - This module also works with C(local) connections for legacy couplings.
options:
  lines:
    description:
  ...
  config:
    description:
      - The module, by default, will connect to the remote device and
        ...
        every task in a coupling.  The I(config) argument allows the
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/ce_config.2016-07-16@22:28:34
"""
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.connection import ConnectionError, Connection
from quantum.module_utils.network.common.config import NetworkConfig as _NetworkConfig
from quantum.module_utils.network.common.config import dumps, ConfigLine, ignore_line
from quantum.module_utils.network.cloudengine.ce import get_config, run_commands, exec_command, cli_err_msg
from quantum.module_utils.network.cloudengine.ce import ce_argument_spec, load_config
from quantum.module_utils.network.cloudengine.ce import check_args as ce_check_args
import re
