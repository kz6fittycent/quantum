...
from quantum.module_utils.network.cloudengine.ce import run_commands
from quantum.module_utils.network.cloudengine.ce import ce_argument_spec, check_args
...
def main():
    ...
    module = QuantumModule(argument_spec=spec, supports_check_mode=True)
