...
options:
  ...
  config:
    description:
      - The C(config) argument allows the coupling designer to supply
...
- name: enable rollback location
  sros_config:
    lines: configure system rollback rollback-location "cf3:/quantum"
    provider: "{{ cli }}"
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/sros_config.2016-07-16@22:28:34
"""
from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.network.common.config import NetworkConfig, dumps
from quantum.module_utils.network.sros.sros import sros_argument_spec, check_args
from quantum.module_utils.network.sros.sros import load_config, run_commands, get_config
