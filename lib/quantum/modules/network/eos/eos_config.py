...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/eos_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /couplings/quantum/backup/eos_config
date:
...
from quantum.module_utils.network.eos.eos import get_config, load_config, get_connection
from quantum.module_utils.network.eos.eos import run_commands
from quantum.module_utils.network.eos.eos import eos_argument_spec
from quantum.module_utils.network.eos.eos import check_args
