...
from quantum.module_utils.network.eos.providers.module import NetworkModule
from quantum.module_utils.network.eos.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
