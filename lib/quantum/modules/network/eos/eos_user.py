...
description:
  - This module provides declarative management of the local usernames
    configured on Arista EOS devices.  It allows couplings to manage
...
commands:
  ...
  type: list
  sample:
    - name quantum secret password
    - name admin secret admin
session_name:
  description: The EOS config session name used to load the configuration
  returned: when changed is True
  type: str
  sample: quantum_1479315771
"""
...
from quantum.module_utils.network.eos.eos import eos_argument_spec, check_args
