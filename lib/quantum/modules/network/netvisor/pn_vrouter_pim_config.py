...
- name: pim config modify
  pn_vrouter_pim_config:
    ...
    state: 'update'
    pn_vrouter_name: 'quantum-spine1-vrouter'
"""
...
from quantum.module_utils.network.netvisor.pn_nvos import pn_cli, run_cli
from quantum.module_utils.network.netvisor.netvisor import run_commands
