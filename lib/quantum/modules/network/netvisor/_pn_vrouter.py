...
deprecated:
  ...
  alternative: Latest modules will be pushed in Quantum future versions.
description:
...
- name: create vrouter
  pn_vrouter:
    state: 'present'
    pn_name: 'quantum-vrouter'
    pn_vnet: 'quantum-fab-global'
...
def pn_cli(module):
    ...
    :param module: The Quantum module to fetch username, password and switch
...
def check_cli(module, cli):
    ...
    :param module: The Quantum module to fetch input parameters
...
def run_cli(module, cli):
    ...
    :param module: The Quantum module to fetch command
    """
    cliswitch = module.params['pn_cliswitch']
