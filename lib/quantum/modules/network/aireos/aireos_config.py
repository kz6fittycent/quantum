...
options:
  ...
  save:
    description:
      ...
      - This option is deprecated as of Quantum 2.7, use C(save_when)
    type: bool
    default: 'no'
  save_when:
    description:
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/aireos_config.2016-07-16@22:28:34
"""
from quantum.module_utils.network.aireos.aireos import run_commands, get_config, load_config
from quantum.module_utils.network.aireos.aireos import aireos_argument_spec
from quantum.module_utils.network.aireos.aireos import check_args as aireos_check_args
