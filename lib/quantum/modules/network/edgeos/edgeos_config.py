  ...
  backup:
    description:
      - The C(backup) argument will backup the current device's active
        ...
        file will be located in the backup folder in the coupling root
        directory or role root directory if the coupling is part of an
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/edgeos_config.2016-07-16@22:28:34
"""
...
from quantum.module_utils.network.edgeos.edgeos import load_config, get_config, run_commands
