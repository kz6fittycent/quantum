...
description:
  - Collects a base set of device facts from a remote device that
    ...
    fact keys with C(quantum_net_<fact>).  The facts module will
...
from quantum.module_utils.network.exos.argspec.facts.facts import FactsArgs
from quantum.module_utils.network.exos.facts.facts import Facts
