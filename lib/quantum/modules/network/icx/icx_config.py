  ...
  backup:
    description:
      - This argument will cause the module to create a full backup of
        ...
        folder in the coupling root directory or role root directory, if
        coupling is part of an quantum role. If the directory does not exist,
        it is created.
    type: bool
    default: 'no'
  defaults:
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/icx_config.2016-07-16@22:28:34
"""

import json
from quantum.module_utils._text import to_text
from quantum.module_utils.connection import ConnectionError
from quantum.module_utils.network.icx.icx import run_commands, get_config
from quantum.module_utils.network.icx.icx import get_defaults_flag, get_connection
from quantum.module_utils.network.icx.icx import check_args as icx_check_args
