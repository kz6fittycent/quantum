...
from quantum.module_utils.network.icx.icx import exec_scp, run_commands
...
def main():
    ...
    module = QuantumModule(argument_spec=argument_spec, supports_check_mode=False, mutually_exclusive=mutually_exclusive)
