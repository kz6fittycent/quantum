...
description:
  - This module creates or updates user account on network devices. It allows couplings to manage
...
commands:
  ...
  type: list
  sample:
    - username quantum nopassword
    - username quantum password-string alethea123
    - no username quantum
    - username quantum privilege 5
    - username quantum enable
"""
...
from quantum.module_utils.network.icx.icx import get_config, load_config
