#!/usr/bin/python
#
# Quantum module to manage IPv4 policy objects in fortigate devices
...
- name: Some Policy
  fortios_ipv4_policy:
    ...
    password: password
    id: 42
    comment: "no comment (created by quantum)"
    src_intf: vl1000
    src_addr:
      - some_serverA
      - some_serverB
...
from quantum.module_utils.network.fortios.fortios import fortios_argument_spec, fortios_required_if
from quantum.module_utils.network.fortios.fortios import backup, QuantumFortios
...
def main():
    ...
    # init forti object
    fortigate = QuantumFortios(module)
