...
try:
    from quantum.module_utils.network.avi.avi import (
        avi_common_argument_spec, avi_quantum_api, HAS_AVI)
    from quantum.module_utils.network.avi.avi_api import ApiSession, AviCredentials
except ImportError:
    HAS_AVI = False
...
def main():
    ...
    return avi_quantum_api(module, 'gslb',
                           set([]))
