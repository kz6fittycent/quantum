...
try:
    from quantum.module_utils.network.avi.avi import (
        ...
        quantum_return, AviCheckModeResponse, HAS_AVI)
...
def main():
    ...
    if not HAS_AVI:
        return module.fail_json(msg=(
            'Avi python API SDK (avisdk>=17.1) or quantum>=2.8 is not installed. '
    ...
    return quantum_return(module, rsp, changed, req=data)
