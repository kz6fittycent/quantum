...
description:
    ...
    - This is intended to be a short hand for using the uri Quantum module to issue the raw HTTP requests directly.
    - It provides consistent return values and has no other dependencies apart from the base Quantum runtime environment.
    - This module is intended to run either on the Quantum control node or a bastion (jumpserver) with access to the actual Netscaler instance
