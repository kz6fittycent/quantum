...
options:
  ...
  leaf_port_blk:
    description:
    - B(Deprecated)
    - Starting with Quantum 2.8 we recommend using the module L(aci_access_port_block_to_access_port, aci_access_port_block_to_access_port.html).
    - The parameter will be removed in Quantum 2.12.
    - HORIZONTALLINE
