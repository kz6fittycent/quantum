...
- A default installation of ACI Multi-Site ships with admin password 'we1come!' which requires a password change on first login.
  See the examples of how to change the 'admin' password using Quantum.
...
from quantum.module_utils.network.aci.mso import MSOModule, mso_argument_spec, issubset
