...
#  description Replaced by Quantum Team
#  mtu 2000
#  vrf custB
...
# !
# interface GigabitEthernet0/0/0/2
#  description Configured and Replaced by Quantum
#  mtu 2000
#  vrf custB
#  ipv4 address 178.18.169.23 255.255.255.0
#  dot1q native vlan 30
...
commands:
  ...
  returned: always
  type: list
  sample: ['interface GigabitEthernet0/0/0/2', 'description: Configured by Quantum', 'shutdown']
"""

from quantum.module_utils.basic import QuantumModule
from quantum.module_utils.network.iosxr.argspec.interfaces.interfaces import InterfacesArgs
from quantum.module_utils.network.iosxr.config.interfaces.interfaces import Interfaces
