...
from quantum.module_utils.network.iosxr.config.lag_interfaces.lag_interfaces import Lag_interfaces
...
def main():
    ...
    module = QuantumModule(argument_spec=Lag_interfacesArgs.argument_spec, required_if=required_if,
