...
from quantum.module_utils.network.iosxr.config.lldp_interfaces.lldp_interfaces import Lldp_interfaces
...
def main():
    ...
    module = QuantumModule(argument_spec=Lldp_interfacesArgs.argument_spec, required_if=required_if,
