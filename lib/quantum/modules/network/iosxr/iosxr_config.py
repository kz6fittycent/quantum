...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/iosxr01_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /couplings/quantum/backup/iosxr01_config
date:
...
from quantum.module_utils.network.iosxr.iosxr import load_config, get_config, get_connection
from quantum.module_utils.network.iosxr.iosxr import iosxr_argument_spec, copy_file
...
def run(module, result):
    ...
    if replace_config:
        ...
        if config_diff or running_base_diff_resp['config_diff']:
            ...
            commands = ['load harddisk:/quantum_config.txt']
            replace_file_path = 'harddisk:/quantum_config.txt'
