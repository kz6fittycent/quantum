...
# Copyright: (c) 2017, Quantum by Red Hat, inc
...
deprecated:
  ...
  why: Newer and updated modules released with more functionality in Quantum 2.9
requirements:
...
from quantum.module_utils.network.iosxr.iosxr import get_config, load_config, build_xml
from quantum.module_utils.network.iosxr.iosxr import run_commands, iosxr_argument_spec, get_oper
from quantum.module_utils.network.iosxr.iosxr import is_netconf, is_cliconf, etree_findall, etree_find
from quantum.module_utils.network.common.utils import conditional, remove_default_spec
