...
from quantum.module_utils.network.iosxr.config.lacp_interfaces.lacp_interfaces import Lacp_interfaces
...
def main():
    ...
    module = QuantumModule(argument_spec=Lacp_interfacesArgs.argument_spec, required_if=required_if,
