...
from quantum.module_utils.network.iosxr.config.lldp_global.lldp_global import Lldp_global
...
def main():
    ...
    module = QuantumModule(argument_spec=Lldp_globalArgs.argument_spec, required_if=required_if,
