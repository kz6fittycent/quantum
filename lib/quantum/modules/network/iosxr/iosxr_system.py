...
from quantum.module_utils.network.iosxr.iosxr import get_config, load_config, etree_findall
from quantum.module_utils.network.iosxr.iosxr import is_cliconf, is_netconf, etree_find
from quantum.module_utils.network.iosxr.iosxr import iosxr_argument_spec, build_xml
...
def main():
    """ Main entry point for Quantum module execution
    """
    argument_spec = dict(
        hostname=dict(),
