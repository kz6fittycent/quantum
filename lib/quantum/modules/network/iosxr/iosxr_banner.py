...
description:
  - This module will configure both exec and motd banners on remote device
    running Cisco IOS XR. It allows couplings to add or remove
    ...
    - '<config xmlns:xc="urn:ietf:params:xml:ns:netconf:base:1.0">
            <banners xmlns="http://cisco.com/ns/yang/Cisco-IOS-XR-infra-infra-cfg">
                <banner xc:operation="merge">
                  ...
                  <banner-text>Quantum banner example</banner-text>
                </banner>
            </banners>
        </config>'
"""
...
from quantum.module_utils.network.iosxr.iosxr import get_config, load_config
from quantum.module_utils.network.iosxr.iosxr import iosxr_argument_spec
from quantum.module_utils.network.iosxr.iosxr import build_xml, is_cliconf
from quantum.module_utils.network.iosxr.iosxr import etree_find, is_netconf
