  ...
  rpcs:
    description:
      - The C(rpcs) argument accepts a list of RPCs to be executed
        ...
        is return to the coupling via the modules results dictionary.
    version_added: "2.3"
  wait_for:
    description:
...
notes:
  ...
  - This module also works with C(network_cli) connections and with C(local) connections for legacy couplings.
"""
...
from quantum.module_utils.network.junos.junos import junos_argument_spec, get_configuration, get_connection, get_capabilities, tostring
from quantum.module_utils.network.common.parsing import Conditional, FailedConditionalError
from quantum.module_utils.network.common.utils import to_lines
