...
# -------------
#
# quantum@junos01# show interfaces
# ge-0/0/1 {
...
from quantum.module_utils.network.junos.config.l2_interfaces.l2_interfaces import L2_interfaces
...
def main():
    ...
    module = QuantumModule(argument_spec=L2_interfacesArgs.argument_spec,
