  ...
  gather_subset:
    description:
      - When supplied, this argument will restrict the facts collected
        ...
        list it fetches the old style facts (fact keys without 'quantum_' prefix) and it requires
...
from quantum.module_utils.network.junos.argspec.facts.facts import FactsArgs
from quantum.module_utils.network.junos.facts.facts import Facts
from quantum.module_utils.network.junos.junos import junos_argument_spec
