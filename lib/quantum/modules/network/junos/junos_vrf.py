...
description:
  - This module provides declarative management of VRF definitions on
    Juniper JUNOS devices.  It allows couplings to manage individual or
...
from quantum.module_utils.network.junos.junos import load_config, map_params_to_obj, map_obj_to_ele, to_param_list
