...
# ge-0/0/1 {
#    description "Configured by Quantum-1";
#    speed 1g;
#    mtu 1800
# }
# ge-0/0/2 {
#    description "Configured by Quantum-2";
#    ether-options {
#        auto-negotiation;
#    }
# }
...
# }
# ge-0/0/11 {
#    description "Configured by Quantum-11";
# }
  ...
  junos_interfaces:
    config:
      - name: ge-0/0/2
        ...
        mtu: 2800
      - name: ge-0/0/3
        description: 'Configured by Quantum-3'
    state: overridden
...
from quantum.module_utils.network.junos.config.interfaces.interfaces import Interfaces
