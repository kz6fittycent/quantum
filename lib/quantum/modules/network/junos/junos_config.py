...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /couplings/quantum/backup/junos01_config
date:
...
from quantum.module_utils.network.common.netconf import exec_rpc
from quantum.module_utils.network.junos.junos import get_diff, load_config, get_configuration
from quantum.module_utils.network.junos.junos import commit_configuration, discard_changes, locked_config
from quantum.module_utils.network.junos.junos import junos_argument_spec, load_configuration, tostring
...
def main():
    ...
    argument_spec = dict(
        ...
        # deprecated replace in Quantum 2.3
