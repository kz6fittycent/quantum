...
quantum_net_image:
  ...
  returned: always
  type: str
quantum_net_stacked_models:
  description: The model names of each device in the stack
  returned: when multiple devices are configured in a stack
  type: list
quantum_net_stacked_serialnums:
...
from quantum.module_utils.network.ios.argspec.facts.facts import FactsArgs
from quantum.module_utils.network.ios.facts.facts import Facts
