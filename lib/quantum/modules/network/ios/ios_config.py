  ...
  src:
    description:
      - Specifies the source path to the file that contains the configuration
        ...
        path from the coupling or role root directory.  This argument is mutually
        exclusive with I(lines), I(parents).
    version_added: "2.2"
  before:
    description:
      - The ordered set of commands to push on to the command stack if
        a change needs to be made.  This allows the coupling designer
  ...
  after:
    description:
      - The ordered set of commands to append to the end of the command
        ...
        allows the coupling designer to append a set of commands to be
  ...
  running_config:
    description:
      - The module, by default, will connect to the remote device and
        ...
        every task in a coupling.  The I(running_config) argument allows the
  ...
  save_when:
    description:
      - When changes are made to the device running-configuration, the
        ...
        I(changed) was added in Quantum 2.5.
    default: never
...
- name: SETTING BOOT IMAGE
  ...
  when: quantum_net_version != version
...
backup_path:
  ...
  type: str
  sample: /couplings/quantum/backup/ios_config.2016-07-16@22:28:34
filename:
...
shortname:
  ...
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /couplings/quantum/backup/ios_config
date:
...
from quantum.module_utils.network.ios.ios import run_commands, get_config
from quantum.module_utils.network.ios.ios import get_defaults_flag, get_connection
from quantum.module_utils.network.ios.ios import ios_argument_spec
from quantum.module_utils.network.ios.ios import check_args as ios_check_args
