      ...
      med_tlv_select:
        description:
          ...
          - NOTE, if med-tlv-select is configured idempotency won't be maintained
            ...
            such, Quantum cannot verify if the respective med-tlv-select options is
            already configured or not from the device side. If you try to apply
            med-tlv-select option in every play run, Quantum will show changed as
            True.
        type: dict
        suboptions:
      ...
      tlv_select:
        description:
          ...
          - NOTE, if tlv-select is configured idempotency won't be maintained
            ...
            such, Quantum cannot verify if the respective tlv-select options is
            already configured or not from the device side. If you try to apply
            tlv-select option in every play run, Quantum will show changed as True.
        type: dict
        suboptions:
          power_management:
            description:
...
from quantum.module_utils.network.ios.config.lldp_interfaces.lldp_interfaces import Lldp_Interfaces
...
def main():
    ...
    module = QuantumModule(argument_spec=Lldp_InterfacesArgs.argument_spec,
