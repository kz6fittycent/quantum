      ...
      reinit:
        description:
          ...
          - NOTE, if LLDP reinit is configured with a starting
            ...
            value. As such, Quantum cannot verify if the respective
            starting reinit value is already configured or not from
            the device side. If you try to apply starting reinit
            value in every play run, Quantum will show changed as True.
...
from quantum.module_utils.network.ios.config.lldp_global.lldp_global import Lldp_global
...
def main():
    ...
    module = QuantumModule(argument_spec=Lldp_globalArgs.argument_spec,
