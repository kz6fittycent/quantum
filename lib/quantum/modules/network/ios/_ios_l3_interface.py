...
from quantum.module_utils.network.ios.ios import get_config, load_config
...
from quantum.module_utils.network.common.utils import is_netmask, is_masklen, to_netmask, to_masklen
