...
description:
  - This will configure both login and motd banners on remote devices
    running Cisco IOS.  It allows couplings to add or remote
  ...
  banner:
    description:
      - Specifies which banner should be configured on the remote device.
        In Quantum 2.4 and earlier only I(login) and I(motd) were supported.
    required: true
...
from quantum.module_utils.network.ios.ios import load_config
