...
description:
  - Collects a base set of device facts from a ONYX Mellanox network devices
    ...
    C(quantum_net_<fact>).  The facts module will always collect a base set of
...
from quantum.module_utils.network.onyx.onyx import BaseOnyxModule
from quantum.module_utils.network.onyx.onyx import show_cmd
...
class OnyxFactsModule(BaseOnyxModule):
    ...
    def run(self):
        ...
        self._module.exit_json(quantum_facts=quantum_facts)
