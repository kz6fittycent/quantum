...
notes:
  ...
  - Detection of existing, running D-Bus session, required to change settings
    ...
    changes on the fly if options are changed via Quantum and
    C(dbus-run-session).
  - Keep in mind that the C(dconf) CLI tool, which this module wraps around,
    ...
    C(value="'myvalue'") - with single quotes as part of the Quantum parameter
    value.
...
class DBusWrapper(object):
    ...
    dbus_wrapper = DBusWrapper(quantum_module)
    ...
    def __init__(self, module):
        ...
        :param module: Quantum module instance used to signal failures and run commands.
        :type module: QuantumModule
        """
    ...
    def run_command(self, command):
        ...
        effectively passed-on to QuantumModule.run_command() method, with
...
class DconfPreference(object):
    ...
    def read(self, key):
        ...
        If an error occurs, a call will be made to QuantumModule.fail_json.
