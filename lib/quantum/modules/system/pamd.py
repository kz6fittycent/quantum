...
options:
  ...
  state:
    ...
    - State C(absent) will remove the rule.  The 'absent' state was added in Quantum 2.4.
    type: str
...
change_count:
    ...
    version_added: 2.4
new_rule:
    description: The changes to the rule.  This was available in Quantum 2.4 and Quantum 2.5.  It was removed in Quantum 2.6.
    type: str
...
updated_rule_(n):
    description: The rule(s) that was/were changed.  This is only available in
      Quantum 2.4 and was removed in Quantum 2.5.
    type: str
    sample:
...
action:
    ...
    - "That action that was taken and is one of: update_rule,
      ...
      absent. This was available in Quantum 2.4 and removed in Quantum 2.8"
    returned: always
    type: str
    sample: "update_rule"
    version_added: 2.4
dest:
    ...
    - "Path to pam.d service that was changed.  This is only available in
      Quantum 2.3 and was removed in Quantum 2.4."
    returned: success
    type: str
...
class PamdService(object):
    ...
    def __str__(self):
        ...
        if lines[1].startswith("# Updated by Quantum"):
            lines.pop(1)

        lines.insert(1, "# Updated by Quantum - " + datetime.now().isoformat())
