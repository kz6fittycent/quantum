...
from quantum.module_utils.basic import get_platform, QuantumModule
...
class SysctlModule(object):
    ...
    def reload_sysctl(self):
        if self.platform == 'freebsd':
            ...
            # https://github.com/quantum/quantum/issues/58158
            return
        else:
    ...
    def write_sysctl(self):
        # open a tmp file
        fd, tmp_path = tempfile.mkstemp('.conf', '.quantum_m_sysctl_', os.path.dirname(self.sysctl_file))
        f = open(tmp_path, "w")
        try:
