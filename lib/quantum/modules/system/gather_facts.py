...
description:
     ...
     - This module is automatically called by couplings to gather useful variables about remote hosts that can be used in couplings.
     - It can also be executed directly by C(/usr/bin/quantum) to check what variables are available to a host.
     - Quantum provides many I(facts) about the system, automatically.
options:
    parallel:
        description:
...
# quantum all -m gather_facts --tree /tmp/facts
"""
