...
options:
    ...
    groups:
        description:
            ...
            - Before Quantum 2.3, the only input format allowed was a comma separated string.
    ...
    shell:
        description:
            ...
            - On macOS, before Quantum 2.5, the default shell for non-system users was C(/usr/bin/false).
              Since Quantum 2.5, the default shell for non-system users on macOS is C(/bin/bash).
    ...
    password:
        description:
            ...
            - See U(https://docs.quantum.com/quantum/faq.html#how-do-i-generate-encrypted-passwords-for-the-user-module)
    ...
    create_home:
        description:
            ...
            - Changed from C(createhome) to C(create_home) in Quantum 2.5.
        type: bool
        default: yes
        aliases: [ createhome ]
    move_home:
    ...
    ssh_key_comment:
        ...
        type: str
        default: quantum-generated on $HOSTNAME
        version_added: "0.9"
    ssh_key_passphrase:
        description:
    ...
    expires:
        description:
            ...
            - Since Quantum 2.6 you can remove the expiry time specify a negative value.
...
notes:
  - There are specific requirements per platform on user management utilities. However
    they generally come pre-installed with the system and Quantum will require they
...
- name: Starting at Quantum 2.6, modify user, remove expiry time
  user:
    name: james18
    expires: -1
'''
...
ssh_fingerprint:
  ...
  type: str
  sample: '2048 SHA256:aYNHYcyVm87Igh0IMEDMbvW0QDlRQfE0aJugp684ko8 quantum-generated on host (RSA)'
ssh_key_file:
...
ssh_public_key:
  ...
  sample: >
    ...
    d5u1u0e6Acju/8aZ/l17IDFiLke5IzlqIMRTEbDwLNeO84YQKWTm9fODHzhYe0yvxqLiK07 quantum-generated on host'
stderr:
...
from quantum.module_utils import distro
from quantum.module_utils.basic import load_platform_subclass, QuantumModule
...
class User(object):
    ...
    def execute_command(self, cmd, use_unsafe_shell=False, data=None, obey_checkmode=True):
        if self.module.check_mode and obey_checkmode:
            ...
            # cast all args to strings quantum-modules-core/issues/4397
...
def main():
    ssh_defaults = dict(
        ...
        type='rsa',
        passphrase=None,
        comment='quantum-generated on %s' % socket.gethostname()
    )
