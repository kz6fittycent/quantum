...
description:
  ...
  - As of Quantum 2.3 support was added for SmartOS and BSDs.
  - As of Quantum 2.4 support was added for macOS.
  - As of Quantum 2.9 support was added for AIX 6.1+
...
from quantum.module_utils.basic import QuantumModule, get_platform, get_distribution
    ...
    def diff(self, phase1='before', phase2='after'):
        ...
        Returns:
            diff: The difference of value between phase1 and phase2.
                ...
                `--diff` option of quantum-coupling.
        """
        diff = {phase1: {}, phase2: {}}
