...
# Copyright: (c) 2016, Brian Coca <bcoca@quantum.com>
    ...
    scope:
        description:
            ...
            - "For systemd to work with 'user', the executing user must have its own instance of dbus started (systemd requirement).
              The user dbus process is normally started during normal login, but not during the run of Quantum tasks.
    ...
    no_block:
        description:
            - Do not synchronously wait for the requested operation to finish.
              Enqueued job will continue without Quantum blocking on its completion.
        type: bool
        default: no
        version_added: "2.3"
notes:
...
from quantum.module_utils.facts.system.chroot import is_chroot
from quantum.module_utils.service import sysv_exists, sysv_is_enabled, fail_if_missing
...
def parse_systemctl_show(lines):
    ...
    # part of that value. Cryptically, this would lead to Quantum reporting that the service file
    # couldn't be found.
    #
...
def main():
    ...
    if unit:
        ...
        # Workaround for https://github.com/quantum/quantum/issues/71528
