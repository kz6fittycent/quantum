...
description:
   ...
   - Starting at Quantum 2.2, multiple entries per host are allowed, but only one for each key type supported by ssh.
...
from quantum.module_utils.common.file import FileLock
