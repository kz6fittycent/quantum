...
options:
    ...
    use:
        ...
        - Normally it uses the value of the 'quantum_service_mgr' fact and falls back to the old 'service' module when none matching is found.
        type: str
        default: auto
        version_added: 2.2
notes:
...
from quantum.module_utils.basic import QuantumModule, load_platform_subclass
from quantum.module_utils.service import fail_if_missing
from quantum.module_utils.six import PY2, b
