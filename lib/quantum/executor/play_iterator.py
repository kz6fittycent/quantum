...
class PlayIterator:
    ...
    def __init__(self, inventory, play, play_context, variable_manager, all_vars, start_at_done=False):
        ...
        # short circuit fact gathering if the entire coupling is conditional
            ...
            if state.run_state == self.ITERATING_SETUP:
                ...
                if not state.pending_setup:
                    ...
                    if (gathering == 'implicit' and implied) or \
                       ...
                       (gathering == 'smart' and implied and not (self._variable_manager._fact_cache.get(host.name, {}).get('_quantum_facts_gathered', False))):
