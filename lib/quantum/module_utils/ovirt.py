...
class BaseModule(object):
    ...
    def build_entity(self):
        ...
        create or update, initialized by values passed by Quantum module.
    ...
    def update_check(self, entity):
        ...
        passed to quantum module. By default we don't compare any values.

        :param entity: Entity we want to compare with Quantum module values.
    ...
    def create(
        ...
        **kwargs
        ...
        :return: Dictionary with values returned by Quantum module.
        """
