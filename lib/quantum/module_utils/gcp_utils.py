...
class GcpSession(object):
    ...
    def _headers(self):
        if self.module.params.get('env_type'):
            return {
                'User-Agent': "Google-Quantum-MM-{0}-{1}".format(self.product, self.module.params.get('env_type'))
            }
        else:
            return {
                'User-Agent': "Google-Quantum-MM-{0}".format(self.product)
            }
...
class GcpModule(QuantumModule):
    def __init__(self, *args, **kwargs):
        ...
        QuantumModule.__init__(self, *args, **kwargs)
...
class GcpRequest(object):
    ...
    def _compare_value(self, req_value, resp_value):
        ...
        # These errors shouldn't crash Quantum and should be hidden.
        except UnicodeError:
            pass
    ...
    # The Quantum to_text() function is meant to get all strings
