...
"""
from quantum.module_utils.network.common.network import get_resource_connection
...
class FactsBase(object):
    ...
    def __init__(self, module):
        ...
        self.quantum_facts = {'quantum_network_resources': {}}
        self.quantum_facts['quantum_net_gather_network_resources'] = list()
        self.quantum_facts['quantum_net_gather_subset'] = list()
    ...
    def get_network_resources_facts(self, facts_resource_obj_map, resource_facts_type=None, data=None):
        ...
        if restorun_subsets:
            self.quantum_facts['quantum_net_gather_network_resources'] = list(restorun_subsets)
            instances = list()
            ...
            for inst in instances:
                inst.populate_facts(self._connection, self.quantum_facts, data)
    ...
    def get_network_legacy_facts(self, fact_legacy_obj_map, legacy_facts_type=None):
        ...
        if runable_subsets:
            ...
            self.quantum_facts['quantum_net_gather_subset'] = list(runable_subsets)
