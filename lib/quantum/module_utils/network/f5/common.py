...
from quantum.module_utils.connection import exec_command
...
MANAGED_BY_ANNOTATION_VERSION = 'f5-quantum.version'
MANAGED_BY_ANNOTATION_MODIFIED = 'f5-quantum.last_modified'
...
def fq_name(partition, value, sub_path=''):
    ...
    The Quantum modules, however, can accept (as names for several
...
def mark_managed_by(quantum_version, params):
    metadata = []
...
class F5BaseClient(object):
    ...
    def reconnect(self):
        ...
        having to re-instantiate the ArgumentSpec and QuantumF5Client classes
    ...
    def merge_provider_auth_provider_param(self, result, provider):
        ...
        #
        # In this case, Quantum will inject the omit-placeholder value
...
class QuantumF5Parameters(object):
    def __init__(self, *args, **kwargs):
