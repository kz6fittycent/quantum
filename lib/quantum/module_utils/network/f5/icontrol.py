...
from quantum.module_utils.urls import generic_urlparse
...
the classes contained herein use Quantum native libraries.
...
class iControlRestSession(object):
    ...
    This acts as a loose wrapper around Quantum's ``Request`` class. We're doing
    ...
    def send(self, method, url, **kwargs):
        ...
        try:
            ...
            # Catch HTTPError delivered from Quantum
            #
            # The structure of this object, in Quantum 2.8 is
            #
            # HttpError {
            #   args
            #   characters_written
...
def download_asm_file(client, url, dest):
    ...
    Arguments:
        ...
        dest (string): The location on (Quantum controller) disk to store the file.
...
def upload_file(client, url, src, dest=None):
    ...
    Examples:
        ...
        >>> from quantum.module_utils.network.f5.icontrol import upload_client
