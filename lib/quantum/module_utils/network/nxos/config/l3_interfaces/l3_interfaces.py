...
from quantum.module_utils.network.common.utils import to_list, remove_empties
...
from quantum.module_utils.network.nxos.utils.utils import remove_rsvd_interfaces, get_interface_type
