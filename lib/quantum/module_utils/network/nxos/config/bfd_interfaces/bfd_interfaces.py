...
from quantum.module_utils.network.nxos.utils.utils import flatten_dict, get_interface_type, normalize_interface, search_obj_in_list, vlan_range_to_list
...
class Bfd_interfaces(ConfigBase):
    ...
    def get_bfd_interfaces_facts(self):
        ...
        bfd_interfaces_facts = facts['quantum_network_resources'].get('bfd_interfaces', [])
        platform = facts.get('quantum_net_platform', '')
