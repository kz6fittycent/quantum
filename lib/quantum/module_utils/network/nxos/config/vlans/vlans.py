...
from quantum.module_utils.network.nxos.utils.utils import get_interface_type, normalize_interface, search_obj_in_list
...
class Vlans(ConfigBase):
    ...
    def get_vlans_facts(self):
        ...
        vlans_facts = facts['quantum_network_resources'].get('vlans')
        if not vlans_facts:
            return []
    ...
    def _state_replaced(self, want, have):
        ...
        Scope is limited to vlan objects defined in the coupling.
        :rtype: A list
        ...
        if obj_in_have:
            ...
            # remove states not specified in the coupling
