...
from quantum.module_utils.network.common.utils import to_list, remove_empties, dict_diff, dict_merge
...
class Lldp_global(ConfigBase):
    ...
    def get_lldp_global_facts(self):
        ...
        lldp_global_facts = facts['quantum_network_resources'].get(
            'lldp_global')
