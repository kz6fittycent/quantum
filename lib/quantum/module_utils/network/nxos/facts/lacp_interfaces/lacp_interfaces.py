...
from quantum.module_utils.network.nxos.argspec.lacp_interfaces.lacp_interfaces import Lacp_interfacesArgs
...
class Lacp_interfacesFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('lacp_interfaces', None)
        facts = {}
        if objs:
