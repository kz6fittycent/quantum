...
from quantum.module_utils.network.nxos.argspec.lag_interfaces.lag_interfaces import Lag_interfacesArgs
from quantum.module_utils.network.nxos.utils.utils import get_interface_type, normalize_interface
...
class Lag_interfacesFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('lag_interfaces', None)
        facts = {}
        if objs:
