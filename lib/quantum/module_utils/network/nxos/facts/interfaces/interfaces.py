...
from quantum.module_utils.network.nxos.argspec.interfaces.interfaces import InterfacesArgs
from quantum.module_utils.network.nxos.utils.utils import get_interface_type
...
class InterfacesFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('interfaces', None)
        facts = {}
        facts['interfaces'] = []
        if objs:
        ...
        quantum_facts['quantum_network_resources']['default_interfaces'] = default_interfaces
        quantum_facts['intf_defs'] = intf_defs
