...
from quantum.module_utils.network.nxos.argspec.bfd_interfaces.bfd_interfaces import Bfd_interfacesArgs
...
class Bfd_interfacesFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('bfd_interfaces', None)
        facts = {}
        if objs:
