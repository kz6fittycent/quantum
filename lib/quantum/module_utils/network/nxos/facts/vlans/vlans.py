...
from quantum.module_utils.network.common.utils import parse_conf_arg, parse_conf_cmd_arg
from quantum.module_utils.network.nxos.argspec.vlans.vlans import VlansArgs
...
class VlansFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('vlans', None)
        facts = {}
        if objs:
            facts['vlans'] = []
