...
from quantum.module_utils.network.common.utils import to_list, dict_diff, param_list_to_dict
from quantum.module_utils.network.eos.facts.facts import Facts
from quantum.module_utils.network.eos.utils.utils import normalize_interface
