...
from quantum.module_utils.network.ios.utils.utils import filter_dict_having_none_value
...
class Lldp_global(ConfigBase):
    ...
    def get_lldp_global_facts(self):
        ...
        lldp_global_facts = facts['quantum_network_resources'].get('lldp_global')
