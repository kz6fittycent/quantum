...
from quantum.module_utils.network.junos.facts.facts import Facts
from quantum.module_utils.network.junos.junos import locked_config, load_config, commit_configuration, discard_changes, tostring
from quantum.module_utils.network.junos.utils.utils import get_resource_config
from quantum.module_utils.network.common.netconf import build_root_xml_node, build_child_xml_node, build_subtree
...
class Lag_interfaces(ConfigBase):
    ...
    def get_lag_interfaces_facts(self):
        ...
        lag_interfaces_facts = facts['quantum_network_resources'].get('lag_interfaces')
