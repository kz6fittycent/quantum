...
from quantum.module_utils.network.junos.junos import get_param, tostring
from quantum.module_utils.network.junos.junos import get_configuration, get_capabilities
