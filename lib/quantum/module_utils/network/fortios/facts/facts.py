...
from quantum.module_utils.network.fortios.argspec.facts.facts import FactsArgs
from quantum.module_utils.network.fortios.argspec.system.system import SystemArgs
from quantum.module_utils.network.common.facts.facts import FactsBase
from quantum.module_utils.network.fortios.facts.system.system import SystemFacts
...
class Facts(FactsBase):
    ...
    def get_network_legacy_facts(self, fact_legacy_obj_map, legacy_facts_type=None):
        ...
        if runable_subsets:
            self.quantum_facts['quantum_net_gather_subset'] = []
            ...
            for inst in instances:
                inst.populate_facts(self._connection, self.quantum_facts)
