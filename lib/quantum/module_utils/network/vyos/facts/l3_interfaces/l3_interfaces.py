...
from quantum.module_utils.network.vyos.argspec.l3_interfaces.l3_interfaces import L3_interfacesArgs
...
class L3_interfacesFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('l3_interfaces', None)
        facts = {}
        if objs:
            facts['l3_interfaces'] = []
