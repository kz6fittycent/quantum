...
from quantum.module_utils.network.common.utils import to_list, dict_diff
from quantum.module_utils.network.vyos.facts.facts import Facts
from quantum.module_utils.six import iteritems
from quantum.module_utils.network.vyos.utils.utils import get_lst_diff_for_dicts, list_diff_have_only
