...
from quantum.module_utils.network.exos.argspec.lldp_global.lldp_global \
    import Lldp_globalArgs
from quantum.module_utils.network.exos.exos import send_requests
...
class Lldp_globalFacts(object):
    ...
    def populate_facts(self, connection, quantum_facts, data=None):
        ...
        quantum_facts['quantum_network_resources'].pop('lldp_global', None)
        facts = {}
