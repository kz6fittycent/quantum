...
from quantum.module_utils.network.common.utils import dict_diff
from quantum.module_utils.six import iteritems
from quantum.module_utils.network.common.utils import remove_empties
from quantum.module_utils.network.iosxr. \
