...
from quantum.module_utils.network.common.utils \
    import (
        to_list,
        dict_diff,
        remove_empties,
...
from quantum.module_utils.network.iosxr.utils.utils \
    import (
        diff_list_of_dicts,
        pad_commands,
        flatten_dict,
...
class Lag_interfaces(ConfigBase):
    ...
    def get_lag_interfaces_facts(self):
        ...
        lag_interfaces_facts = facts['quantum_network_resources'].get(
            'lag_interfaces')
