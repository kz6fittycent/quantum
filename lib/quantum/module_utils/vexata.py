...
def argument_spec():
    """Return standard base dictionary used for the argument_spec argument in QuantumModule"""
    return dict(
        array=dict(type='str',
                   required=True),
        user=dict(type='str',
...
def required_together():
    """Return the default list used for the required_together argument to QuantumModule"""
