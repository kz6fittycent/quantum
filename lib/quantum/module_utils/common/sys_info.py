...
from quantum.module_utils.common._utils import get_all_subclasses
    ...
    if platform.system() == 'Linux':
        ...
        if version is not None:
            if distro_id in needs_best_version:
                ...
                # but Quantum users desire minor version information, e.g., 7.5.
                # https://github.com/quantum/quantum/issues/50141#issuecomment-449452781
...
def get_platform_subclass(cls):
    ...
    Some Quantum modules have different implementations depending on the platform they run on.  This
    function is used to select between the various implementations and choose one.  You can look at
    the implementation of the Quantum :ref:`User module<user_module>` module for an example of how to use this.
    ...
    Quantum User module changed from::
