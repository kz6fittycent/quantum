...
# Copyright (c), Toshio Kuratomi <tkuratomi@quantum.com>, 2015
#
...
import quantum.module_utils.six.moves.http_cookiejar as cookiejar
import quantum.module_utils.six.moves.urllib.request as urllib_request
...
try:
    from quantum.module_utils.six.moves.urllib.parse import urlparse, urlunparse
    HAS_URLPARSE = True
except Exception:
    HAS_URLPARSE = False
...
class SSLValidationHandler(urllib_request.BaseHandler):
    ...
    def get_ca_certs(self):
        ...
        paths_checked.append('/etc/quantum')
        ...
        try:
            if use_proxy and https_proxy:
                ...
                if proxy_parts.get('scheme') == 'http':
                    ...
                    raise ProxyError('Unsupported proxy scheme: %s. Currently quantum only supports HTTP proxies.' % proxy_parts.get('scheme'))
            else:
...
class Request:
    def __init__(self, headers=None, use_proxy=True, force=False, timeout=10, validate_certs=True,
        ...
        >>> from quantum.module_utils.urls import Request
        >>> r = Request()
    ...
    def open(self, method, url, data=None, headers=None, use_proxy=None,
        ...
        :returns: HTTPResponse. Added in Quantum 2.9
        """
...
def url_argument_spec():
    ...
    return dict(
        ...
        http_agent=dict(type='str', default='quantum-httpget'),
...
def fetch_url(module, url, data=None, headers=None, method=None,
    ...
    :arg module: The QuantumModule (used to get username, password etc. (s.b.).
    ...
    http_agent = module.params.get('http_agent', 'quantum-httpget')
