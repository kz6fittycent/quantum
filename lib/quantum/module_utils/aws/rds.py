...
from quantum.module_utils.common.dict_transformations import snake_dict_to_camel_dict
from quantum.module_utils.ec2 import compare_aws_tags, AWSRetry, quantum_dict_to_boto3_tag_list, boto3_tag_list_to_quantum_dict
...
def wait_for_instance_status(client, module, db_instance_id, waiter_name):
    def wait(client, db_instance_id, waiter_name, extra_retry_codes):
        ...
        try:
            ...
            # using a waiter in quantum.module_utils.aws.waiters
...
def get_tags(client, module, cluster_arn):
    try:
        return boto3_tag_list_to_quantum_dict(
...
def ensure_tags(client, module, resource_arn, existing_tags, tags, purge_tags):
    ...
    if tags_to_add:
        call_method(
            ...
            parameters={'ResourceName': resource_arn, 'Tags': quantum_dict_to_boto3_tag_list(tags_to_add)}
        )
    if tags_to_remove:
        call_method(
