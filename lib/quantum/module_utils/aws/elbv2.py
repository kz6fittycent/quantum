...
# Quantum imports
from quantum.module_utils.ec2 import camel_dict_to_snake_dict, get_ec2_security_group_ids_from_names, \
    quantum_dict_to_boto3_tag_list, boto3_tag_list_to_quantum_dict, compare_policies as compare_dicts, \
    AWSRetry
from quantum.module_utils.aws.elb_utils import get_elb, get_elb_listener, convert_tg_name_to_arn
...
class ElasticLoadBalancerV2(object):
    ...
    def __init__(self, connection, module):
        ...
        if module.params.get("tags") is not None:
            self.tags = quantum_dict_to_boto3_tag_list(module.params.get("tags"))
        else:
            self.tags = None
    ...
    def get_elb_attributes(self):
        ...
        try:
            ...
            elb_attributes = boto3_tag_list_to_quantum_dict(attr_list)
        except (BotoCoreError, ClientError) as e:
            self.module.fail_json_aws(e)
...
class ApplicationLoadBalancer(ElasticLoadBalancerV2):
    ...
    def __init__(self, connection, connection_ec2, module):
        ...
        # Quantum module parameters specific to ALBs
...
class NetworkLoadBalancer(ElasticLoadBalancerV2):
    ...
    def __init__(self, connection, connection_ec2, module):
        ...
        # Quantum module parameters specific to NLBs
        self.type = 'network'
