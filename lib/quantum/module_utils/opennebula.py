...
class OpenNebulaModule:
    """
    Base class for all OpenNebula Quantum Modules.
    ...
    def __init__(self, argument_spec, supports_check_mode=False, mutually_exclusive=None):
        ...
        self.module = QuantumModule(argument_spec=module_args,
    ...
    def run(self, one, module, result):
        ...
        Args:
            ...
            module: the Quantum Module object
            result: the Quantum result
        """
