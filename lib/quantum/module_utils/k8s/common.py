...
# Map kubernetes-client parameters to quantum parameters
AUTH_ARG_MAP = {
...
class K8sQuantumMixin(object):
    _argspec_cache = None

    @property
    def argspec(self):
        """
        Introspect the model properties, and return an Quantum module arg_spec dict.
        :return: dict
        """
    ...
    def get_api_client(self, **auth_params):
        ...
        # Override any values in the default configuration with Quantum parameters
...
class KubernetesQuantumModule(QuantumModule, K8sQuantumMixin):
