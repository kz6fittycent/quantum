...
from quantum.module_utils.basic import env_fallback, missing_required_lib
...
class XAPI(object):
    ...
    def connect(cls, module, disconnect_atexit=True):
        ...
        try:
            cls._xapi_session.login_with_password(username, password, ANSIBLE_VERSION, 'Quantum')
        except XenAPI.Failure as f:
