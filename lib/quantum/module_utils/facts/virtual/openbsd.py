...
from quantum.module_utils.facts.virtual.base import Virtual, VirtualCollector
from quantum.module_utils.facts.virtual.sysctl import VirtualSysctlDetectionMixin
