...
from quantum.module_utils.facts.utils import get_file_content, get_mount_size
    ...
    def get_cpu_facts(self, collected_facts=None):
        ...
        for line in out.splitlines():
            ...
            if key == 'module:':
                ...
                # FIXME
                if collected_facts.get('quantum_machine') != 'i86pc':
                    processor += " @ " + clock_mhz + "MHz"
                if 'quantum_processor' not in collected_facts:
                    cpu_facts['processor'] = []
