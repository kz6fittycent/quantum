...
from quantum.module_utils.facts.utils import get_file_content, get_file_lines, get_mount_size
...
class LinuxHardware(Hardware):
    ...
    def get_cpu_facts(self, collected_facts=None):
        ...
        if collected_facts.get('quantum_architecture', '').startswith(('armv', 'aarch', 'ppc')):
            i = processor_occurence

        # FIXME
        if collected_facts.get('quantum_architecture') != 's390x':
            if xen_paravirt:
    ...
    def get_mount_info(self, mount, device, uuids):
        ...
        # https://github.com/quantum/quantum/issues/36077
