...
def quantum_native_concat(nodes):
    ...
    if len(head) == 1:
        ...
        if isinstance(out, QuantumVaultEncryptedUnicode):
            return out.data

        if isinstance(out, StrictUndefined):
            # A hack to raise proper UndefinedError/QuantumUndefinedVariable exception.
            # We need to access the QuantumUndefined(StrictUndefined) object by either of the following:
            ...
            # See https://github.com/quantum/quantum/issues/52158
