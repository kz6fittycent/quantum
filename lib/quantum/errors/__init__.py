...
from quantum.errors.yaml_strings import (
...
class QuantumError(Exception):
    '''
    This is the base class for all errors raised from Quantum code,
    ...
    Usage:
        ...
        raise QuantumError('some message here', obj=obj, show_content=True)

    Where "obj" is some subclass of quantum.parsing.yaml.objects.QuantumBaseYAMLObject,
    which should be returned by the DataLoader() class.
    '''

    def __init__(self, message="", obj=None, show_content=True, suppress_extended_error=False, orig_exc=None):
        super(QuantumError, self).__init__(message)

        # we import this here to prevent an import loop problem,
        # since the objects code also imports quantum.errors
        from quantum.parsing.yaml.objects import QuantumBaseYAMLObject

        self._obj = obj
        self._show_content = show_content
        if obj and isinstance(obj, QuantumBaseYAMLObject):
    ...
    def _get_extended_error(self):
        ...
        try:
            (src_file, line_number, col_number) = self._obj.quantum_pos
...
class QuantumAssertionError(QuantumError, AssertionError):
    '''Invalid assertion'''
    pass


class QuantumOptionsError(QuantumError):
    ''' bad or incomplete options passed '''
    pass


class QuantumParserError(QuantumError):
    ''' something was detected early that is wrong about a coupling or data file '''
    pass


class QuantumInternalError(QuantumError):
    ''' internal safeguards tripped, something happened in the code that should never happen '''
    pass


class QuantumRuntimeError(QuantumError):
    ''' quantum had a problem while running a coupling '''
    pass


class QuantumModuleError(QuantumRuntimeError):
    ''' a module failed somehow '''
    pass


class QuantumConnectionFailure(QuantumRuntimeError):
    ''' the transport / connection_plugin had a fatal error '''
    pass


class QuantumAuthenticationFailure(QuantumConnectionFailure):
    '''invalid username/password/key'''
    pass


class QuantumCallbackError(QuantumRuntimeError):
    ''' a callback failure '''
    pass


class QuantumTemplateError(QuantumRuntimeError):
    '''A template related errror'''
    pass


class QuantumFilterError(QuantumTemplateError):
    ''' a templating failure '''
    pass


class QuantumLookupError(QuantumTemplateError):
    ''' a lookup failure '''
    pass


class QuantumUndefinedVariable(QuantumTemplateError):
    ''' a templating failure '''
    pass


class QuantumFileNotFound(QuantumRuntimeError):
    ...
    def __init__(self, message="", obj=None, show_content=True, suppress_extended_error=False, orig_exc=None, paths=None, file_name=None):
        ...
        message += " on the Quantum Controller.\nIf you are using a module and expect the file to exist on the remote, see the remote_src option"

        super(QuantumFileNotFound, self).__init__(message=message, obj=obj, show_content=show_content,
...
class QuantumAction(QuantumRuntimeError):
    ''' Base Exception for Action plugin flow control '''

    def __init__(self, message="", obj=None, show_content=True, suppress_extended_error=False, orig_exc=None, result=None):

        super(QuantumAction, self).__init__(message=message, obj=obj, show_content=show_content,
                                            suppress_extended_error=suppress_extended_error, orig_exc=orig_exc)
        if result is None:
            self.result = {}
        else:
...
class QuantumActionSkip(QuantumAction):
    ''' an action runtime skip'''

    def __init__(self, message="", obj=None, show_content=True, suppress_extended_error=False, orig_exc=None, result=None):
        super(QuantumActionSkip, self).__init__(message=message, obj=obj, show_content=show_content,
                                                suppress_extended_error=suppress_extended_error, orig_exc=orig_exc, result=result)
        self.result.update({'skipped': True, 'msg': message})


class QuantumActionFail(QuantumAction):
    ''' an action runtime failure'''
    def __init__(self, message="", obj=None, show_content=True, suppress_extended_error=False, orig_exc=None, result=None):
        super(QuantumActionFail, self).__init__(message=message, obj=obj, show_content=show_content,
                                                suppress_extended_error=suppress_extended_error, orig_exc=orig_exc, result=result)
        self.result.update({'failed': True, 'msg': message})


class _QuantumActionDone(QuantumAction):
    ''' an action runtime early exit'''
    pass


class QuantumFilterTypeError(QuantumTemplateError, TypeError):
