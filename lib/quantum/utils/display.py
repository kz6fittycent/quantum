...
class Display(with_metaclass(Singleton, object)):
    ...
    def display(self, msg, color=None, stderr=False, screen_only=False, log_only=False, newline=True):
        ...
        if not log_only:
            ...
            # code in 'bin/quantum-connection' (and other relevant places).
            if not stderr:
                fileobj = sys.stdout
            else:
                fileobj = sys.stderr
        ...
        if logger and not screen_only:
            ...
            if color:
                ...
                try:
                    ...
                    raise QuantumAssertionError('Invalid color supplied to display: %s' % color)
            # actually log
            logger.log(lvl, msg2)
    ...
    def deprecated(self, msg, version=None, removed=False, date=None, collection_name=None):
        ...
        if not removed:
            ...
            new_msg = new_msg + " Deprecation warnings can be disabled by setting deprecation_warnings=False in quantum.cfg.\n\n"
        else:
            raise QuantumError("[DEPRECATED]: %s.\nPlease update your couplings." % msg)
    ...
    def do_var_prompt(self, varname, private=True, prompt=None, encrypt=None, confirm=False, salt_size=None, salt=None, default=None, unsafe=None):
        ...
        if encrypt:
            ...
            from quantum.utils.encrypt import do_encrypt
