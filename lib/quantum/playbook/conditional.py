...
class Conditional:
    ...
    def __init__(self, loader=None):
        ...
        # is used as a mix-in with a coupling base class
        if not hasattr(self, '_loader'):
            if loader is None:
                raise QuantumError("a loader must be specified when using Conditional() directly")
            else:
                self._loader = loader
    ...
    def _check_conditional(self, conditional, templar, all_vars):
        ...
        try:
            ...
            try:
                ...
                raise QuantumError("Invalid conditional detected: %s" % to_native(e))
            ...
            if val == "True":
                ...
                raise QuantumError("unable to evaluate conditional: %s" % original)
            ...
            try:
                ...
                # trigger the QuantumUndefinedVariable exception again below
                raise
            except Exception:
                raise QuantumUndefinedVariable("error while evaluating conditional (%s): %s" % (original, e))
