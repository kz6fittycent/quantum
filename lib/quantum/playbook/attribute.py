...
class Attribute:
    ...
    def __init__(
        ...
        derive from coupling data.  The attributes of the object are basically
        a schema for the yaml coupling.
        ...
        :kwarg private: Not used at runtime.  The docs coupling keyword dumper uses it to determine
