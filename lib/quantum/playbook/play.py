...
from quantum.coupling.helpers import load_list_of_blocks, load_list_of_roles
from quantum.coupling.role import Role
from quantum.coupling.taggable import Taggable
from quantum.vars.manager import preprocess_vars
...
class Play(Base, Taggable, CollectionSearch):
    ...
    def load(data, variable_manager=None, loader=None, vars=None):
        if ('name' not in data or data['name'] is None) and 'hosts' in data:
            if data['hosts'] is None or all(host is None for host in data['hosts']):
                raise QuantumParserError("Hosts list cannot be empty - please check your coupling")
    ...
    def preprocess_data(self, ds):
        ...
        if not isinstance(ds, dict):
            raise QuantumAssertionError('while preprocessing data (%s), ds should be a dict but was a %s' % (ds, type(ds)))
        ...
        if 'user' in ds:
            ...
            if 'remote_user' in ds:
                raise QuantumParserError("both 'user' and 'remote_user' are set for %s. "
    ...
    def _load_tasks(self, attr, ds):
        ...
        try:
            ...
            raise QuantumParserError("A malformed block was encountered while loading tasks: %s" % to_native(e), obj=self._ds, orig_exc=e)
    ...
    def _load_pre_tasks(self, attr, ds):
        ...
        try:
            ...
            raise QuantumParserError("A malformed block was encountered while loading pre_tasks", obj=self._ds, orig_exc=e)
    ...
    def _load_post_tasks(self, attr, ds):
        ...
        try:
            ...
            raise QuantumParserError("A malformed block was encountered while loading post_tasks", obj=self._ds, orig_exc=e)
    ...
    def _load_handlers(self, attr, ds):
        ...
        try:
            ...
            raise QuantumParserError("A malformed block was encountered while loading handlers", obj=self._ds, orig_exc=e)
    ...
    def _load_roles(self, attr, ds):
        ...
        try:
            ...
            raise QuantumParserError("A malformed role declaration was encountered.", obj=self._ds, orig_exc=e)
        ...
        if new_ds is not None:
            for prompt_data in new_ds:
                if 'name' not in prompt_data:
                    raise QuantumParserError("Invalid vars_prompt data structure", obj=ds)
                else:
