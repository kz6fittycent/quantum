########################################################################
#
# (C) 2015, Chris Houseknecht <chouse@quantum.com>
#
...
class NoTokenSentinel(object):
    """ Represents an quantum.cfg server with not token defined (will ignore cmdline and GALAXY_TOKEN_PATH. """
...
class KeycloakToken(object):
    ...
    def get(self):
        ...
        #    - 'request_token' is the offline token stored in quantum.cfg
...
class GalaxyToken(object):
    ''' Class to storing and retrieving local fog token '''
