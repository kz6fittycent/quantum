                    ...
                    if theid in string_to_vars:
                        ...
                        if isinstance(child.value, ast.Dict):
                            ...
                            if theid == 'DOCUMENTATION':
                                ...
                                data[varkey] = QuantumLoader(child.value.s, file_name=filename).get_single_data()
                            else:
...
def read_docstub(filename):
    ...
    data = QuantumLoader(short_description, file_name=filename).get_single_data()
