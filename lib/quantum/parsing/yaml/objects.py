...
class QuantumBaseYAMLObject(object):
    '''
    ...
    def _get_quantum_position(self):
        return (self._data_source, self._line_number, self._column_number)

    def _set_quantum_position(self, obj):
        try:
            (src, line, col) = obj
        except (TypeError, ValueError):
            raise AssertionError(
                'quantum_pos can only be set with a tuple/list '
    ...
    quantum_pos = property(_get_quantum_position, _set_quantum_position)


class QuantumMapping(QuantumBaseYAMLObject, dict):
    ''' sub class for dictionaries '''
    pass


class QuantumUnicode(QuantumBaseYAMLObject, text_type):
    ''' sub class for unicode objects '''
    pass


class QuantumSequence(QuantumBaseYAMLObject, list):
    ''' sub class for lists '''
    pass
...
class QuantumVaultEncryptedUnicode(yaml.YAMLObject, QuantumBaseYAMLObject):
    __UNSAFE__ = True
    __ENCRYPTED__ = True
    yaml_tag = u'!vault'
    ...
    def from_plaintext(cls, seq, vault, secret):
        if not vault:
            raise vault.QuantumVaultError('Error creating QuantumVaultEncryptedUnicode, invalid vault (%s) provided' % vault)
    ...
    def __init__(self, ciphertext):
        '''A QuantumUnicode with a Vault attribute that can decrypt it.
        ...
        '''
        super(QuantumVaultEncryptedUnicode, self).__init__()
