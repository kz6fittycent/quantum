...
from quantum.parsing.yaml.objects import QuantumMapping, QuantumSequence, QuantumUnicode
...
class QuantumConstructor(SafeConstructor):
    def __init__(self, file_name=None, vault_secrets=None):
        self._quantum_file_name = file_name
        super(QuantumConstructor, self).__init__()
        self._vaults = {}
    ...
    def construct_yaml_map(self, node):
        ...
        data.update(value)
        data.quantum_pos = self._node_position_info(node)
    ...
    def construct_mapping(self, node, deep=False):
        ...
        mapping.quantum_pos = self._node_position_info(node)
        ...
        for key_node, value_node in node.value:
            ...
            if key in mapping:
                msg = (u'While constructing a mapping from {1}, line {2}, column {3}, found a duplicate dict key ({0}).'
                       u' Using last defined value only.'.format(key, *mapping.quantum_pos))
    ...
    def construct_yaml_str(self, node):
        ...
        ret = QuantumUnicode(value)

        ret.quantum_pos = self._node_position_info(node)
    ...
    def construct_vault_encrypted_unicode(self, node):
        ...
        if vault.secrets is None:
            raise ConstructorError(context=None, context_mark=None,
                                   ...
                                   note=None)
        ret = QuantumVaultEncryptedUnicode(b_ciphertext_data)
        ret.vault = vault
        return ret

    def construct_yaml_seq(self, node):
        data = QuantumSequence()
        yield data
    ...
    def _node_position_info(self, node):
        ...
        datasource = self._quantum_file_name or node.start_mark.name

        return (datasource, line, column)


QuantumConstructor.add_constructor(
    u'tag:yaml.org,2002:map',
    QuantumConstructor.construct_yaml_map)
...
QuantumConstructor.add_constructor(
    ...
    QuantumConstructor.construct_yaml_str)
...
QuantumConstructor.add_constructor(
    ...
    QuantumConstructor.construct_yaml_seq)

QuantumConstructor.add_constructor(
    u'!unsafe',
    QuantumConstructor.construct_yaml_unsafe)

QuantumConstructor.add_constructor(
    u'!vault',
    QuantumConstructor.construct_vault_encrypted_unicode)

QuantumConstructor.add_constructor(u'!vault-encrypted', QuantumConstructor.construct_vault_encrypted_unicode)
